...
if (!class_exists("ConversionTrackerService", false)) {
  ...
  class ConversionTrackerService extends AdWordsSoapClient {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/cm/v201710";
    const ENDPOINT = "https://adwords.google.com/api/adwords/cm/v201710/ConversionTrackerService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://adwords.google.com/api/adwords/cm/v201710/ConversionTrackerService";
    /**
