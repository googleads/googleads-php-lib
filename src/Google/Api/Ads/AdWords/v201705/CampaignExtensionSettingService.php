...
if (!class_exists("MessageFeedItem", false)) {
  /**
   * Represents a Message extension.
   * @package Google_Api_Ads_AdWords_v201705
   * @subpackage v201705
   */
  class MessageFeedItem extends ExtensionFeedItem {

    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/cm/v201705";
    const XSI_TYPE = "MessageFeedItem";

    /**
     * @access public
     * @var string
     */
    public $messageBusinessName;
     ...
     * @var string
     */
    public $messagePhoneNumber;

    /**
     * @access public
     * @var string
     */
    public $messageExtensionText;
    ...
    public function __construct($messageBusinessName = null, $messageCountryCode = null, $messagePhoneNumber = null, $messageExtensionText = null, $messageText = null, $feedId = null, $feedItemId = null, $status = null, $feedType = null, $startTime = null, $endTime = null, $devicePreference = null, $scheduling = null, $campaignTargeting = null, $adGroupTargeting = null, $keywordTargeting = null, $geoTargeting = null, $geoTargetingRestriction = null, $policyData = null, $ExtensionFeedItemType = null) {
      parent::__construct();
...
if (!class_exists("PromotionFeedItem", false)) {
  /**
   * Represents a promotion extension.
   * @package Google_Api_Ads_AdWords_v201705
   * @subpackage v201705
   */
  class PromotionFeedItem extends ExtensionFeedItem {

    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/cm/v201705";
    const XSI_TYPE = "PromotionFeedItem";
    ...
    /**
     * @access public
     * @var tnsPromotionExtensionDiscountModifier
     */
    ...
    /**
     * @access public
     * @var tnsPromotionExtensionOccasion
     */
    public $occasion;
     ...
     */
    public $promotionUrlCustomParameters;
...
if (!class_exists("PromotionExtensionDiscountModifier", false)) {
  /**
...
if (!class_exists("PromotionExtensionOccasion", false)) {
  /**
  ...
  class PromotionExtensionOccasion {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/cm/v201705";
    const XSI_TYPE = "PromotionExtensionOccasion";
...
if (!class_exists("CampaignExtensionSettingService", false)) {
  ...
  class CampaignExtensionSettingService extends AdWordsSoapClient {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/cm/v201705";
    const ENDPOINT = "https://adwords.google.com/api/adwords/cm/v201705/CampaignExtensionSettingService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://adwords.google.com/api/adwords/cm/v201705/CampaignExtensionSettingService";
    /**
    ...
    public static $classmap = array(
      ...
      "PromotionExtensionDiscountModifier" => "PromotionExtensionDiscountModifier",
      "PromotionExtensionOccasion" => "PromotionExtensionOccasion",
