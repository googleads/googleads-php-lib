...
if (!class_exists("ConstantDataService", false)) {
  ...
  class ConstantDataService extends AdWordsSoapClient {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/cm/v201802";
    const ENDPOINT = "https://adwords.google.com/api/adwords/cm/v201802/ConstantDataService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://adwords.google.com/api/adwords/cm/v201802/ConstantDataService";
    /**
