<?php
/**
 * Contains all client objects for the CampaignGroupPerformanceTargetService
 * service.
 *
 * PHP version 5
 *
...
if (!class_exists("CampaignGroupPerformanceTargetService", false)) {
  ...
  class CampaignGroupPerformanceTargetService extends AdWordsSoapClient {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/cm/v201802";
    const ENDPOINT = "https://adwords.google.com/api/adwords/cm/v201802/CampaignGroupPerformanceTargetService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://adwords.google.com/api/adwords/cm/v201802/CampaignGroupPerformanceTargetService";
    /**
