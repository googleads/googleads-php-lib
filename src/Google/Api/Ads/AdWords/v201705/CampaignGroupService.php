<?php
/**
 * Contains all client objects for the CampaignGroupService
 * service.
 *
 * PHP version 5
 *
...
if (!class_exists("CampaignGroupOperation", false)) {
   ...
   * @subpackage v201705
   */
  class CampaignGroupOperation extends Operation {

    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/cm/v201802";
    const XSI_TYPE = "CampaignGroupOperation";
...
if (!class_exists("CampaignGroupPage", false)) {
  /**
   ...
   * @subpackage v201705
   */
  class CampaignGroupPage extends Page {

    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/cm/v201802";
    const XSI_TYPE = "CampaignGroupPage";
...
if (!class_exists("CampaignGroupReturnValue", false)) {
  /**
   * A container for return values from the CampaignGroupService mutate calls.
   * @package Google_Api_Ads_AdWords_v201705
   * @subpackage v201705
   */
  class CampaignGroupReturnValue extends ListReturnValue {

    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/cm/v201802";
    const XSI_TYPE = "CampaignGroupReturnValue";
...
if (!class_exists("CampaignGroupService", false)) {
  /**
   * CampaignGroupService
   * @package Google_Api_Ads_AdWords_v201705
   * @subpackage v201705
   */
  class CampaignGroupService extends AdWordsSoapClient {

    const SERVICE_NAME = "CampaignGroupService";
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/cm/v201802";
    const ENDPOINT = "https://adwords.google.com/api/adwords/cm/v201802/CampaignGroupService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://adwords.google.com/api/adwords/cm/v201802/CampaignGroupService";
    /**
    ...
    public static $classmap = array(
      ...
      "CampaignGroupError" => "CampaignGroupError",
      "CampaignGroupOperation" => "CampaignGroupOperation",
      "CampaignGroupPage" => "CampaignGroupPage",
      "CampaignGroupReturnValue" => "CampaignGroupReturnValue",
      ...
      "CampaignGroupError.Reason" => "CampaignGroupErrorReason",
      ...
      "get" => "CampaignGroupServiceGet",
      "getResponse" => "CampaignGroupServiceGetResponse",
      "mutate" => "CampaignGroupServiceMutate",
      "mutateResponse" => "CampaignGroupServiceMutateResponse",
    );
    ...
    public function get($selector) {
      $args = new CampaignGroupServiceGet($selector);
    ...
    public function mutate($operations) {
      $args = new CampaignGroupServiceMutate($operations);
