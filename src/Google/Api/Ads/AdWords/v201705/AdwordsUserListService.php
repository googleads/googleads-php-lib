...
if (!class_exists("AddressInfo", false)) {
  ...
  class AddressInfo {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/rm/v201705";
    const XSI_TYPE = "AddressInfo";
...
if (!class_exists("DataUploadResult", false)) {
  /**
  ...
  class DataUploadResult {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/rm/v201705";
    const XSI_TYPE = "DataUploadResult";

    /**
     * @access public
     * @var tnsUserListUploadStatus
     */
    public $uploadStatus;
...
if (!class_exists("Member", false)) {
  /**
   * Class that holds user list member identifiers. Multiple member identifiers of same member could
   * be provided at the same time. At least one identifier is required to be provided.
   * @package Google_Api_Ads_AdWords_v201705
   * @subpackage v201705
   */
  class Member {
...
if (!class_exists("MutateMembersOperand", false)) {
  ...
  class MutateMembersOperand {
    ...
    public function __construct($userListId = null, $removeAll = null, $membersList = null) {
...
if (!class_exists("RelativeDate", false)) {
  /**
...
if (!class_exists("Rule", false)) {
  ...
  class Rule {
    ...
    /**
     * @access public
     * @var tnsUserListRuleTypeEnumsEnum
     */
    public $ruleType;
    ...
    public function __construct($groups = null, $ruleType = null) {
      $this->groups = $groups;
...
if (!class_exists("RuleBasedUserListPrepopulationStatus", false)) {
  /**
  ...
  class RuleBasedUserListPrepopulationStatus {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/rm/v201705";
    const XSI_TYPE = "RuleBasedUserList.PrepopulationStatus";
...
if (!class_exists("UserListClosingReason", false)) {
  /**
  ...
  class UserListClosingReason {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/rm/v201705";
    const XSI_TYPE = "UserListClosingReason";
...
if (!class_exists("UserListRuleTypeEnumsEnum", false)) {
  /**
   * Rule based userlist rule type.
   * @package Google_Api_Ads_AdWords_v201705
   * @subpackage v201705
   */
  class UserListRuleTypeEnumsEnum {

    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/rm/v201705";
    const XSI_TYPE = "UserListRuleTypeEnums.Enum";
...
if (!class_exists("UserListUploadStatus", false)) {
  /**
   * The status of the upload/remove-all operation on a CRM based UserList.
   * @package Google_Api_Ads_AdWords_v201705
   * @subpackage v201705
   */
  class UserListUploadStatus {

    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/rm/v201705";
    const XSI_TYPE = "UserListUploadStatus";
...
if (!class_exists("CrmBasedUserList", false)) {
  ...
  class CrmBasedUserList extends UserList {
    ...
    public function __construct($dataUploadResult = null, $id = null, $isReadOnly = null, $name = null, $description = null, $status = null, $integrationCode = null, $accessReason = null, $accountUserListStatus = null, $membershipLifeSpan = null, $size = null, $sizeRange = null, $sizeForSearch = null, $sizeRangeForSearch = null, $listType = null, $isEligibleForSearch = null, $isEligibleForDisplay = null, $closingReason = null, $UserListType = null) {
      parent::__construct();
...
if (!class_exists("RuleBasedUserList", false)) {
  ...
  class RuleBasedUserList extends UserList {
    ...
    /**
     * @access public
     * @var tnsRuleBasedUserListPrepopulationStatus
     */
...
if (!class_exists("DateSpecificRuleUserList", false)) {
  ...
  class DateSpecificRuleUserList extends RuleBasedUserList {
    ...
    public function __construct($rule = null, $startDate = null, $endDate = null, $prepopulationStatus = null) {
      parent::__construct();
      $this->rule = $rule;
...
if (!class_exists("ExpressionRuleUserList", false)) {
  ...
  class ExpressionRuleUserList extends RuleBasedUserList {
    ...
    public function __construct($rule = null, $prepopulationStatus = null) {
      parent::__construct();
      $this->rule = $rule;
      $this->prepopulationStatus = $prepopulationStatus;
    }
...
if (!class_exists("AdwordsUserListService", false)) {
  ...
  class AdwordsUserListService extends AdWordsSoapClient {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/rm/v201705";
    const ENDPOINT = "https://adwords.google.com/api/adwords/rm/v201705/AdwordsUserListService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://adwords.google.com/api/adwords/rm/v201705/AdwordsUserListService";
    /**
    ...
    public static $classmap = array(
      ...
      "RuleBasedUserList.PrepopulationStatus" => "RuleBasedUserListPrepopulationStatus",
      "SizeRange" => "SizeRange",
      "StringRuleItem.StringOperator" => "StringRuleItemStringOperator",
      "UserListClosingReason" => "UserListClosingReason",
      ...
      "UserListRuleTypeEnums.Enum" => "UserListRuleTypeEnumsEnum",
      "UserListType" => "UserListType",
      "UserListUploadStatus" => "UserListUploadStatus",
