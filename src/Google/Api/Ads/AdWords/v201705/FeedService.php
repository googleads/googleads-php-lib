...
if (!class_exists("FeedService", false)) {
  ...
  class FeedService extends AdWordsSoapClient {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/cm/v201802";
    const ENDPOINT = "https://adwords.google.com/api/adwords/cm/v201802/FeedService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://adwords.google.com/api/adwords/cm/v201802/FeedService";
    /**
