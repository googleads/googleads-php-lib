...
if (!class_exists("AdSchedule", false)) {
  ...
  class AdSchedule extends Criterion {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/express/v201609";
...
if (!class_exists("BudgetSuggestionSelector", false)) {
  /**
...
if (!class_exists("CurrencyCode", false)) {
  /**
   * A currency, as defined by Unicode's "CLDR", itself based on ISO 4217. Note that this list does
   * not normally list currencies that have never been the official (or de facto) currency of a
   * country. That means that it excludes
   * 
   * <ul>
   * <li>Fund codes, like BOV Bolivia Mvdol
   * <li>Precious metals, like XAU Gold
   * <li>Other codes of limited usage, like XRE RINET Funds Code
   * </ul>
   * 
   * <p>This class does not supply methods for getting information about currencies. For those
   * methods, see {@link com.google.i18n.identifiers.CurrencyInfo}. The codes are in alphabetical
   * order by code, to prevent the lines from moving around in the list if the common name changes.
   * 
   * <p>It contains no behavior, but is the authoritative definition of Currency <em>identity</em> in
   * java Google code.
   * 
   * <p>Do:
   * 
   * <ul>
   * <li>use it everywhere you need to compare currencies
   * <li>use it in all APIs that take/return a currency, particularly ones you expose to other
   * projects/subsystems
   * <li>get the instance corresponding to an ISO code using {@link #valueOf}
   * <li>get the String ISO code with {@link name}
   * <li>use the String ISO code in your DB as a key to currencies
   * <li>put your project-specific currency-related information in a class under your project root,
   * using an EnumMap to map Currencies to these objects.
   * </ul>
   * 
   * <p>Do <em>not</em>:
   * 
   * <ul>
   * <li>depend on the ordinal of a currency, for example using {@link #ordinal} or depending on the
   * index of a particular currency in the {@link #values} array.
   * <li>depend on the comparison order of currencies, via {@link #compareTo}), or via the iteration
   * order of an EnumSet, etc.
   * </ul>
   * 
   * <p>This enum does not:
   * 
   * <ul>
   * <li>have i18n features
   * <li>have application-specific data (say "billable unit")
   * </ul>
   * 
   * <p>These concerns will be addressed by other classes, some in application-specific packages,
   * others in common.base.i18n. The latter ones will be listed with "see" tags in this class.
   * @package Google_Api_Ads_AdWords_v201609
   * @subpackage v201609
   */
  class CurrencyCode {
...
if (!class_exists("BudgetSuggestionServiceGet", false)) {
  /**
...
if (!class_exists("BudgetSuggestionServiceGetResponse", false)) {
  /**
   * 
   * @package Google_Api_Ads_AdWords_v201609
   * @subpackage v201609
...
if (!class_exists("BudgetSuggestionService", false)) {
  ...
  class BudgetSuggestionService extends AdWordsSoapClient {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/express/v201609";
    const ENDPOINT = "https://adwords.google.com/api/adwords/express/v201609/BudgetSuggestionService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://adwords.google.com/api/adwords/express/v201609/BudgetSuggestionService";
    /**
