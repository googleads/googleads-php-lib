...
if (!class_exists("ExperimentService", false)) {
  ...
  class ExperimentService extends AdWordsSoapClient {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/cm/v201506";
    const ENDPOINT = "https://adwords.google.com/api/adwords/cm/v201506/ExperimentService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://adwords.google.com/api/adwords/cm/v201506/ExperimentService";
    /**
