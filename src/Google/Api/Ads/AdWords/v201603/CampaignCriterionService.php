...
if (!class_exists("CampaignCriterion", false)) {
  ...
  class CampaignCriterion {
    ...
    public function __construct($campaignId = null, $isNegative = null, $criterion = null, $bidModifier = null, $baseCampaignId = null, $forwardCompatibilityMap = null, $CampaignCriterionType = null) {
...
if (!class_exists("CampaignCriterionService", false)) {
  ...
  class CampaignCriterionService extends AdWordsSoapClient {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/cm/v201603";
    const ENDPOINT = "https://adwords.google.com/api/adwords/cm/v201603/CampaignCriterionService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://adwords.google.com/api/adwords/cm/v201603/CampaignCriterionService";
    /**
