...
if (!class_exists("AdGroupBidModifierService", false)) {
  ...
  class AdGroupBidModifierService extends AdWordsSoapClient {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/cm/v201603";
    const ENDPOINT = "https://adwords.google.com/api/adwords/cm/v201603/AdGroupBidModifierService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://adwords.google.com/api/adwords/cm/v201603/AdGroupBidModifierService";
    /**
