...
if (!class_exists("TrafficEstimatorService", false)) {
  ...
  class TrafficEstimatorService extends AdWordsSoapClient {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/o/v201710";
    const ENDPOINT = "https://adwords.google.com/api/adwords/o/v201710/TrafficEstimatorService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://adwords.google.com/api/adwords/o/v201710/TrafficEstimatorService";
    /**
