...
if (!class_exists("SharedCriterionService", false)) {
  ...
  class SharedCriterionService extends AdWordsSoapClient {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/cm/v201710";
    const ENDPOINT = "https://adwords.google.com/api/adwords/cm/v201710/SharedCriterionService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://adwords.google.com/api/adwords/cm/v201710/SharedCriterionService";
    /**
