...
class ReportUtils {
   ...
   * @param Google\Api\Ads\AdWords\Lib\AdWordsUser $user the user that created the ReportDefinition
   ...
   * @param string $path an optional path of the file to download the report to
   * @param Google\Api\Ads\AdWords\Lib\AdWordsUser $user the user to retrieve report with
   ...
   * @param Google\Api\Ads\AdWords\Lib\AdWordsUser $user the AdWordsUser to make the request for
   ...
   * @param Google\Api\Ads\AdWords\Lib\AdWordsUser $user the AdWordsUser to get credentials from
...
if (!class_exists("Google\\Api\\Ads\\AdWords\\Util\\ReportDefinition", FALSE)) {
  /**
...
if (!class_exists("Google\\Api\\Ads\\AdWords\\Util\\Selector", FALSE)) {
  /**
...
if (!class_exists("Google\\Api\\Ads\\AdWords\\Util\\Predicate", FALSE)) {
  /**
...
if (!class_exists("Google\\Api\\Ads\\AdWords\\Util\\PredicateOperator", FALSE)) {
  /**
...
if (!class_exists("Google\\Api\\Ads\\AdWords\\Util\\DateRange", FALSE)) {
/**
...
if (!class_exists("Google\\Api\\Ads\\AdWords\\Util\\OrderBy", FALSE)) {
/**
...
if (!class_exists("Google\\Api\\Ads\\AdWords\\Util\\Paging", FALSE)) {
/**
...
if (!class_exists("Google\\Api\\Ads\\AdWords\\Util\\SortOrder", FALSE)) {
/**
...
if (!class_exists("Google\\Api\\Ads\\AdWords\\Util\\ReportDefinitionReportType", FALSE)) {
/**
...
if (!class_exists("Google\\Api\\Ads\\AdWords\\Util\\ReportDefinitionDateRangeType", FALSE)) {
/**
...
if (!class_exists("Google\\Api\\Ads\\AdWords\\Util\\DownloadFormat", FALSE)) {
/**
