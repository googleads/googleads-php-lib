<?php
/**
 * Contains all client objects for the AdGroupExtensionSettingService
 * service.
 *
 * PHP version 5
 *
...
if (!class_exists("AdGroupExtensionSettingServiceGet", false)) {
  /**
...
if (!class_exists("AdGroupExtensionSettingServiceGetResponse", false)) {
  /**
   * 
   * @package Google_Api_Ads_AdWords_v201502
   * @subpackage v201502
   */
  class AdGroupExtensionSettingServiceGetResponse {
    ...
    /**
     * @access public
     * @var AdGroupExtensionSettingPage
     */
    public $rval;
...
if (!class_exists("AdGroupExtensionSettingServiceMutate", false)) {
  /**
...
if (!class_exists("AdGroupExtensionSettingServiceMutateResponse", false)) {
  /**
   * 
   * @package Google_Api_Ads_AdWords_v201502
   * @subpackage v201502
   */
  class AdGroupExtensionSettingServiceMutateResponse {
    ...
    /**
     * @access public
     * @var AdGroupExtensionSettingReturnValue
     */
    public $rval;
...
if (!class_exists("AdGroupExtensionSettingOperation", false)) {
  /**
...
if (!class_exists("AdGroupExtensionSettingPage", false)) {
  /**
...
if (!class_exists("AdGroupExtensionSettingReturnValue", false)) {
  /**
...
if (!class_exists("AdGroupExtensionSettingService", false)) {
  /**
  ...
  class AdGroupExtensionSettingService extends AdWordsSoapClient {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/cm/v201502";
    const ENDPOINT = "https://adwords.google.com/api/adwords/cm/v201502/AdGroupExtensionSettingService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://adwords.google.com/api/adwords/cm/v201502/AdGroupExtensionSettingService";
    /**
