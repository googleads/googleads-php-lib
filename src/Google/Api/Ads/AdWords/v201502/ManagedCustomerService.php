...
if (!class_exists("ManagedCustomer", false)) {
  ...
  class ManagedCustomer {
    ...
    public function __construct($name = null, $companyName = null, $customerId = null, $canManageClients = null, $currencyCode = null, $dateTimeZone = null, $testAccount = null, $accountLabels = null) {
      $this->name = $name;
