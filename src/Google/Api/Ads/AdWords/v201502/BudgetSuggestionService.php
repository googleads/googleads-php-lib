...
if (!class_exists("BudgetSuggestionService", false)) {
  ...
  class BudgetSuggestionService extends AdWordsSoapClient {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/express/v201502";
    const ENDPOINT = "https://adwords.google.com/api/adwords/express/v201502/BudgetSuggestionService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://adwords.google.com/api/adwords/express/v201502/BudgetSuggestionService";
    /**
