...
if (!class_exists("AdGroupAdService", false)) {
  ...
  class AdGroupAdService extends AdWordsSoapClient {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/cm/v201601";
    const ENDPOINT = "https://adwords.google.com/api/adwords/cm/v201601/AdGroupAdService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://adwords.google.com/api/adwords/cm/v201601/AdGroupAdService";
    /**
