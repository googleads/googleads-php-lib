<?php
/**
 * Contains all client objects for the BatchJobService
 * service.
 *
 * PHP version 5
 *
...
if (!class_exists("ProgressStats", false)) {
  /**
...
if (!class_exists("TemporaryUrl", false)) {
  /**
...
if (!class_exists("BatchJob", false)) {
  /**
...
if (!class_exists("BatchJobErrorReason", false)) {
  /**
   * The reason for the error.
   * @package Google_Api_Ads_AdWords_v201702
   * @subpackage v201702
   */
  class BatchJobErrorReason {

    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/cm/v201702";
    const XSI_TYPE = "BatchJobError.Reason";
...
if (!class_exists("BatchJobProcessingErrorReason", false)) {
  /**
   * The reason for the error.
   * @package Google_Api_Ads_AdWords_v201702
   * @subpackage v201702
   */
  class BatchJobProcessingErrorReason {

    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/cm/v201702";
    const XSI_TYPE = "BatchJobProcessingError.Reason";
...
if (!class_exists("BatchJobStatus", false)) {
  /**
...
if (!class_exists("BatchJobServiceGet", false)) {
  /**
...
if (!class_exists("BatchJobServiceGetResponse", false)) {
  /**
   * 
   * @package Google_Api_Ads_AdWords_v201702
   * @subpackage v201702
   */
  class BatchJobServiceGetResponse {
...
if (!class_exists("BatchJobServiceMutate", false)) {
  /**
...
if (!class_exists("BatchJobServiceMutateResponse", false)) {
  /**
   * 
   * @package Google_Api_Ads_AdWords_v201702
   * @subpackage v201702
...
if (!class_exists("BatchJobError", false)) {
  /**
   * An error related to a {@code BatchJob}.
   * @package Google_Api_Ads_AdWords_v201702
   * @subpackage v201702
   */
  class BatchJobError extends ApiError {

    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/cm/v201702";
    const XSI_TYPE = "BatchJobError";

    /**
     * @access public
     * @var tnsBatchJobErrorReason
     */
    public $reason;
...
if (!class_exists("BatchJobProcessingError", false)) {
  /**
   * An error related to processing a {@code BatchJob}.
   * @package Google_Api_Ads_AdWords_v201702
   * @subpackage v201702
   */
  class BatchJobProcessingError extends ApiError {
    ...
    /**
     * @access public
     * @var tnsBatchJobProcessingErrorReason
     */
    public $reason;
...
if (!class_exists("BatchJobOperation", false)) {
  /**
...
if (!class_exists("BatchJobService", false)) {
  ...
  class BatchJobService extends AdWordsSoapClient {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/cm/v201702";
    const ENDPOINT = "https://adwords.google.com/api/adwords/cm/v201702/BatchJobService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://adwords.google.com/api/adwords/cm/v201702/BatchJobService";
    /**
