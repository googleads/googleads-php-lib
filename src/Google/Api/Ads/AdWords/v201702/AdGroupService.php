...
if (!class_exists("AdGroupType", false)) {
  /**
...
if (!class_exists("AdGroupService", false)) {
  ...
  class AdGroupService extends AdWordsSoapClient {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/cm/v201702";
    const ENDPOINT = "https://adwords.google.com/api/adwords/cm/v201702/AdGroupService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://adwords.google.com/api/adwords/cm/v201702/AdGroupService";
    /**
