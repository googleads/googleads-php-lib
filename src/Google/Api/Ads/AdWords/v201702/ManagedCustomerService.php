...
if (!class_exists("ManagedCustomerLabel", false)) {
  ...
  class ManagedCustomerLabel {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/mcm/v201702";
...
if (!class_exists("ManagedCustomerServiceError", false)) {
  ...
  class ManagedCustomerServiceError extends ApiError {
    ...
    public function __construct($reason = null, $customerIds = null, $fieldPath = null, $fieldPathElements = null, $trigger = null, $errorString = null, $ApiErrorType = null) {
      parent::__construct();
      $this->reason = $reason;
...
if (!class_exists("ManagedCustomer", false)) {
  ...
  class ManagedCustomer {
    ...
    public function __construct($name = null, $customerId = null, $canManageClients = null, $currencyCode = null, $dateTimeZone = null, $testAccount = null, $accountLabels = null, $excludeHiddenAccounts = null) {
      $this->name = $name;
      $this->customerId = $customerId;
...
if (!class_exists("ManagedCustomerService", false)) {
  ...
  class ManagedCustomerService extends AdWordsSoapClient {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/mcm/v201702";
    const ENDPOINT = "https://adwords.google.com/api/adwords/mcm/v201702/ManagedCustomerService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://adwords.google.com/api/adwords/mcm/v201702/ManagedCustomerService";
    /**
