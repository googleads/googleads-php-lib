<?php
/**
 * Contains all client objects for the TrialAsyncErrorService
 * service.
 *
 * PHP version 5
 *
...
if (!class_exists("TrialAsyncError", false)) {
  /**
...
if (!class_exists("TrialAsyncErrorServiceGet", false)) {
  /**
   ...
   * @subpackage v201702
   */
  class TrialAsyncErrorServiceGet {
...
if (!class_exists("TrialAsyncErrorServiceGetResponse", false)) {
  /**
   * 
   * @package Google_Api_Ads_AdWords_v201702
   * @subpackage v201702
   */
  class TrialAsyncErrorServiceGetResponse {
...
if (!class_exists("TrialAsyncErrorPage", false)) {
  /**
...
if (!class_exists("TrialAsyncErrorService", false)) {
  /**
  ...
  class TrialAsyncErrorService extends AdWordsSoapClient {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/cm/v201702";
    const ENDPOINT = "https://adwords.google.com/api/adwords/cm/v201702/TrialAsyncErrorService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://adwords.google.com/api/adwords/cm/v201702/TrialAsyncErrorService";
    /**
    ...
    public static $classmap = array(
      ...
      "Selector" => "Selector",
      "TrialAsyncError" => "TrialAsyncError",
      ...
      "get" => "TrialAsyncErrorServiceGet",
      "getResponse" => "TrialAsyncErrorServiceGetResponse",
      "query" => "Query",
