...
if (!class_exists("RelationshipType", false)) {
  /**
  ...
  class RelationshipType {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/cm/v201702";
    const XSI_TYPE = "RelationshipType";
...
if (!class_exists("AffiliateLocationFeedData", false)) {
  /**
   * Data used to configure an Affiliate Location Feed populated with the specified chains.
   * @package Google_Api_Ads_AdWords_v201702
   * @subpackage v201702
   */
  class AffiliateLocationFeedData extends SystemFeedGenerationData {

    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/cm/v201702";
    const XSI_TYPE = "AffiliateLocationFeedData";
    ...
    public function __construct($chains = null, $relationshipType = null, $SystemFeedGenerationDataType = null) {
      parent::__construct();
      $this->chains = $chains;
...
if (!class_exists("FeedService", false)) {
  ...
  class FeedService extends AdWordsSoapClient {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/cm/v201702";
    const ENDPOINT = "https://adwords.google.com/api/adwords/cm/v201702/FeedService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://adwords.google.com/api/adwords/cm/v201702/FeedService";
    /**
