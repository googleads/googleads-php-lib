...
if (!class_exists("AdGroupChangeData", false)) {
  ...
  class AdGroupChangeData {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/ch/v201702";
...
if (!class_exists("CustomerSyncError", false)) {
  ...
  class CustomerSyncError extends ApiError {
    ...
    public function __construct($reason = null, $campaignId = null, $fieldPath = null, $fieldPathElements = null, $trigger = null, $errorString = null, $ApiErrorType = null) {
      parent::__construct();
      $this->reason = $reason;
      $this->campaignId = $campaignId;
      $this->fieldPath = $fieldPath;
...
if (!class_exists("CustomerSyncService", false)) {
  ...
  class CustomerSyncService extends AdWordsSoapClient {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/ch/v201702";
    const ENDPOINT = "https://adwords.google.com/api/adwords/ch/v201702/CustomerSyncService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://adwords.google.com/api/adwords/ch/v201702/CustomerSyncService";
    /**
