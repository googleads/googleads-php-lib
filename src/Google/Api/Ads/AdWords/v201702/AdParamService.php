...
if (!class_exists("AdParamService", false)) {
  ...
  class AdParamService extends AdWordsSoapClient {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/cm/v201702";
    const ENDPOINT = "https://adwords.google.com/api/adwords/cm/v201702/AdParamService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://adwords.google.com/api/adwords/cm/v201702/AdParamService";
    /**
