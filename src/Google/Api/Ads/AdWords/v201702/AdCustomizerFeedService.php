<?php
/**
 * Contains all client objects for the AdCustomizerFeedService
 * service.
 *
 * PHP version 5
 *
...
if (!class_exists("AdCustomizerFeedAttribute", false)) {
  /**
...
if (!class_exists("AdCustomizerFeed", false)) {
  /**
...
if (!class_exists("AdCustomizerFeedAttributeType", false)) {
  /**
   * Possible data types.
   * @package Google_Api_Ads_AdWords_v201702
   * @subpackage v201702
   */
  class AdCustomizerFeedAttributeType {

    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/cm/v201702";
    const XSI_TYPE = "AdCustomizerFeedAttribute.Type";
...
if (!class_exists("AdCustomizerFeedErrorReason", false)) {
  /**
   * Error reasons.
   * @package Google_Api_Ads_AdWords_v201702
   * @subpackage v201702
  ...
  class AdCustomizerFeedErrorReason {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/cm/v201702";
    const XSI_TYPE = "AdCustomizerFeedError.Reason";
...
if (!class_exists("AdCustomizerFeedServiceGet", false)) {
  /**
...
if (!class_exists("AdCustomizerFeedServiceGetResponse", false)) {
  /**
   * 
   * @package Google_Api_Ads_AdWords_v201702
   * @subpackage v201702
   */
  class AdCustomizerFeedServiceGetResponse {
...
if (!class_exists("AdCustomizerFeedServiceMutate", false)) {
  /**
   ...
   * @subpackage v201702
   */
  class AdCustomizerFeedServiceMutate {
...
if (!class_exists("AdCustomizerFeedServiceMutateResponse", false)) {
  /**
   * 
   * @package Google_Api_Ads_AdWords_v201702
   * @subpackage v201702
   */
  class AdCustomizerFeedServiceMutateResponse {
    ...
    /**
     * @access public
     * @var AdCustomizerFeedReturnValue
     */
    public $rval;
...
if (!class_exists("AdCustomizerFeedError", false)) {
  /**
...
if (!class_exists("AdCustomizerFeedOperation", false)) {
  /**
   * Operation used to create or mutate an AdCustomizerFeed.
   * @package Google_Api_Ads_AdWords_v201702
   * @subpackage v201702
   */
  class AdCustomizerFeedOperation extends Operation {
...
if (!class_exists("AdCustomizerFeedPage", false)) {
  /**
...
if (!class_exists("AdCustomizerFeedReturnValue", false)) {
  /**
...
if (!class_exists("AdCustomizerFeedService", false)) {
  /**
  ...
  class AdCustomizerFeedService extends AdWordsSoapClient {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/cm/v201702";
    const ENDPOINT = "https://adwords.google.com/api/adwords/cm/v201702/AdCustomizerFeedService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://adwords.google.com/api/adwords/cm/v201702/AdCustomizerFeedService";
    /**
