<?php
/**
 * Contains all client objects for the DraftService
 * service.
 *
 * PHP version 5
 *
...
if (!class_exists("DraftServiceGet", false)) {
  /**
...
if (!class_exists("DraftServiceGetResponse", false)) {
  /**
   * 
   * @package Google_Api_Ads_AdWords_v201702
   * @subpackage v201702
   */
  class DraftServiceGetResponse {
...
if (!class_exists("DraftServiceMutate", false)) {
  /**
...
if (!class_exists("DraftServiceMutateResponse", false)) {
  /**
   * 
   * @package Google_Api_Ads_AdWords_v201702
   * @subpackage v201702
   */
  class DraftServiceMutateResponse {
...
if (!class_exists("DraftOperation", false)) {
  /**
   * DraftOperation for creating drafts and changing draft states.
   * @package Google_Api_Ads_AdWords_v201702
   * @subpackage v201702
   */
  class DraftOperation extends Operation {

    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/cm/v201702";
    const XSI_TYPE = "DraftOperation";
...
if (!class_exists("DraftReturnValue", false)) {
  /**
   * A container for return values from a {@DraftService#mutate} call.
   * @package Google_Api_Ads_AdWords_v201702
   * @subpackage v201702
   */
  class DraftReturnValue extends ListReturnValue {

    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/cm/v201702";
    const XSI_TYPE = "DraftReturnValue";
...
if (!class_exists("DraftPage", false)) {
   ...
   * @subpackage v201702
   */
  class DraftPage extends NullStatsPage {

    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/cm/v201702";
    const XSI_TYPE = "DraftPage";
...
if (!class_exists("DraftService", false)) {
  /**
   * DraftService
   * @package Google_Api_Ads_AdWords_v201702
   * @subpackage v201702
  ...
  class DraftService extends AdWordsSoapClient {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/cm/v201702";
    const ENDPOINT = "https://adwords.google.com/api/adwords/cm/v201702/DraftService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://adwords.google.com/api/adwords/cm/v201702/DraftService";
    /**
