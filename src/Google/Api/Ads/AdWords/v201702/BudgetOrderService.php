...
if (!class_exists("BillingAccount", false)) {
  ...
  class BillingAccount {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/billing/v201702";
...
if (!class_exists("BudgetOrderService", false)) {
  ...
  class BudgetOrderService extends AdWordsSoapClient {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/billing/v201702";
    const ENDPOINT = "https://adwords.google.com/api/adwords/billing/v201702/BudgetOrderService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://adwords.google.com/api/adwords/billing/v201702/BudgetOrderService";
    /**
