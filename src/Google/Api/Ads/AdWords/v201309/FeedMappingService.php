...
if (!class_exists("Google_Api_Ads_AdWords_v201309\\AttributeFieldMapping", false)) {
  /**
...
if (!class_exists("Google_Api_Ads_AdWords_v201309\\FeedMapping", false)) {
  /**
...
if (!class_exists("Google_Api_Ads_AdWords_v201309\\FeedMappingStatus", false)) {
  /**
...
if (!class_exists("Google_Api_Ads_AdWords_v201309\\FeedMappingErrorReason", false)) {
  /**
...
if (!class_exists("Google_Api_Ads_AdWords_v201309\\FeedMappingServiceGet", false)) {
  /**
...
if (!class_exists("Google_Api_Ads_AdWords_v201309\\FeedMappingServiceGetResponse", false)) {
  /**
   * 
   * @package Google_Api_Ads_AdWords_v201309
   * @subpackage v201309
...
if (!class_exists("Google_Api_Ads_AdWords_v201309\\FeedMappingServiceMutate", false)) {
  /**
...
if (!class_exists("Google_Api_Ads_AdWords_v201309\\FeedMappingServiceMutateResponse", false)) {
  /**
   * 
   * @package Google_Api_Ads_AdWords_v201309
   * @subpackage v201309
...
if (!class_exists("Google_Api_Ads_AdWords_v201309\\FeedMappingError", false)) {
  /**
...
if (!class_exists("Google_Api_Ads_AdWords_v201309\\FeedMappingOperation", false)) {
  /**
...
if (!class_exists("Google_Api_Ads_AdWords_v201309\\FeedMappingReturnValue", false)) {
  /**
...
if (!class_exists("Google_Api_Ads_AdWords_v201309\\FeedMappingPage", false)) {
  /**
...
if (!class_exists("FeedMappingService", false)) {
   ...
   * @subpackage v201309
   */
  class FeedMappingService extends Google_Api_Ads_AdWords_v201309\Google_Api_Ads_AdWords_Lib_AdWordsSoapClient {

    const SERVICE_NAME = "FeedMappingService";
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/cm/v201309";
    const ENDPOINT = "https://adwords.google.com/api/adwords/cm/v201309/FeedMappingService";
    ...
    public static $classmap = array(
      "AttributeFieldMapping" => "Google_Api_Ads_AdWords_v201309\\AttributeFieldMapping",
      ...
      "FeedMapping" => "Google_Api_Ads_AdWords_v201309\\FeedMapping",
      "FeedMappingError" => "Google_Api_Ads_AdWords_v201309\\FeedMappingError",
      "FeedMappingOperation" => "Google_Api_Ads_AdWords_v201309\\FeedMappingOperation",
      "FeedMappingPage" => "Google_Api_Ads_AdWords_v201309\\FeedMappingPage",
      "FeedMappingReturnValue" => "Google_Api_Ads_AdWords_v201309\\FeedMappingReturnValue",
      ...
      "FeedMapping.Status" => "Google_Api_Ads_AdWords_v201309\\FeedMappingStatus",
      "FeedMappingError.Reason" => "Google_Api_Ads_AdWords_v201309\\FeedMappingErrorReason",
      ...
      "get" => "Google_Api_Ads_AdWords_v201309\\FeedMappingServiceGet",
      "getResponse" => "Google_Api_Ads_AdWords_v201309\\FeedMappingServiceGetResponse",
      "mutate" => "Google_Api_Ads_AdWords_v201309\\FeedMappingServiceMutate",
      "mutateResponse" => "Google_Api_Ads_AdWords_v201309\\FeedMappingServiceMutateResponse",
    );
