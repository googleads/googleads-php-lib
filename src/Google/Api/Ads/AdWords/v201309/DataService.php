...
if (!class_exists("Google_Api_Ads_AdWords_v201309\\DataErrorReason", false)) {
  /**
   * Reasons for error.
   * @package Google_Api_Ads_AdWords_v201309
   * @subpackage v201309
...
if (!class_exists("Google_Api_Ads_AdWords_v201309\\GetAdGroupBidLandscape", false)) {
  /**
...
if (!class_exists("Google_Api_Ads_AdWords_v201309\\GetAdGroupBidLandscapeResponse", false)) {
  /**
   * 
   * @package Google_Api_Ads_AdWords_v201309
   * @subpackage v201309
...
if (!class_exists("Google_Api_Ads_AdWords_v201309\\GetCriterionBidLandscape", false)) {
  /**
   * <span class="constraint Required">This field is required and should not be {@code null}.</span>
   * 
   * 
...
if (!class_exists("Google_Api_Ads_AdWords_v201309\\GetCriterionBidLandscapeResponse", false)) {
  /**
   * 
   * @package Google_Api_Ads_AdWords_v201309
   * @subpackage v201309
...
if (!class_exists("Google_Api_Ads_AdWords_v201309\\DataError", false)) {
  /**
...
if (!class_exists("Google_Api_Ads_AdWords_v201309\\AdGroupBidLandscapePage", false)) {
  /**
...
if (!class_exists("Google_Api_Ads_AdWords_v201309\\CriterionBidLandscapePage", false)) {
  /**
...
if (!class_exists("DataService", false)) {
   ...
   * @subpackage v201309
   */
  class DataService extends Google_Api_Ads_AdWords_v201309\Google_Api_Ads_AdWords_Lib_AdWordsSoapClient {
    ...
    public static $classmap = array(
      ...
      "DataError" => "Google_Api_Ads_AdWords_v201309\\DataError",
      ...
      "AdGroupBidLandscapePage" => "Google_Api_Ads_AdWords_v201309\\AdGroupBidLandscapePage",
      "CriterionBidLandscapePage" => "Google_Api_Ads_AdWords_v201309\\CriterionBidLandscapePage",
      ...
      "DataError.Reason" => "Google_Api_Ads_AdWords_v201309\\DataErrorReason",
      "getAdGroupBidLandscape" => "Google_Api_Ads_AdWords_v201309\\GetAdGroupBidLandscape",
      "getAdGroupBidLandscapeResponse" => "Google_Api_Ads_AdWords_v201309\\GetAdGroupBidLandscapeResponse",
      "getCriterionBidLandscape" => "Google_Api_Ads_AdWords_v201309\\GetCriterionBidLandscape",
      "getCriterionBidLandscapeResponse" => "Google_Api_Ads_AdWords_v201309\\GetCriterionBidLandscapeResponse",
    );
