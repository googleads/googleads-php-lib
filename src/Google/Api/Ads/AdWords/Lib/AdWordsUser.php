 ...
 * @see        Google\Api\Ads\Common\Lib\AdsUser
 */
...
class AdWordsUser extends AdsUser {
   ...
   * @param Google\Api\Ads\Common\Lib\SoapClientFactory $serviceFactory the factory to create the client.
   ...
   * @throws Google\Api\Ads\Common\Lib\ServiceException if an error occurred when getting the service
   */
   ...
   * @throws Google\Api\Ads\Common\Lib\ValidationException if there are any validation errors
   */
