...
if (!class_exists("Google_Api_Ads_AdWords_v201402\\Estimate", false)) {
  /**
...
if (!class_exists("Google_Api_Ads_AdWords_v201402\\EstimateRequest", false)) {
  /**
...
if (!class_exists("Google_Api_Ads_AdWords_v201402\\KeywordEstimate", false)) {
  /**
...
if (!class_exists("Google_Api_Ads_AdWords_v201402\\KeywordEstimateRequest", false)) {
  /**
...
if (!class_exists("Google_Api_Ads_AdWords_v201402\\StatsEstimate", false)) {
  /**
...
if (!class_exists("Google_Api_Ads_AdWords_v201402\\TrafficEstimatorResult", false)) {
  /**
...
if (!class_exists("Google_Api_Ads_AdWords_v201402\\TrafficEstimatorSelector", false)) {
  /**
...
if (!class_exists("Google_Api_Ads_AdWords_v201402\\TrafficEstimatorServiceGet", false)) {
  /**
...
if (!class_exists("Google_Api_Ads_AdWords_v201402\\TrafficEstimatorServiceGetResponse", false)) {
  /**
   * 
   * @package Google_Api_Ads_AdWords_v201402
   * @subpackage v201402
...
if (!class_exists("Google_Api_Ads_AdWords_v201402\\AdGroupEstimate", false)) {
  /**
...
if (!class_exists("Google_Api_Ads_AdWords_v201402\\AdGroupEstimateRequest", false)) {
  /**
...
if (!class_exists("Google_Api_Ads_AdWords_v201402\\CampaignEstimate", false)) {
  /**
...
if (!class_exists("Google_Api_Ads_AdWords_v201402\\CampaignEstimateRequest", false)) {
  /**
...
if (!class_exists("TrafficEstimatorService", false)) {
   ...
   * @subpackage v201402
   */
  class TrafficEstimatorService extends Google_Api_Ads_AdWords_v201402\Google_Api_Ads_AdWords_Lib_AdWordsSoapClient {
    ...
    public static $classmap = array(
      ...
      "AdGroupEstimate" => "Google_Api_Ads_AdWords_v201402\\AdGroupEstimate",
      "AdGroupEstimateRequest" => "Google_Api_Ads_AdWords_v201402\\AdGroupEstimateRequest",
      "CampaignEstimate" => "Google_Api_Ads_AdWords_v201402\\CampaignEstimate",
      "CampaignEstimateRequest" => "Google_Api_Ads_AdWords_v201402\\CampaignEstimateRequest",
      "CurrencyCodeError" => "Google_Api_Ads_AdWords_v201402\\CurrencyCodeError",
      "Estimate" => "Google_Api_Ads_AdWords_v201402\\Estimate",
      "EstimateRequest" => "Google_Api_Ads_AdWords_v201402\\EstimateRequest",
      "KeywordEstimate" => "Google_Api_Ads_AdWords_v201402\\KeywordEstimate",
      "KeywordEstimateRequest" => "Google_Api_Ads_AdWords_v201402\\KeywordEstimateRequest",
      "MatchesRegexError" => "Google_Api_Ads_AdWords_v201402\\MatchesRegexError",
      "StatsEstimate" => "Google_Api_Ads_AdWords_v201402\\StatsEstimate",
      "TrafficEstimatorError" => "Google_Api_Ads_AdWords_v201402\\TrafficEstimatorError",
      "TrafficEstimatorResult" => "Google_Api_Ads_AdWords_v201402\\TrafficEstimatorResult",
      "TrafficEstimatorSelector" => "Google_Api_Ads_AdWords_v201402\\TrafficEstimatorSelector",
      ...
      "get" => "Google_Api_Ads_AdWords_v201402\\TrafficEstimatorServiceGet",
      "getResponse" => "Google_Api_Ads_AdWords_v201402\\TrafficEstimatorServiceGetResponse",
    );
