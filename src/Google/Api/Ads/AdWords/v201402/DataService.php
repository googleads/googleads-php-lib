...
if (!class_exists("Google_Api_Ads_AdWords_v201402\\DataErrorReason", false)) {
  /**
   * Reasons for error.
   * @package Google_Api_Ads_AdWords_v201402
   * @subpackage v201402
...
if (!class_exists("Google_Api_Ads_AdWords_v201402\\GetAdGroupBidLandscape", false)) {
  /**
...
if (!class_exists("Google_Api_Ads_AdWords_v201402\\GetAdGroupBidLandscapeResponse", false)) {
  /**
   * 
   * @package Google_Api_Ads_AdWords_v201402
   * @subpackage v201402
...
if (!class_exists("Google_Api_Ads_AdWords_v201402\\GetCriterionBidLandscape", false)) {
  /**
   * <span class="constraint Required">This field is required and should not be {@code null}.</span>
   * 
   * 
...
if (!class_exists("Google_Api_Ads_AdWords_v201402\\GetCriterionBidLandscapeResponse", false)) {
  /**
   * 
   * @package Google_Api_Ads_AdWords_v201402
   * @subpackage v201402
...
if (!class_exists("Google_Api_Ads_AdWords_v201402\\QueryAdGroupBidLandscape", false)) {
  /**
   * <span class="constraint Required">This field is required and should not be {@code null}.</span>
   * 
   * 
...
if (!class_exists("Google_Api_Ads_AdWords_v201402\\QueryAdGroupBidLandscapeResponse", false)) {
  /**
   * 
   * @package Google_Api_Ads_AdWords_v201402
   * @subpackage v201402
...
if (!class_exists("Google_Api_Ads_AdWords_v201402\\QueryCriterionBidLandscape", false)) {
  /**
   * <span class="constraint Required">This field is required and should not be {@code null}.</span>
   * 
   * 
...
if (!class_exists("Google_Api_Ads_AdWords_v201402\\QueryCriterionBidLandscapeResponse", false)) {
  /**
   * 
   * @package Google_Api_Ads_AdWords_v201402
   * @subpackage v201402
...
if (!class_exists("Google_Api_Ads_AdWords_v201402\\DataError", false)) {
  /**
...
if (!class_exists("Google_Api_Ads_AdWords_v201402\\AdGroupBidLandscapePage", false)) {
  /**
...
if (!class_exists("Google_Api_Ads_AdWords_v201402\\CriterionBidLandscapePage", false)) {
  /**
...
if (!class_exists("DataService", false)) {
   ...
   * @subpackage v201402
   */
  class DataService extends Google_Api_Ads_AdWords_v201402\Google_Api_Ads_AdWords_Lib_AdWordsSoapClient {
     ...
     * @var string
     */
    public static $endpoint = "https://adwords.google.com/api/adwords/cm/v201402/DataService";
    /**
    ...
    public static $classmap = array(
      ...
      "DataError" => "Google_Api_Ads_AdWords_v201402\\DataError",
      ...
      "AdGroupBidLandscapePage" => "Google_Api_Ads_AdWords_v201402\\AdGroupBidLandscapePage",
      "CriterionBidLandscapePage" => "Google_Api_Ads_AdWords_v201402\\CriterionBidLandscapePage",
      ...
      "DataError.Reason" => "Google_Api_Ads_AdWords_v201402\\DataErrorReason",
      "getAdGroupBidLandscape" => "Google_Api_Ads_AdWords_v201402\\GetAdGroupBidLandscape",
      "getAdGroupBidLandscapeResponse" => "Google_Api_Ads_AdWords_v201402\\GetAdGroupBidLandscapeResponse",
      "getCriterionBidLandscape" => "Google_Api_Ads_AdWords_v201402\\GetCriterionBidLandscape",
      "getCriterionBidLandscapeResponse" => "Google_Api_Ads_AdWords_v201402\\GetCriterionBidLandscapeResponse",
      "queryAdGroupBidLandscape" => "Google_Api_Ads_AdWords_v201402\\QueryAdGroupBidLandscape",
      "queryAdGroupBidLandscapeResponse" => "Google_Api_Ads_AdWords_v201402\\QueryAdGroupBidLandscapeResponse",
      "queryCriterionBidLandscape" => "Google_Api_Ads_AdWords_v201402\\QueryCriterionBidLandscape",
      "queryCriterionBidLandscapeResponse" => "Google_Api_Ads_AdWords_v201402\\QueryCriterionBidLandscapeResponse",
    );
