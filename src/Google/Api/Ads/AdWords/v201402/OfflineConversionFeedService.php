...
if (!class_exists("Google\\Api\\Ads\\AdWords\\v201402\\OfflineConversionFeed", false)) {
  /**
...
if (!class_exists("Google\\Api\\Ads\\AdWords\\v201402\\OfflineConversionErrorReason", false)) {
  /**
...
if (!class_exists("Google\\Api\\Ads\\AdWords\\v201402\\OfflineConversionFeedServiceMutate", false)) {
  /**
...
if (!class_exists("Google\\Api\\Ads\\AdWords\\v201402\\OfflineConversionFeedServiceMutateResponse", false)) {
  /**
   * 
   * @package Google\Api\Ads\AdWords\v201402
   * @subpackage v201402
...
if (!class_exists("Google\\Api\\Ads\\AdWords\\v201402\\OfflineConversionError", false)) {
  /**
...
if (!class_exists("Google\\Api\\Ads\\AdWords\\v201402\\OfflineConversionFeedOperation", false)) {
  /**
...
if (!class_exists("Google\\Api\\Ads\\AdWords\\v201402\\OfflineConversionFeedReturnValue", false)) {
  /**
...
if (!class_exists("OfflineConversionFeedService", false)) {
  ...
  class OfflineConversionFeedService extends \Google\Api\Ads\AdWords\Lib\AdWordsSoapClient {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/cm/v201402";
    const ENDPOINT = "https://adwords.google.com/api/adwords/cm/v201402/OfflineConversionFeedService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://adwords.google.com/api/adwords/cm/v201402/OfflineConversionFeedService";
    /**
    ...
    public static $classmap = array(
      ...
      "OfflineConversionError" => "Google\\Api\\Ads\\AdWords\\v201402\\OfflineConversionError",
      "OfflineConversionFeed" => "Google\\Api\\Ads\\AdWords\\v201402\\OfflineConversionFeed",
      "OfflineConversionFeedOperation" => "Google\\Api\\Ads\\AdWords\\v201402\\OfflineConversionFeedOperation",
      ...
      "OfflineConversionFeedReturnValue" => "Google\\Api\\Ads\\AdWords\\v201402\\OfflineConversionFeedReturnValue",
      ...
      "OfflineConversionError.Reason" => "Google\\Api\\Ads\\AdWords\\v201402\\OfflineConversionErrorReason",
      ...
      "mutate" => "Google\\Api\\Ads\\AdWords\\v201402\\OfflineConversionFeedServiceMutate",
      "mutateResponse" => "Google\\Api\\Ads\\AdWords\\v201402\\OfflineConversionFeedServiceMutateResponse",
    );
