...
if (!class_exists("Google_Api_Ads_AdWords_v201402\\AttributeFieldMapping", false)) {
  /**
...
if (!class_exists("Google_Api_Ads_AdWords_v201402\\FeedMapping", false)) {
  /**
...
if (!class_exists("Google_Api_Ads_AdWords_v201402\\FeedMappingStatus", false)) {
  /**
...
if (!class_exists("Google_Api_Ads_AdWords_v201402\\FeedMappingErrorReason", false)) {
  /**
...
if (!class_exists("Google_Api_Ads_AdWords_v201402\\FeedMappingServiceGet", false)) {
  /**
...
if (!class_exists("Google_Api_Ads_AdWords_v201402\\FeedMappingServiceGetResponse", false)) {
  /**
   * 
   * @package Google_Api_Ads_AdWords_v201402
   * @subpackage v201402
...
if (!class_exists("Google_Api_Ads_AdWords_v201402\\FeedMappingServiceMutate", false)) {
  /**
...
if (!class_exists("Google_Api_Ads_AdWords_v201402\\FeedMappingServiceMutateResponse", false)) {
  /**
   * 
   * @package Google_Api_Ads_AdWords_v201402
   * @subpackage v201402
...
if (!class_exists("Google_Api_Ads_AdWords_v201402\\FeedMappingError", false)) {
  /**
...
if (!class_exists("Google_Api_Ads_AdWords_v201402\\FeedMappingOperation", false)) {
  /**
...
if (!class_exists("Google_Api_Ads_AdWords_v201402\\FeedMappingReturnValue", false)) {
  /**
...
if (!class_exists("Google_Api_Ads_AdWords_v201402\\FeedMappingPage", false)) {
  /**
...
if (!class_exists("FeedMappingService", false)) {
   ...
   * @subpackage v201402
   */
  class FeedMappingService extends Google_Api_Ads_AdWords_v201402\Google_Api_Ads_AdWords_Lib_AdWordsSoapClient {

    const SERVICE_NAME = "FeedMappingService";
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/cm/v201402";
    const ENDPOINT = "https://adwords.google.com/api/adwords/cm/v201402/FeedMappingService";
    ...
    public static $classmap = array(
      "AttributeFieldMapping" => "Google_Api_Ads_AdWords_v201402\\AttributeFieldMapping",
      ...
      "FeedMapping" => "Google_Api_Ads_AdWords_v201402\\FeedMapping",
      "FeedMappingError" => "Google_Api_Ads_AdWords_v201402\\FeedMappingError",
      "FeedMappingOperation" => "Google_Api_Ads_AdWords_v201402\\FeedMappingOperation",
      "FeedMappingPage" => "Google_Api_Ads_AdWords_v201402\\FeedMappingPage",
      "FeedMappingReturnValue" => "Google_Api_Ads_AdWords_v201402\\FeedMappingReturnValue",
      ...
      "FeedMapping.Status" => "Google_Api_Ads_AdWords_v201402\\FeedMappingStatus",
      "FeedMappingError.Reason" => "Google_Api_Ads_AdWords_v201402\\FeedMappingErrorReason",
      ...
      "get" => "Google_Api_Ads_AdWords_v201402\\FeedMappingServiceGet",
      "getResponse" => "Google_Api_Ads_AdWords_v201402\\FeedMappingServiceGetResponse",
      "mutate" => "Google_Api_Ads_AdWords_v201402\\FeedMappingServiceMutate",
      "mutateResponse" => "Google_Api_Ads_AdWords_v201402\\FeedMappingServiceMutateResponse",
