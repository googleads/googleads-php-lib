...
if (!class_exists("CustomerSyncService", false)) {
  ...
  class CustomerSyncService extends AdWordsSoapClient {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/ch/v201509";
    const ENDPOINT = "https://adwords.google.com/api/adwords/ch/v201509/CustomerSyncService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://adwords.google.com/api/adwords/ch/v201509/CustomerSyncService";
    /**
