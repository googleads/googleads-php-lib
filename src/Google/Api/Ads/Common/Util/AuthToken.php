...
class AuthToken {
   ...
   * @param Google\Api\Ads\Common\Util\CurlUtils $curlUtils an instance of CurlUtils
   */
   ...
   * @throws Google\Api\Ads\Common\Lib\AuthTokenException if an error occurs during authentication
   */
