...
abstract class DeprecationUtils {
   ...
   *
   * @param Google\Api\Ads\Common\Lib\AdsUser $user the AdsUser to test
   */
   ...
   * @throws Google\Api\Ads\Common\Lib\ServiceException if the requested version does not support
   *     ClientLogin
   */
