...
abstract class AdsSoapClient extends SoapClient {
  ...
  /**
   * The {@link Google\Api\Ads\Common\Lib\AdsUser} which generated this client.
   * @var Google\Api\Ads\Common\Lib\AdsUser the user that generated this client
   * @access protected
   */
  protected $user;
   ...
   * @param Google\Api\Ads\Common\Lib\AdsUser $user the user which is responsible for this client
