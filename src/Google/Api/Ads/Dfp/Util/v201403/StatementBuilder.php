...
use Google\Api\Ads\Dfp\v201403\Statement;
...
class StatementBuilder {
  ...
  /**
   * Gets the {@link Google\Api\Ads\Dfp\v201403\Statement} representing the state of this statement
   * builder.
   *
   * @return Statement the {@link Google\Api\Ads\Dfp\v201403\Statement}
   */
   ...
   * @throws Google\Api\Ads\Common\Lib\ValidationException if the query is invalid
   */
