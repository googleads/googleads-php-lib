...
class DateTimeUtils {
  ...
  /**
   * {@link Google\Api\Ads\Dfp\Util\v201403\DateTimeUtils} is meant to be used statically.
   */
   ...
   *
   * @param Google\Api\Ads\Dfp\v201403\DfpDateTime $dfpDateTime a DfpDateTime object
   ...
   *
   * @param Google\Api\Ads\Dfp\v201403\Date $dfpDate the DFP date to stringify
   ...
   *
   * @param Google\Api\Ads\Dfp\v201403\DfpDateTime $dfpDateTime the DFP date time to stringify
   ...
   * </code></pre>
   *
   * @param Google\Api\Ads\Dfp\v201403\DfpDateTime $dfpDateTime the DFP date time to stringify into a new
   *     time zone
