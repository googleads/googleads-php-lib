...
if (!class_exists("CustomizableAttributes", false)) {
  ...
  class CustomizableAttributes {
     ...
     * @var boolean
     */
    public $allowMobileApplicationTargetingCustomization;
...
if (!class_exists("NonProgrammaticProductError", false)) {
  /**
   * Lists all non-programmatic errors associated with products which can't be used in Marketplace.
   * @package GoogleApiAdsDfp
   * @subpackage v201611
   */
  class NonProgrammaticProductError extends ApiError {

    const WSDL_NAMESPACE = "https://www.google.com/apis/ads/publisher/v201611";
    const XSI_TYPE = "NonProgrammaticProductError";

    /**
     * @access public
     * @var tnsNonProgrammaticProductErrorReason
     */
    public $reason;
...
if (!class_exists("ProductMarketplaceInfo", false)) {
  /**
  ...
  class ProductMarketplaceInfo {
    ...
    const WSDL_NAMESPACE = "https://www.google.com/apis/ads/publisher/v201611";
    const XSI_TYPE = "ProductMarketplaceInfo";

    /**
     * @access public
     * @var tnsAdExchangeEnvironment
     */
    public $adExchangeEnvironment;
...
if (!class_exists("ProgrammaticEntitiesError", false)) {
  /**
   * Lists all programmatic errors associated with entities which can be used in Marketplace.
   * @package GoogleApiAdsDfp
   * @subpackage v201611
   */
  class ProgrammaticEntitiesError extends ApiError {

    const WSDL_NAMESPACE = "https://www.google.com/apis/ads/publisher/v201611";
    const XSI_TYPE = "ProgrammaticEntitiesError";

    /**
     * @access public
     * @var tnsProgrammaticEntitiesErrorReason
     */
    public $reason;
...
if (!class_exists("ProgrammaticProductError", false)) {
  /**
   * Lists all programmatic errors associated with products which can be used in Marketplace.
   * @package GoogleApiAdsDfp
   * @subpackage v201611
   */
  class ProgrammaticProductError extends ApiError {

    const WSDL_NAMESPACE = "https://www.google.com/apis/ads/publisher/v201611";
    const XSI_TYPE = "ProgrammaticProductError";

    /**
     * @access public
     * @var tnsProgrammaticProductErrorReason
     */
    public $reason;
...
if (!class_exists("PublishProducts", false)) {
  /**
   * The action used to publish products to Marketplace.
   * @package GoogleApiAdsDfp
   * @subpackage v201611
   */
  class PublishProducts extends ProductAction {

    const WSDL_NAMESPACE = "https://www.google.com/apis/ads/publisher/v201611";
    const XSI_TYPE = "PublishProducts";
...
if (!class_exists("WithdrawProducts", false)) {
  /**
   * The action used to withdraw products from Marketplace.
   * @package GoogleApiAdsDfp
   * @subpackage v201611
   */
  class WithdrawProducts extends ProductAction {

    const WSDL_NAMESPACE = "https://www.google.com/apis/ads/publisher/v201611";
    const XSI_TYPE = "WithdrawProducts";
...
if (!class_exists("AdExchangeEnvironment", false)) {
  /**
   * Identifies the the format of inventory or "channel" in which ads serve.
   * @package GoogleApiAdsDfp
   * @subpackage v201611
   */
  class AdExchangeEnvironment {
    ...
    const WSDL_NAMESPACE = "https://www.google.com/apis/ads/publisher/v201611";
    const XSI_TYPE = "AdExchangeEnvironment";
...
if (!class_exists("NonProgrammaticProductErrorReason", false)) {
  /**
   * The reasons for the target error.
   * @package GoogleApiAdsDfp
   * @subpackage v201611
   */
  class NonProgrammaticProductErrorReason {

    const WSDL_NAMESPACE = "https://www.google.com/apis/ads/publisher/v201611";
    const XSI_TYPE = "NonProgrammaticProductError.Reason";
...
if (!class_exists("ProgrammaticEntitiesErrorReason", false)) {
  /**
   * The reasons for the target error.
   * @package GoogleApiAdsDfp
   * @subpackage v201611
  ...
  class ProgrammaticEntitiesErrorReason {
    ...
    const WSDL_NAMESPACE = "https://www.google.com/apis/ads/publisher/v201611";
    const XSI_TYPE = "ProgrammaticEntitiesError.Reason";
...
if (!class_exists("ProgrammaticProductErrorReason", false)) {
  /**
   * The reasons for the target error.
   * @package GoogleApiAdsDfp
   * @subpackage v201611
   */
  class ProgrammaticProductErrorReason {

    const WSDL_NAMESPACE = "https://www.google.com/apis/ads/publisher/v201611";
    const XSI_TYPE = "ProgrammaticProductError.Reason";
...
if (!class_exists("CreateProducts", false)) {
  /**
...
if (!class_exists("CreateProductsResponse", false)) {
  /**
   * 
   * @package GoogleApiAdsDfp
   * @subpackage v201611
...
if (!class_exists("ProductService", false)) {
  ...
  class ProductService extends DfpSoapClient {
    ...
    const WSDL_NAMESPACE = "https://www.google.com/apis/ads/publisher/v201611";
    const ENDPOINT = "https://ads.google.com/apis/ads/publisher/v201611/ProductService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://ads.google.com/apis/ads/publisher/v201611/ProductService";
    /**
    ...
    public static $classmap = array(
      ...
      "Money" => "Money",
      "NonProgrammaticProductError" => "NonProgrammaticProductError",
      ...
      "ProgrammaticEntitiesError" => "ProgrammaticEntitiesError",
      "ProgrammaticProductError" => "ProgrammaticProductError",
      ...
      "WithdrawProducts" => "WithdrawProducts",
      ...
      "NonProgrammaticProductError.Reason" => "NonProgrammaticProductErrorReason",
      ...
      "ProgrammaticEntitiesError.Reason" => "ProgrammaticEntitiesErrorReason",
      "ProgrammaticProductError.Reason" => "ProgrammaticProductErrorReason",
    ...
    public function createProducts($products) {
      $args = new CreateProducts($products);
      $result = $this->__soapCall("createProducts", array($args));
      return $result->rval;
    }
    /**
     * Gets a {@link ProductPage} of {@link Product} objects that satisfy the criteria specified by
