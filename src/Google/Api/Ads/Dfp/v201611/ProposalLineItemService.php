...
if (!class_exists("ProposalLineItem", false)) {
  ...
  class ProposalLineItem {
     ...
     * @var DateTime
     */
    public $lastReservationDateTime;
    ...
    /**
     * @access public
     * @var ProposalLineItemMarketplaceInfo
     */
...
if (!class_exists("ProposalLineItemMarketplaceInfo", false)) {
  /**
  ...
  class ProposalLineItemMarketplaceInfo {
    ...
    const WSDL_NAMESPACE = "https://www.google.com/apis/ads/publisher/v201611";
    const XSI_TYPE = "ProposalLineItemMarketplaceInfo";
...
if (!class_exists("ReserveProposalLineItems", false)) {
  /**
   * The action to reserve inventory for {@link ProposalLineItem} objects. It does not
   * overbook inventory unless {@link #allowOverbook} is set to {@code true}.
   * This action is only applicable for programmatic proposals not using sales management.
   * @package GoogleApiAdsDfp
   * @subpackage v201611
   */
  class ReserveProposalLineItems extends ProposalLineItemAction {

    const WSDL_NAMESPACE = "https://www.google.com/apis/ads/publisher/v201611";
    const XSI_TYPE = "ReserveProposalLineItems";
...
if (!class_exists("ProposalLineItemService", false)) {
  ...
  class ProposalLineItemService extends DfpSoapClient {
    ...
    const WSDL_NAMESPACE = "https://www.google.com/apis/ads/publisher/v201611";
    const ENDPOINT = "https://ads.google.com/apis/ads/publisher/v201611/ProposalLineItemService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://ads.google.com/apis/ads/publisher/v201611/ProposalLineItemService";
    /**
    ...
    public static $classmap = array(
      ...
      "ReserveProposalLineItems" => "ReserveProposalLineItems",
