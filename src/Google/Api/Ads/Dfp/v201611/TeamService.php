...
if (!class_exists("Team", false)) {
  ...
  class Team {
    ...
    public function __construct($id = null, $name = null, $description = null, $hasAllCompanies = null, $hasAllInventory = null, $teamAccessType = null) {
      $this->id = $id;
      $this->name = $name;
...
if (!class_exists("TeamService", false)) {
  ...
  class TeamService extends DfpSoapClient {
    ...
    const WSDL_NAMESPACE = "https://www.google.com/apis/ads/publisher/v201611";
    const ENDPOINT = "https://ads.google.com/apis/ads/publisher/v201611/TeamService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://ads.google.com/apis/ads/publisher/v201611/TeamService";
    /**
