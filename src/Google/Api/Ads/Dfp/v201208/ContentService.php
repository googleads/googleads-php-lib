...
class ContentService extends DfpSoapClient {
  ...
  const WSDL_NAMESPACE = "https://www.google.com/apis/ads/publisher/v201208";
  const ENDPOINT = "https://www.google.com/apis/ads/publisher/v201208/ContentService";
  ...
  public function getUncategorizedContentByStatement($filterStatement) {
    $args = new GetUncategorizedContentByStatement($filterStatement);
    $result = $this->__soapCall("getUncategorizedContentByStatement", array($args));
    return $result->rval;
  }
}}