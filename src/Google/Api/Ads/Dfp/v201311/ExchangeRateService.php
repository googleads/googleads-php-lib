<?php
/**
 * Contains all client objects for the ExchangeRateService service.
 *
 * PHP version 5
 *
...
class ExchangeRateRefreshRate {
   ...
   */
  public function getXsiTypeName() {
    return "ExchangeRateRefreshRate";
  }
...
class ExchangeRateService extends DfpSoapClient {
  ...
  public function __construct($wsdl=null, $options, $user) {
    $options["classmap"] = ExchangeRateService::$classmap;
    parent::__construct($wsdl, $options, $user, 'ExchangeRateService', 'https://www.google.com/apis/ads/publisher/v201311');
  }
  ...
  public function createExchangeRates($exchangeRates) {
    $arg = new createExchangeRates($exchangeRates);
    $result = $this->__soapCall("createExchangeRates", array($arg));
    return $result->rval;
  }
  ...
  public function getExchangeRate($exchangeRateId) {
    $arg = new getExchangeRate($exchangeRateId);
    $result = $this->__soapCall("getExchangeRate", array($arg));
    return $result->rval;
  }
  ...
  public function getExchangeRatesByStatement($filterStatement) {
    $arg = new getExchangeRatesByStatement($filterStatement);
    $result = $this->__soapCall("getExchangeRatesByStatement", array($arg));
    return $result->rval;
  }
  ...
  public function performExchangeRateAction($exchangeRateAction, $filterStatement) {
    $arg = new performExchangeRateAction($exchangeRateAction, $filterStatement);
    $result = $this->__soapCall("performExchangeRateAction", array($arg));
    return $result->rval;
  }
  ...
  public function updateExchangeRates($exchangeRates) {
    $arg = new updateExchangeRates($exchangeRates);
    $result = $this->__soapCall("updateExchangeRates", array($arg));
    return $result->rval;
  }
