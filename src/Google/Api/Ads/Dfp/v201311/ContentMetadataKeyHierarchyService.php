<?php
/**
 * Contains all client objects for the ContentMetadataKeyHierarchyService service.
 *
 * PHP version 5
 *
...
class ContentMetadataKeyHierarchy {
   ...
   */
  public function getXsiTypeName() {
    return "ContentMetadataKeyHierarchy";
  }

  public function __construct($id = NULL, $name = NULL, $hierarchyLevels = NULL) {
    $this->id = $id;
    $this->name = $name;
...
class ContentMetadataKeyHierarchyError extends ApiError {
   ...
   */
  public function getXsiTypeName() {
    return "ContentMetadataKeyHierarchyError";
  }
...
class ContentMetadataKeyHierarchyLevel {
   ...
   */
  public function getXsiTypeName() {
    return "ContentMetadataKeyHierarchyLevel";
  }
...
class ContentMetadataKeyHierarchyPage {
   ...
   */
  public function getXsiTypeName() {
    return "ContentMetadataKeyHierarchyPage";
  }
...
class ContentMetadataKeyHierarchyErrorReason {
   ...
   */
  public function getXsiTypeName() {
    return "ContentMetadataKeyHierarchyError.Reason";
  }
...
class ContentMetadataKeyHierarchyService extends DfpSoapClient {
   ...
   * @var string
   */
  public static $endpoint = "https://www.google.com/apis/ads/publisher/v201311/ContentMetadataKeyHierarchyService";
  ...
  public function getContentMetadataKeyHierarchiesByStatement($filterStatement) {
    $arg = new getContentMetadataKeyHierarchiesByStatement($filterStatement);
    $result = $this->__soapCall("getContentMetadataKeyHierarchiesByStatement", array($arg));
    return $result->rval;
  }
