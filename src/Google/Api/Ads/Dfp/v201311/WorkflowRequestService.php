<?php
/**
 * Contains all client objects for the WorkflowRequestService service.
 *
 * PHP version 5
 *
...
class WorkflowApprovalRequestStatus {
   ...
   */
  public function getXsiTypeName() {
    return "WorkflowApprovalRequestStatus";
  }
...
class ApproveWorkflowApprovalRequests extends WorkflowRequestAction {
   ...
   */
  public function getXsiTypeName() {
    return "ApproveWorkflowApprovalRequests";
  }
...
class RejectWorkflowApprovalRequests extends WorkflowRequestAction {
   ...
   */
  public function getXsiTypeName() {
    return "RejectWorkflowApprovalRequests";
  }
...
class WorkflowRequestService extends DfpSoapClient {
  ...
  public function __construct($wsdl=null, $options, $user) {
    $options["classmap"] = WorkflowRequestService::$classmap;
    parent::__construct($wsdl, $options, $user, 'WorkflowRequestService', 'https://www.google.com/apis/ads/publisher/v201311');
  }
  ...
  public function getWorkflowRequestsByStatement($filterStatement) {
    $arg = new getWorkflowRequestsByStatement($filterStatement);
    $result = $this->__soapCall("getWorkflowRequestsByStatement", array($arg));
    return $result->rval;
  }
  ...
  public function performWorkflowRequestAction($action, $filterStatement) {
    $arg = new performWorkflowRequestAction($action, $filterStatement);
    $result = $this->__soapCall("performWorkflowRequestAction", array($arg));
    return $result->rval;
  }
