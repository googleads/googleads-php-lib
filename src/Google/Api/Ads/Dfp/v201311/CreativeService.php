...
class AdMobBackfillCreative extends BaseDynamicAllocationCreative {
   ...
   */
  public function getXsiTypeName() {
    return "AdMobBackfillCreative";
  }

  public function __construct($additionalParameters = NULL, $publisherId = NULL, $advertiserId = NULL, $id = NULL, $name = NULL, $size = NULL, $previewUrl = NULL, $appliedLabels = NULL, $lastModifiedDateTime = NULL, $customFieldValues = NULL, $CreativeType = NULL) {
    parent::__construct();
...
class CreativeService extends DfpSoapClient {
   ...
   * @var string
   */
  public static $endpoint = "https://www.google.com/apis/ads/publisher/v201311/CreativeService";
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'CreativeService', 'https://www.google.com/apis/ads/publisher/v201311');
  }
