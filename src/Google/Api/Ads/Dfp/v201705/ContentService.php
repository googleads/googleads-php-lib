...
if (!class_exists("Content", false)) {
  ...
  class Content {
    ...
    /**
     * @access public
     * @var tnsDaiIngestStatus
     */
    public $daiIngestStatus;

    /**
     * @access public
     * @var DaiIngestError[]
     */
    public $daiIngestErrors;

    /**
     * @access public
     * @var DateTime
     */
    public $lastDaiIngestDateTime;
    ...
    public function __construct($id = null, $name = null, $status = null, $statusDefinedBy = null, $daiIngestStatus = null, $daiIngestErrors = null, $lastDaiIngestDateTime = null, $importDateTime = null, $lastModifiedDateTime = null, $userDefinedCustomTargetingValueIds = null, $mappingRuleDefinedCustomTargetingValueIds = null, $cmsSources = null) {
      $this->id = $id;
      $this->name = $name;
      $this->status = $status;
...
if (!class_exists("DaiIngestError", false)) {
  /**
  ...
  class DaiIngestError {
    ...
    const WSDL_NAMESPACE = "https://www.google.com/apis/ads/publisher/v201705";
    const XSI_TYPE = "DaiIngestError";

    /**
     * @access public
     * @var tnsDaiIngestErrorReason
     */
    public $reason;
...
if (!class_exists("DaiIngestErrorReason", false)) {
  /**
  ...
  class DaiIngestErrorReason {
    ...
    const WSDL_NAMESPACE = "https://www.google.com/apis/ads/publisher/v201705";
    const XSI_TYPE = "DaiIngestErrorReason";
...
if (!class_exists("DaiIngestStatus", false)) {
  /**
  ...
  class DaiIngestStatus {
    ...
    const WSDL_NAMESPACE = "https://www.google.com/apis/ads/publisher/v201705";
    const XSI_TYPE = "DaiIngestStatus";
...
if (!class_exists("ContentService", false)) {
  ...
  class ContentService extends DfpSoapClient {
    ...
    const WSDL_NAMESPACE = "https://www.google.com/apis/ads/publisher/v201705";
    const ENDPOINT = "https://ads.google.com/apis/ads/publisher/v201705/ContentService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://ads.google.com/apis/ads/publisher/v201705/ContentService";
    /**
    ...
    public static $classmap = array(
      ...
      "DaiIngestErrorReason" => "DaiIngestErrorReason",
