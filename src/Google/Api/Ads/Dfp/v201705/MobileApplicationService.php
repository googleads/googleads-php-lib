<?php
/**
 * Contains all client objects for the MobileApplicationService
 * service.
 *
 * PHP version 5
 *
...
if (!class_exists("MobileApplicationAction", false)) {
  /**
  ...
  class MobileApplicationAction {
    ...
    const WSDL_NAMESPACE = "https://www.google.com/apis/ads/publisher/v201705";
    const XSI_TYPE = "MobileApplicationAction";
...
if (!class_exists("MobileApplicationActionError", false)) {
  /**
   * Lists all error reasons associated with performing actions on {@link MobileApplication} objects.
   * @package GoogleApiAdsDfp
   * @subpackage v201705
   */
  class MobileApplicationActionError extends ApiError {

    const WSDL_NAMESPACE = "https://www.google.com/apis/ads/publisher/v201705";
    const XSI_TYPE = "MobileApplicationActionError";

    /**
     * @access public
     * @var tnsMobileApplicationActionErrorReason
     */
    public $reason;
...
if (!class_exists("MobileApplication", false)) {
  ...
  class MobileApplication {
    ...
    /**
     * @access public
     * @var tnsMobileApplicationPlatform
     */
    public $platform;
...
if (!class_exists("MobileApplicationError", false)) {
  /**
   * Lists all errors associated with {@link MobileApplication} objects.
   * @package GoogleApiAdsDfp
   * @subpackage v201705
   */
  class MobileApplicationError extends ApiError {

    const WSDL_NAMESPACE = "https://www.google.com/apis/ads/publisher/v201705";
    const XSI_TYPE = "MobileApplicationError";

    /**
     * @access public
     * @var tnsMobileApplicationErrorReason
     */
    public $reason;
...
if (!class_exists("MobileApplicationPage", false)) {
  /**
  ...
  class MobileApplicationPage {
    ...
    const WSDL_NAMESPACE = "https://www.google.com/apis/ads/publisher/v201705";
    const XSI_TYPE = "MobileApplicationPage";
...
if (!class_exists("MobileApplicationActionErrorReason", false)) {
  /**
   * The reasons for the target error.
   * @package GoogleApiAdsDfp
   * @subpackage v201705
   */
  class MobileApplicationActionErrorReason {

    const WSDL_NAMESPACE = "https://www.google.com/apis/ads/publisher/v201705";
    const XSI_TYPE = "MobileApplicationActionError.Reason";
...
if (!class_exists("MobileApplicationErrorReason", false)) {
  /**
  ...
  class MobileApplicationErrorReason {
    ...
    const WSDL_NAMESPACE = "https://www.google.com/apis/ads/publisher/v201705";
    const XSI_TYPE = "MobileApplicationError.Reason";
...
if (!class_exists("MobileApplicationPlatform", false)) {
  /**
  ...
  class MobileApplicationPlatform {
    ...
    const WSDL_NAMESPACE = "https://www.google.com/apis/ads/publisher/v201705";
    const XSI_TYPE = "MobileApplicationPlatform";
...
if (!class_exists("MobileApplicationStore", false)) {
  /**
   * A store a {@link MobileApplication} is available on.
   * @package GoogleApiAdsDfp
   * @subpackage v201705
   */
  class MobileApplicationStore {

    const WSDL_NAMESPACE = "https://www.google.com/apis/ads/publisher/v201705";
    const XSI_TYPE = "MobileApplicationStore";
...
if (!class_exists("CreateMobileApplications", false)) {
  /**
   ...
   * @subpackage v201705
   */
  class CreateMobileApplications {
    ...
    public function __construct($mobileApplications = null) {
...
if (!class_exists("CreateMobileApplicationsResponse", false)) {
  /**
   * 
   * @package GoogleApiAdsDfp
   * @subpackage v201705
...
if (!class_exists("GetMobileApplicationsByStatement", false)) {
  /**
   ...
   * @subpackage v201705
   */
  class GetMobileApplicationsByStatement {
...
if (!class_exists("GetMobileApplicationsByStatementResponse", false)) {
  /**
   * 
   * @package GoogleApiAdsDfp
   * @subpackage v201705
...
if (!class_exists("PerformMobileApplicationAction", false)) {
  /**
   ...
   * @subpackage v201705
   */
  class PerformMobileApplicationAction {
    ...
    /**
     * @access public
     * @var MobileApplicationAction
     */
    public $mobileApplicationAction;
    ...
    public function __construct($mobileApplicationAction = null, $filterStatement = null) {
...
if (!class_exists("PerformMobileApplicationActionResponse", false)) {
  /**
   * 
   * @package GoogleApiAdsDfp
   * @subpackage v201705
...
if (!class_exists("UpdateMobileApplications", false)) {
  /**
   ...
   * @subpackage v201705
   */
  class UpdateMobileApplications {
...
if (!class_exists("UpdateMobileApplicationsResponse", false)) {
  /**
   * 
   * @package GoogleApiAdsDfp
   * @subpackage v201705
...
if (!class_exists("UnarchiveMobileApplications", false)) {
  /**
   * The action used to activate {@link MobileApplication} objects.
   * @package GoogleApiAdsDfp
   * @subpackage v201705
   */
  class UnarchiveMobileApplications extends MobileApplicationAction {

    const WSDL_NAMESPACE = "https://www.google.com/apis/ads/publisher/v201705";
    const XSI_TYPE = "UnarchiveMobileApplications";
...
if (!class_exists("ArchiveMobileApplications", false)) {
  /**
   * The action used to deactivate {@link MobileApplication} objects.
   * @package GoogleApiAdsDfp
   * @subpackage v201705
   */
  class ArchiveMobileApplications extends MobileApplicationAction {

    const WSDL_NAMESPACE = "https://www.google.com/apis/ads/publisher/v201705";
    const XSI_TYPE = "ArchiveMobileApplications";
...
if (!class_exists("MobileApplicationService", false)) {
  /**
   * MobileApplicationService
   * @package GoogleApiAdsDfp
   * @subpackage v201705
   */
  class MobileApplicationService extends DfpSoapClient {

    const SERVICE_NAME = "MobileApplicationService";
    const WSDL_NAMESPACE = "https://www.google.com/apis/ads/publisher/v201705";
    const ENDPOINT = "https://ads.google.com/apis/ads/publisher/v201705/MobileApplicationService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://ads.google.com/apis/ads/publisher/v201705/MobileApplicationService";
    /**
    ...
    public static $classmap = array(
      ...
      "UnarchiveMobileApplications" => "UnarchiveMobileApplications",
      "ApiError" => "ApiError",
      ...
      "DateValue" => "DateValue",
      "ArchiveMobileApplications" => "ArchiveMobileApplications",
      "FeatureError" => "FeatureError",
      "FieldPathElement" => "FieldPathElement",
      "InternalApiError" => "InternalApiError",
      "MobileApplicationAction" => "MobileApplicationAction",
      "MobileApplicationActionError" => "MobileApplicationActionError",
      "MobileApplication" => "MobileApplication",
      "MobileApplicationError" => "MobileApplicationError",
      ...
      "MobileApplicationActionError.Reason" => "MobileApplicationActionErrorReason",
      "MobileApplicationError.Reason" => "MobileApplicationErrorReason",
      "MobileApplicationPlatform" => "MobileApplicationPlatform",
      "MobileApplicationStore" => "MobileApplicationStore",
     ...
     * @return the created mobileApplications with their IDs filled in
     */
    public function createMobileApplications($mobileApplications) {
      $args = new CreateMobileApplications($mobileApplications);
      $result = $this->__soapCall("createMobileApplications", array($args));
      return $result->rval;
    }
    /**
     * Gets a {@link MobileApplicationPage mobileApplicationPage} of
     ...
     * @return the mobile applications that match the given filter
     */
    public function getMobileApplicationsByStatement($filterStatement) {
      $args = new GetMobileApplicationsByStatement($filterStatement);
      $result = $this->__soapCall("getMobileApplicationsByStatement", array($args));
      return $result->rval;
    }
    /**
     * Performs an action on {@link MobileApplication mobile applications}.
     ...
     * @return the result of the action performed
     */
    public function performMobileApplicationAction($mobileApplicationAction, $filterStatement) {
      $args = new PerformMobileApplicationAction($mobileApplicationAction, $filterStatement);
      $result = $this->__soapCall("performMobileApplicationAction", array($args));
      return $result->rval;
    }
    /**
     * Updates the specified {@link MobileApplication mobile applications}.
     ...
     * @return the updated mobileApplications
     */
    public function updateMobileApplications($mobileApplications) {
      $args = new UpdateMobileApplications($mobileApplications);
      $result = $this->__soapCall("updateMobileApplications", array($args));
      return $result->rval;
    }
  }
}
