...
if (!class_exists("LiveStreamEvent", false)) {
  ...
  class LiveStreamEvent {
     ...
     * @var boolean
     */
    public $tokenAuthenticationUnsigned;

    /**
     * @access public
     * @var tnsOriginForwardingType
     */
    public $originForwardingType;

    /**
     * @access public
     * @var string
     */
    public $originPathPrefix;
    ...
    /**
     * @access public
     * @var tnsAdBreakFillType
     */
    public $adBreakFillType;
...
if (!class_exists("SamSessionError", false)) {
  /**
   * Lists all errors associated with the Session Activity Monitor (SAM).
   * @package GoogleApiAdsDfp
   * @subpackage v201705
   */
  class SamSessionError extends ApiError {

    const WSDL_NAMESPACE = "https://www.google.com/apis/ads/publisher/v201705";
    const XSI_TYPE = "SamSessionError";

    /**
     * @access public
     * @var tnsSamSessionErrorReason
     */
    public $reason;
...
if (!class_exists("AdBreakFillType", false)) {
  /**
  ...
  class AdBreakFillType {
    ...
    const WSDL_NAMESPACE = "https://www.google.com/apis/ads/publisher/v201705";
    const XSI_TYPE = "AdBreakFillType";
...
if (!class_exists("OriginForwardingType", false)) {
  /**
   ...
   * @subpackage v201705
   */
  class OriginForwardingType {

    const WSDL_NAMESPACE = "https://www.google.com/apis/ads/publisher/v201705";
    const XSI_TYPE = "OriginForwardingType";
...
if (!class_exists("SamSessionErrorReason", false)) {
  /**
   * Describes reasons for SAM session errors.
   * @package GoogleApiAdsDfp
   * @subpackage v201705
   */
  class SamSessionErrorReason {

    const WSDL_NAMESPACE = "https://www.google.com/apis/ads/publisher/v201705";
    const XSI_TYPE = "SamSessionError.Reason";
...
if (!class_exists("RegisterSessionsForMonitoring", false)) {
  /**
   ...
   * @subpackage v201705
   */
  class RegisterSessionsForMonitoring {
...
if (!class_exists("RegisterSessionsForMonitoringResponse", false)) {
  /**
   * 
   * @package GoogleApiAdsDfp
   * @subpackage v201705
...
if (!class_exists("LiveStreamEventService", false)) {
  ...
  class LiveStreamEventService extends DfpSoapClient {
    ...
    const WSDL_NAMESPACE = "https://www.google.com/apis/ads/publisher/v201705";
    const ENDPOINT = "https://ads.google.com/apis/ads/publisher/v201705/LiveStreamEventService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://ads.google.com/apis/ads/publisher/v201705/LiveStreamEventService";
    /**
    ...
    public static $classmap = array(
      ...
      "SamSessionError" => "SamSessionError",
      ...
      "SamSessionError.Reason" => "SamSessionErrorReason",
      ...
      "registerSessionsForMonitoringResponse" => "RegisterSessionsForMonitoringResponse",
     ...
     * @throws ApiException if there is an error registering any of the session IDs
     */
    public function registerSessionsForMonitoring($sessionIds) {
      $args = new RegisterSessionsForMonitoring($sessionIds);
      $result = $this->__soapCall("registerSessionsForMonitoring", array($args));
      return $result->rval;
    }
    /**
     * Updates the specified {@link LiveStreamEvent} objects.
