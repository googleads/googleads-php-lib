...
if (!class_exists("TeamAction", false)) {
  /**
   * Represents the actions that can be performed on {@link Team} objects.
   * @package GoogleApiAdsDfp
   * @subpackage v201705
   */
  class TeamAction {
...
if (!class_exists("TeamStatus", false)) {
  /**
...
if (!class_exists("PerformTeamAction", false)) {
  /**
  ...
  class PerformTeamAction {
    ...
    public function __construct($teamAction = null, $filterStatement = null) {
...
if (!class_exists("PerformTeamActionResponse", false)) {
  /**
   * 
   * @package GoogleApiAdsDfp
   * @subpackage v201705
...
if (!class_exists("ActivateTeams", false)) {
  /**
   * The action used for activating {@link Team} objects.
   * @package GoogleApiAdsDfp
   * @subpackage v201705
   */
  class ActivateTeams extends TeamAction {

    const WSDL_NAMESPACE = "https://www.google.com/apis/ads/publisher/v201705";
    const XSI_TYPE = "ActivateTeams";
...
if (!class_exists("DeactivateTeams", false)) {
  /**
   * The action used for deactivating {@link Team} objects.
   * @package GoogleApiAdsDfp
   * @subpackage v201705
   */
  class DeactivateTeams extends TeamAction {

    const WSDL_NAMESPACE = "https://www.google.com/apis/ads/publisher/v201705";
    const XSI_TYPE = "DeactivateTeams";
...
if (!class_exists("TeamService", false)) {
  ...
  class TeamService extends DfpSoapClient {
    ...
    const WSDL_NAMESPACE = "https://www.google.com/apis/ads/publisher/v201705";
    const ENDPOINT = "https://ads.google.com/apis/ads/publisher/v201705/TeamService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://ads.google.com/apis/ads/publisher/v201705/TeamService";
    /**
    ...
    public static $classmap = array(
      ...
      "DateValue" => "DateValue",
      "DeactivateTeams" => "DeactivateTeams",
      ...
      "performTeamAction" => "PerformTeamAction",
      "performTeamActionResponse" => "PerformTeamActionResponse",
     ...
     * @return the result of the action performed
     */
    public function performTeamAction($teamAction, $filterStatement) {
      $args = new PerformTeamAction($teamAction, $filterStatement);
      $result = $this->__soapCall("performTeamAction", array($args));
      return $result->rval;
    }
    /**
     * Updates the specified {@link Team} objects.
