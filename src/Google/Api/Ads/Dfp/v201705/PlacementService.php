...
if (!class_exists("Placement", false)) {
  ...
  class Placement extends SiteTargetingInfo {
    ...
    public function __construct($id = null, $name = null, $description = null, $placementCode = null, $status = null, $targetedAdUnitIds = null, $lastModifiedDateTime = null) {
      parent::__construct();
      $this->id = $id;
      $this->name = $name;
...
if (!class_exists("PlacementService", false)) {
  ...
  class PlacementService extends DfpSoapClient {
    ...
    const WSDL_NAMESPACE = "https://www.google.com/apis/ads/publisher/v201705";
    const ENDPOINT = "https://ads.google.com/apis/ads/publisher/v201705/PlacementService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://ads.google.com/apis/ads/publisher/v201705/PlacementService";
    /**
