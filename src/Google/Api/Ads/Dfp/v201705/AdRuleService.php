...
if (!class_exists("AdRuleTargetingErrorReason", false)) {
  /**
  ...
  class AdRuleTargetingErrorReason {
    ...
    const WSDL_NAMESPACE = "https://www.google.com/apis/ads/publisher/v201705";
    const XSI_TYPE = "AdRuleTargetingError.Reason";
...
if (!class_exists("AdRuleTargetingError", false)) {
  /**
   * Lists all errors associated with ad rule targeting.
   * @package GoogleApiAdsDfp
   * @subpackage v201705
   */
  class AdRuleTargetingError extends ApiError {

    const WSDL_NAMESPACE = "https://www.google.com/apis/ads/publisher/v201705";
    const XSI_TYPE = "AdRuleTargetingError";

    /**
     * @access public
     * @var tnsAdRuleTargetingErrorReason
     */
    public $reason;
...
if (!class_exists("AdRuleService", false)) {
  ...
  class AdRuleService extends DfpSoapClient {
    ...
    const WSDL_NAMESPACE = "https://www.google.com/apis/ads/publisher/v201705";
    const ENDPOINT = "https://ads.google.com/apis/ads/publisher/v201705/AdRuleService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://ads.google.com/apis/ads/publisher/v201705/AdRuleService";
    /**
    ...
    public static $classmap = array(
      ...
      "AdRuleTargetingError" => "AdRuleTargetingError",
      ...
      "AdRuleTargetingError.Reason" => "AdRuleTargetingErrorReason",
