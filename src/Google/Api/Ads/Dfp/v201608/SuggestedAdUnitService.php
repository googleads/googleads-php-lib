...
if (!class_exists("ApproveSuggestedAdUnits", false)) {
  /**
   * Action to approve {@link SuggestedAdUnit} objects.
   * @package GoogleApiAdsDfp
   * @subpackage v201608
   */
  class ApproveSuggestedAdUnits extends SuggestedAdUnitAction {

    const WSDL_NAMESPACE = "https://www.google.com/apis/ads/publisher/v201608";
    const XSI_TYPE = "ApproveSuggestedAdUnits";
...
if (!class_exists("SuggestedAdUnitService", false)) {
  ...
  class SuggestedAdUnitService extends DfpSoapClient {
    ...
    const WSDL_NAMESPACE = "https://www.google.com/apis/ads/publisher/v201608";
    const ENDPOINT = "https://ads.google.com/apis/ads/publisher/v201608/SuggestedAdUnitService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://ads.google.com/apis/ads/publisher/v201608/SuggestedAdUnitService";
    /**
    ...
    public static $classmap = array(
      ...
      "ApproveSuggestedAdUnits" => "ApproveSuggestedAdUnits",
