...
if (!class_exists("RateCard", false)) {
  ...
  class RateCard {
    ...
    public function __construct($id = null, $name = null, $currencyCode = null, $status = null, $forMarketplace = null, $pricingModel = null, $appliedTeamIds = null, $lastModifiedDateTime = null) {
      $this->id = $id;
      $this->name = $name;
...
if (!class_exists("RateCardService", false)) {
  ...
  class RateCardService extends DfpSoapClient {
    ...
    const WSDL_NAMESPACE = "https://www.google.com/apis/ads/publisher/v201608";
    const ENDPOINT = "https://ads.google.com/apis/ads/publisher/v201608/RateCardService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://ads.google.com/apis/ads/publisher/v201608/RateCardService";
    /**
