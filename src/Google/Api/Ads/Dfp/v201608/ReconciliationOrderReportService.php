...
if (!class_exists("ReconciliationOrderReport", false)) {
  ...
  class ReconciliationOrderReport {
     ...
     * @var Money
     */
    public $proposalNetBillableRevenueManualAdjustment;

    /**
     * @access public
     * @var Money
     */
    public $proposalGrossBillableRevenueManualAdjustment;
...
if (!class_exists("UpdateReconciliationOrderReports", false)) {
  /**
   ...
   * @subpackage v201608
   */
  class UpdateReconciliationOrderReports {
     ...
     * @var ReconciliationOrderReport[]
     */
    public $reconciliationOrderReports;
    ...
    public function __construct($reconciliationOrderReports = null) {
      $this->reconciliationOrderReports = $reconciliationOrderReports;
    }

  }
}

if (!class_exists("UpdateReconciliationOrderReportsResponse", false)) {
  /**
   * 
   * @package GoogleApiAdsDfp
   * @subpackage v201608
...
if (!class_exists("ReconciliationOrderReportService", false)) {
  ...
  class ReconciliationOrderReportService extends DfpSoapClient {
    ...
    const WSDL_NAMESPACE = "https://www.google.com/apis/ads/publisher/v201608";
    const ENDPOINT = "https://ads.google.com/apis/ads/publisher/v201608/ReconciliationOrderReportService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://ads.google.com/apis/ads/publisher/v201608/ReconciliationOrderReportService";
    /**
    ...
    public static $classmap = array(
      ...
      "updateReconciliationOrderReports" => "UpdateReconciliationOrderReports",
      "updateReconciliationOrderReportsResponse" => "UpdateReconciliationOrderReportsResponse",
    );
     ...
     * @return the updated reconciliation order reports
     */
    public function updateReconciliationOrderReports($reconciliationOrderReports) {
      $args = new UpdateReconciliationOrderReports($reconciliationOrderReports);
      $result = $this->__soapCall("updateReconciliationOrderReports", array($args));
      return $result->rval;
    }
  }
}
