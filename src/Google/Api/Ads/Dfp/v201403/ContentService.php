...
if (!class_exists("Google\\Api\\Ads\\Dfp\\v201403\\CmsContent", false)) {
  /**
...
if (!class_exists("Google\\Api\\Ads\\Dfp\\v201403\\Content", false)) {
  /**
  ...
  class Content {
    ...
    public function __construct($id = null, $name = null, $status = null, $statusDefinedBy = null, $lastModifiedDateTime = null, $userDefinedCustomTargetingValueIds = null, $mappingRuleDefinedCustomTargetingValueIds = null, $cmsSources = null) {
      $this->id = $id;
      $this->name = $name;
      $this->status = $status;
...
if (!class_exists("Google\\Api\\Ads\\Dfp\\v201403\\ContentPage", false)) {
  /**
...
if (!class_exists("Google\\Api\\Ads\\Dfp\\v201403\\ContentPartnerError", false)) {
  /**
...
if (!class_exists("Google\\Api\\Ads\\Dfp\\v201403\\ContentPartnerErrorReason", false)) {
  /**
...
if (!class_exists("Google\\Api\\Ads\\Dfp\\v201403\\ContentStatus", false)) {
  /**
...
if (!class_exists("Google\\Api\\Ads\\Dfp\\v201403\\ContentStatusDefinedBy", false)) {
  /**
...
if (!class_exists("Google\\Api\\Ads\\Dfp\\v201403\\GetContentByStatement", false)) {
  /**
...
if (!class_exists("Google\\Api\\Ads\\Dfp\\v201403\\GetContentByStatementResponse", false)) {
  /**
   * 
   * @package Google\Api\Ads\Dfp\v201403
   * @subpackage v201403
...
if (!class_exists("Google\\Api\\Ads\\Dfp\\v201403\\GetContentByStatementAndCustomTargetingValue", false)) {
  /**
   * Gets a {@link ContentPage} of {@link Content} objects that satisfy the
...
if (!class_exists("Google\\Api\\Ads\\Dfp\\v201403\\GetContentByStatementAndCustomTargetingValueResponse", false)) {
  /**
   * 
   * @package Google\Api\Ads\Dfp\v201403
   * @subpackage v201403
...
if (!class_exists("ContentService", false)) {
   ...
   * @subpackage v201403
   */
  class ContentService extends \Google\Api\Ads\Dfp\Lib\DfpSoapClient {

    const SERVICE_NAME = "ContentService";
    const WSDL_NAMESPACE = "https://www.google.com/apis/ads/publisher/v201403";
    const ENDPOINT = "https://www.google.com/apis/ads/publisher/v201403/ContentService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://www.google.com/apis/ads/publisher/v201403/ContentService";
    /**
    ...
    public static $classmap = array(
      ...
      "CmsContent" => "Google\\Api\\Ads\\Dfp\\v201403\\CmsContent",
      "CommonError" => "Google\\Api\\Ads\\Dfp\\v201403\\CommonError",
      "Content" => "Google\\Api\\Ads\\Dfp\\v201403\\Content",
      "ContentPage" => "Google\\Api\\Ads\\Dfp\\v201403\\ContentPage",
      "ContentPartnerError" => "Google\\Api\\Ads\\Dfp\\v201403\\ContentPartnerError",
      ...
      "ContentPartnerError.Reason" => "Google\\Api\\Ads\\Dfp\\v201403\\ContentPartnerErrorReason",
      "ContentStatus" => "Google\\Api\\Ads\\Dfp\\v201403\\ContentStatus",
      ...
      "ContentStatusDefinedBy" => "Google\\Api\\Ads\\Dfp\\v201403\\ContentStatusDefinedBy",
      "StringLengthError.Reason" => "Google\\Api\\Ads\\Dfp\\v201403\\StringLengthErrorReason",
      "getContentByStatement" => "Google\\Api\\Ads\\Dfp\\v201403\\GetContentByStatement",
      "getContentByStatementResponse" => "Google\\Api\\Ads\\Dfp\\v201403\\GetContentByStatementResponse",
      "getContentByStatementAndCustomTargetingValue" => "Google\\Api\\Ads\\Dfp\\v201403\\GetContentByStatementAndCustomTargetingValue",
      "getContentByStatementAndCustomTargetingValueResponse" => "Google\\Api\\Ads\\Dfp\\v201403\\GetContentByStatementAndCustomTargetingValueResponse",
    );
