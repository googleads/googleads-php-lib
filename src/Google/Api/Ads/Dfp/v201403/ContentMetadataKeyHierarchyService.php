...
if (!class_exists("ActivateContentMetadataKeyHierarchies", FALSE)) {
/**
 * The action used for activating {@link ContentMetadataKeyHierarchy} objects.
 * @package GoogleApiAdsDfp
 * @subpackage v201403
 */
class ActivateContentMetadataKeyHierarchies extends ContentMetadataKeyHierarchyAction {

  const WSDL_NAMESPACE = "https://www.google.com/apis/ads/publisher/v201403";
  const XSI_TYPE = "ActivateContentMetadataKeyHierarchies";
...
class ContentMetadataKeyHierarchyService extends DfpSoapClient {
  ...
  public static $classmap = array(
    "ActivateContentMetadataKeyHierarchies" => "ActivateContentMetadataKeyHierarchies",
    "ApiError" => "ApiError",
