...
if (!class_exists("Google\\Api\\Ads\\Dfp\\v201403\\WorkflowRequest", false)) {
  /**
  ...
  class WorkflowRequest {
    ...
    public function __construct($id = null, $workflowRuleName = null, $entityId = null, $entityType = null, $WorkflowRequestType = null) {
      $this->id = $id;
...
if (!class_exists("Google\\Api\\Ads\\Dfp\\v201403\\ProposalActionError", false)) {
  /**
...
if (!class_exists("Google\\Api\\Ads\\Dfp\\v201403\\WorkflowActionError", false)) {
  /**
...
if (!class_exists("Google\\Api\\Ads\\Dfp\\v201403\\WorkflowApprovalRequest", false)) {
  /**
  ...
  class WorkflowApprovalRequest extends WorkflowRequest {
    ...
    public function __construct($status = null, $id = null, $workflowRuleName = null, $entityId = null, $entityType = null, $WorkflowRequestType = null) {
      parent::__construct();
      $this->status = $status;
      $this->id = $id;
      $this->workflowRuleName = $workflowRuleName;
...
if (!class_exists("Google\\Api\\Ads\\Dfp\\v201403\\WorkflowRequestAction", false)) {
  /**
  ...
  class WorkflowRequestAction {
     ...
     * @var string
     */
    public $WorkflowRequestActionType;
    private $_parameterMap = array(
      "WorkflowRequestAction.Type" => "WorkflowRequestActionType",
    );
...
if (!class_exists("Google\\Api\\Ads\\Dfp\\v201403\\WorkflowRequestPage", false)) {
  /**
...
if (!class_exists("Google\\Api\\Ads\\Dfp\\v201403\\WorkflowApprovalRequestStatus", false)) {
  /**
...
if (!class_exists("Google\\Api\\Ads\\Dfp\\v201403\\ProposalActionErrorReason", false)) {
  /**
   * The reasons for the target error.
   * @package Google\Api\Ads\Dfp\v201403
   * @subpackage v201403
...
if (!class_exists("Google\\Api\\Ads\\Dfp\\v201403\\WorkflowActionErrorReason", false)) {
  /**
   * The reasons for the target error.
   * @package Google\Api\Ads\Dfp\v201403
   * @subpackage v201403
...
if (!class_exists("Google\\Api\\Ads\\Dfp\\v201403\\WorkflowEntityType", false)) {
  /**
...
if (!class_exists("Google\\Api\\Ads\\Dfp\\v201403\\GetWorkflowRequestsByStatement", false)) {
  /**
...
if (!class_exists("Google\\Api\\Ads\\Dfp\\v201403\\GetWorkflowRequestsByStatementResponse", false)) {
  /**
   * 
   * @package Google\Api\Ads\Dfp\v201403
   * @subpackage v201403
...
if (!class_exists("Google\\Api\\Ads\\Dfp\\v201403\\PerformWorkflowRequestAction", false)) {
  /**
...
if (!class_exists("Google\\Api\\Ads\\Dfp\\v201403\\PerformWorkflowRequestActionResponse", false)) {
  /**
   * 
   * @package Google\Api\Ads\Dfp\v201403
   * @subpackage v201403
...
if (!class_exists("Google\\Api\\Ads\\Dfp\\v201403\\ApproveWorkflowApprovalRequests", false)) {
  /**
...
if (!class_exists("Google\\Api\\Ads\\Dfp\\v201403\\RejectWorkflowApprovalRequests", false)) {
  /**
...
if (!class_exists("WorkflowRequestService", false)) {
   ...
   * @subpackage v201403
   */
  class WorkflowRequestService extends \Google\Api\Ads\Dfp\Lib\DfpSoapClient {

    const SERVICE_NAME = "WorkflowRequestService";
    const WSDL_NAMESPACE = "https://www.google.com/apis/ads/publisher/v201403";
    const ENDPOINT = "https://www.google.com/apis/ads/publisher/v201403/WorkflowRequestService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://www.google.com/apis/ads/publisher/v201403/WorkflowRequestService";
    /**
    ...
    public static $classmap = array(
      ...
      "ApproveWorkflowApprovalRequests" => "Google\\Api\\Ads\\Dfp\\v201403\\ApproveWorkflowApprovalRequests",
      ...
      "WorkflowRequest" => "Google\\Api\\Ads\\Dfp\\v201403\\WorkflowRequest",
      ...
      "ProposalActionError" => "Google\\Api\\Ads\\Dfp\\v201403\\ProposalActionError",
      ...
      "RejectWorkflowApprovalRequests" => "Google\\Api\\Ads\\Dfp\\v201403\\RejectWorkflowApprovalRequests",
      ...
      "WorkflowActionError" => "Google\\Api\\Ads\\Dfp\\v201403\\WorkflowActionError",
      "WorkflowApprovalRequest" => "Google\\Api\\Ads\\Dfp\\v201403\\WorkflowApprovalRequest",
      "WorkflowRequestAction" => "Google\\Api\\Ads\\Dfp\\v201403\\WorkflowRequestAction",
      "WorkflowRequestPage" => "Google\\Api\\Ads\\Dfp\\v201403\\WorkflowRequestPage",
      "ApiVersionError.Reason" => "Google\\Api\\Ads\\Dfp\\v201403\\ApiVersionErrorReason",
      "WorkflowApprovalRequestStatus" => "Google\\Api\\Ads\\Dfp\\v201403\\WorkflowApprovalRequestStatus",
      ...
      "ProposalActionError.Reason" => "Google\\Api\\Ads\\Dfp\\v201403\\ProposalActionErrorReason",
      ...
      "WorkflowActionError.Reason" => "Google\\Api\\Ads\\Dfp\\v201403\\WorkflowActionErrorReason",
      "WorkflowEntityType" => "Google\\Api\\Ads\\Dfp\\v201403\\WorkflowEntityType",
      "getWorkflowRequestsByStatement" => "Google\\Api\\Ads\\Dfp\\v201403\\GetWorkflowRequestsByStatement",
      "getWorkflowRequestsByStatementResponse" => "Google\\Api\\Ads\\Dfp\\v201403\\GetWorkflowRequestsByStatementResponse",
      "performWorkflowRequestAction" => "Google\\Api\\Ads\\Dfp\\v201403\\PerformWorkflowRequestAction",
      "performWorkflowRequestActionResponse" => "Google\\Api\\Ads\\Dfp\\v201403\\PerformWorkflowRequestActionResponse",
    );
