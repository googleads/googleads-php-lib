<?php
/**
 * Contains all client objects for the ReconciliationLineItemReportService
 * service.
 *
 * PHP version 5
 *
...
if (!class_exists("BillableRevenueOverrides", false)) {
  /**
  ...
  class BillableRevenueOverrides {
    ...
    const WSDL_NAMESPACE = "https://www.google.com/apis/ads/publisher/v201605";
    const XSI_TYPE = "BillableRevenueOverrides";

    /**
     * @access public
     * @var Money
     */
    public $netBillableRevenueOverride;

    /**
     * @access public
     * @var Money
     */
    public $grossBillableRevenueOverride;

    /**
     * @access public
     * @var Money
     */
    public $billableRevenueOverride;
...
if (!class_exists("ReconciliationLineItemReport", false)) {
  /**
  ...
  class ReconciliationLineItemReport {
    ...
    const WSDL_NAMESPACE = "https://www.google.com/apis/ads/publisher/v201605";
    const XSI_TYPE = "ReconciliationLineItemReport";
     ...
     * @var integer
     */
    public $rolloverVolume;

    /**
     * @access public
     * @var integer
     */
    public $billableVolume;

    /**
     * @access public
     * @var Money
     */
    public $netBillableRevenue;

    /**
     * @access public
     * @var Money
     */
    public $grossBillableRevenue;

    /**
     * @access public
     * @var BillableRevenueOverrides
     */
...
if (!class_exists("ReconciliationLineItemReportPage", false)) {
  /**
   * Captures a page of {@link ReconciliationLineItemReport} objects.
   * @package GoogleApiAdsDfp
   * @subpackage v201605
   */
  class ReconciliationLineItemReportPage {
    ...
    const WSDL_NAMESPACE = "https://www.google.com/apis/ads/publisher/v201605";
    const XSI_TYPE = "ReconciliationLineItemReportPage";

    /**
     * @access public
     * @var ReconciliationLineItemReport[]
     */
    public $results;
...
if (!class_exists("GetReconciliationLineItemReportsByStatement", false)) {
   ...
   * @subpackage v201605
   */
  class GetReconciliationLineItemReportsByStatement {
...
if (!class_exists("GetReconciliationLineItemReportsByStatementResponse", false)) {
  /**
   * 
   * @package GoogleApiAdsDfp
   * @subpackage v201605
  ...
  class GetReconciliationLineItemReportsByStatementResponse {
    ...
    /**
     * @access public
     * @var ReconciliationLineItemReportPage
     */
    public $rval;
...
if (!class_exists("UpdateReconciliationLineItemReports", false)) {
  /**
  ...
  class UpdateReconciliationLineItemReports {
     ...
     * @var ReconciliationLineItemReport[]
     */
    public $reconciliationLineItemReports;
    ...
    public function __construct($reconciliationLineItemReports = null) {
      $this->reconciliationLineItemReports = $reconciliationLineItemReports;
    }

  }
}

if (!class_exists("UpdateReconciliationLineItemReportsResponse", false)) {
  /**
   * 
   * @package GoogleApiAdsDfp
   * @subpackage v201605
...
if (!class_exists("ReconciliationLineItemReportService", false)) {
  /**
   * ReconciliationLineItemReportService
   * @package GoogleApiAdsDfp
   * @subpackage v201605
   */
  class ReconciliationLineItemReportService extends DfpSoapClient {

    const SERVICE_NAME = "ReconciliationLineItemReportService";
    const WSDL_NAMESPACE = "https://www.google.com/apis/ads/publisher/v201605";
    const ENDPOINT = "https://ads.google.com/apis/ads/publisher/v201605/ReconciliationLineItemReportService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://ads.google.com/apis/ads/publisher/v201605/ReconciliationLineItemReportService";
    /**
    ...
    public static $classmap = array(
      ...
      "ReconciliationLineItemReport" => "ReconciliationLineItemReport",
      "ReconciliationLineItemReportPage" => "ReconciliationLineItemReportPage",
      ...
      "updateReconciliationLineItemReportsResponse" => "UpdateReconciliationLineItemReportsResponse",
    );
     ...
     * @return the {@link ReconciliationLineItemReport} objects that match the given filter
     */
    public function getReconciliationLineItemReportsByStatement($filterStatement) {
      $args = new GetReconciliationLineItemReportsByStatement($filterStatement);
      $result = $this->__soapCall("getReconciliationLineItemReportsByStatement", array($args));
      return $result->rval;
    }
    /**
     * Updates a list of {@link ReconciliationLineItemReport} objects which belong to same
     ...
     * @return the updated {@link ReconciliationLineItemReport} objects
     */
    public function updateReconciliationLineItemReports($reconciliationLineItemReports) {
      $args = new UpdateReconciliationLineItemReports($reconciliationLineItemReports);
      $result = $this->__soapCall("updateReconciliationLineItemReports", array($args));
      return $result->rval;
    }
  }
}
