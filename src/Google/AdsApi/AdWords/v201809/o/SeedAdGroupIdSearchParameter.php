 ...
 */
class SeedAdGroupIdSearchParameter extends \Google\AdsApi\AdWords\v201809\o\SearchParameter
{
    ...
    /**
     * @param int $adGroupId
     * @return \Google\AdsApi\AdWords\v201809\o\SeedAdGroupIdSearchParameter
     */
