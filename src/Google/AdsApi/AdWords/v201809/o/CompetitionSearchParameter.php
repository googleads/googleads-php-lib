 ...
 */
class CompetitionSearchParameter extends \Google\AdsApi\AdWords\v201809\o\SearchParameter
{
    ...
    /**
     * @param string[] $levels
     * @return \Google\AdsApi\AdWords\v201809\o\CompetitionSearchParameter
     */
