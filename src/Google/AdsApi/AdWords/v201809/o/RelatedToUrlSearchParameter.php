 ...
 */
class RelatedToUrlSearchParameter extends \Google\AdsApi\AdWords\v201809\o\SearchParameter
{
    ...
    /**
     * @param string[] $urls
     * @return \Google\AdsApi\AdWords\v201809\o\RelatedToUrlSearchParameter
     */
