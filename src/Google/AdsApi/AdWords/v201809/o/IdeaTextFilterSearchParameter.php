 ...
 */
class IdeaTextFilterSearchParameter extends \Google\AdsApi\AdWords\v201809\o\SearchParameter
{
    ...
    /**
     * @param string[] $included
     * @return \Google\AdsApi\AdWords\v201809\o\IdeaTextFilterSearchParameter
     */
