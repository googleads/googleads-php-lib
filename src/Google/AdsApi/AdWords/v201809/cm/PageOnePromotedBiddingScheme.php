 ...
 */
class PageOnePromotedBiddingScheme extends \Google\AdsApi\AdWords\v201809\cm\BiddingScheme
{
    ...
    /**
     * @param string $strategyGoal
     * @return \Google\AdsApi\AdWords\v201809\cm\PageOnePromotedBiddingScheme
     */
