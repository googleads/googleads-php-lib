 ...
 */
class RequestContextOperand extends \Google\AdsApi\AdWords\v201809\cm\FunctionArgumentOperand
{
    ...
    /**
     * @param string $contextType
     * @return \Google\AdsApi\AdWords\v201809\cm\RequestContextOperand
     */
