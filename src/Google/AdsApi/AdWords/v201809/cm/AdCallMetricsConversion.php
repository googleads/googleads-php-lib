 ...
 */
class AdCallMetricsConversion extends \Google\AdsApi\AdWords\v201809\cm\ConversionTracker
{
    ...
    /**
     * @param int $phoneCallDuration
     * @return \Google\AdsApi\AdWords\v201809\cm\AdCallMetricsConversion
     */
