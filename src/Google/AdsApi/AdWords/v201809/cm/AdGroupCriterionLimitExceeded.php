 ...
 */
class AdGroupCriterionLimitExceeded extends \Google\AdsApi\AdWords\v201809\cm\EntityCountLimitExceeded
{
    ...
    /**
     * @param string $limitType
     * @return \Google\AdsApi\AdWords\v201809\cm\AdGroupCriterionLimitExceeded
     */
