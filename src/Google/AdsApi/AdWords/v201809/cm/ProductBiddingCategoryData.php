 ...
 */
class ProductBiddingCategoryData extends \Google\AdsApi\AdWords\v201809\cm\ConstantData
{

    /**
     * @var \Google\AdsApi\AdWords\v201809\cm\ProductBiddingCategory $dimensionValue
     */
    protected $dimensionValue = null;

    /**
     * @var \Google\AdsApi\AdWords\v201809\cm\ProductBiddingCategory $parentDimensionValue
     */
    ...
    /**
     * @var \Google\AdsApi\AdWords\v201809\cm\String_StringMapEntry[] $displayValue
     */
    protected $displayValue = null;

    /**
     * @param string $ConstantDataType
     * @param \Google\AdsApi\AdWords\v201809\cm\ProductBiddingCategory $dimensionValue
     * @param \Google\AdsApi\AdWords\v201809\cm\ProductBiddingCategory $parentDimensionValue
     * @param string $country
     * @param string $status
     * @param \Google\AdsApi\AdWords\v201809\cm\String_StringMapEntry[] $displayValue
     */
