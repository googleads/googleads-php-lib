...
class FeedMapping
{
    ...
    /**
     * @var \Google\AdsApi\AdWords\v201809\cm\AttributeFieldMapping[] $attributeFieldMappings
     */
     ...
     * @param string $status
     * @param \Google\AdsApi\AdWords\v201809\cm\AttributeFieldMapping[] $attributeFieldMappings
