...
class CriterionErrorReason
{
    ...
    const CANNOT_ADD_POSITIVE_PLACEMENTS_TO_SEARCH_CAMPAIGNS = 'CANNOT_ADD_POSITIVE_PLACEMENTS_TO_SEARCH_CAMPAIGNS';
    ...
    const ADSENSE_FOR_MOBILE_APPS_PLACEMENT_DEPRECATED = 'ADSENSE_FOR_MOBILE_APPS_PLACEMENT_DEPRECATED';
