 ...
 */
class AdCampaignAdSubProductTypeError extends \Google\AdsApi\AdWords\v201809\cm\ApiError
{
    ...
    /**
     * @param string $reason
     * @return \Google\AdsApi\AdWords\v201809\cm\AdCampaignAdSubProductTypeError
     */
