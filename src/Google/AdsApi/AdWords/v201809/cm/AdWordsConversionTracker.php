 ...
 */
class AdWordsConversionTracker extends \Google\AdsApi\AdWords\v201809\cm\ConversionTracker
{
    ...
    /**
     * @param string $trackingCodeType
     * @return \Google\AdsApi\AdWords\v201809\cm\AdWordsConversionTracker
     */
