...
class DateRuleItem
{
    ...
    /**
     * @var \Google\AdsApi\AdWords\v201809\rm\DateKey $key
     */
    protected $key = null;
    ...
    /**
     * @var \Google\AdsApi\AdWords\v201809\rm\RelativeDate $relativeValue
     */
    protected $relativeValue = null;

    /**
     * @param \Google\AdsApi\AdWords\v201809\rm\DateKey $key
     * @param string $op
     * @param string $value
     * @param \Google\AdsApi\AdWords\v201809\rm\RelativeDate $relativeValue
     */
    ...
    /**
     * @return \Google\AdsApi\AdWords\v201809\rm\RelativeDate
     */
