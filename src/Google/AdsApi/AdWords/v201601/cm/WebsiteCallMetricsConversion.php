...
class WebsiteCallMetricsConversion extends \Google\AdsApi\AdWords\v201601\cm\ConversionTracker
{
    ...
    /**
     * @param int $phoneCallDuration
     * @return \Google\AdsApi\AdWords\v201601\cm\WebsiteCallMetricsConversion
     */
