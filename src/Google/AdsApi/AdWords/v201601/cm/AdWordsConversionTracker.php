...
class AdWordsConversionTracker extends \Google\AdsApi\AdWords\v201601\cm\ConversionTracker
{
    ...
    /**
     * @param string $snippet
     * @return \Google\AdsApi\AdWords\v201601\cm\AdWordsConversionTracker
     */
