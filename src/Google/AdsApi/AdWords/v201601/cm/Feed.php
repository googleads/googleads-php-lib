...
class Feed
{
    ...
    /**
     * @var \Google\AdsApi\AdWords\v201601\cm\FeedAttribute[] $attributes
     */
    ...
    /**
     * @var \Google\AdsApi\AdWords\v201601\cm\SystemFeedGenerationData $systemFeedGenerationData
     */
     ...
     * @param int $id
     * @param string $name
     * @param \Google\AdsApi\AdWords\v201601\cm\FeedAttribute[] $attributes
     * @param string $status
     * @param string $origin
     * @param \Google\AdsApi\AdWords\v201601\cm\SystemFeedGenerationData $systemFeedGenerationData
     */
