...
class SimilarUserList extends \Google\AdsApi\AdWords\v201601\rm\UserList
{
    ...
    /**
     * @param int $seedUserListId
     * @return \Google\AdsApi\AdWords\v201601\rm\SimilarUserList
     */
