...
class ManagedCustomerServiceError extends \Google\AdsApi\AdWords\v201601\cm\ApiError
{
    ...
    /**
     * @param string $reason
     * @return \Google\AdsApi\AdWords\v201601\mcm\ManagedCustomerServiceError
     */
