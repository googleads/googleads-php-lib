...
class OfflineData
{
    ...
    /**
     * @var \Google\AdsApi\AdWords\v201710\rm\StoreSalesTransaction $StoreSalesTransaction
     */
    protected $StoreSalesTransaction = null;

    /**
     * @param \Google\AdsApi\AdWords\v201710\rm\StoreSalesTransaction $StoreSalesTransaction
     */
