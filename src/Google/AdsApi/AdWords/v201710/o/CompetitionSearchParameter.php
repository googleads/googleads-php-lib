 ...
 */
class CompetitionSearchParameter extends \Google\AdsApi\AdWords\v201710\o\SearchParameter
{
    ...
    /**
     * @param string[] $levels
     * @return \Google\AdsApi\AdWords\v201710\o\CompetitionSearchParameter
     */
