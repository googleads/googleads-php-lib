 ...
 */
class StructuredSnippetFeedItem extends \Google\AdsApi\AdWords\v201710\cm\ExtensionFeedItem
{
    ...
    /**
     * @param string $header
     * @return \Google\AdsApi\AdWords\v201710\cm\StructuredSnippetFeedItem
     */
