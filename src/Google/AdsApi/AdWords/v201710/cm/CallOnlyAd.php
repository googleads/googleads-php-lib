 ...
 */
class CallOnlyAd extends \Google\AdsApi\AdWords\v201710\cm\Ad
{
    ...
    /**
     * @param string $countryCode
     * @return \Google\AdsApi\AdWords\v201710\cm\CallOnlyAd
     */
