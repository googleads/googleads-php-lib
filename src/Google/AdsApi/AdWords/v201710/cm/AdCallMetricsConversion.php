 ...
 */
class AdCallMetricsConversion extends \Google\AdsApi\AdWords\v201710\cm\ConversionTracker
{
    ...
    /**
     * @param int $phoneCallDuration
     * @return \Google\AdsApi\AdWords\v201710\cm\AdCallMetricsConversion
     */
