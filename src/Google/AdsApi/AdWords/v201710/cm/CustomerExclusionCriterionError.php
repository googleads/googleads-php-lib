 ...
 */
class CustomerExclusionCriterionError extends \Google\AdsApi\AdWords\v201710\cm\ApiError
{
    ...
    /**
     * @param string $reason
     * @return \Google\AdsApi\AdWords\v201710\cm\CustomerExclusionCriterionError
     */
