 ...
 */
class ThirdPartyRedirectAd extends \Google\AdsApi\AdWords\v201710\cm\RichMediaAd
{
    ...
    {
      parent::__construct($id, $url, $displayUrl, $finalUrls, $finalMobileUrls, $finalAppUrls, $trackingUrlTemplate, $urlCustomParameters, $urlData, $automated, $type, $devicePreference, $AdType, $name, $dimensions, $snippet, $impressionBeaconUrl, $adDuration, $certifiedVendorFormatId, $sourceUrl, $richMediaAdType, $adAttributes);
    ...
    /**
     * @param boolean $isCookieTargeted
     * @return \Google\AdsApi\AdWords\v201710\cm\ThirdPartyRedirectAd
     */
