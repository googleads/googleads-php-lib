 ...
 */
class ConversionOptimizerBiddingScheme extends \Google\AdsApi\AdWords\v201603\cm\BiddingScheme
{
    ...
    /**
     * @param string $pricingMode
     * @return \Google\AdsApi\AdWords\v201603\cm\ConversionOptimizerBiddingScheme
     */
