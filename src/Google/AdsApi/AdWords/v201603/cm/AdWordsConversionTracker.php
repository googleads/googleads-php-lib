 ...
 */
class AdWordsConversionTracker extends \Google\AdsApi\AdWords\v201603\cm\ConversionTracker
{
    ...
    /**
     * @param string $snippet
     * @return \Google\AdsApi\AdWords\v201603\cm\AdWordsConversionTracker
     */
