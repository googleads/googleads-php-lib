 ...
 */
class LocationCriterionServiceError extends \Google\AdsApi\AdWords\v201603\cm\ApiError
{
    ...
    /**
     * @param string $reason
     * @return \Google\AdsApi\AdWords\v201603\cm\LocationCriterionServiceError
     */
