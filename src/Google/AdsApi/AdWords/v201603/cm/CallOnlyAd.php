 ...
 */
class CallOnlyAd extends \Google\AdsApi\AdWords\v201603\cm\Ad
{
    ...
    /**
     * @param string $countryCode
     * @return \Google\AdsApi\AdWords\v201603\cm\CallOnlyAd
     */
