 ...
 */
class AdCallMetricsConversion extends \Google\AdsApi\AdWords\v201603\cm\ConversionTracker
{
    ...
    /**
     * @param int $phoneCallDuration
     * @return \Google\AdsApi\AdWords\v201603\cm\AdCallMetricsConversion
     */
