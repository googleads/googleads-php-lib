 ...
 */
class CompetitionSearchParameter extends \Google\AdsApi\AdWords\v201603\o\SearchParameter
{
    ...
    /**
     * @param string $levels
     * @return \Google\AdsApi\AdWords\v201603\o\CompetitionSearchParameter
     */
