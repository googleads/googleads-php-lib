 ...
 */
class RelatedToQuerySearchParameter extends \Google\AdsApi\AdWords\v201603\o\SearchParameter
{
    ...
    /**
     * @param string[] $queries
     * @return \Google\AdsApi\AdWords\v201603\o\RelatedToQuerySearchParameter
     */
