...
class StatsEstimate
{
    ...
    /**
     * @var \Google\AdsApi\AdWords\v201802\cm\Money $averageCpc
     */
    ...
    /**
     * @var \Google\AdsApi\AdWords\v201802\cm\Money $totalCost
     */
    protected $totalCost = null;

    /**
     * @param \Google\AdsApi\AdWords\v201802\cm\Money $averageCpc
     * @param float $averagePosition
     * @param float $clickThroughRate
     * @param float $clicksPerDay
     * @param float $impressionsPerDay
     * @param \Google\AdsApi\AdWords\v201802\cm\Money $totalCost
     */
