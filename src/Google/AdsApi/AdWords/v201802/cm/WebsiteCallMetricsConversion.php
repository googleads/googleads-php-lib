 ...
 */
class WebsiteCallMetricsConversion extends \Google\AdsApi\AdWords\v201802\cm\ConversionTracker
{
    ...
    /**
     * @param int $phoneCallDuration
     * @return \Google\AdsApi\AdWords\v201802\cm\WebsiteCallMetricsConversion
     */
