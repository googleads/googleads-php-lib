...
class Feed
{
    ...
    /**
     * @var \Google\AdsApi\AdWords\v201802\cm\FeedAttribute[] $attributes
     */
    ...
    /**
     * @var \Google\AdsApi\AdWords\v201802\cm\SystemFeedGenerationData $systemFeedGenerationData
     */
     ...
     * @param int $id
     * @param string $name
     * @param \Google\AdsApi\AdWords\v201802\cm\FeedAttribute[] $attributes
     * @param string $status
     * @param string $origin
     * @param \Google\AdsApi\AdWords\v201802\cm\SystemFeedGenerationData $systemFeedGenerationData
     */
    ...
    /**
     * @return \Google\AdsApi\AdWords\v201802\cm\FeedAttribute[]
     */
