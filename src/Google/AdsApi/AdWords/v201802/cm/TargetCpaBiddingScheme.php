 ...
 */
class TargetCpaBiddingScheme extends \Google\AdsApi\AdWords\v201802\cm\BiddingScheme
{

    /**
     * @var \Google\AdsApi\AdWords\v201802\cm\Money $targetCpa
     */
    protected $targetCpa = null;

    /**
     * @var \Google\AdsApi\AdWords\v201802\cm\Money $maxCpcBidCeiling
     */
    protected $maxCpcBidCeiling = null;

    /**
     * @var \Google\AdsApi\AdWords\v201802\cm\Money $maxCpcBidFloor
     */
    protected $maxCpcBidFloor = null;

    /**
     * @param string $BiddingSchemeType
     * @param \Google\AdsApi\AdWords\v201802\cm\Money $targetCpa
     * @param \Google\AdsApi\AdWords\v201802\cm\Money $maxCpcBidCeiling
     * @param \Google\AdsApi\AdWords\v201802\cm\Money $maxCpcBidFloor
     */
    ...
    /**
     * @param \Google\AdsApi\AdWords\v201802\cm\Money $targetCpa
     * @return \Google\AdsApi\AdWords\v201802\cm\TargetCpaBiddingScheme
     */
