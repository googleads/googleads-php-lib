 ...
 */
class FeedAttributeOperand extends \Google\AdsApi\AdWords\v201802\cm\FunctionArgumentOperand
{
    ...
    /**
     * @param int $feedId
     * @return \Google\AdsApi\AdWords\v201802\cm\FeedAttributeOperand
     */
