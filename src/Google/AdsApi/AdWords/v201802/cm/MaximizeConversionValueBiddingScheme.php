 ...
 */
class MaximizeConversionValueBiddingScheme extends \Google\AdsApi\AdWords\v201802\cm\BiddingScheme
{
    ...
    /**
     * @param float $targetRoas
     * @return \Google\AdsApi\AdWords\v201802\cm\MaximizeConversionValueBiddingScheme
     */
