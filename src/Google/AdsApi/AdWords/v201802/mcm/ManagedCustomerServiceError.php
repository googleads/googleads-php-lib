 ...
 */
class ManagedCustomerServiceError extends \Google\AdsApi\AdWords\v201802\cm\ApiError
{
    ...
    /**
     * @param string $reason
     * @return \Google\AdsApi\AdWords\v201802\mcm\ManagedCustomerServiceError
     */
