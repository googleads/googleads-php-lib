...
use Google\AdsApi\AdWords\v201710\cm\MutateResult;
use Google\AdsApi\AdWords\v201710\cm\Operation;
...
final class BatchJobs {
  ...
  public function __construct(
    ...
    $this->batchJobsDelegate = ($batchJobsDelegate === null)
        ? new BatchJobsDelegate($session, $httpClient, $mutateResultClassName)
        : $batchJobsDelegate;
  ...
  public function uploadIncrementalBatchJobOperations(array $operations,
    ...
    return $this->batchJobsDelegate->uploadIncrementalBatchJobOperations(
        $operations, $batchJobUploadStatus);
  }
