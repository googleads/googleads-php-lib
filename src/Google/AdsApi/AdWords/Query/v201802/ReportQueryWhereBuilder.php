 ...
 * `ReportQueryBuilder` object for chaining.
 */
final class ReportQueryWhereBuilder implements WhereBuilderInterface
{
    /**
     * @var ReportQueryBuilder the query builder object for continuation of
     ...
     * @param ReportQueryBuilder $queryBuilder the query builder object for
     *     continuation of building a complete AWQL string
     * @return ReportQueryWhereBuilder a where builder object to build a logic
     ...
     * @return ReportQueryBuilder the `ReportQueryBuilder` object for
     *     continuation of building a complete AWQL string
     */
    ...
    {
        $this->expressionBuilder->doesNotContainIgnoreCase($value);
        return $this->queryBuilder;
    }
