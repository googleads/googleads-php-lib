 ...
 */
class FeedAttributeReferenceError extends \Google\AdsApi\AdWords\v201607\cm\ApiError
{
    ...
    /**
     * @param string $reason
     * @return \Google\AdsApi\AdWords\v201607\cm\FeedAttributeReferenceError
     */
