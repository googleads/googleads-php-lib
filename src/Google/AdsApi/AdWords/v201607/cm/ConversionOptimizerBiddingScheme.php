 ...
 */
class ConversionOptimizerBiddingScheme extends \Google\AdsApi\AdWords\v201607\cm\BiddingScheme
{
    ...
    /**
     * @param string $pricingMode
     * @return \Google\AdsApi\AdWords\v201607\cm\ConversionOptimizerBiddingScheme
     */
