 ...
 */
class ProductCanonicalCondition extends \Google\AdsApi\AdWords\v201607\cm\ProductDimension
{
    ...
    /**
     * @param string $condition
     * @return \Google\AdsApi\AdWords\v201607\cm\ProductCanonicalCondition
     */
