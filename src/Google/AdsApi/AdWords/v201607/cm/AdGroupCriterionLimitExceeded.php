 ...
 */
class AdGroupCriterionLimitExceeded extends \Google\AdsApi\AdWords\v201607\cm\EntityCountLimitExceeded
{
    ...
    /**
     * @param string $limitType
     * @return \Google\AdsApi\AdWords\v201607\cm\AdGroupCriterionLimitExceeded
     */
