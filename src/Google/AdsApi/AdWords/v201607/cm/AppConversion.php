 ...
 */
class AppConversion extends \Google\AdsApi\AdWords\v201607\cm\ConversionTracker
{
    ...
    /**
     * @param string $appId
     * @return \Google\AdsApi\AdWords\v201607\cm\AppConversion
     */
