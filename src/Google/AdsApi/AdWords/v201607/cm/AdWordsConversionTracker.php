 ...
 */
class AdWordsConversionTracker extends \Google\AdsApi\AdWords\v201607\cm\ConversionTracker
{
    ...
    /**
     * @param string $snippet
     * @return \Google\AdsApi\AdWords\v201607\cm\AdWordsConversionTracker
     */
