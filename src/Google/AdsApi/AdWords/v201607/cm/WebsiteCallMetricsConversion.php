 ...
 */
class WebsiteCallMetricsConversion extends \Google\AdsApi\AdWords\v201607\cm\ConversionTracker
{
    ...
    /**
     * @param int $phoneCallDuration
     * @return \Google\AdsApi\AdWords\v201607\cm\WebsiteCallMetricsConversion
     */
