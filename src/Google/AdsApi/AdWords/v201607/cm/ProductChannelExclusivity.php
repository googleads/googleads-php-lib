 ...
 */
class ProductChannelExclusivity extends \Google\AdsApi\AdWords\v201607\cm\ProductDimension
{
    ...
    /**
     * @param string $channelExclusivity
     * @return \Google\AdsApi\AdWords\v201607\cm\ProductChannelExclusivity
     */
