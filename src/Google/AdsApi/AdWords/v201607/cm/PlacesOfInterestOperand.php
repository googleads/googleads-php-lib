 ...
 */
class PlacesOfInterestOperand extends \Google\AdsApi\AdWords\v201607\cm\FunctionArgumentOperand
{
    ...
    /**
     * @param string $category
     * @return \Google\AdsApi\AdWords\v201607\cm\PlacesOfInterestOperand
     */
