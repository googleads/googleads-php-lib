 ...
 */
class BiddingStrategyReturnValue extends \Google\AdsApi\AdWords\v201609\cm\ListReturnValue
{

    /**
     * @var \Google\AdsApi\AdWords\v201609\cm\SharedBiddingStrategy[] $value
     */
    protected $value = null;

    /**
     * @param string $ListReturnValueType
     * @param \Google\AdsApi\AdWords\v201609\cm\SharedBiddingStrategy[] $value
     */
