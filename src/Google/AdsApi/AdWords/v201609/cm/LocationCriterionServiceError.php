 ...
 */
class LocationCriterionServiceError extends \Google\AdsApi\AdWords\v201609\cm\ApiError
{
    ...
    /**
     * @param string $reason
     * @return \Google\AdsApi\AdWords\v201609\cm\LocationCriterionServiceError
     */
