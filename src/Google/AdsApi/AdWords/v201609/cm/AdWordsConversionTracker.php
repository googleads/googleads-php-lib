 ...
 */
class AdWordsConversionTracker extends \Google\AdsApi\AdWords\v201609\cm\ConversionTracker
{
    ...
    /**
     * @param string $snippet
     * @return \Google\AdsApi\AdWords\v201609\cm\AdWordsConversionTracker
     */
