 ...
 */
class ProductCanonicalCondition extends \Google\AdsApi\AdWords\v201609\cm\ProductDimension
{
    ...
    /**
     * @param string $condition
     * @return \Google\AdsApi\AdWords\v201609\cm\ProductCanonicalCondition
     */
