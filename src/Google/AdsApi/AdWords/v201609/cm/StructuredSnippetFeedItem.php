 ...
 */
class StructuredSnippetFeedItem extends \Google\AdsApi\AdWords\v201609\cm\ExtensionFeedItem
{
    ...
    /**
     * @param string $header
     * @return \Google\AdsApi\AdWords\v201609\cm\StructuredSnippetFeedItem
     */
