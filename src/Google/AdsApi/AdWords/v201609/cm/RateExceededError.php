 ...
 */
class RateExceededError extends \Google\AdsApi\AdWords\v201609\cm\ApiError
{
     ...
     */
    public function __construct($fieldPath = null, $trigger = null, $errorString = null, $ApiErrorType = null, $reason = null, $rateName = null, $rateScope = null, $retryAfterSeconds = null)
    {
    ...
    /**
     * @param string $reason
     * @return \Google\AdsApi\AdWords\v201609\cm\RateExceededError
     */
