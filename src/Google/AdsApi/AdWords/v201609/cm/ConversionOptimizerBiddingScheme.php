 ...
 */
class ConversionOptimizerBiddingScheme extends \Google\AdsApi\AdWords\v201609\cm\BiddingScheme
{
    ...
    /**
     * @param string $pricingMode
     * @return \Google\AdsApi\AdWords\v201609\cm\ConversionOptimizerBiddingScheme
     */
