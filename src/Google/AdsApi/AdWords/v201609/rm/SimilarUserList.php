 ...
 */
class SimilarUserList extends \Google\AdsApi\AdWords\v201609\rm\UserList
{
    ...
    /**
     * @param int $seedUserListId
     * @return \Google\AdsApi\AdWords\v201609\rm\SimilarUserList
     */
