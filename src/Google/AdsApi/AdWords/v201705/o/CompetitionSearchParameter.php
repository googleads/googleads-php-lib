 ...
 */
class CompetitionSearchParameter extends \Google\AdsApi\AdWords\v201705\o\SearchParameter
{
    ...
    /**
     * @param string[] $levels
     * @return \Google\AdsApi\AdWords\v201705\o\CompetitionSearchParameter
     */
