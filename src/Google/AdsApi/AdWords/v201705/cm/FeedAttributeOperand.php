 ...
 */
class FeedAttributeOperand extends \Google\AdsApi\AdWords\v201705\cm\FunctionArgumentOperand
{
    ...
    /**
     * @param int $feedId
     * @return \Google\AdsApi\AdWords\v201705\cm\FeedAttributeOperand
     */
