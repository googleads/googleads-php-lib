 ...
 */
class AdWordsConversionTracker extends \Google\AdsApi\AdWords\v201705\cm\ConversionTracker
{
    ...
    /**
     * @param string $snippet
     * @return \Google\AdsApi\AdWords\v201705\cm\AdWordsConversionTracker
     */
