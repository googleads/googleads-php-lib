 ...
 */
class WebsiteCallMetricsConversion extends \Google\AdsApi\AdWords\v201705\cm\ConversionTracker
{
    ...
    /**
     * @param int $phoneCallDuration
     * @return \Google\AdsApi\AdWords\v201705\cm\WebsiteCallMetricsConversion
     */
