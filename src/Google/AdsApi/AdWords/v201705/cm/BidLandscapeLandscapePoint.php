...
class BidLandscapeLandscapePoint
{
    ...
    /**
     * @var \Google\AdsApi\AdWords\v201705\cm\Money $bid
     */
    protected $bid = null;
    ...
    /**
     * @var \Google\AdsApi\AdWords\v201705\cm\Money $cost
     */
    protected $cost = null;
    ...
    /**
     * @var \Google\AdsApi\AdWords\v201705\cm\Money $requiredBudget
     */
    ...
    /**
     * @var \Google\AdsApi\AdWords\v201705\cm\Money $totalLocalCost
     */
    ...
    /**
     * @param \Google\AdsApi\AdWords\v201705\cm\Money $bid
     * @param int $clicks
     * @param \Google\AdsApi\AdWords\v201705\cm\Money $cost
     * @param int $impressions
     * @param int $promotedImpressions
     * @param \Google\AdsApi\AdWords\v201705\cm\Money $requiredBudget
     * @param float $bidModifier
     * @param int $totalLocalImpressions
     * @param int $totalLocalClicks
     * @param \Google\AdsApi\AdWords\v201705\cm\Money $totalLocalCost
    ...
    /**
     * @param \Google\AdsApi\AdWords\v201705\cm\Money $bid
     * @return \Google\AdsApi\AdWords\v201705\cm\BidLandscapeLandscapePoint
     */
