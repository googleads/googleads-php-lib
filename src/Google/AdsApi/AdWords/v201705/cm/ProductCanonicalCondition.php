 ...
 */
class ProductCanonicalCondition extends \Google\AdsApi\AdWords\v201705\cm\ProductDimension
{
    ...
    /**
     * @param string $condition
     * @return \Google\AdsApi\AdWords\v201705\cm\ProductCanonicalCondition
     */
