 ...
 */
class AdGroupCriterionLimitExceeded extends \Google\AdsApi\AdWords\v201705\cm\EntityCountLimitExceeded
{
    ...
    /**
     * @param string $limitType
     * @return \Google\AdsApi\AdWords\v201705\cm\AdGroupCriterionLimitExceeded
     */
