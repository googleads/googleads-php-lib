...
class MatchingFunction
{
    ...
    /**
     * @var \Google\AdsApi\AdWords\v201705\cm\FunctionArgumentOperand[] $lhsOperand
     */
    protected $lhsOperand = null;

    /**
     * @var \Google\AdsApi\AdWords\v201705\cm\FunctionArgumentOperand[] $rhsOperand
     */
     ...
     * @param \Google\AdsApi\AdWords\v201705\cm\FunctionArgumentOperand[] $lhsOperand
     * @param \Google\AdsApi\AdWords\v201705\cm\FunctionArgumentOperand[] $rhsOperand
    ...
    /**
     * @param string $operator
     * @return \Google\AdsApi\AdWords\v201705\cm\MatchingFunction
     */
