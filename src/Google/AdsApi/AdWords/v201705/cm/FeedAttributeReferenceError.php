 ...
 */
class FeedAttributeReferenceError extends \Google\AdsApi\AdWords\v201705\cm\ApiError
{
    ...
    /**
     * @param string $reason
     * @return \Google\AdsApi\AdWords\v201705\cm\FeedAttributeReferenceError
     */
