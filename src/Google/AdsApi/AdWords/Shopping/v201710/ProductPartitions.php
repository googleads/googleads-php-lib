 ...
 */
namespace Google\AdsApi\AdWords\Shopping\v201710;
...
use Google\AdsApi\AdWords\v201710\cm\ProductDimension;
use Google\AdsApi\AdWords\v201710\cm\ProductPartition;
use Google\AdsApi\AdWords\v201710\cm\ProductPartitionType;
use ReflectionClass;
...
final class ProductPartitions {
   ...
   */
  public static function createSubdivision(ProductPartition $parent = null,
  ...
  /**
   * Creates a unit node (product partition) by specifying the parent node and
   * the value being partitioned on.
   *
   * @param null|ProductPartition $parent the parent product partition for a
   *     newly created unit
   * @param null|ProductDimension $value the case value for a newly created unit
   * @return ProductPartition the newly created product partition
   */
  public static function createUnit(ProductPartition $parent = null,
      ProductDimension $value = null) {
   ...
   */
  public static function asBiddableAdGroupCriterion($adGroupId,
      ProductPartition $productPartition, $bidAmount = null) {
   ...
   */
  public static function asNegativeAdGroupCriterion($adGroupId,
      ...
      if ($page->getEntries() !== null) {
        ...
        foreach ($page->getEntries() as $adGroupCriterion) {
          ...
          if ($adGroupCriterion->getCriterion()->getParentCriterionId()
              !== null) {
            $parentCriterionId =
                $adGroupCriterion->getCriterion()->getParentCriterionId();
            $children[$parentCriterionId][] = $adGroupCriterion->getCriterion();
          } else {
   ...
   */
  private static function traverseTree(Criterion $node, array $children,
      $level) {
    $type = 'n/a';
    $value = 'n/a';
