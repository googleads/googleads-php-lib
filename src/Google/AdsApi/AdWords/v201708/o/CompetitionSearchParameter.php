 ...
 */
class CompetitionSearchParameter extends \Google\AdsApi\AdWords\v201708\o\SearchParameter
{
    ...
    /**
     * @param string[] $levels
     * @return \Google\AdsApi\AdWords\v201708\o\CompetitionSearchParameter
     */
