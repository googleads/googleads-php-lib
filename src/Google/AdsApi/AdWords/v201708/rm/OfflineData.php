...
class OfflineData
{
    ...
    /**
     * @var \Google\AdsApi\AdWords\v201708\rm\StoreSalesTransaction $StoreSalesTransaction
     */
    protected $StoreSalesTransaction = null;

    /**
     * @param \Google\AdsApi\AdWords\v201708\rm\StoreSalesTransaction $StoreSalesTransaction
     */
