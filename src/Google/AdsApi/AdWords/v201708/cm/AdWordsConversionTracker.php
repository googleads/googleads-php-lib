 ...
 */
class AdWordsConversionTracker extends \Google\AdsApi\AdWords\v201708\cm\ConversionTracker
{
    ...
    /**
     * @param string $snippet
     * @return \Google\AdsApi\AdWords\v201708\cm\AdWordsConversionTracker
     */
