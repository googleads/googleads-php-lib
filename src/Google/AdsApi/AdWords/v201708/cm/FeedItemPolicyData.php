 ...
 */
class FeedItemPolicyData extends \Google\AdsApi\AdWords\v201708\cm\PolicyData
{
    ...
    /**
     * @var \Google\AdsApi\AdWords\v201708\cm\FeedItemAttributeError[] $validationErrors
     */
    ...
    /**
     * @param \Google\AdsApi\AdWords\v201708\cm\DisapprovalReason[] $disapprovalReasons
     * @param string $PolicyDataType
     * @param int $placeholderType
     * @param int $feedMappingId
     * @param string $validationStatus
     * @param string $approvalStatus
     * @param \Google\AdsApi\AdWords\v201708\cm\FeedItemAttributeError[] $validationErrors
    ...
    /**
     * @return \Google\AdsApi\AdWords\v201708\cm\FeedItemAttributeError[]
     */
