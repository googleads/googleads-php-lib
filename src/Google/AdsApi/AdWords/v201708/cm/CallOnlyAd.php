 ...
 */
class CallOnlyAd extends \Google\AdsApi\AdWords\v201708\cm\Ad
{
    ...
    /**
     * @param string $countryCode
     * @return \Google\AdsApi\AdWords\v201708\cm\CallOnlyAd
     */
