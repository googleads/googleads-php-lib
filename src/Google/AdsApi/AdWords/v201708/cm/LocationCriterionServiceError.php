 ...
 */
class LocationCriterionServiceError extends \Google\AdsApi\AdWords\v201708\cm\ApiError
{
    ...
    /**
     * @param string $reason
     * @return \Google\AdsApi\AdWords\v201708\cm\LocationCriterionServiceError
     */
