 ...
 */
class AdCallMetricsConversion extends \Google\AdsApi\AdWords\v201708\cm\ConversionTracker
{
    ...
    /**
     * @param int $phoneCallDuration
     * @return \Google\AdsApi\AdWords\v201708\cm\AdCallMetricsConversion
     */
