 ...
 */
class MaximizeConversionValueBiddingScheme extends \Google\AdsApi\AdWords\v201806\cm\BiddingScheme
{
    ...
    /**
     * @param float $targetRoas
     * @return \Google\AdsApi\AdWords\v201806\cm\MaximizeConversionValueBiddingScheme
     */
