 ...
 */
class AdCallMetricsConversion extends \Google\AdsApi\AdWords\v201806\cm\ConversionTracker
{
    ...
    /**
     * @param int $phoneCallDuration
     * @return \Google\AdsApi\AdWords\v201806\cm\AdCallMetricsConversion
     */
