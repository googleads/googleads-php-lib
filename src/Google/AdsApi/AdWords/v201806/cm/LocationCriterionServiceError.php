 ...
 */
class LocationCriterionServiceError extends \Google\AdsApi\AdWords\v201806\cm\ApiError
{
    ...
    /**
     * @param string $reason
     * @return \Google\AdsApi\AdWords\v201806\cm\LocationCriterionServiceError
     */
