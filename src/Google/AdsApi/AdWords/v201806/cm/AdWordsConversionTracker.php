 ...
 */
class AdWordsConversionTracker extends \Google\AdsApi\AdWords\v201806\cm\ConversionTracker
{
    ...
    /**
     * @param string $trackingCodeType
     * @return \Google\AdsApi\AdWords\v201806\cm\AdWordsConversionTracker
     */
