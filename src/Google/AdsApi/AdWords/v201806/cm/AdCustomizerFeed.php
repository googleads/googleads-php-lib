...
class AdCustomizerFeed
{
    ...
    /**
     * @var \Google\AdsApi\AdWords\v201806\cm\AdCustomizerFeedAttribute[] $feedAttributes
     */
     ...
     * @param \Google\AdsApi\AdWords\v201806\cm\AdCustomizerFeedAttribute[] $feedAttributes
     */
