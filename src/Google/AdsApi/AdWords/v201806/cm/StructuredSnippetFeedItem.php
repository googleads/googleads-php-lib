 ...
 */
class StructuredSnippetFeedItem extends \Google\AdsApi\AdWords\v201806\cm\ExtensionFeedItem
{
    ...
    /**
     * @param string $header
     * @return \Google\AdsApi\AdWords\v201806\cm\StructuredSnippetFeedItem
     */
