 ...
 */
class PlacesOfInterestOperand extends \Google\AdsApi\AdWords\v201702\cm\FunctionArgumentOperand
{
    ...
    /**
     * @param string $category
     * @return \Google\AdsApi\AdWords\v201702\cm\PlacesOfInterestOperand
     */
