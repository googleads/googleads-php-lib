 ...
 */
class AdCallMetricsConversion extends \Google\AdsApi\AdWords\v201702\cm\ConversionTracker
{
    ...
    /**
     * @param int $phoneCallDuration
     * @return \Google\AdsApi\AdWords\v201702\cm\AdCallMetricsConversion
     */
