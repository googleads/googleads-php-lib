 ...
 */
class ProductCanonicalCondition extends \Google\AdsApi\AdWords\v201702\cm\ProductDimension
{
    ...
    /**
     * @param string $condition
     * @return \Google\AdsApi\AdWords\v201702\cm\ProductCanonicalCondition
     */
