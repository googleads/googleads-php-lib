 ...
 */
class PageOnePromotedBiddingScheme extends \Google\AdsApi\AdWords\v201702\cm\BiddingScheme
{
    ...
    /**
     * @param string $strategyGoal
     * @return \Google\AdsApi\AdWords\v201702\cm\PageOnePromotedBiddingScheme
     */
