 ...
 */
class FeedItemPolicyData extends \Google\AdsApi\AdWords\v201702\cm\PolicyData
{
    ...
    /**
     * @var \Google\AdsApi\AdWords\v201702\cm\FeedItemAttributeError[] $validationErrors
     */
