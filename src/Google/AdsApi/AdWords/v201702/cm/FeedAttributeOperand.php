 ...
 */
class FeedAttributeOperand extends \Google\AdsApi\AdWords\v201702\cm\FunctionArgumentOperand
{
    ...
    /**
     * @param int $feedId
     * @return \Google\AdsApi\AdWords\v201702\cm\FeedAttributeOperand
     */
