 ...
 */
class StructuredSnippetFeedItem extends \Google\AdsApi\AdWords\v201702\cm\ExtensionFeedItem
{
    ...
    /**
     * @param string $header
     * @return \Google\AdsApi\AdWords\v201702\cm\StructuredSnippetFeedItem
     */
