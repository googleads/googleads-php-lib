 ...
 */
class LocationCriterionServiceError extends \Google\AdsApi\AdWords\v201702\cm\ApiError
{
    ...
    /**
     * @param string $reason
     * @return \Google\AdsApi\AdWords\v201702\cm\LocationCriterionServiceError
     */
