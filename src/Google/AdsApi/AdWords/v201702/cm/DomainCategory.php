 ...
 */
class DomainCategory extends \Google\AdsApi\AdWords\v201702\cm\DimensionProperties
{
    ...
    /**
     * @var \Google\AdsApi\AdWords\v201702\cm\Money $recommendedCpc
     */
     ...
     * @param \Google\AdsApi\AdWords\v201702\cm\LevelOfDetail $levelOfDetail
     * @param string $category
     * @param float $coverage
     * @param string $domainName
     * @param string $isoLanguage
     * @param \Google\AdsApi\AdWords\v201702\cm\Money $recommendedCpc
    ...
    /**
     * @param string $category
     * @return \Google\AdsApi\AdWords\v201702\cm\DomainCategory
     */
