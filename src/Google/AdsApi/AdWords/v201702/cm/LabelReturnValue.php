 ...
 */
class LabelReturnValue extends \Google\AdsApi\AdWords\v201702\cm\ListReturnValue
{

    /**
     * @var \Google\AdsApi\AdWords\v201702\cm\Label[] $value
     */
    protected $value = null;

    /**
     * @param string $ListReturnValueType
     * @param \Google\AdsApi\AdWords\v201702\cm\Label[] $value
     */
