 ...
 */
class AdGroupCriterionLimitExceeded extends \Google\AdsApi\AdWords\v201702\cm\EntityCountLimitExceeded
{
    ...
    /**
     * @param string $limitType
     * @return \Google\AdsApi\AdWords\v201702\cm\AdGroupCriterionLimitExceeded
     */
