 ...
 */
class ProductChannelExclusivity extends \Google\AdsApi\AdWords\v201702\cm\ProductDimension
{
    ...
    /**
     * @param string $channelExclusivity
     * @return \Google\AdsApi\AdWords\v201702\cm\ProductChannelExclusivity
     */
