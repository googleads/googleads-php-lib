 ...
 */
class CompetitionSearchParameter extends \Google\AdsApi\AdWords\v201605\o\SearchParameter
{
    ...
    /**
     * @param string $levels
     * @return \Google\AdsApi\AdWords\v201605\o\CompetitionSearchParameter
     */
