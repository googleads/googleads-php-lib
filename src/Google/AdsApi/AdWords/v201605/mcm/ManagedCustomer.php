...
class ManagedCustomer
{
    ...
    /**
     * @var \Google\AdsApi\AdWords\v201605\mcm\AccountLabel[] $accountLabels
     */
     ...
     * @param \Google\AdsApi\AdWords\v201605\mcm\AccountLabel[] $accountLabels
     * @param boolean $excludeHiddenAccounts
     */
    public function __construct($name = null, $companyName = null, $customerId = null, $canManageClients = null, $currencyCode = null, $dateTimeZone = null, $testAccount = null, array $accountLabels = null, $excludeHiddenAccounts = null)
    {
      $this->name = $name;
    ...
    /**
     * @return \Google\AdsApi\AdWords\v201605\mcm\AccountLabel[]
     */
