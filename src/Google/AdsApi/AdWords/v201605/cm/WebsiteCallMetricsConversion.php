 ...
 */
class WebsiteCallMetricsConversion extends \Google\AdsApi\AdWords\v201605\cm\ConversionTracker
{
    ...
    /**
     * @param int $phoneCallDuration
     * @return \Google\AdsApi\AdWords\v201605\cm\WebsiteCallMetricsConversion
     */
