 ...
 */
class LocationCriterionServiceError extends \Google\AdsApi\AdWords\v201605\cm\ApiError
{
    ...
    /**
     * @param string $reason
     * @return \Google\AdsApi\AdWords\v201605\cm\LocationCriterionServiceError
     */
