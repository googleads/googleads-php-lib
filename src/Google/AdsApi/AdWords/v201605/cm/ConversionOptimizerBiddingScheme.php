 ...
 */
class ConversionOptimizerBiddingScheme extends \Google\AdsApi\AdWords\v201605\cm\BiddingScheme
{
    ...
    /**
     * @param string $pricingMode
     * @return \Google\AdsApi\AdWords\v201605\cm\ConversionOptimizerBiddingScheme
     */
