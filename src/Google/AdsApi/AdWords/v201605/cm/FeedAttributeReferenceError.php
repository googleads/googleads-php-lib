 ...
 */
class FeedAttributeReferenceError extends \Google\AdsApi\AdWords\v201605\cm\ApiError
{
    ...
    /**
     * @param string $reason
     * @return \Google\AdsApi\AdWords\v201605\cm\FeedAttributeReferenceError
     */
