 ...
 */
class LineItemCreativeAssociationError extends \Google\AdsApi\AdManager\v202205\ApiError
{
    ...
    /**
     * @param string $reason
     * @return \Google\AdsApi\AdManager\v202205\LineItemCreativeAssociationError
     */
