 ...
 */
class RichMediaStudioCreative extends \Google\AdsApi\AdManager\v202205\BaseRichMediaStudioCreative
{
    ...
    /**
     * @param string $lockedOrientation
     * @return \Google\AdsApi\AdManager\v202205\RichMediaStudioCreative
     */
