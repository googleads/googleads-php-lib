 ...
 */
abstract class HasDestinationUrlCreative extends \Google\AdsApi\AdManager\v202205\Creative
{
    ...
    /**
     * @param string $destinationUrl
     * @return \Google\AdsApi\AdManager\v202205\HasDestinationUrlCreative
     */
