...
class TrafficDataResponse
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202205\TimeSeries $historicalTimeSeries
     */
    protected $historicalTimeSeries = null;

    /**
     * @var \Google\AdsApi\AdManager\v202205\TimeSeries $forecastedTimeSeries
     */
    protected $forecastedTimeSeries = null;

    /**
     * @var \Google\AdsApi\AdManager\v202205\TimeSeries $forecastedAssignedTimeSeries
     */
    protected $forecastedAssignedTimeSeries = null;

    /**
     * @var \Google\AdsApi\AdManager\v202205\DateRange $overallDateRange
     */
    protected $overallDateRange = null;

    /**
     * @param \Google\AdsApi\AdManager\v202205\TimeSeries $historicalTimeSeries
     * @param \Google\AdsApi\AdManager\v202205\TimeSeries $forecastedTimeSeries
     * @param \Google\AdsApi\AdManager\v202205\TimeSeries $forecastedAssignedTimeSeries
     * @param \Google\AdsApi\AdManager\v202205\DateRange $overallDateRange
     */
    ...
    /**
     * @return \Google\AdsApi\AdManager\v202205\TimeSeries
     */
