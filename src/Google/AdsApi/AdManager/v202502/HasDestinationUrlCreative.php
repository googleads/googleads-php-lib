 ...
 */
abstract class HasDestinationUrlCreative extends \Google\AdsApi\AdManager\v202502\Creative
{
    ...
    /**
     * @param string $destinationUrl
     * @return \Google\AdsApi\AdManager\v202502\HasDestinationUrlCreative
     */
