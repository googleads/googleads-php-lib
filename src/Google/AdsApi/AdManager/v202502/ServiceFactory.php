...
final class ServiceFactory
{
    ...
    /**
     * Creates a new service client for `AdsTxtService`.
     *
     * @param AdsSession $session a session containing configurations for the service client
     * @return AdsTxtService a new service client
     */
    public function createAdsTxtService(AdsSession $session)
    {
        return $this->services->get($session, AdsTxtService::class);
    }
