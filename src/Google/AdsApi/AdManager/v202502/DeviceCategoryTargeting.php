...
class DeviceCategoryTargeting
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202502\Technology[] $targetedDeviceCategories
     */
    protected $targetedDeviceCategories = null;

    /**
     * @var \Google\AdsApi\AdManager\v202502\Technology[] $excludedDeviceCategories
     */
    protected $excludedDeviceCategories = null;

    /**
     * @param \Google\AdsApi\AdManager\v202502\Technology[] $targetedDeviceCategories
     * @param \Google\AdsApi\AdManager\v202502\Technology[] $excludedDeviceCategories
     */
    ...
    /**
     * @param \Google\AdsApi\AdManager\v202502\Technology[]|null $targetedDeviceCategories
