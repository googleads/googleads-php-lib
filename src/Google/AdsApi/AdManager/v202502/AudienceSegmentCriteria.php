 ...
 */
class AudienceSegmentCriteria extends \Google\AdsApi\AdManager\v202502\CustomCriteriaLeaf
{
    ...
    /**
     * @param string $operator
     * @return \Google\AdsApi\AdManager\v202502\AudienceSegmentCriteria
     */
