 ...
 */
abstract class BaseVideoCreative extends \Google\AdsApi\AdManager\v202502\HasDestinationUrlCreative
{
    ...
    /**
     * @param int $duration
     * @return \Google\AdsApi\AdManager\v202502\BaseVideoCreative
     */
