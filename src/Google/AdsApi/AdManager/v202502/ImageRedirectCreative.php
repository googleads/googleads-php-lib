 ...
 */
class ImageRedirectCreative extends \Google\AdsApi\AdManager\v202502\BaseImageRedirectCreative
{
    ...
    /**
     * @param string $altText
     * @return \Google\AdsApi\AdManager\v202502\ImageRedirectCreative
     */
