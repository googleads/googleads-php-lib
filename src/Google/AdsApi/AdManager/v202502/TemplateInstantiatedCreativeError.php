 ...
 */
class TemplateInstantiatedCreativeError extends \Google\AdsApi\AdManager\v202502\ApiError
{
    ...
    /**
     * @param string $reason
     * @return \Google\AdsApi\AdManager\v202502\TemplateInstantiatedCreativeError
     */
