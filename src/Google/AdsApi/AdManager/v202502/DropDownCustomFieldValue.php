 ...
 */
class DropDownCustomFieldValue extends \Google\AdsApi\AdManager\v202502\BaseCustomFieldValue
{
    ...
    /**
     * @param int $customFieldOptionId
     * @return \Google\AdsApi\AdManager\v202502\DropDownCustomFieldValue
     */
