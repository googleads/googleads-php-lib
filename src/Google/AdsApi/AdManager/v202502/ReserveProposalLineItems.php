 ...
 */
class ReserveProposalLineItems extends \Google\AdsApi\AdManager\v202502\ProposalLineItemAction
{
    ...
    /**
     * @param boolean $allowOverbook
     * @return \Google\AdsApi\AdManager\v202502\ReserveProposalLineItems
     */
