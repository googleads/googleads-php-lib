 ...
 */
class AdExchangeCreative extends \Google\AdsApi\AdManager\v202502\HasHtmlSnippetDynamicAllocationCreative
{
    ...
    /**
     * @param boolean $isNativeEligible
     * @return \Google\AdsApi\AdManager\v202502\AdExchangeCreative
     */
