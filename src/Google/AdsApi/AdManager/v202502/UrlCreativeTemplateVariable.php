 ...
 */
class UrlCreativeTemplateVariable extends \Google\AdsApi\AdManager\v202502\CreativeTemplateVariable
{
    ...
    /**
     * @param string $defaultValue
     * @return \Google\AdsApi\AdManager\v202502\UrlCreativeTemplateVariable
     */
