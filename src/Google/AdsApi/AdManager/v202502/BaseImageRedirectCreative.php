 ...
 */
abstract class BaseImageRedirectCreative extends \Google\AdsApi\AdManager\v202502\HasDestinationUrlCreative
{
    ...
    /**
     * @param string $imageUrl
     * @return \Google\AdsApi\AdManager\v202502\BaseImageRedirectCreative
     */
