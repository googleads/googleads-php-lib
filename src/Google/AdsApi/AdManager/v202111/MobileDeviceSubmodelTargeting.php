...
class MobileDeviceSubmodelTargeting
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202111\Technology[] $targetedMobileDeviceSubmodels
     */
    protected $targetedMobileDeviceSubmodels = null;

    /**
     * @var \Google\AdsApi\AdManager\v202111\Technology[] $excludedMobileDeviceSubmodels
     */
    protected $excludedMobileDeviceSubmodels = null;

    /**
     * @param \Google\AdsApi\AdManager\v202111\Technology[] $targetedMobileDeviceSubmodels
     * @param \Google\AdsApi\AdManager\v202111\Technology[] $excludedMobileDeviceSubmodels
     */
    ...
    /**
     * @param \Google\AdsApi\AdManager\v202111\Technology[]|null $targetedMobileDeviceSubmodels
    ...
    /**
     * @param \Google\AdsApi\AdManager\v202111\Technology[]|null $excludedMobileDeviceSubmodels
     * @return \Google\AdsApi\AdManager\v202111\MobileDeviceSubmodelTargeting
     */
