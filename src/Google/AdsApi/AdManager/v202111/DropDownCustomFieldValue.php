 ...
 */
class DropDownCustomFieldValue extends \Google\AdsApi\AdManager\v202111\BaseCustomFieldValue
{
    ...
    /**
     * @param int $customFieldOptionId
     * @return \Google\AdsApi\AdManager\v202111\DropDownCustomFieldValue
     */
