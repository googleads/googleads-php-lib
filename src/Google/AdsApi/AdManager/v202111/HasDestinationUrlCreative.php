 ...
 */
abstract class HasDestinationUrlCreative extends \Google\AdsApi\AdManager\v202111\Creative
{
    ...
    /**
     * @param string $destinationUrl
     * @return \Google\AdsApi\AdManager\v202111\HasDestinationUrlCreative
     */
