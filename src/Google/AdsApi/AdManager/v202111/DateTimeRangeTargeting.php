...
class DateTimeRangeTargeting
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202111\DateTimeRange[] $targetedDateTimeRanges
     */
    protected $targetedDateTimeRanges = null;

    /**
     * @param \Google\AdsApi\AdManager\v202111\DateTimeRange[] $targetedDateTimeRanges
     */
    ...
    /**
     * @param \Google\AdsApi\AdManager\v202111\DateTimeRange[]|null $targetedDateTimeRanges
