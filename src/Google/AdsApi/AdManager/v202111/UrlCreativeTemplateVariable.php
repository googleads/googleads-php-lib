 ...
 */
class UrlCreativeTemplateVariable extends \Google\AdsApi\AdManager\v202111\CreativeTemplateVariable
{
    ...
    /**
     * @param string $defaultValue
     * @return \Google\AdsApi\AdManager\v202111\UrlCreativeTemplateVariable
     */
