 ...
 */
class AdExchangeCreative extends \Google\AdsApi\AdManager\v202111\HasHtmlSnippetDynamicAllocationCreative
{
    ...
    /**
     * @param boolean $isNativeEligible
     * @return \Google\AdsApi\AdManager\v202111\AdExchangeCreative
     */
