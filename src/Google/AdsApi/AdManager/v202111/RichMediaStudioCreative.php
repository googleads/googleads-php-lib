 ...
 */
class RichMediaStudioCreative extends \Google\AdsApi\AdManager\v202111\BaseRichMediaStudioCreative
{
    ...
    /**
     * @param string $lockedOrientation
     * @return \Google\AdsApi\AdManager\v202111\RichMediaStudioCreative
     */
