 ...
 */
class LongCreativeTemplateVariable extends \Google\AdsApi\AdManager\v202111\CreativeTemplateVariable
{
    ...
    /**
     * @param int $defaultValue
     * @return \Google\AdsApi\AdManager\v202111\LongCreativeTemplateVariable
     */
