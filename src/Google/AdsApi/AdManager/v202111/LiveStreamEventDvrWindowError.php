 ...
 */
class LiveStreamEventDvrWindowError extends \Google\AdsApi\AdManager\v202111\ApiError
{
    ...
    /**
     * @param string $reason
     * @return \Google\AdsApi\AdManager\v202111\LiveStreamEventDvrWindowError
     */
