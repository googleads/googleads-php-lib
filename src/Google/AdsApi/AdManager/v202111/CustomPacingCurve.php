...
class CustomPacingCurve
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202111\CustomPacingGoal[] $customPacingGoals
     */
    protected $customPacingGoals = null;

    /**
     * @param string $customPacingGoalUnit
     * @param \Google\AdsApi\AdManager\v202111\CustomPacingGoal[] $customPacingGoals
     */
    ...
    /**
     * @return \Google\AdsApi\AdManager\v202111\CustomPacingGoal[]
     */
    ...
    /**
     * @param \Google\AdsApi\AdManager\v202111\CustomPacingGoal[]|null $customPacingGoals
     * @return \Google\AdsApi\AdManager\v202111\CustomPacingCurve
     */
