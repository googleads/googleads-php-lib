...
class OperatingSystemVersionTargeting
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202111\Technology[] $targetedOperatingSystemVersions
     */
    protected $targetedOperatingSystemVersions = null;

    /**
     * @var \Google\AdsApi\AdManager\v202111\Technology[] $excludedOperatingSystemVersions
     */
    protected $excludedOperatingSystemVersions = null;

    /**
     * @param \Google\AdsApi\AdManager\v202111\Technology[] $targetedOperatingSystemVersions
     * @param \Google\AdsApi\AdManager\v202111\Technology[] $excludedOperatingSystemVersions
     */
    ...
    /**
     * @param \Google\AdsApi\AdManager\v202111\Technology[]|null $targetedOperatingSystemVersions
    ...
    /**
     * @param \Google\AdsApi\AdManager\v202111\Technology[]|null $excludedOperatingSystemVersions
     * @return \Google\AdsApi\AdManager\v202111\OperatingSystemVersionTargeting
     */
