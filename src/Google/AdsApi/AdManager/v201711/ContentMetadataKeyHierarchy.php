...
class ContentMetadataKeyHierarchy
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v201711\ContentMetadataKeyHierarchyLevel[] $hierarchyLevels
     */
     ...
     * @param int $id
     * @param string $name
     * @param \Google\AdsApi\AdManager\v201711\ContentMetadataKeyHierarchyLevel[] $hierarchyLevels
     * @param string $status
     */
    ...
    /**
     * @return \Google\AdsApi\AdManager\v201711\ContentMetadataKeyHierarchyLevel[]
     */
