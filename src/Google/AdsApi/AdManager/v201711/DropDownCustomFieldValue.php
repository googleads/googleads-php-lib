 ...
 */
class DropDownCustomFieldValue extends \Google\AdsApi\AdManager\v201711\BaseCustomFieldValue
{
    ...
    /**
     * @param int $customFieldOptionId
     * @return \Google\AdsApi\AdManager\v201711\DropDownCustomFieldValue
     */
