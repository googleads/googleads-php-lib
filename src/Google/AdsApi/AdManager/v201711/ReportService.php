...
class ReportService extends \Google\AdsApi\Common\AdsSoapClient
{
    ...
    private static $classmap = array (
      ...
      'ReportDownloadOptions' => 'Google\\AdsApi\\AdManager\\v201711\\ReportDownloadOptions',
      'ReportError' => 'Google\\AdsApi\\AdManager\\v201711\\ReportError',
      'ReportJob' => 'Google\\AdsApi\\AdManager\\v201711\\ReportJob',
      'ReportQuery' => 'Google\\AdsApi\\AdManager\\v201711\\ReportQuery',
      ...
      'SavedQuery' => 'Google\\AdsApi\\AdManager\\v201711\\SavedQuery',
      'SavedQueryPage' => 'Google\\AdsApi\\AdManager\\v201711\\SavedQueryPage',
      ...
      'getReportDownloadURLResponse' => 'Google\\AdsApi\\AdManager\\v201711\\getReportDownloadURLResponse',
      'getReportDownloadUrlWithOptionsResponse' => 'Google\\AdsApi\\AdManager\\v201711\\getReportDownloadUrlWithOptionsResponse',
      'getReportJobStatusResponse' => 'Google\\AdsApi\\AdManager\\v201711\\getReportJobStatusResponse',
      'getSavedQueriesByStatementResponse' => 'Google\\AdsApi\\AdManager\\v201711\\getSavedQueriesByStatementResponse',
      'runReportJobResponse' => 'Google\\AdsApi\\AdManager\\v201711\\runReportJobResponse',
    );
     ...
     * @param \Google\AdsApi\AdManager\v201711\ExportFormat $exportFormat Constant: string - Valid values: TSV, TSV_EXCEL, CSV_DUMP, XML, XLSX
     * @return string
     ...
     *
     * @param int $reportJobId
     * @param \Google\AdsApi\AdManager\v201711\ReportDownloadOptions $reportDownloadOptions
     * @return string
     * @throws \Google\AdsApi\AdManager\v201711\ApiException
     */
    public function getReportDownloadUrlWithOptions($reportJobId, \Google\AdsApi\AdManager\v201711\ReportDownloadOptions $reportDownloadOptions)
    {
     ...
     * @return \Google\AdsApi\AdManager\v201711\SavedQueryPage
     * @throws \Google\AdsApi\AdManager\v201711\ApiException
     */
    public function getSavedQueriesByStatement(\Google\AdsApi\AdManager\v201711\Statement $filterStatement)
    {
     ...
     * </ul>
     *
     * @param \Google\AdsApi\AdManager\v201711\ReportJob $reportJob
     * @return \Google\AdsApi\AdManager\v201711\ReportJob
     * @throws \Google\AdsApi\AdManager\v201711\ApiException
     */
    public function runReportJob(\Google\AdsApi\AdManager\v201711\ReportJob $reportJob)
    {
