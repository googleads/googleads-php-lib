 ...
 */
class ImageCreative extends \Google\AdsApi\AdManager\v201711\BaseImageCreative
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v201711\CreativeAsset[] $secondaryImageAssets
     */
     ...
     * @param \Google\AdsApi\AdManager\v201711\CreativeAsset $primaryImageAsset
     * @param string $altText
     * @param string $thirdPartyImpressionUrl
     * @param \Google\AdsApi\AdManager\v201711\CreativeAsset[] $secondaryImageAssets
    ...
    /**
     * @param string $altText
     * @return \Google\AdsApi\AdManager\v201711\ImageCreative
     */
