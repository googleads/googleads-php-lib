 ...
 */
class WorkflowExternalConditionRequest extends \Google\AdsApi\AdManager\v201711\WorkflowRequest
{
    ...
    /**
     * @param string $status
     * @return \Google\AdsApi\AdManager\v201711\WorkflowExternalConditionRequest
     */
