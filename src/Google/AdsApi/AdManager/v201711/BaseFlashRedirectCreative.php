 ...
 */
abstract class BaseFlashRedirectCreative extends \Google\AdsApi\AdManager\v201711\HasDestinationUrlCreative
{
    ...
    /**
     * @param string $flashUrl
     * @return \Google\AdsApi\AdManager\v201711\BaseFlashRedirectCreative
     */
