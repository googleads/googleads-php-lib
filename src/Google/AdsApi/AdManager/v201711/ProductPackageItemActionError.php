 ...
 */
class ProductPackageItemActionError extends \Google\AdsApi\AdManager\v201711\ApiError
{
    ...
    /**
     * @param string $reason
     * @return \Google\AdsApi\AdManager\v201711\ProductPackageItemActionError
     */
