 ...
 */
class RequestApprovalProgressAction extends \Google\AdsApi\AdManager\v201711\ProgressAction
{
    ...
    /**
     * @param int $approverId
     * @return \Google\AdsApi\AdManager\v201711\RequestApprovalProgressAction
     */
