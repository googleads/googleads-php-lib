 ...
 */
abstract class BaseImageRedirectCreative extends \Google\AdsApi\AdManager\v201711\HasDestinationUrlCreative
{
    ...
    /**
     * @param string $imageUrl
     * @return \Google\AdsApi\AdManager\v201711\BaseImageRedirectCreative
     */
