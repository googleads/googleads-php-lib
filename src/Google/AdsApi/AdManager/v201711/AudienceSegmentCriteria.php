 ...
 */
class AudienceSegmentCriteria extends \Google\AdsApi\AdManager\v201711\CustomCriteriaLeaf
{
    ...
    /**
     * @param string $operator
     * @return \Google\AdsApi\AdManager\v201711\AudienceSegmentCriteria
     */
