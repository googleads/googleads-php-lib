...
class SavedQuery
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v201711\ReportQuery $reportQuery
     */
     ...
     * @param int $id
     * @param string $name
     * @param \Google\AdsApi\AdManager\v201711\ReportQuery $reportQuery
    ...
    /**
     * @param int $id
     * @return \Google\AdsApi\AdManager\v201711\SavedQuery
     */
