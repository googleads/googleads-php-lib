 ...
 */
class CustomTargetingPremiumFeature extends \Google\AdsApi\AdManager\v201711\PremiumFeature
{
    ...
    /**
     * @param int $customTargetingKeyId
     * @return \Google\AdsApi\AdManager\v201711\CustomTargetingPremiumFeature
     */
