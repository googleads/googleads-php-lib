 ...
 */
class AdMobBackfillCreative extends \Google\AdsApi\AdManager\v201711\BaseDynamicAllocationCreative
{
    ...
    /**
     * @param string $additionalParameters
     * @return \Google\AdsApi\AdManager\v201711\AdMobBackfillCreative
     */
