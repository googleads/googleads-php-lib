 ...
 */
abstract class HasDestinationUrlCreative extends \Google\AdsApi\AdManager\v201711\Creative
{
    ...
    /**
     * @param string $destinationUrl
     * @return \Google\AdsApi\AdManager\v201711\HasDestinationUrlCreative
     */
