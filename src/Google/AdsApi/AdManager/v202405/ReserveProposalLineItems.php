 ...
 */
class ReserveProposalLineItems extends \Google\AdsApi\AdManager\v202405\ProposalLineItemAction
{
    ...
    /**
     * @param boolean $allowOverbook
     * @return \Google\AdsApi\AdManager\v202405\ReserveProposalLineItems
     */
