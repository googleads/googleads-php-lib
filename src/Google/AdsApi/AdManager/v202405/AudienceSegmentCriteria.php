 ...
 */
class AudienceSegmentCriteria extends \Google\AdsApi\AdManager\v202405\CustomCriteriaLeaf
{
    ...
    /**
     * @param string $operator
     * @return \Google\AdsApi\AdManager\v202405\AudienceSegmentCriteria
     */
