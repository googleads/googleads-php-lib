 ...
 */
abstract class BaseImageRedirectCreative extends \Google\AdsApi\AdManager\v202405\HasDestinationUrlCreative
{
    ...
    /**
     * @param string $imageUrl
     * @return \Google\AdsApi\AdManager\v202405\BaseImageRedirectCreative
     */
