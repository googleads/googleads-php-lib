 ...
 */
class AdExchangeCreative extends \Google\AdsApi\AdManager\v202405\HasHtmlSnippetDynamicAllocationCreative
{
    ...
    /**
     * @param boolean $isNativeEligible
     * @return \Google\AdsApi\AdManager\v202405\AdExchangeCreative
     */
