...
class HlsSettings
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202405\MasterPlaylistSettings $masterPlaylistSettings
     */
    protected $masterPlaylistSettings = null;

    /**
     * @param string $playlistType
     * @param \Google\AdsApi\AdManager\v202405\MasterPlaylistSettings $masterPlaylistSettings
     */
    ...
    /**
     * @return \Google\AdsApi\AdManager\v202405\MasterPlaylistSettings
     */
