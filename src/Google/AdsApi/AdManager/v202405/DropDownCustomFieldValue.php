 ...
 */
class DropDownCustomFieldValue extends \Google\AdsApi\AdManager\v202405\BaseCustomFieldValue
{
    ...
    /**
     * @param int $customFieldOptionId
     * @return \Google\AdsApi\AdManager\v202405\DropDownCustomFieldValue
     */
