 ...
 */
abstract class HasDestinationUrlCreative extends \Google\AdsApi\AdManager\v202405\Creative
{
    ...
    /**
     * @param string $destinationUrl
     * @return \Google\AdsApi\AdManager\v202405\HasDestinationUrlCreative
     */
