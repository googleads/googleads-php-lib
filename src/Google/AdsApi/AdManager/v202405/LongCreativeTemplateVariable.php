 ...
 */
class LongCreativeTemplateVariable extends \Google\AdsApi\AdManager\v202405\CreativeTemplateVariable
{
    ...
    /**
     * @param int $defaultValue
     * @return \Google\AdsApi\AdManager\v202405\LongCreativeTemplateVariable
     */
