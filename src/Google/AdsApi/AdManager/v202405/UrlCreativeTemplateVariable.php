 ...
 */
class UrlCreativeTemplateVariable extends \Google\AdsApi\AdManager\v202405\CreativeTemplateVariable
{
    ...
    /**
     * @param string $defaultValue
     * @return \Google\AdsApi\AdManager\v202405\UrlCreativeTemplateVariable
     */
