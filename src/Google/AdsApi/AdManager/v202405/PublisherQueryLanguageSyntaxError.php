 ...
 */
class PublisherQueryLanguageSyntaxError extends \Google\AdsApi\AdManager\v202405\ApiError
{
    ...
    /**
     * @param string $reason
     * @return \Google\AdsApi\AdManager\v202405\PublisherQueryLanguageSyntaxError
     */
