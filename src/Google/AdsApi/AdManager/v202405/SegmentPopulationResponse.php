...
class SegmentPopulationResponse
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202405\IdError[] $idErrors
     */
    protected $idErrors = null;

    /**
     * @param int $batchUploadId
     * @param \Google\AdsApi\AdManager\v202405\IdError[] $idErrors
     */
    ...
    /**
     * @return \Google\AdsApi\AdManager\v202405\IdError[]
     */
    ...
    /**
     * @param \Google\AdsApi\AdManager\v202405\IdError[]|null $idErrors
     * @return \Google\AdsApi\AdManager\v202405\SegmentPopulationResponse
     */
