...
class DateTimeRangeTargeting
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202605\DateTimeRange[] $targetedDateTimeRanges
     */
    protected $targetedDateTimeRanges = null;

    /**
     * @param \Google\AdsApi\AdManager\v202605\DateTimeRange[] $targetedDateTimeRanges
     */
    ...
    /**
     * @param \Google\AdsApi\AdManager\v202605\DateTimeRange[]|null $targetedDateTimeRanges
