 ...
 */
abstract class HasDestinationUrlCreative extends \Google\AdsApi\AdManager\v202605\Creative
{
    ...
    /**
     * @param string $destinationUrl
     * @return \Google\AdsApi\AdManager\v202605\HasDestinationUrlCreative
     */
