 ...
 */
class AudienceSegmentCriteria extends \Google\AdsApi\AdManager\v202605\CustomCriteriaLeaf
{
    ...
    /**
     * @param string $operator
     * @return \Google\AdsApi\AdManager\v202605\AudienceSegmentCriteria
     */
