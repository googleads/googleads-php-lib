...
class SegmentPopulationResponse
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202605\IdError[] $idErrors
     */
    protected $idErrors = null;

    /**
     * @param int $batchUploadId
     * @param \Google\AdsApi\AdManager\v202605\IdError[] $idErrors
     */
    ...
    /**
     * @return \Google\AdsApi\AdManager\v202605\IdError[]
     */
    ...
    /**
     * @param \Google\AdsApi\AdManager\v202605\IdError[]|null $idErrors
     * @return \Google\AdsApi\AdManager\v202605\SegmentPopulationResponse
     */
