 ...
 */
class ImageRedirectCreative extends \Google\AdsApi\AdManager\v202605\BaseImageRedirectCreative
{
    ...
    /**
     * @param string $altText
     * @return \Google\AdsApi\AdManager\v202605\ImageRedirectCreative
     */
