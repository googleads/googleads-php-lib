 ...
 */
class StringCreativeTemplateVariable extends \Google\AdsApi\AdManager\v202605\CreativeTemplateVariable
{
    ...
    /**
     * @param string $defaultValue
     * @return \Google\AdsApi\AdManager\v202605\StringCreativeTemplateVariable
     */
