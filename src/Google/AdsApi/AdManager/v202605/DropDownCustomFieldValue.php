 ...
 */
class DropDownCustomFieldValue extends \Google\AdsApi\AdManager\v202605\BaseCustomFieldValue
{
    ...
    /**
     * @param int $customFieldOptionId
     * @return \Google\AdsApi\AdManager\v202605\DropDownCustomFieldValue
     */
