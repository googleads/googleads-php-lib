 ...
 */
class LongCreativeTemplateVariable extends \Google\AdsApi\AdManager\v202605\CreativeTemplateVariable
{
    ...
    /**
     * @param int $defaultValue
     * @return \Google\AdsApi\AdManager\v202605\LongCreativeTemplateVariable
     */
