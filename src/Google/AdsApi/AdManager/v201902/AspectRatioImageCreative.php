 ...
 */
class AspectRatioImageCreative extends \Google\AdsApi\AdManager\v201902\HasDestinationUrlCreative
{

    /**
     * @var \Google\AdsApi\AdManager\v201902\CreativeAsset[] $imageAssets
     */
