 ...
 */
class WorkflowExternalConditionRequest extends \Google\AdsApi\AdManager\v201902\WorkflowRequest
{
    ...
    /**
     * @param string $status
     * @return \Google\AdsApi\AdManager\v201902\WorkflowExternalConditionRequest
     */
