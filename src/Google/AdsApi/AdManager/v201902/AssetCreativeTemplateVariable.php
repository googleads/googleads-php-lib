 ...
 */
class AssetCreativeTemplateVariable extends \Google\AdsApi\AdManager\v201902\CreativeTemplateVariable
{
    ...
    /**
     * @param string[] $mimeTypes
     * @return \Google\AdsApi\AdManager\v201902\AssetCreativeTemplateVariable
     */
