 ...
 */
class AdMobBackfillCreative extends \Google\AdsApi\AdManager\v201902\BaseDynamicAllocationCreative
{
    ...
    /**
     * @param string $additionalParameters
     * @return \Google\AdsApi\AdManager\v201902\AdMobBackfillCreative
     */
