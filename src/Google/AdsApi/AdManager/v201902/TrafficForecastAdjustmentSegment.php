...
class TrafficForecastAdjustmentSegment
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v201902\TimeSeries $adjustmentTimeSeries
     */
    protected $adjustmentTimeSeries = null;

    /**
     * @var \Google\AdsApi\AdManager\v201902\HistoricalAdjustment $historicalAdjustment
     */
    protected $historicalAdjustment = null;

    /**
     * @param string $basisType
     * @param \Google\AdsApi\AdManager\v201902\TimeSeries $adjustmentTimeSeries
     * @param \Google\AdsApi\AdManager\v201902\HistoricalAdjustment $historicalAdjustment
     */
    ...
    /**
     * @param string $basisType
     * @return \Google\AdsApi\AdManager\v201902\TrafficForecastAdjustmentSegment
     */
    ...
    /**
     * @return \Google\AdsApi\AdManager\v201902\HistoricalAdjustment
     */
