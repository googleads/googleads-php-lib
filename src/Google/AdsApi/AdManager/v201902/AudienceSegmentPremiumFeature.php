 ...
 */
class AudienceSegmentPremiumFeature extends \Google\AdsApi\AdManager\v201902\PremiumFeature
{
    ...
    /**
     * @param int $audienceSegmentId
     * @return \Google\AdsApi\AdManager\v201902\AudienceSegmentPremiumFeature
     */
