 ...
 */
abstract class BaseFlashRedirectCreative extends \Google\AdsApi\AdManager\v201902\HasDestinationUrlCreative
{
    ...
    /**
     * @param string $flashUrl
     * @return \Google\AdsApi\AdManager\v201902\BaseFlashRedirectCreative
     */
