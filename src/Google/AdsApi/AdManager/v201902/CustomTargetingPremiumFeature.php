 ...
 */
class CustomTargetingPremiumFeature extends \Google\AdsApi\AdManager\v201902\PremiumFeature
{
    ...
    /**
     * @param int $customTargetingKeyId
     * @return \Google\AdsApi\AdManager\v201902\CustomTargetingPremiumFeature
     */
