 ...
 */
class AdMobBackfillCreative extends \Google\AdsApi\AdManager\v201808\BaseDynamicAllocationCreative
{
    ...
    /**
     * @param string $additionalParameters
     * @return \Google\AdsApi\AdManager\v201808\AdMobBackfillCreative
     */
