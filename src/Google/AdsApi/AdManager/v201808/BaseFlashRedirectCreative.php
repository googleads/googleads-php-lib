 ...
 */
abstract class BaseFlashRedirectCreative extends \Google\AdsApi\AdManager\v201808\HasDestinationUrlCreative
{
    ...
    /**
     * @param string $flashUrl
     * @return \Google\AdsApi\AdManager\v201808\BaseFlashRedirectCreative
     */
