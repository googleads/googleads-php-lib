 ...
 */
class MobileApplicationActionError extends \Google\AdsApi\AdManager\v201808\ApiError
{
    ...
    /**
     * @param string $reason
     * @return \Google\AdsApi\AdManager\v201808\MobileApplicationActionError
     */
