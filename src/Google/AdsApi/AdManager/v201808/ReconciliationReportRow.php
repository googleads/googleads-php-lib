...
class ReconciliationReportRow
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v201808\Money $lineItemCostPerUnit
     */
    ...
    /**
     * @var \Google\AdsApi\AdManager\v201808\Money $contractedRevenue
     */
    protected $contractedRevenue = null;

    /**
     * @var \Google\AdsApi\AdManager\v201808\Money $dfpRevenue
     */
    protected $dfpRevenue = null;

    /**
     * @var \Google\AdsApi\AdManager\v201808\Money $thirdPartyRevenue
     */
    protected $thirdPartyRevenue = null;

    /**
     * @var \Google\AdsApi\AdManager\v201808\Money $manualRevenue
     */
    protected $manualRevenue = null;

    /**
     * @var \Google\AdsApi\AdManager\v201808\Money $reconciledRevenue
     */
     ...
     * @param \Google\AdsApi\AdManager\v201808\Money $lineItemCostPerUnit
     * @param int $lineItemContractedUnitsBought
     * @param int $dfpVolume
     * @param int $thirdPartyVolume
     * @param int $manualVolume
     * @param int $reconciledVolume
     * @param \Google\AdsApi\AdManager\v201808\Money $contractedRevenue
     * @param \Google\AdsApi\AdManager\v201808\Money $dfpRevenue
     * @param \Google\AdsApi\AdManager\v201808\Money $thirdPartyRevenue
     * @param \Google\AdsApi\AdManager\v201808\Money $manualRevenue
     * @param \Google\AdsApi\AdManager\v201808\Money $reconciledRevenue
