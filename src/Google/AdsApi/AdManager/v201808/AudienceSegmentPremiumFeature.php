 ...
 */
class AudienceSegmentPremiumFeature extends \Google\AdsApi\AdManager\v201808\PremiumFeature
{
    ...
    /**
     * @param int $audienceSegmentId
     * @return \Google\AdsApi\AdManager\v201808\AudienceSegmentPremiumFeature
     */
