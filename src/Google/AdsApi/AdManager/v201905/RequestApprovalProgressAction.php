 ...
 */
class RequestApprovalProgressAction extends \Google\AdsApi\AdManager\v201905\ProgressAction
{
    ...
    /**
     * @param int $approverId
     * @return \Google\AdsApi\AdManager\v201905\RequestApprovalProgressAction
     */
