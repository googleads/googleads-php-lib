 ...
 */
class RichMediaStudioCreative extends \Google\AdsApi\AdManager\v201905\BaseRichMediaStudioCreative
{
    ...
    /**
     * @param string $lockedOrientation
     * @return \Google\AdsApi\AdManager\v201905\RichMediaStudioCreative
     */
