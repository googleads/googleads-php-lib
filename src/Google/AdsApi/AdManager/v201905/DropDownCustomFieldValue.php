 ...
 */
class DropDownCustomFieldValue extends \Google\AdsApi\AdManager\v201905\BaseCustomFieldValue
{
    ...
    /**
     * @param int $customFieldOptionId
     * @return \Google\AdsApi\AdManager\v201905\DropDownCustomFieldValue
     */
