 ...
 */
class ThirdPartyAudienceSegment extends \Google\AdsApi\AdManager\v201905\AudienceSegment
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v201905\Money $cost
     */
    protected $cost = null;
     ...
     * @param int $adIdSize
     * @param int $ppidSize
     * @param \Google\AdsApi\AdManager\v201905\AudienceSegmentDataProvider $dataProvider
     * @param string $type
     * @param string $approvalStatus
     * @param \Google\AdsApi\AdManager\v201905\Money $cost
    ...
    /**
     * @param string $approvalStatus
     * @return \Google\AdsApi\AdManager\v201905\ThirdPartyAudienceSegment
     */
