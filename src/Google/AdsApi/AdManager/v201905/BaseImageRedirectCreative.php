 ...
 */
abstract class BaseImageRedirectCreative extends \Google\AdsApi\AdManager\v201905\HasDestinationUrlCreative
{
    ...
    /**
     * @param string $imageUrl
     * @return \Google\AdsApi\AdManager\v201905\BaseImageRedirectCreative
     */
