...
class OperatingSystemVersionTargeting
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v201905\Technology[] $targetedOperatingSystemVersions
     */
    protected $targetedOperatingSystemVersions = null;

    /**
     * @var \Google\AdsApi\AdManager\v201905\Technology[] $excludedOperatingSystemVersions
     */
    protected $excludedOperatingSystemVersions = null;

    /**
     * @param \Google\AdsApi\AdManager\v201905\Technology[] $targetedOperatingSystemVersions
     * @param \Google\AdsApi\AdManager\v201905\Technology[] $excludedOperatingSystemVersions
     */
    ...
    /**
     * @param \Google\AdsApi\AdManager\v201905\Technology[]|null $targetedOperatingSystemVersions
    ...
    /**
     * @param \Google\AdsApi\AdManager\v201905\Technology[]|null $excludedOperatingSystemVersions
     * @return \Google\AdsApi\AdManager\v201905\OperatingSystemVersionTargeting
     */
