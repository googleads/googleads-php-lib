...
class HlsSettings
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v201905\MasterPlaylistSettings $masterPlaylistSettings
     */
    protected $masterPlaylistSettings = null;

    /**
     * @param string $playlistType
     * @param \Google\AdsApi\AdManager\v201905\MasterPlaylistSettings $masterPlaylistSettings
     */
    ...
    /**
     * @return \Google\AdsApi\AdManager\v201905\MasterPlaylistSettings
     */
