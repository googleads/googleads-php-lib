 ...
 */
class CustomTargetingPremiumFeature extends \Google\AdsApi\AdManager\v201905\PremiumFeature
{
    ...
    /**
     * @param int $customTargetingKeyId
     * @return \Google\AdsApi\AdManager\v201905\CustomTargetingPremiumFeature
     */
