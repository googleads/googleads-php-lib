 ...
 */
abstract class BaseFlashRedirectCreative extends \Google\AdsApi\AdManager\v201905\HasDestinationUrlCreative
{
    ...
    /**
     * @param string $flashUrl
     * @return \Google\AdsApi\AdManager\v201905\BaseFlashRedirectCreative
     */
