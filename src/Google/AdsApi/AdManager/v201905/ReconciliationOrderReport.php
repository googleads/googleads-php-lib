...
class ReconciliationOrderReport
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v201905\DateTime $submissionDateTime
     */
    ...
    /**
     * @var \Google\AdsApi\AdManager\v201905\Money $proposalNetBillableRevenueManualAdjustment
     */
    protected $proposalNetBillableRevenueManualAdjustment = null;

    /**
     * @var \Google\AdsApi\AdManager\v201905\Money $proposalGrossBillableRevenueManualAdjustment
     */
     ...
     * @param string $status
     * @param \Google\AdsApi\AdManager\v201905\DateTime $submissionDateTime
     * @param int $submitterId
     * @param \Google\AdsApi\AdManager\v201905\Money $proposalNetBillableRevenueManualAdjustment
     * @param \Google\AdsApi\AdManager\v201905\Money $proposalGrossBillableRevenueManualAdjustment
     */
