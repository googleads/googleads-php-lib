 ...
 */
class AudienceSegmentPremiumFeature extends \Google\AdsApi\AdManager\v201905\PremiumFeature
{
    ...
    /**
     * @param int $audienceSegmentId
     * @return \Google\AdsApi\AdManager\v201905\AudienceSegmentPremiumFeature
     */
