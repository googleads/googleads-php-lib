 ...
 */
class WorkflowExternalConditionRequest extends \Google\AdsApi\AdManager\v201905\WorkflowRequest
{
    ...
    /**
     * @param string $status
     * @return \Google\AdsApi\AdManager\v201905\WorkflowExternalConditionRequest
     */
