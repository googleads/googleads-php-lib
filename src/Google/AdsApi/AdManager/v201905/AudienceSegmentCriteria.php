 ...
 */
class AudienceSegmentCriteria extends \Google\AdsApi\AdManager\v201905\CustomCriteriaLeaf
{
    ...
    /**
     * @param string $operator
     * @return \Google\AdsApi\AdManager\v201905\AudienceSegmentCriteria
     */
