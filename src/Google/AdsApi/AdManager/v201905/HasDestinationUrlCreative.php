 ...
 */
abstract class HasDestinationUrlCreative extends \Google\AdsApi\AdManager\v201905\Creative
{
    ...
    /**
     * @param string $destinationUrl
     * @return \Google\AdsApi\AdManager\v201905\HasDestinationUrlCreative
     */
