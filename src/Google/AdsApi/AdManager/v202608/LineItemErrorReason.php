...
class LineItemErrorReason
{
    ...
    const LINKED_WEB_PROPERTY_NOT_ALLOWED_FOR_ADX_BACKFILL = 'LINKED_WEB_PROPERTY_NOT_ALLOWED_FOR_ADX_BACKFILL';
    ...
    const PLACEHOLDER_COUNT_NOT_SUPPORTED = 'PLACEHOLDER_COUNT_NOT_SUPPORTED';
    ...
    const TARGET_PLATFORM_NOT_ALLOWED = 'TARGET_PLATFORM_NOT_ALLOWED';
    ...
    const REPEATED_CREATIVE_SERVING_NOT_ALLOWED = 'REPEATED_CREATIVE_SERVING_NOT_ALLOWED';
