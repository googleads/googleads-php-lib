 ...
 */
class LiveStreamEventDvrWindowError extends \Google\AdsApi\AdManager\v202608\ApiError
{
    ...
    /**
     * @param string $reason
     * @return \Google\AdsApi\AdManager\v202608\LiveStreamEventDvrWindowError
     */
