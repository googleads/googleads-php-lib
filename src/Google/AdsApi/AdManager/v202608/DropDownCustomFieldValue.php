 ...
 */
class DropDownCustomFieldValue extends \Google\AdsApi\AdManager\v202608\BaseCustomFieldValue
{
    ...
    /**
     * @param int $customFieldOptionId
     * @return \Google\AdsApi\AdManager\v202608\DropDownCustomFieldValue
     */
