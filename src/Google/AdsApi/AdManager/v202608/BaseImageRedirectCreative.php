 ...
 */
abstract class BaseImageRedirectCreative extends \Google\AdsApi\AdManager\v202608\HasDestinationUrlCreative
{
    ...
    /**
     * @param string $imageUrl
     * @return \Google\AdsApi\AdManager\v202608\BaseImageRedirectCreative
     */
