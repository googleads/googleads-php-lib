...
class SegmentPopulationResponse
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202608\IdError[] $idErrors
     */
    protected $idErrors = null;

    /**
     * @param int $batchUploadId
     * @param \Google\AdsApi\AdManager\v202608\IdError[] $idErrors
     */
    ...
    /**
     * @return \Google\AdsApi\AdManager\v202608\IdError[]
     */
    ...
    /**
     * @param \Google\AdsApi\AdManager\v202608\IdError[]|null $idErrors
     * @return \Google\AdsApi\AdManager\v202608\SegmentPopulationResponse
     */
