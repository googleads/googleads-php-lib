 ...
 */
class ImageRedirectCreative extends \Google\AdsApi\AdManager\v202305\BaseImageRedirectCreative
{
    ...
    /**
     * @param string $altText
     * @return \Google\AdsApi\AdManager\v202305\ImageRedirectCreative
     */
