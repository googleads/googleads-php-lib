 ...
 */
class LineItemCreativeAssociationError extends \Google\AdsApi\AdManager\v202305\ApiError
{
    ...
    /**
     * @param string $reason
     * @return \Google\AdsApi\AdManager\v202305\LineItemCreativeAssociationError
     */
