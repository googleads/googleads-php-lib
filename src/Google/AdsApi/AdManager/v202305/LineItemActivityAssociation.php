...
class LineItemActivityAssociation
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202305\Money $clickThroughConversionCost
     */
    protected $clickThroughConversionCost = null;

    /**
     * @var \Google\AdsApi\AdManager\v202305\Money $viewThroughConversionCost
     */
    protected $viewThroughConversionCost = null;

    /**
     * @param int $activityId
     * @param \Google\AdsApi\AdManager\v202305\Money $clickThroughConversionCost
     * @param \Google\AdsApi\AdManager\v202305\Money $viewThroughConversionCost
     */
