 ...
 */
abstract class BaseImageRedirectCreative extends \Google\AdsApi\AdManager\v202305\HasDestinationUrlCreative
{
    ...
    /**
     * @param string $imageUrl
     * @return \Google\AdsApi\AdManager\v202305\BaseImageRedirectCreative
     */
