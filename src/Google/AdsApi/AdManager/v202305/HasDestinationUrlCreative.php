 ...
 */
abstract class HasDestinationUrlCreative extends \Google\AdsApi\AdManager\v202305\Creative
{
    ...
    /**
     * @param string $destinationUrl
     * @return \Google\AdsApi\AdManager\v202305\HasDestinationUrlCreative
     */
