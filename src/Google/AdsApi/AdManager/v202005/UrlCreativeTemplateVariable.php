 ...
 */
class UrlCreativeTemplateVariable extends \Google\AdsApi\AdManager\v202005\CreativeTemplateVariable
{
    ...
    /**
     * @param string $defaultValue
     * @return \Google\AdsApi\AdManager\v202005\UrlCreativeTemplateVariable
     */
