 ...
 */
class CreativeTemplateOperationError extends \Google\AdsApi\AdManager\v202005\ApiError
{
    ...
    /**
     * @param string $reason
     * @return \Google\AdsApi\AdManager\v202005\CreativeTemplateOperationError
     */
