 ...
 */
class DropDownCustomFieldValue extends \Google\AdsApi\AdManager\v202005\BaseCustomFieldValue
{
    ...
    /**
     * @param int $customFieldOptionId
     * @return \Google\AdsApi\AdManager\v202005\DropDownCustomFieldValue
     */
