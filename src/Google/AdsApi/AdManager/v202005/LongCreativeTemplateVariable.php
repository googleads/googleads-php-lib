 ...
 */
class LongCreativeTemplateVariable extends \Google\AdsApi\AdManager\v202005\CreativeTemplateVariable
{
    ...
    /**
     * @param int $defaultValue
     * @return \Google\AdsApi\AdManager\v202005\LongCreativeTemplateVariable
     */
