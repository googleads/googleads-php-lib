 ...
 */
class AudienceSegmentCriteria extends \Google\AdsApi\AdManager\v202005\CustomCriteriaLeaf
{
    ...
    /**
     * @param string $operator
     * @return \Google\AdsApi\AdManager\v202005\AudienceSegmentCriteria
     */
