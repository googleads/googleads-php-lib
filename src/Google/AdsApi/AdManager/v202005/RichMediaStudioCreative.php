 ...
 */
class RichMediaStudioCreative extends \Google\AdsApi\AdManager\v202005\BaseRichMediaStudioCreative
{
    ...
    /**
     * @param string $lockedOrientation
     * @return \Google\AdsApi\AdManager\v202005\RichMediaStudioCreative
     */
