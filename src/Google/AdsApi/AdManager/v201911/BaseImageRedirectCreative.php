 ...
 */
abstract class BaseImageRedirectCreative extends \Google\AdsApi\AdManager\v201911\HasDestinationUrlCreative
{
    ...
    /**
     * @param string $imageUrl
     * @return \Google\AdsApi\AdManager\v201911\BaseImageRedirectCreative
     */
