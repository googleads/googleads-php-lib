 ...
 */
class DropDownCustomFieldValue extends \Google\AdsApi\AdManager\v201911\BaseCustomFieldValue
{
    ...
    /**
     * @param int $customFieldOptionId
     * @return \Google\AdsApi\AdManager\v201911\DropDownCustomFieldValue
     */
