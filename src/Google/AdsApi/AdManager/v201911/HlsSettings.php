...
class HlsSettings
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v201911\MasterPlaylistSettings $masterPlaylistSettings
     */
    protected $masterPlaylistSettings = null;

    /**
     * @param string $playlistType
     * @param \Google\AdsApi\AdManager\v201911\MasterPlaylistSettings $masterPlaylistSettings
     */
    ...
    /**
     * @param string $playlistType
     * @return \Google\AdsApi\AdManager\v201911\HlsSettings
     */
