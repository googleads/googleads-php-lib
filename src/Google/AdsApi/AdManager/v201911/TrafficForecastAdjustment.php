...
class TrafficForecastAdjustment
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v201911\TrafficTimeSeriesFilterCriteria $filterCriteria
     */
    protected $filterCriteria = null;

    /**
     * @var \Google\AdsApi\AdManager\v201911\TrafficForecastAdjustmentSegment[] $forecastAdjustmentSegments
     */
    ...
    /**
     * @param int $id
     * @param \Google\AdsApi\AdManager\v201911\TrafficTimeSeriesFilterCriteria $filterCriteria
     * @param \Google\AdsApi\AdManager\v201911\TrafficForecastAdjustmentSegment[] $forecastAdjustmentSegments
    ...
    /**
     * @param \Google\AdsApi\AdManager\v201911\TrafficForecastAdjustmentSegment[]|null $forecastAdjustmentSegments
     * @return \Google\AdsApi\AdManager\v201911\TrafficForecastAdjustment
     */
