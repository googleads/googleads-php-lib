 ...
 */
abstract class BaseVideoCreative extends \Google\AdsApi\AdManager\v201911\HasDestinationUrlCreative
{
    ...
    /**
     * @param int $duration
     * @return \Google\AdsApi\AdManager\v201911\BaseVideoCreative
     */
