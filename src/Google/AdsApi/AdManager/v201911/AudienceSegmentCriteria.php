 ...
 */
class AudienceSegmentCriteria extends \Google\AdsApi\AdManager\v201911\CustomCriteriaLeaf
{
    ...
    /**
     * @param string $operator
     * @return \Google\AdsApi\AdManager\v201911\AudienceSegmentCriteria
     */
