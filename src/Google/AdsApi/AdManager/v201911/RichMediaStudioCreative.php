 ...
 */
class RichMediaStudioCreative extends \Google\AdsApi\AdManager\v201911\BaseRichMediaStudioCreative
{
    ...
    /**
     * @param string $lockedOrientation
     * @return \Google\AdsApi\AdManager\v201911\RichMediaStudioCreative
     */
