 ...
 */
class RichMediaStudioCreative extends \Google\AdsApi\AdManager\v202211\BaseRichMediaStudioCreative
{
    ...
    /**
     * @param string $lockedOrientation
     * @return \Google\AdsApi\AdManager\v202211\RichMediaStudioCreative
     */
