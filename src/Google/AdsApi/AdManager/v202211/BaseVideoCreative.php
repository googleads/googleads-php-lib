 ...
 */
abstract class BaseVideoCreative extends \Google\AdsApi\AdManager\v202211\HasDestinationUrlCreative
{
    ...
    /**
     * @param int $duration
     * @return \Google\AdsApi\AdManager\v202211\BaseVideoCreative
     */
