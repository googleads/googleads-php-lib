...
class HlsSettings
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202211\MasterPlaylistSettings $masterPlaylistSettings
     */
    protected $masterPlaylistSettings = null;

    /**
     * @param string $playlistType
     * @param \Google\AdsApi\AdManager\v202211\MasterPlaylistSettings $masterPlaylistSettings
     */
    ...
    /**
     * @param string $playlistType
     * @return \Google\AdsApi\AdManager\v202211\HlsSettings
     */
    ...
    /**
     * @return \Google\AdsApi\AdManager\v202211\MasterPlaylistSettings
     */
