 ...
 */
abstract class BaseImageRedirectCreative extends \Google\AdsApi\AdManager\v202211\HasDestinationUrlCreative
{
    ...
    /**
     * @param string $imageUrl
     * @return \Google\AdsApi\AdManager\v202211\BaseImageRedirectCreative
     */
