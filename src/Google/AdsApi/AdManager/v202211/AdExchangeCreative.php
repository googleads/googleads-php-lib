 ...
 */
class AdExchangeCreative extends \Google\AdsApi\AdManager\v202211\HasHtmlSnippetDynamicAllocationCreative
{
    ...
    /**
     * @param boolean $isNativeEligible
     * @return \Google\AdsApi\AdManager\v202211\AdExchangeCreative
     */
