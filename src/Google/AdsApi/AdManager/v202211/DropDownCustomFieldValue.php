 ...
 */
class DropDownCustomFieldValue extends \Google\AdsApi\AdManager\v202211\BaseCustomFieldValue
{
    ...
    /**
     * @param int $customFieldOptionId
     * @return \Google\AdsApi\AdManager\v202211\DropDownCustomFieldValue
     */
