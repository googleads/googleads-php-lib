...
class Dimension
{
    ...
    const INVENTORY_OWNERSHIP_CODE = 'INVENTORY_OWNERSHIP_CODE';
    const INVENTORY_OWNERSHIP_NAME = 'INVENTORY_OWNERSHIP_NAME';
    const NETWORK_PARTNER_ID = 'NETWORK_PARTNER_ID';
    const NETWORK_PARTNER_NAME = 'NETWORK_PARTNER_NAME';
