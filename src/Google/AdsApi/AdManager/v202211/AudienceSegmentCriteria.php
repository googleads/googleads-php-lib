 ...
 */
class AudienceSegmentCriteria extends \Google\AdsApi\AdManager\v202211\CustomCriteriaLeaf
{
    ...
    /**
     * @param string $operator
     * @return \Google\AdsApi\AdManager\v202211\AudienceSegmentCriteria
     */
