 ...
 */
class UrlCreativeTemplateVariable extends \Google\AdsApi\AdManager\v202211\CreativeTemplateVariable
{
    ...
    /**
     * @param string $defaultValue
     * @return \Google\AdsApi\AdManager\v202211\UrlCreativeTemplateVariable
     */
