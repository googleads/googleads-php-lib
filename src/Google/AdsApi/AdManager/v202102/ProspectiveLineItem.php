...
class ProspectiveLineItem
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202102\LineItem $lineItem
     */
    protected $lineItem = null;

    /**
     * @var \Google\AdsApi\AdManager\v202102\ProposalLineItem $proposalLineItem
     */
    ...
    /**
     * @param \Google\AdsApi\AdManager\v202102\LineItem $lineItem
     * @param \Google\AdsApi\AdManager\v202102\ProposalLineItem $proposalLineItem
    ...
    /**
     * @param \Google\AdsApi\AdManager\v202102\LineItem $lineItem
     * @return \Google\AdsApi\AdManager\v202102\ProspectiveLineItem
     */
