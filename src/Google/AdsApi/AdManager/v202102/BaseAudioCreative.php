 ...
 */
abstract class BaseAudioCreative extends \Google\AdsApi\AdManager\v202102\HasDestinationUrlCreative
{
    ...
    /**
     * @param int $duration
     * @return \Google\AdsApi\AdManager\v202102\BaseAudioCreative
     */
