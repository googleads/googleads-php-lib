 ...
 */
class LiveStreamEventCdnSettingsError extends \Google\AdsApi\AdManager\v202102\ApiError
{
    ...
    /**
     * @param string $reason
     * @return \Google\AdsApi\AdManager\v202102\LiveStreamEventCdnSettingsError
     */
