 ...
 */
class DropDownCustomFieldValue extends \Google\AdsApi\AdManager\v202105\BaseCustomFieldValue
{
    ...
    /**
     * @param int $customFieldOptionId
     * @return \Google\AdsApi\AdManager\v202105\DropDownCustomFieldValue
     */
