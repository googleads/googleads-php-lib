 ...
 */
abstract class HasDestinationUrlCreative extends \Google\AdsApi\AdManager\v202105\Creative
{
    ...
    /**
     * @param string $destinationUrl
     * @return \Google\AdsApi\AdManager\v202105\HasDestinationUrlCreative
     */
