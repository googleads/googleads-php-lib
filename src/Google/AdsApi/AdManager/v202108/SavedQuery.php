...
class SavedQuery
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202108\ReportQuery $reportQuery
     */
     ...
     * @param int $id
     * @param string $name
     * @param \Google\AdsApi\AdManager\v202108\ReportQuery $reportQuery
    ...
    /**
     * @return \Google\AdsApi\AdManager\v202108\ReportQuery
     */
