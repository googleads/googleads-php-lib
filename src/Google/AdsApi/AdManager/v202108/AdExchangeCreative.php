 ...
 */
class AdExchangeCreative extends \Google\AdsApi\AdManager\v202108\HasHtmlSnippetDynamicAllocationCreative
{
    ...
    /**
     * @param boolean $isNativeEligible
     * @return \Google\AdsApi\AdManager\v202108\AdExchangeCreative
     */
