...
class VideoPositionTargeting
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202108\VideoPositionTarget[] $targetedPositions
     */
    protected $targetedPositions = null;

    /**
     * @param \Google\AdsApi\AdManager\v202108\VideoPositionTarget[] $targetedPositions
     */
    ...
    /**
     * @param \Google\AdsApi\AdManager\v202108\VideoPositionTarget[]|null $targetedPositions
