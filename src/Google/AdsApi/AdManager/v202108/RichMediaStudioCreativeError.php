 ...
 */
class RichMediaStudioCreativeError extends \Google\AdsApi\AdManager\v202108\ApiError
{
    ...
    /**
     * @param string $reason
     * @return \Google\AdsApi\AdManager\v202108\RichMediaStudioCreativeError
     */
