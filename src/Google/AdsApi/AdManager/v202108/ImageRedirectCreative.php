 ...
 */
class ImageRedirectCreative extends \Google\AdsApi\AdManager\v202108\BaseImageRedirectCreative
{
    ...
    /**
     * @param string $altText
     * @return \Google\AdsApi\AdManager\v202108\ImageRedirectCreative
     */
