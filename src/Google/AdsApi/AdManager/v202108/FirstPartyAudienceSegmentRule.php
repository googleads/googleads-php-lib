...
class FirstPartyAudienceSegmentRule
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202108\InventoryTargeting $inventoryRule
     */
    protected $inventoryRule = null;

    /**
     * @var \Google\AdsApi\AdManager\v202108\CustomCriteriaSet $customCriteriaRule
     */
    protected $customCriteriaRule = null;

    /**
     * @param \Google\AdsApi\AdManager\v202108\InventoryTargeting $inventoryRule
     * @param \Google\AdsApi\AdManager\v202108\CustomCriteriaSet $customCriteriaRule
     */
