 ...
 */
class DropDownCustomFieldValue extends \Google\AdsApi\AdManager\v202108\BaseCustomFieldValue
{
    ...
    /**
     * @param int $customFieldOptionId
     * @return \Google\AdsApi\AdManager\v202108\DropDownCustomFieldValue
     */
