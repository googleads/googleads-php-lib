 ...
 */
abstract class BaseAudioCreative extends \Google\AdsApi\AdManager\v202108\HasDestinationUrlCreative
{
    ...
    /**
     * @param int $duration
     * @return \Google\AdsApi\AdManager\v202108\BaseAudioCreative
     */
