 ...
 */
class UrlCreativeTemplateVariable extends \Google\AdsApi\AdManager\v202108\CreativeTemplateVariable
{
    ...
    /**
     * @param string $defaultValue
     * @return \Google\AdsApi\AdManager\v202108\UrlCreativeTemplateVariable
     */
