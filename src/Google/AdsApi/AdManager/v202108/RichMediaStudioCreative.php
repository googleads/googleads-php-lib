 ...
 */
class RichMediaStudioCreative extends \Google\AdsApi\AdManager\v202108\BaseRichMediaStudioCreative
{
    ...
    /**
     * @param string $lockedOrientation
     * @return \Google\AdsApi\AdManager\v202108\RichMediaStudioCreative
     */
