...
class LineItemActivityAssociation
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202108\Money $clickThroughConversionCost
     */
    protected $clickThroughConversionCost = null;

    /**
     * @var \Google\AdsApi\AdManager\v202108\Money $viewThroughConversionCost
     */
    protected $viewThroughConversionCost = null;

    /**
     * @param int $activityId
     * @param \Google\AdsApi\AdManager\v202108\Money $clickThroughConversionCost
     * @param \Google\AdsApi\AdManager\v202108\Money $viewThroughConversionCost
     */
