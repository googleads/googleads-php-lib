 ...
 */
class AudienceSegmentPremiumFeature extends \Google\AdsApi\AdManager\v201805\PremiumFeature
{
    ...
    /**
     * @param int $audienceSegmentId
     * @return \Google\AdsApi\AdManager\v201805\AudienceSegmentPremiumFeature
     */
