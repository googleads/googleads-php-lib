 ...
 */
class RequestApprovalProgressAction extends \Google\AdsApi\AdManager\v201805\ProgressAction
{
    ...
    /**
     * @param int $approverId
     * @return \Google\AdsApi\AdManager\v201805\RequestApprovalProgressAction
     */
