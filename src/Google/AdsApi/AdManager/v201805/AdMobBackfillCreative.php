 ...
 */
class AdMobBackfillCreative extends \Google\AdsApi\AdManager\v201805\BaseDynamicAllocationCreative
{
    ...
    /**
     * @param string $additionalParameters
     * @return \Google\AdsApi\AdManager\v201805\AdMobBackfillCreative
     */
