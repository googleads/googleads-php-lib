 ...
 */
abstract class HasDestinationUrlCreative extends \Google\AdsApi\AdManager\v201805\Creative
{
    ...
    /**
     * @param string $destinationUrl
     * @return \Google\AdsApi\AdManager\v201805\HasDestinationUrlCreative
     */
