...
class ReconciliationReportRow
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v201805\Money $lineItemCostPerUnit
     */
    ...
    /**
     * @var \Google\AdsApi\AdManager\v201805\Money $contractedRevenue
     */
    protected $contractedRevenue = null;

    /**
     * @var \Google\AdsApi\AdManager\v201805\Money $dfpRevenue
     */
    protected $dfpRevenue = null;

    /**
     * @var \Google\AdsApi\AdManager\v201805\Money $thirdPartyRevenue
     */
    protected $thirdPartyRevenue = null;

    /**
     * @var \Google\AdsApi\AdManager\v201805\Money $manualRevenue
     */
    protected $manualRevenue = null;

    /**
     * @var \Google\AdsApi\AdManager\v201805\Money $reconciledRevenue
     */
     ...
     * @param \Google\AdsApi\AdManager\v201805\Money $lineItemCostPerUnit
     * @param int $lineItemContractedUnitsBought
     * @param int $dfpVolume
     * @param int $thirdPartyVolume
     * @param int $manualVolume
     * @param int $reconciledVolume
     * @param \Google\AdsApi\AdManager\v201805\Money $contractedRevenue
     * @param \Google\AdsApi\AdManager\v201805\Money $dfpRevenue
     * @param \Google\AdsApi\AdManager\v201805\Money $thirdPartyRevenue
     * @param \Google\AdsApi\AdManager\v201805\Money $manualRevenue
     * @param \Google\AdsApi\AdManager\v201805\Money $reconciledRevenue
