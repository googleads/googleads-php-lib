 ...
 */
class CustomTargetingPremiumFeature extends \Google\AdsApi\AdManager\v201805\PremiumFeature
{
    ...
    /**
     * @param int $customTargetingKeyId
     * @return \Google\AdsApi\AdManager\v201805\CustomTargetingPremiumFeature
     */
