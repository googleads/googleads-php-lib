 ...
 */
class ContentMetadataTargetingError extends \Google\AdsApi\AdManager\v201805\ApiError
{
    ...
    /**
     * @param string $reason
     * @return \Google\AdsApi\AdManager\v201805\ContentMetadataTargetingError
     */
