 ...
 */
abstract class BaseFlashRedirectCreative extends \Google\AdsApi\AdManager\v201805\HasDestinationUrlCreative
{
    ...
    /**
     * @param string $flashUrl
     * @return \Google\AdsApi\AdManager\v201805\BaseFlashRedirectCreative
     */
