 ...
 */
class WorkflowExternalConditionRequest extends \Google\AdsApi\AdManager\v201805\WorkflowRequest
{
    ...
    /**
     * @param string $status
     * @return \Google\AdsApi\AdManager\v201805\WorkflowExternalConditionRequest
     */
