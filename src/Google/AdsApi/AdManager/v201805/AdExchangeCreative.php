 ...
 */
class AdExchangeCreative extends \Google\AdsApi\AdManager\v201805\HasHtmlSnippetDynamicAllocationCreative
{
    ...
    /**
     * @param boolean $isNativeEligible
     * @return \Google\AdsApi\AdManager\v201805\AdExchangeCreative
     */
