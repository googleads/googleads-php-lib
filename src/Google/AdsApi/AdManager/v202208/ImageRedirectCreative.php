 ...
 */
class ImageRedirectCreative extends \Google\AdsApi\AdManager\v202208\BaseImageRedirectCreative
{
    ...
    /**
     * @param string $altText
     * @return \Google\AdsApi\AdManager\v202208\ImageRedirectCreative
     */
