 ...
 */
class ReserveProposalLineItems extends \Google\AdsApi\AdManager\v202208\ProposalLineItemAction
{
    ...
    /**
     * @param boolean $allowOverbook
     * @return \Google\AdsApi\AdManager\v202208\ReserveProposalLineItems
     */
