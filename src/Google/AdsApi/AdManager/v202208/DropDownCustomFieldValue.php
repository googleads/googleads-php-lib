 ...
 */
class DropDownCustomFieldValue extends \Google\AdsApi\AdManager\v202208\BaseCustomFieldValue
{
    ...
    /**
     * @param int $customFieldOptionId
     * @return \Google\AdsApi\AdManager\v202208\DropDownCustomFieldValue
     */
