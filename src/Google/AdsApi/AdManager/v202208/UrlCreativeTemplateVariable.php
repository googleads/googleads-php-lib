 ...
 */
class UrlCreativeTemplateVariable extends \Google\AdsApi\AdManager\v202208\CreativeTemplateVariable
{
    ...
    /**
     * @param string $defaultValue
     * @return \Google\AdsApi\AdManager\v202208\UrlCreativeTemplateVariable
     */
