 ...
 */
class AdExchangeCreative extends \Google\AdsApi\AdManager\v202208\HasHtmlSnippetDynamicAllocationCreative
{
    ...
    /**
     * @param boolean $isNativeEligible
     * @return \Google\AdsApi\AdManager\v202208\AdExchangeCreative
     */
