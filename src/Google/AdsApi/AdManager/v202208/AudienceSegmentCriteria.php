 ...
 */
class AudienceSegmentCriteria extends \Google\AdsApi\AdManager\v202208\CustomCriteriaLeaf
{
    ...
    /**
     * @param string $operator
     * @return \Google\AdsApi\AdManager\v202208\AudienceSegmentCriteria
     */
