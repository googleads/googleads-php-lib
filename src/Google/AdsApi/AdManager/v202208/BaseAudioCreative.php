 ...
 */
abstract class BaseAudioCreative extends \Google\AdsApi\AdManager\v202208\HasDestinationUrlCreative
{
    ...
    /**
     * @param int $duration
     * @return \Google\AdsApi\AdManager\v202208\BaseAudioCreative
     */
