 ...
 */
abstract class BaseImageRedirectCreative extends \Google\AdsApi\AdManager\v202208\HasDestinationUrlCreative
{
    ...
    /**
     * @param string $imageUrl
     * @return \Google\AdsApi\AdManager\v202208\BaseImageRedirectCreative
     */
