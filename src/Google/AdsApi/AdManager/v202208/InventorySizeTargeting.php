...
class InventorySizeTargeting
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202208\TargetedSize[] $targetedSizes
     */
    protected $targetedSizes = null;

    /**
     * @param boolean $isTargeted
     * @param \Google\AdsApi\AdManager\v202208\TargetedSize[] $targetedSizes
     */
    ...
    /**
     * @param \Google\AdsApi\AdManager\v202208\TargetedSize[]|null $targetedSizes
     * @return \Google\AdsApi\AdManager\v202208\InventorySizeTargeting
     */
