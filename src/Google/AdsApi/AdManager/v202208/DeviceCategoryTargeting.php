...
class DeviceCategoryTargeting
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202208\Technology[] $targetedDeviceCategories
     */
    protected $targetedDeviceCategories = null;

    /**
     * @var \Google\AdsApi\AdManager\v202208\Technology[] $excludedDeviceCategories
     */
    protected $excludedDeviceCategories = null;

    /**
     * @param \Google\AdsApi\AdManager\v202208\Technology[] $targetedDeviceCategories
     * @param \Google\AdsApi\AdManager\v202208\Technology[] $excludedDeviceCategories
     */
    ...
    /**
     * @param \Google\AdsApi\AdManager\v202208\Technology[]|null $targetedDeviceCategories
    ...
    /**
     * @param \Google\AdsApi\AdManager\v202208\Technology[]|null $excludedDeviceCategories
     * @return \Google\AdsApi\AdManager\v202208\DeviceCategoryTargeting
     */
