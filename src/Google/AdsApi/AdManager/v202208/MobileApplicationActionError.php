 ...
 */
class MobileApplicationActionError extends \Google\AdsApi\AdManager\v202208\ApiError
{
    ...
    /**
     * @param string $reason
     * @return \Google\AdsApi\AdManager\v202208\MobileApplicationActionError
     */
