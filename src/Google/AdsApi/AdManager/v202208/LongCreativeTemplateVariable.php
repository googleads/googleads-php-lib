 ...
 */
class LongCreativeTemplateVariable extends \Google\AdsApi\AdManager\v202208\CreativeTemplateVariable
{
    ...
    /**
     * @param int $defaultValue
     * @return \Google\AdsApi\AdManager\v202208\LongCreativeTemplateVariable
     */
