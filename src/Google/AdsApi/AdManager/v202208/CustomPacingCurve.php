...
class CustomPacingCurve
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202208\CustomPacingGoal[] $customPacingGoals
     */
    protected $customPacingGoals = null;

    /**
     * @param string $customPacingGoalUnit
     * @param \Google\AdsApi\AdManager\v202208\CustomPacingGoal[] $customPacingGoals
     */
    ...
    /**
     * @return \Google\AdsApi\AdManager\v202208\CustomPacingGoal[]
     */
    ...
    /**
     * @param \Google\AdsApi\AdManager\v202208\CustomPacingGoal[]|null $customPacingGoals
     * @return \Google\AdsApi\AdManager\v202208\CustomPacingCurve
     */
