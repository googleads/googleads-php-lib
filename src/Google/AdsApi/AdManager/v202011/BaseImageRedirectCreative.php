 ...
 */
abstract class BaseImageRedirectCreative extends \Google\AdsApi\AdManager\v202011\HasDestinationUrlCreative
{
    ...
    /**
     * @param string $imageUrl
     * @return \Google\AdsApi\AdManager\v202011\BaseImageRedirectCreative
     */
