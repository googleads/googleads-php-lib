...
class TrafficDataResponse
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202011\TimeSeries $historicalTimeSeries
     */
    protected $historicalTimeSeries = null;

    /**
     * @var \Google\AdsApi\AdManager\v202011\TimeSeries $forecastedTimeSeries
     */
    protected $forecastedTimeSeries = null;

    /**
     * @var \Google\AdsApi\AdManager\v202011\TimeSeries $forecastedAssignedTimeSeries
     */
    protected $forecastedAssignedTimeSeries = null;

    /**
     * @var \Google\AdsApi\AdManager\v202011\DateRange $overallDateRange
     */
    protected $overallDateRange = null;

    /**
     * @param \Google\AdsApi\AdManager\v202011\TimeSeries $historicalTimeSeries
     * @param \Google\AdsApi\AdManager\v202011\TimeSeries $forecastedTimeSeries
     * @param \Google\AdsApi\AdManager\v202011\TimeSeries $forecastedAssignedTimeSeries
     * @param \Google\AdsApi\AdManager\v202011\DateRange $overallDateRange
     */
    ...
    /**
     * @return \Google\AdsApi\AdManager\v202011\TimeSeries
     */
