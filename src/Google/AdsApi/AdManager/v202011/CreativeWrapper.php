...
class CreativeWrapper
{
     ...
     * @param string $status
     */
    public function __construct($id = null, $labelId = null, $htmlHeader = null, $htmlFooter = null, $ampHead = null, $ampBody = null, $thirdPartyDataDeclaration = null, $ordering = null, $status = null)
    {
      $this->id = $id;
