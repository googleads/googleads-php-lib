 ...
 */
class RichMediaStudioCreative extends \Google\AdsApi\AdManager\v202011\BaseRichMediaStudioCreative
{
    ...
    /**
     * @param string $lockedOrientation
     * @return \Google\AdsApi\AdManager\v202011\RichMediaStudioCreative
     */
