 ...
 */
class DropDownCustomFieldValue extends \Google\AdsApi\AdManager\v202011\BaseCustomFieldValue
{
    ...
    /**
     * @param int $customFieldOptionId
     * @return \Google\AdsApi\AdManager\v202011\DropDownCustomFieldValue
     */
