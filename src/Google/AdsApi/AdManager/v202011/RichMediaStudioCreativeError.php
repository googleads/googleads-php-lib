 ...
 */
class RichMediaStudioCreativeError extends \Google\AdsApi\AdManager\v202011\ApiError
{
    ...
    /**
     * @param string $reason
     * @return \Google\AdsApi\AdManager\v202011\RichMediaStudioCreativeError
     */
