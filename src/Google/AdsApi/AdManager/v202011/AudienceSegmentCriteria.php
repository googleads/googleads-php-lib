 ...
 */
class AudienceSegmentCriteria extends \Google\AdsApi\AdManager\v202011\CustomCriteriaLeaf
{
    ...
    /**
     * @param string $operator
     * @return \Google\AdsApi\AdManager\v202011\AudienceSegmentCriteria
     */
