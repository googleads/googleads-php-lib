 ...
 */
class ImageRedirectCreative extends \Google\AdsApi\AdManager\v202011\BaseImageRedirectCreative
{
    ...
    /**
     * @param string $altText
     * @return \Google\AdsApi\AdManager\v202011\ImageRedirectCreative
     */
