 ...
 */
class UrlCreativeTemplateVariable extends \Google\AdsApi\AdManager\v202011\CreativeTemplateVariable
{
    ...
    /**
     * @param string $defaultValue
     * @return \Google\AdsApi\AdManager\v202011\UrlCreativeTemplateVariable
     */
