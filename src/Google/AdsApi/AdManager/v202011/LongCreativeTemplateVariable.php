 ...
 */
class LongCreativeTemplateVariable extends \Google\AdsApi\AdManager\v202011\CreativeTemplateVariable
{
    ...
    /**
     * @param int $defaultValue
     * @return \Google\AdsApi\AdManager\v202011\LongCreativeTemplateVariable
     */
