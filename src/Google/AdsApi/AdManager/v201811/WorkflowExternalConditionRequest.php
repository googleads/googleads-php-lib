 ...
 */
class WorkflowExternalConditionRequest extends \Google\AdsApi\AdManager\v201811\WorkflowRequest
{
    ...
    /**
     * @param string $status
     * @return \Google\AdsApi\AdManager\v201811\WorkflowExternalConditionRequest
     */
