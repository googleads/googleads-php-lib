 ...
 */
class RequestApprovalProgressAction extends \Google\AdsApi\AdManager\v201811\ProgressAction
{
    ...
    /**
     * @param int $approverId
     * @return \Google\AdsApi\AdManager\v201811\RequestApprovalProgressAction
     */
