 ...
 */
class AdMobBackfillCreative extends \Google\AdsApi\AdManager\v201811\BaseDynamicAllocationCreative
{
    ...
    /**
     * @param string $additionalParameters
     * @return \Google\AdsApi\AdManager\v201811\AdMobBackfillCreative
     */
