 ...
 */
class CustomTargetingPremiumFeature extends \Google\AdsApi\AdManager\v201811\PremiumFeature
{
    ...
    /**
     * @param int $customTargetingKeyId
     * @return \Google\AdsApi\AdManager\v201811\CustomTargetingPremiumFeature
     */
