 ...
 */
class ContentMetadataTargetingError extends \Google\AdsApi\AdManager\v201811\ApiError
{
    ...
    /**
     * @param string $reason
     * @return \Google\AdsApi\AdManager\v201811\ContentMetadataTargetingError
     */
