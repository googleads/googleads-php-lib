 ...
 */
class LongCreativeTemplateVariable extends \Google\AdsApi\AdManager\v202411\CreativeTemplateVariable
{
    ...
    /**
     * @param int $defaultValue
     * @return \Google\AdsApi\AdManager\v202411\LongCreativeTemplateVariable
     */
