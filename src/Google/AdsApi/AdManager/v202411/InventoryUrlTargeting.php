...
class InventoryUrlTargeting
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202411\InventoryUrl[] $targetedUrls
     */
    protected $targetedUrls = null;

    /**
     * @var \Google\AdsApi\AdManager\v202411\InventoryUrl[] $excludedUrls
     */
    ...
    /**
     * @return \Google\AdsApi\AdManager\v202411\InventoryUrl[]
     */
