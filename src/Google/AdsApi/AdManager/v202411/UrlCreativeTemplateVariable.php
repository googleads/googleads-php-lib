 ...
 */
class UrlCreativeTemplateVariable extends \Google\AdsApi\AdManager\v202411\CreativeTemplateVariable
{
    ...
    /**
     * @param string $defaultValue
     * @return \Google\AdsApi\AdManager\v202411\UrlCreativeTemplateVariable
     */
