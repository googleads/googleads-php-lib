 ...
 */
abstract class HasDestinationUrlCreative extends \Google\AdsApi\AdManager\v202411\Creative
{
    ...
    /**
     * @param string $destinationUrl
     * @return \Google\AdsApi\AdManager\v202411\HasDestinationUrlCreative
     */
