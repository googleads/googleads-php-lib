 ...
 */
class ReserveProposalLineItems extends \Google\AdsApi\AdManager\v202411\ProposalLineItemAction
{
    ...
    /**
     * @param boolean $allowOverbook
     * @return \Google\AdsApi\AdManager\v202411\ReserveProposalLineItems
     */
