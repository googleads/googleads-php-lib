 ...
 */
class AdExchangeCreative extends \Google\AdsApi\AdManager\v202411\HasHtmlSnippetDynamicAllocationCreative
{
    ...
    /**
     * @param boolean $isNativeEligible
     * @return \Google\AdsApi\AdManager\v202411\AdExchangeCreative
     */
