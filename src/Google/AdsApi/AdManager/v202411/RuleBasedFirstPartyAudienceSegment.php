 ...
 */
class RuleBasedFirstPartyAudienceSegment extends \Google\AdsApi\AdManager\v202411\RuleBasedFirstPartyAudienceSegmentSummary
{

    /**
     * @var \Google\AdsApi\AdManager\v202411\FirstPartyAudienceSegmentRule $rule
     */
    protected $rule = null;
     ...
     * @param int $adIdSize
     * @param int $ppidSize
     * @param \Google\AdsApi\AdManager\v202411\AudienceSegmentDataProvider $dataProvider
     * @param string $type
     * @param int $pageViews
     * @param int $recencyDays
     * @param int $membershipExpirationDays
     * @param \Google\AdsApi\AdManager\v202411\FirstPartyAudienceSegmentRule $rule
     */
    ...
    /**
     * @return \Google\AdsApi\AdManager\v202411\FirstPartyAudienceSegmentRule
     */
    ...
    /**
     * @param \Google\AdsApi\AdManager\v202411\FirstPartyAudienceSegmentRule $rule
     * @return \Google\AdsApi\AdManager\v202411\RuleBasedFirstPartyAudienceSegment
     */
