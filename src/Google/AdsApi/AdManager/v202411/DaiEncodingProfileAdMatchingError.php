 ...
 */
class DaiEncodingProfileAdMatchingError extends \Google\AdsApi\AdManager\v202411\ApiError
{
    ...
    /**
     * @param string $reason
     * @return \Google\AdsApi\AdManager\v202411\DaiEncodingProfileAdMatchingError
     */
