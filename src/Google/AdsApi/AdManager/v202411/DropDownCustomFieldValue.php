 ...
 */
class DropDownCustomFieldValue extends \Google\AdsApi\AdManager\v202411\BaseCustomFieldValue
{
    ...
    /**
     * @param int $customFieldOptionId
     * @return \Google\AdsApi\AdManager\v202411\DropDownCustomFieldValue
     */
