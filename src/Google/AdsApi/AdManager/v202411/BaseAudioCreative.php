 ...
 */
abstract class BaseAudioCreative extends \Google\AdsApi\AdManager\v202411\HasDestinationUrlCreative
{
    ...
    /**
     * @param int $duration
     * @return \Google\AdsApi\AdManager\v202411\BaseAudioCreative
     */
