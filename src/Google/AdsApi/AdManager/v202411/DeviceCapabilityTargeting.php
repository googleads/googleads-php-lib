...
class DeviceCapabilityTargeting
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202411\Technology[] $targetedDeviceCapabilities
     */
    protected $targetedDeviceCapabilities = null;

    /**
     * @var \Google\AdsApi\AdManager\v202411\Technology[] $excludedDeviceCapabilities
     */
    protected $excludedDeviceCapabilities = null;

    /**
     * @param \Google\AdsApi\AdManager\v202411\Technology[] $targetedDeviceCapabilities
     * @param \Google\AdsApi\AdManager\v202411\Technology[] $excludedDeviceCapabilities
     */
    ...
    /**
     * @param \Google\AdsApi\AdManager\v202411\Technology[]|null $targetedDeviceCapabilities
    ...
    /**
     * @param \Google\AdsApi\AdManager\v202411\Technology[]|null $excludedDeviceCapabilities
     * @return \Google\AdsApi\AdManager\v202411\DeviceCapabilityTargeting
     */
