 ...
 */
class DropDownCustomFieldValue extends \Google\AdsApi\AdManager\v202408\BaseCustomFieldValue
{
    ...
    /**
     * @param int $customFieldOptionId
     * @return \Google\AdsApi\AdManager\v202408\DropDownCustomFieldValue
     */
