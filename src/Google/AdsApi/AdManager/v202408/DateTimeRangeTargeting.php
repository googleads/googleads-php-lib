...
class DateTimeRangeTargeting
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202408\DateTimeRange[] $targetedDateTimeRanges
     */
    protected $targetedDateTimeRanges = null;

    /**
     * @param \Google\AdsApi\AdManager\v202408\DateTimeRange[] $targetedDateTimeRanges
     */
    ...
    /**
     * @param \Google\AdsApi\AdManager\v202408\DateTimeRange[]|null $targetedDateTimeRanges
