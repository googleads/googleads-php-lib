 ...
 */
class DaiAuthenticationKeyActionError extends \Google\AdsApi\AdManager\v202408\ApiError
{
    ...
    /**
     * @param string $reason
     * @return \Google\AdsApi\AdManager\v202408\DaiAuthenticationKeyActionError
     */
