 ...
 */
class UrlCreativeTemplateVariable extends \Google\AdsApi\AdManager\v202008\CreativeTemplateVariable
{
    ...
    /**
     * @param string $defaultValue
     * @return \Google\AdsApi\AdManager\v202008\UrlCreativeTemplateVariable
     */
