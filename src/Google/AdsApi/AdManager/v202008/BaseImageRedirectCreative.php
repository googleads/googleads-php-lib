 ...
 */
abstract class BaseImageRedirectCreative extends \Google\AdsApi\AdManager\v202008\HasDestinationUrlCreative
{
    ...
    /**
     * @param string $imageUrl
     * @return \Google\AdsApi\AdManager\v202008\BaseImageRedirectCreative
     */
