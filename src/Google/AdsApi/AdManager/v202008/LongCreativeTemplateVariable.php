 ...
 */
class LongCreativeTemplateVariable extends \Google\AdsApi\AdManager\v202008\CreativeTemplateVariable
{
    ...
    /**
     * @param int $defaultValue
     * @return \Google\AdsApi\AdManager\v202008\LongCreativeTemplateVariable
     */
