 ...
 */
class RichMediaStudioCreative extends \Google\AdsApi\AdManager\v202008\BaseRichMediaStudioCreative
{
    ...
    /**
     * @param string $lockedOrientation
     * @return \Google\AdsApi\AdManager\v202008\RichMediaStudioCreative
     */
