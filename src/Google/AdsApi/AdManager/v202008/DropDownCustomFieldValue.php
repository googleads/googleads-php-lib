 ...
 */
class DropDownCustomFieldValue extends \Google\AdsApi\AdManager\v202008\BaseCustomFieldValue
{
    ...
    /**
     * @param int $customFieldOptionId
     * @return \Google\AdsApi\AdManager\v202008\DropDownCustomFieldValue
     */
