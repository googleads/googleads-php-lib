 ...
 */
class ImageRedirectCreative extends \Google\AdsApi\AdManager\v202008\BaseImageRedirectCreative
{
    ...
    /**
     * @param string $altText
     * @return \Google\AdsApi\AdManager\v202008\ImageRedirectCreative
     */
