...
class CustomPacingCurve
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202008\CustomPacingGoal[] $customPacingGoals
     */
    protected $customPacingGoals = null;

    /**
     * @param string $customPacingGoalUnit
     * @param \Google\AdsApi\AdManager\v202008\CustomPacingGoal[] $customPacingGoals
     */
    ...
    /**
     * @return \Google\AdsApi\AdManager\v202008\CustomPacingGoal[]
     */
    ...
    /**
     * @param \Google\AdsApi\AdManager\v202008\CustomPacingGoal[]|null $customPacingGoals
     * @return \Google\AdsApi\AdManager\v202008\CustomPacingCurve
     */
