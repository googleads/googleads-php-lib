 ...
 */
abstract class HasDestinationUrlCreative extends \Google\AdsApi\AdManager\v202008\Creative
{
    ...
    /**
     * @param string $destinationUrl
     * @return \Google\AdsApi\AdManager\v202008\HasDestinationUrlCreative
     */
