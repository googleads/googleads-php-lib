 ...
 */
class DropDownCustomFieldValue extends \Google\AdsApi\AdManager\v202002\BaseCustomFieldValue
{
    ...
    /**
     * @param int $customFieldOptionId
     * @return \Google\AdsApi\AdManager\v202002\DropDownCustomFieldValue
     */
