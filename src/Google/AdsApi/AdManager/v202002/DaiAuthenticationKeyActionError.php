 ...
 */
class DaiAuthenticationKeyActionError extends \Google\AdsApi\AdManager\v202002\ApiError
{
    ...
    /**
     * @param string $reason
     * @return \Google\AdsApi\AdManager\v202002\DaiAuthenticationKeyActionError
     */
