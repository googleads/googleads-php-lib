 ...
 */
class OptimizedPoddingAdRuleSlot extends \Google\AdsApi\AdManager\v202002\BaseAdRuleSlot
{
    ...
    {
      parent::__construct($slotBehavior, $maxVideoAdDuration, $videoMidrollFrequencyType, $videoMidrollFrequency, $bumper, $maxBumperDuration, $maxPodDuration, $maxAdsInPod, $breakTemplateId);
    }
