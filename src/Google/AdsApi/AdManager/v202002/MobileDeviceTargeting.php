...
class MobileDeviceTargeting
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202002\Technology[] $targetedMobileDevices
     */
    protected $targetedMobileDevices = null;

    /**
     * @var \Google\AdsApi\AdManager\v202002\Technology[] $excludedMobileDevices
     */
    protected $excludedMobileDevices = null;

    /**
     * @param \Google\AdsApi\AdManager\v202002\Technology[] $targetedMobileDevices
     * @param \Google\AdsApi\AdManager\v202002\Technology[] $excludedMobileDevices
     */
    ...
    /**
     * @param \Google\AdsApi\AdManager\v202002\Technology[]|null $targetedMobileDevices
    ...
    /**
     * @param \Google\AdsApi\AdManager\v202002\Technology[]|null $excludedMobileDevices
     * @return \Google\AdsApi\AdManager\v202002\MobileDeviceTargeting
     */
