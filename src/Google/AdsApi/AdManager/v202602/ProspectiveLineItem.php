...
class ProspectiveLineItem
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202602\LineItem $lineItem
     */
    protected $lineItem = null;

    /**
     * @var \Google\AdsApi\AdManager\v202602\ProposalLineItem $proposalLineItem
     */
    ...
    /**
     * @param \Google\AdsApi\AdManager\v202602\LineItem $lineItem
     * @param \Google\AdsApi\AdManager\v202602\ProposalLineItem $proposalLineItem
    ...
    /**
     * @param \Google\AdsApi\AdManager\v202602\LineItem $lineItem
     * @return \Google\AdsApi\AdManager\v202602\ProspectiveLineItem
     */
