...
class LineItemSummary
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202602\DateTime $startDateTime
     */
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202602\DateTime $endDateTime
     */
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202602\CustomPacingCurve $customPacingCurve
     */
    protected $customPacingCurve = null;
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202602\FrequencyCap[] $frequencyCaps
     */
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202602\Money $costPerUnit
     */
    protected $costPerUnit = null;

    /**
     * @var \Google\AdsApi\AdManager\v202602\Money $valueCostPerUnit
     */
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202602\CreativePlaceholder[] $creativePlaceholders
     */
    protected $creativePlaceholders = null;

    /**
     * @var \Google\AdsApi\AdManager\v202602\LineItemActivityAssociation[] $activityAssociations
     */
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202602\Stats $stats
     */
    protected $stats = null;

    /**
     * @var \Google\AdsApi\AdManager\v202602\DeliveryIndicator $deliveryIndicator
     */
    protected $deliveryIndicator = null;

    /**
     * @var \Google\AdsApi\AdManager\v202602\DeliveryData $deliveryData
     */
    protected $deliveryData = null;

    /**
     * @var \Google\AdsApi\AdManager\v202602\Money $budget
     */
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202602\AppliedLabel[] $appliedLabels
     */
    protected $appliedLabels = null;

    /**
     * @var \Google\AdsApi\AdManager\v202602\AppliedLabel[] $effectiveAppliedLabels
     */
    ...
    /**
     * @var string $competitiveConstraintScope
     */
    protected $competitiveConstraintScope = null;

    /**
     * @var \Google\AdsApi\AdManager\v202602\DateTime $lastModifiedDateTime
     */
    protected $lastModifiedDateTime = null;

    /**
     * @var \Google\AdsApi\AdManager\v202602\DateTime $creationDateTime
     */
    protected $creationDateTime = null;

    /**
     * @var \Google\AdsApi\AdManager\v202602\BaseCustomFieldValue[] $customFieldValues
     */
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202602\ThirdPartyMeasurementSettings $thirdPartyMeasurementSettings
     */
    protected $thirdPartyMeasurementSettings = null;

    /**
     * @var boolean $youtubeKidsRestricted
     */
    protected $youtubeKidsRestricted = null;
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202602\Goal $primaryGoal
     */
    protected $primaryGoal = null;

    /**
     * @var \Google\AdsApi\AdManager\v202602\Goal[] $secondaryGoals
     */
    protected $secondaryGoals = null;

    /**
     * @var \Google\AdsApi\AdManager\v202602\GrpSettings $grpSettings
     */
    protected $grpSettings = null;

    /**
     * @var \Google\AdsApi\AdManager\v202602\LineItemDealInfoDto $dealInfo
     */
    protected $dealInfo = null;

    /**
     * @var int[] $viewabilityProviderCompanyIds
     */
    protected $viewabilityProviderCompanyIds = null;
    ...
    /**
     * @var boolean $repeatedCreativeServingEnabled
     */
    protected $repeatedCreativeServingEnabled = null;
     ...
     * @param \Google\AdsApi\AdManager\v202602\DateTime $startDateTime
     * @param string $startDateTimeType
     * @param \Google\AdsApi\AdManager\v202602\DateTime $endDateTime
     ...
     * @param \Google\AdsApi\AdManager\v202602\CustomPacingCurve $customPacingCurve
     * @param string $roadblockingType
     * @param string $skippableAdType
     * @param \Google\AdsApi\AdManager\v202602\FrequencyCap[] $frequencyCaps
     * @param string $lineItemType
     * @param int $priority
     * @param \Google\AdsApi\AdManager\v202602\Money $costPerUnit
     * @param \Google\AdsApi\AdManager\v202602\Money $valueCostPerUnit
     * @param string $costType
     * @param string $discountType
     * @param float $discount
     * @param int $contractedUnitsBought
     * @param \Google\AdsApi\AdManager\v202602\CreativePlaceholder[] $creativePlaceholders
     * @param \Google\AdsApi\AdManager\v202602\LineItemActivityAssociation[] $activityAssociations
     ...
     * @param \Google\AdsApi\AdManager\v202602\Stats $stats
     * @param \Google\AdsApi\AdManager\v202602\DeliveryIndicator $deliveryIndicator
     * @param \Google\AdsApi\AdManager\v202602\DeliveryData $deliveryData
     * @param \Google\AdsApi\AdManager\v202602\Money $budget
     * @param string $status
     * @param string $reservationStatus
     * @param boolean $isArchived
     * @param string $webPropertyCode
     * @param \Google\AdsApi\AdManager\v202602\AppliedLabel[] $appliedLabels
     * @param \Google\AdsApi\AdManager\v202602\AppliedLabel[] $effectiveAppliedLabels
     ...
     * @param \Google\AdsApi\AdManager\v202602\DateTime $lastModifiedDateTime
     * @param \Google\AdsApi\AdManager\v202602\DateTime $creationDateTime
     * @param \Google\AdsApi\AdManager\v202602\BaseCustomFieldValue[] $customFieldValues
     * @param boolean $isMissingCreatives
     * @param string $programmaticCreativeSource
     * @param \Google\AdsApi\AdManager\v202602\ThirdPartyMeasurementSettings $thirdPartyMeasurementSettings
     * @param boolean $youtubeKidsRestricted
     * @param int $videoMaxDuration
     * @param \Google\AdsApi\AdManager\v202602\Goal $primaryGoal
     * @param \Google\AdsApi\AdManager\v202602\Goal[] $secondaryGoals
     * @param \Google\AdsApi\AdManager\v202602\GrpSettings $grpSettings
     * @param \Google\AdsApi\AdManager\v202602\LineItemDealInfoDto $dealInfo
    ...
    public function __construct($orderId = null, $id = null, $name = null, $externalId = null, $orderName = null, $startDateTime = null, $startDateTimeType = null, $endDateTime = null, $autoExtensionDays = null, $unlimitedEndDateTime = null, $creativeRotationType = null, $deliveryRateType = null, $deliveryForecastSource = null, $customPacingCurve = null, $roadblockingType = null, $skippableAdType = null, ?array $frequencyCaps = null, $lineItemType = null, $priority = null, $costPerUnit = null, $valueCostPerUnit = null, $costType = null, $discountType = null, $discount = null, $contractedUnitsBought = null, ?array $creativePlaceholders = null, ?array $activityAssociations = null, $environmentType = null, ?array $allowedFormats = null, $companionDeliveryOption = null, $allowOverbook = null, $skipInventoryCheck = null, $skipCrossSellingRuleWarningChecks = null, $reserveAtCreation = null, $stats = null, $deliveryIndicator = null, $deliveryData = null, $budget = null, $status = null, $reservationStatus = null, $isArchived = null, $webPropertyCode = null, ?array $appliedLabels = null, ?array $effectiveAppliedLabels = null, $disableSameAdvertiserCompetitiveExclusion = null, $lastModifiedByApp = null, $notes = null, $competitiveConstraintScope = null, $lastModifiedDateTime = null, $creationDateTime = null, ?array $customFieldValues = null, $isMissingCreatives = null, $programmaticCreativeSource = null, $thirdPartyMeasurementSettings = null, $youtubeKidsRestricted = null, $videoMaxDuration = null, $primaryGoal = null, ?array $secondaryGoals = null, $grpSettings = null, $dealInfo = null, ?array $viewabilityProviderCompanyIds = null, $childContentEligibility = null, $customVastExtension = null, $repeatedCreativeServingEnabled = null, $deliveryAllocationProfileId = null)
    {
      ...
      $this->repeatedCreativeServingEnabled = $repeatedCreativeServingEnabled;
    ...
    /**
     * @param int $orderId
     * @return \Google\AdsApi\AdManager\v202602\LineItemSummary
     */
    ...
    /**
     * @return \Google\AdsApi\AdManager\v202602\DateTime
     */
    ...
    /**
     * @return \Google\AdsApi\AdManager\v202602\CustomPacingCurve
     */
     ...
     * @return \Google\AdsApi\AdManager\v202602\LineItemSummary
     */
    public function setCustomPacingCurve($customPacingCurve)
    {
      $this->customPacingCurve = $customPacingCurve;
      return $this;
    }
    ...
    /**
     * @return \Google\AdsApi\AdManager\v202602\FrequencyCap[]
     */
    ...
    /**
     * @param \Google\AdsApi\AdManager\v202602\FrequencyCap[]|null $frequencyCaps
     * @return \Google\AdsApi\AdManager\v202602\LineItemSummary
     */
    ...
    /**
     * @return \Google\AdsApi\AdManager\v202602\Money
     */
    ...
    /**
     * @return \Google\AdsApi\AdManager\v202602\CreativePlaceholder[]
     */
    ...
    /**
     * @param \Google\AdsApi\AdManager\v202602\CreativePlaceholder[]|null $creativePlaceholders
     * @return \Google\AdsApi\AdManager\v202602\LineItemSummary
     */
    ...
    /**
     * @return \Google\AdsApi\AdManager\v202602\LineItemActivityAssociation[]
     */
    ...
    /**
     * @param \Google\AdsApi\AdManager\v202602\LineItemActivityAssociation[]|null $activityAssociations
     * @return \Google\AdsApi\AdManager\v202602\LineItemSummary
     */
    ...
    /**
     * @return \Google\AdsApi\AdManager\v202602\Stats
     */
    ...
    /**
     * @return \Google\AdsApi\AdManager\v202602\DeliveryIndicator
     */
    ...
    /**
     * @return \Google\AdsApi\AdManager\v202602\DeliveryData
     */
    ...
    /**
     * @return \Google\AdsApi\AdManager\v202602\AppliedLabel[]
     */
     ...
     * @return \Google\AdsApi\AdManager\v202602\LineItemSummary
     */
    public function setCompetitiveConstraintScope($competitiveConstraintScope)
    {
      $this->competitiveConstraintScope = $competitiveConstraintScope;
      return $this;
    }
    ...
    /**
     * @return \Google\AdsApi\AdManager\v202602\BaseCustomFieldValue[]
     */
    ...
    /**
     * @return \Google\AdsApi\AdManager\v202602\ThirdPartyMeasurementSettings
     */
    ...
    {
      return $this->youtubeKidsRestricted;
    }
     ...
     * @return \Google\AdsApi\AdManager\v202602\LineItemSummary
     */
    public function setYoutubeKidsRestricted($youtubeKidsRestricted)
    {
      $this->youtubeKidsRestricted = $youtubeKidsRestricted;
      return $this;
    }
    ...
    /**
     * @return \Google\AdsApi\AdManager\v202602\Goal
     */
    ...
    /**
     * @param \Google\AdsApi\AdManager\v202602\Goal[]|null $secondaryGoals
     * @return \Google\AdsApi\AdManager\v202602\LineItemSummary
     */
    ...
    /**
     * @return \Google\AdsApi\AdManager\v202602\GrpSettings
     */
    ...
    /**
     * @return \Google\AdsApi\AdManager\v202602\LineItemDealInfoDto
     */
     ...
     * @return int[]
     */
    public function getViewabilityProviderCompanyIds()
    {
    ...
    {
      return $this->repeatedCreativeServingEnabled;
    }
     ...
     * @return \Google\AdsApi\AdManager\v202602\LineItemSummary
     */
    public function setRepeatedCreativeServingEnabled($repeatedCreativeServingEnabled)
    {
      $this->repeatedCreativeServingEnabled = $repeatedCreativeServingEnabled;
      return $this;
    }
