 ...
 */
class RichMediaStudioCreative extends \Google\AdsApi\AdManager\v202602\BaseRichMediaStudioCreative
{
    ...
    /**
     * @param string $lockedOrientation
     * @return \Google\AdsApi\AdManager\v202602\RichMediaStudioCreative
     */
