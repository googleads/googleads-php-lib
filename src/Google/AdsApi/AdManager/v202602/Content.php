...
class Content
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202602\DaiIngestError[] $hlsIngestErrors
     */
    protected $hlsIngestErrors = null;

    /**
     * @var \Google\AdsApi\AdManager\v202602\DateTime $lastHlsIngestDateTime
     */
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202602\DaiIngestError[] $dashIngestErrors
     */
    protected $dashIngestErrors = null;

    /**
     * @var \Google\AdsApi\AdManager\v202602\DateTime $lastDashIngestDateTime
     */
    protected $lastDashIngestDateTime = null;

    /**
     * @var \Google\AdsApi\AdManager\v202602\DateTime $importDateTime
     */
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202602\CmsContent[] $cmsSources
     */
     ...
     * @param \Google\AdsApi\AdManager\v202602\DaiIngestError[] $hlsIngestErrors
     * @param \Google\AdsApi\AdManager\v202602\DateTime $lastHlsIngestDateTime
     * @param string $dashIngestStatus
     * @param \Google\AdsApi\AdManager\v202602\DaiIngestError[] $dashIngestErrors
     * @param \Google\AdsApi\AdManager\v202602\DateTime $lastDashIngestDateTime
     * @param \Google\AdsApi\AdManager\v202602\DateTime $importDateTime
     * @param \Google\AdsApi\AdManager\v202602\DateTime $lastModifiedDateTime
     * @param \Google\AdsApi\AdManager\v202602\CmsContent[] $cmsSources
    ...
    /**
     * @param int $id
     * @return \Google\AdsApi\AdManager\v202602\Content
     */
    ...
    /**
     * @return \Google\AdsApi\AdManager\v202602\DaiIngestError[]
     */
    ...
    /**
     * @param \Google\AdsApi\AdManager\v202602\DaiIngestError[]|null $hlsIngestErrors
     * @return \Google\AdsApi\AdManager\v202602\Content
     */
    ...
    /**
     * @param \Google\AdsApi\AdManager\v202602\DaiIngestError[]|null $dashIngestErrors
     * @return \Google\AdsApi\AdManager\v202602\Content
     */
    ...
    /**
     * @return \Google\AdsApi\AdManager\v202602\CmsContent[]
     */
    ...
    /**
     * @param \Google\AdsApi\AdManager\v202602\CmsContent[]|null $cmsSources
     * @return \Google\AdsApi\AdManager\v202602\Content
     */
