...
class AdsTxtService extends \Google\AdsApi\Common\AdsSoapClient
{
    ...
    private static $classmap = array (
      ...
      'getMcmSupplyChainDiagnosticsDownloadUrlResponse' => 'Google\\AdsApi\\AdManager\\v202602\\getMcmSupplyChainDiagnosticsDownloadUrlResponse',
    );
    ...
    public function __construct(array $options = array(),
                $wsdl = 'https://ads.google.com/apis/ads/publisher/v202602/AdsTxtService?wsdl')
    {
