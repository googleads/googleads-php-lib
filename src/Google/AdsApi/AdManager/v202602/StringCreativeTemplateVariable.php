 ...
 */
class StringCreativeTemplateVariable extends \Google\AdsApi\AdManager\v202602\CreativeTemplateVariable
{
    ...
    /**
     * @param string $defaultValue
     * @return \Google\AdsApi\AdManager\v202602\StringCreativeTemplateVariable
     */
