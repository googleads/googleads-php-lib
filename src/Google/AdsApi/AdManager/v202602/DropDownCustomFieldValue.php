 ...
 */
class DropDownCustomFieldValue extends \Google\AdsApi\AdManager\v202602\BaseCustomFieldValue
{
    ...
    /**
     * @param int $customFieldOptionId
     * @return \Google\AdsApi\AdManager\v202602\DropDownCustomFieldValue
     */
