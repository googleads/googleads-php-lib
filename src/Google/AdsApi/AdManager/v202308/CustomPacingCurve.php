...
class CustomPacingCurve
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202308\CustomPacingGoal[] $customPacingGoals
     */
    protected $customPacingGoals = null;

    /**
     * @param string $customPacingGoalUnit
     * @param \Google\AdsApi\AdManager\v202308\CustomPacingGoal[] $customPacingGoals
     */
    ...
    /**
     * @return \Google\AdsApi\AdManager\v202308\CustomPacingGoal[]
     */
    ...
    /**
     * @param \Google\AdsApi\AdManager\v202308\CustomPacingGoal[]|null $customPacingGoals
     * @return \Google\AdsApi\AdManager\v202308\CustomPacingCurve
     */
