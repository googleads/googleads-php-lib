...
class MobileDeviceSubmodelTargeting
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202308\Technology[] $targetedMobileDeviceSubmodels
     */
    protected $targetedMobileDeviceSubmodels = null;

    /**
     * @var \Google\AdsApi\AdManager\v202308\Technology[] $excludedMobileDeviceSubmodels
     */
    protected $excludedMobileDeviceSubmodels = null;

    /**
     * @param \Google\AdsApi\AdManager\v202308\Technology[] $targetedMobileDeviceSubmodels
     * @param \Google\AdsApi\AdManager\v202308\Technology[] $excludedMobileDeviceSubmodels
     */
    ...
    /**
     * @param \Google\AdsApi\AdManager\v202308\Technology[]|null $targetedMobileDeviceSubmodels
    ...
    /**
     * @param \Google\AdsApi\AdManager\v202308\Technology[]|null $excludedMobileDeviceSubmodels
     * @return \Google\AdsApi\AdManager\v202308\MobileDeviceSubmodelTargeting
     */
