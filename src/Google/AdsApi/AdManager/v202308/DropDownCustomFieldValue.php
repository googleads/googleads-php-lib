 ...
 */
class DropDownCustomFieldValue extends \Google\AdsApi\AdManager\v202308\BaseCustomFieldValue
{
    ...
    /**
     * @param int $customFieldOptionId
     * @return \Google\AdsApi\AdManager\v202308\DropDownCustomFieldValue
     */
