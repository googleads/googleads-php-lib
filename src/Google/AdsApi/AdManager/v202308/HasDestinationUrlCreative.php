 ...
 */
abstract class HasDestinationUrlCreative extends \Google\AdsApi\AdManager\v202308\Creative
{
    ...
    /**
     * @param string $destinationUrl
     * @return \Google\AdsApi\AdManager\v202308\HasDestinationUrlCreative
     */
