 ...
 */
class RichMediaStudioCreative extends \Google\AdsApi\AdManager\v202308\BaseRichMediaStudioCreative
{
    ...
    /**
     * @param string $lockedOrientation
     * @return \Google\AdsApi\AdManager\v202308\RichMediaStudioCreative
     */
