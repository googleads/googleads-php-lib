...
class HlsSettings
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202511\MasterPlaylistSettings $masterPlaylistSettings
     */
    protected $masterPlaylistSettings = null;

    /**
     * @param string $playlistType
     * @param \Google\AdsApi\AdManager\v202511\MasterPlaylistSettings $masterPlaylistSettings
     */
    ...
    /**
     * @return \Google\AdsApi\AdManager\v202511\MasterPlaylistSettings
     */
