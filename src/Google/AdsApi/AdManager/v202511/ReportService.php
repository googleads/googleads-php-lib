...
class ReportService extends \Google\AdsApi\Common\AdsSoapClient
{
    ...
    private static $classmap = array (
      ...
      'ReportDownloadOptions' => 'Google\\AdsApi\\AdManager\\v202511\\ReportDownloadOptions',
      'ReportError' => 'Google\\AdsApi\\AdManager\\v202511\\ReportError',
      'ReportJob' => 'Google\\AdsApi\\AdManager\\v202511\\ReportJob',
      'ReportQuery' => 'Google\\AdsApi\\AdManager\\v202511\\ReportQuery',
      ...
      'SavedQuery' => 'Google\\AdsApi\\AdManager\\v202511\\SavedQuery',
      'SavedQueryPage' => 'Google\\AdsApi\\AdManager\\v202511\\SavedQueryPage',
      ...
      'getReportDownloadURLResponse' => 'Google\\AdsApi\\AdManager\\v202511\\getReportDownloadURLResponse',
      'getReportDownloadUrlWithOptionsResponse' => 'Google\\AdsApi\\AdManager\\v202511\\getReportDownloadUrlWithOptionsResponse',
      'getReportJobStatusResponse' => 'Google\\AdsApi\\AdManager\\v202511\\getReportJobStatusResponse',
      'getSavedQueriesByStatementResponse' => 'Google\\AdsApi\\AdManager\\v202511\\getSavedQueriesByStatementResponse',
      'runReportJobResponse' => 'Google\\AdsApi\\AdManager\\v202511\\runReportJobResponse',
    );
     ...
     * @param \Google\AdsApi\AdManager\v202511\ExportFormat $exportFormat Constant: string - Valid values: TSV, TSV_EXCEL, CSV_DUMP, XML, XLSX
     * @return string
     ...
     *
     * @param int $reportJobId
     * @param \Google\AdsApi\AdManager\v202511\ReportDownloadOptions $reportDownloadOptions
     * @return string
     * @throws \Google\AdsApi\AdManager\v202511\ApiException
     */
    public function getReportDownloadUrlWithOptions($reportJobId, \Google\AdsApi\AdManager\v202511\ReportDownloadOptions $reportDownloadOptions)
    {
     ...
     * @return \Google\AdsApi\AdManager\v202511\SavedQueryPage
     * @throws \Google\AdsApi\AdManager\v202511\ApiException
     */
    public function getSavedQueriesByStatement(\Google\AdsApi\AdManager\v202511\Statement $filterStatement)
    {
     ...
     * </ul>
     *
     * @param \Google\AdsApi\AdManager\v202511\ReportJob $reportJob
     * @return \Google\AdsApi\AdManager\v202511\ReportJob
     * @throws \Google\AdsApi\AdManager\v202511\ApiException
     */
    public function runReportJob(\Google\AdsApi\AdManager\v202511\ReportJob $reportJob)
    {
