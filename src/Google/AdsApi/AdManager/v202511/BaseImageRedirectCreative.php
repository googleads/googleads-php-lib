 ...
 */
abstract class BaseImageRedirectCreative extends \Google\AdsApi\AdManager\v202511\HasDestinationUrlCreative
{
    ...
    /**
     * @param string $imageUrl
     * @return \Google\AdsApi\AdManager\v202511\BaseImageRedirectCreative
     */
