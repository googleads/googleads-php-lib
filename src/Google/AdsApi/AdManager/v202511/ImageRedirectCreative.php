 ...
 */
class ImageRedirectCreative extends \Google\AdsApi\AdManager\v202511\BaseImageRedirectCreative
{
    ...
    /**
     * @param string $altText
     * @return \Google\AdsApi\AdManager\v202511\ImageRedirectCreative
     */
