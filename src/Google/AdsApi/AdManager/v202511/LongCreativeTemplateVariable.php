 ...
 */
class LongCreativeTemplateVariable extends \Google\AdsApi\AdManager\v202511\CreativeTemplateVariable
{
    ...
    /**
     * @param int $defaultValue
     * @return \Google\AdsApi\AdManager\v202511\LongCreativeTemplateVariable
     */
