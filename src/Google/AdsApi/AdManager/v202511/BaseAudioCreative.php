 ...
 */
abstract class BaseAudioCreative extends \Google\AdsApi\AdManager\v202511\HasDestinationUrlCreative
{
    ...
    /**
     * @param int $duration
     * @return \Google\AdsApi\AdManager\v202511\BaseAudioCreative
     */
