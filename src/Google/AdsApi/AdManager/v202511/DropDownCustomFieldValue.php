 ...
 */
class DropDownCustomFieldValue extends \Google\AdsApi\AdManager\v202511\BaseCustomFieldValue
{
    ...
    /**
     * @param int $customFieldOptionId
     * @return \Google\AdsApi\AdManager\v202511\DropDownCustomFieldValue
     */
