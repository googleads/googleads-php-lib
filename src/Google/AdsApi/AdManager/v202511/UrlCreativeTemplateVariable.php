 ...
 */
class UrlCreativeTemplateVariable extends \Google\AdsApi\AdManager\v202511\CreativeTemplateVariable
{
    ...
    /**
     * @param string $defaultValue
     * @return \Google\AdsApi\AdManager\v202511\UrlCreativeTemplateVariable
     */
