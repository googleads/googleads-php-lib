...
class Content
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202511\DaiIngestError[] $hlsIngestErrors
     */
    protected $hlsIngestErrors = null;

    /**
     * @var \Google\AdsApi\AdManager\v202511\DateTime $lastHlsIngestDateTime
     */
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202511\DaiIngestError[] $dashIngestErrors
     */
    protected $dashIngestErrors = null;

    /**
     * @var \Google\AdsApi\AdManager\v202511\DateTime $lastDashIngestDateTime
     */
    protected $lastDashIngestDateTime = null;

    /**
     * @var \Google\AdsApi\AdManager\v202511\DateTime $importDateTime
     */
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202511\CmsContent[] $cmsSources
     */
     ...
     * @param \Google\AdsApi\AdManager\v202511\DaiIngestError[] $hlsIngestErrors
     * @param \Google\AdsApi\AdManager\v202511\DateTime $lastHlsIngestDateTime
     * @param string $dashIngestStatus
     * @param \Google\AdsApi\AdManager\v202511\DaiIngestError[] $dashIngestErrors
     * @param \Google\AdsApi\AdManager\v202511\DateTime $lastDashIngestDateTime
     * @param \Google\AdsApi\AdManager\v202511\DateTime $importDateTime
     * @param \Google\AdsApi\AdManager\v202511\DateTime $lastModifiedDateTime
     * @param \Google\AdsApi\AdManager\v202511\CmsContent[] $cmsSources
    ...
    /**
     * @param int $id
     * @return \Google\AdsApi\AdManager\v202511\Content
     */
    ...
    /**
     * @return \Google\AdsApi\AdManager\v202511\DaiIngestError[]
     */
    ...
    /**
     * @param \Google\AdsApi\AdManager\v202511\DaiIngestError[]|null $hlsIngestErrors
     * @return \Google\AdsApi\AdManager\v202511\Content
     */
    ...
    /**
     * @param \Google\AdsApi\AdManager\v202511\DaiIngestError[]|null $dashIngestErrors
     * @return \Google\AdsApi\AdManager\v202511\Content
     */
    ...
    /**
     * @return \Google\AdsApi\AdManager\v202511\CmsContent[]
     */
    ...
    /**
     * @param \Google\AdsApi\AdManager\v202511\CmsContent[]|null $cmsSources
     * @return \Google\AdsApi\AdManager\v202511\Content
     */
