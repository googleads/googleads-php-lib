 ...
 */
class RichMediaStudioCreative extends \Google\AdsApi\AdManager\v202511\BaseRichMediaStudioCreative
{
    ...
    /**
     * @param string $lockedOrientation
     * @return \Google\AdsApi\AdManager\v202511\RichMediaStudioCreative
     */
