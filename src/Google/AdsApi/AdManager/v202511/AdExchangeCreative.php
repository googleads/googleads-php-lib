 ...
 */
class AdExchangeCreative extends \Google\AdsApi\AdManager\v202511\HasHtmlSnippetDynamicAllocationCreative
{
    ...
    /**
     * @param boolean $isNativeEligible
     * @return \Google\AdsApi\AdManager\v202511\AdExchangeCreative
     */
