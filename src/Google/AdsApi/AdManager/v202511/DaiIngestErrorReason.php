...
class DaiIngestErrorReason
{
    ...
    const MIXED_AD_BREAK_TAGS = 'MIXED_AD_BREAK_TAGS';
    const AD_BREAK_TAGS_INCONSISTENT_ACROSS_VARIANTS = 'AD_BREAK_TAGS_INCONSISTENT_ACROSS_VARIANTS';
    const MALFORMED_SUBTITLES = 'MALFORMED_SUBTITLES';
    const SUBTITLES_TOO_LARGE = 'SUBTITLES_TOO_LARGE';
    ...
    const CUE_POINT_COUNT_DOES_NOT_MATCH_PTS_COUNT = 'CUE_POINT_COUNT_DOES_NOT_MATCH_PTS_COUNT';
    const DISCONTINUITY_COUNT_DOES_NOT_MATCH_PTS_COUNT = 'DISCONTINUITY_COUNT_DOES_NOT_MATCH_PTS_COUNT';
    const DASH_CUE_POINT_EVENT_MISMATCH = 'DASH_CUE_POINT_EVENT_MISMATCH';
    const DASH_MANIFEST_CONDITIONING_FAILED = 'DASH_MANIFEST_CONDITIONING_FAILED';
    const DASH_MANIFEST_CONDITIONING_SEGMENT_BOUNDARY_ERROR = 'DASH_MANIFEST_CONDITIONING_SEGMENT_BOUNDARY_ERROR';
    const CLOSED_CAPTION_LANGUAGE_VALUE_INVALID = 'CLOSED_CAPTION_LANGUAGE_VALUE_INVALID';
    const CLOSED_CAPTION_NAME_VALUE_INVALID = 'CLOSED_CAPTION_NAME_VALUE_INVALID';
    const CLOSED_CAPTION_CHARACTERISTICS_VALUE_UNEXPECTED = 'CLOSED_CAPTION_CHARACTERISTICS_VALUE_UNEXPECTED';
    const CLOSED_CAPTIONS_WITH_DUPLICATE_KEYS = 'CLOSED_CAPTIONS_WITH_DUPLICATE_KEYS';
    const SUBTITLES_PRESENT_IN_FEED_AND_MANIFEST = 'SUBTITLES_PRESENT_IN_FEED_AND_MANIFEST';
    const INVALID_MEDIA_PROFILE = 'INVALID_MEDIA_PROFILE';
    const CHAPTER_PTS_MISMATCH = 'CHAPTER_PTS_MISMATCH';
    const CHAPTER_RENDITION_ERROR = 'CHAPTER_RENDITION_ERROR';
