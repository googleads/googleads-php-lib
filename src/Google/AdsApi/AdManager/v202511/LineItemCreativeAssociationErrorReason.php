...
class LineItemCreativeAssociationErrorReason
{
    ...
    const CREATIVE_SKIPPABILITY_MISMATCH_WITH_LINE_ITEM = 'CREATIVE_SKIPPABILITY_MISMATCH_WITH_LINE_ITEM';
    const CREATIVE_BUYER_PLACEMENT_ID_REQUIRED = 'CREATIVE_BUYER_PLACEMENT_ID_REQUIRED';
