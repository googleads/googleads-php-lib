 ...
 */
class AudienceSegmentCriteria extends \Google\AdsApi\AdManager\v202511\CustomCriteriaLeaf
{
    ...
    /**
     * @param string $operator
     * @return \Google\AdsApi\AdManager\v202511\AudienceSegmentCriteria
     */
