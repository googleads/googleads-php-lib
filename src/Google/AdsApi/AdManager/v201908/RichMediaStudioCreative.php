 ...
 */
class RichMediaStudioCreative extends \Google\AdsApi\AdManager\v201908\BaseRichMediaStudioCreative
{
    ...
    /**
     * @param string $lockedOrientation
     * @return \Google\AdsApi\AdManager\v201908\RichMediaStudioCreative
     */
