 ...
 */
abstract class HasDestinationUrlCreative extends \Google\AdsApi\AdManager\v201908\Creative
{
    ...
    /**
     * @param string $destinationUrl
     * @return \Google\AdsApi\AdManager\v201908\HasDestinationUrlCreative
     */
