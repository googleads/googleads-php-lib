 ...
 */
abstract class BaseImageRedirectCreative extends \Google\AdsApi\AdManager\v201908\HasDestinationUrlCreative
{
    ...
    /**
     * @param string $imageUrl
     * @return \Google\AdsApi\AdManager\v201908\BaseImageRedirectCreative
     */
