...
class OperatingSystemVersionTargeting
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v201908\Technology[] $targetedOperatingSystemVersions
     */
    protected $targetedOperatingSystemVersions = null;

    /**
     * @var \Google\AdsApi\AdManager\v201908\Technology[] $excludedOperatingSystemVersions
     */
    protected $excludedOperatingSystemVersions = null;

    /**
     * @param \Google\AdsApi\AdManager\v201908\Technology[] $targetedOperatingSystemVersions
     * @param \Google\AdsApi\AdManager\v201908\Technology[] $excludedOperatingSystemVersions
     */
    ...
    /**
     * @param \Google\AdsApi\AdManager\v201908\Technology[]|null $targetedOperatingSystemVersions
    ...
    /**
     * @param \Google\AdsApi\AdManager\v201908\Technology[]|null $excludedOperatingSystemVersions
     * @return \Google\AdsApi\AdManager\v201908\OperatingSystemVersionTargeting
     */
