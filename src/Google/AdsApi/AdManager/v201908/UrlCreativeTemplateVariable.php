 ...
 */
class UrlCreativeTemplateVariable extends \Google\AdsApi\AdManager\v201908\CreativeTemplateVariable
{
    ...
    /**
     * @param string $defaultValue
     * @return \Google\AdsApi\AdManager\v201908\UrlCreativeTemplateVariable
     */
