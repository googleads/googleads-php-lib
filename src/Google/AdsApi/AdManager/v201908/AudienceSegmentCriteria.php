 ...
 */
class AudienceSegmentCriteria extends \Google\AdsApi\AdManager\v201908\CustomCriteriaLeaf
{
    ...
    /**
     * @param string $operator
     * @return \Google\AdsApi\AdManager\v201908\AudienceSegmentCriteria
     */
