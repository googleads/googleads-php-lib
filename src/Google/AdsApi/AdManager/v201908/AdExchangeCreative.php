 ...
 */
class AdExchangeCreative extends \Google\AdsApi\AdManager\v201908\HasHtmlSnippetDynamicAllocationCreative
{
    ...
    /**
     * @param boolean $isNativeEligible
     * @return \Google\AdsApi\AdManager\v201908\AdExchangeCreative
     */
