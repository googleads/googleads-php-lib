 ...
 */
class DropDownCustomFieldValue extends \Google\AdsApi\AdManager\v201908\BaseCustomFieldValue
{
    ...
    /**
     * @param int $customFieldOptionId
     * @return \Google\AdsApi\AdManager\v201908\DropDownCustomFieldValue
     */
