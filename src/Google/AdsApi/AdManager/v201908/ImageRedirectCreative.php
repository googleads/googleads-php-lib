 ...
 */
class ImageRedirectCreative extends \Google\AdsApi\AdManager\v201908\BaseImageRedirectCreative
{
    ...
    /**
     * @param string $altText
     * @return \Google\AdsApi\AdManager\v201908\ImageRedirectCreative
     */
