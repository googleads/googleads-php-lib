 ...
 */
abstract class BaseVideoCreative extends \Google\AdsApi\AdManager\v201908\HasDestinationUrlCreative
{
    ...
    /**
     * @param int $duration
     * @return \Google\AdsApi\AdManager\v201908\BaseVideoCreative
     */
