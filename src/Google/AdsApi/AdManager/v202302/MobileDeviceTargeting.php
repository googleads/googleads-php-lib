...
class MobileDeviceTargeting
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202302\Technology[] $targetedMobileDevices
     */
    protected $targetedMobileDevices = null;

    /**
     * @var \Google\AdsApi\AdManager\v202302\Technology[] $excludedMobileDevices
     */
    protected $excludedMobileDevices = null;

    /**
     * @param \Google\AdsApi\AdManager\v202302\Technology[] $targetedMobileDevices
     * @param \Google\AdsApi\AdManager\v202302\Technology[] $excludedMobileDevices
     */
    ...
    /**
     * @param \Google\AdsApi\AdManager\v202302\Technology[]|null $targetedMobileDevices
    ...
    /**
     * @param \Google\AdsApi\AdManager\v202302\Technology[]|null $excludedMobileDevices
     * @return \Google\AdsApi\AdManager\v202302\MobileDeviceTargeting
     */
