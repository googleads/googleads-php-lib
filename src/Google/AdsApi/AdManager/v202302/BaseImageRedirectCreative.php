 ...
 */
abstract class BaseImageRedirectCreative extends \Google\AdsApi\AdManager\v202302\HasDestinationUrlCreative
{
    ...
    /**
     * @param string $imageUrl
     * @return \Google\AdsApi\AdManager\v202302\BaseImageRedirectCreative
     */
