 ...
 */
class DropDownCustomFieldValue extends \Google\AdsApi\AdManager\v202302\BaseCustomFieldValue
{
    ...
    /**
     * @param int $customFieldOptionId
     * @return \Google\AdsApi\AdManager\v202302\DropDownCustomFieldValue
     */
