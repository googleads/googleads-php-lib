...
class DeviceCapabilityTargeting
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202302\Technology[] $targetedDeviceCapabilities
     */
    protected $targetedDeviceCapabilities = null;

    /**
     * @var \Google\AdsApi\AdManager\v202302\Technology[] $excludedDeviceCapabilities
     */
    protected $excludedDeviceCapabilities = null;

    /**
     * @param \Google\AdsApi\AdManager\v202302\Technology[] $targetedDeviceCapabilities
     * @param \Google\AdsApi\AdManager\v202302\Technology[] $excludedDeviceCapabilities
     */
    ...
    /**
     * @param \Google\AdsApi\AdManager\v202302\Technology[]|null $targetedDeviceCapabilities
    ...
    /**
     * @param \Google\AdsApi\AdManager\v202302\Technology[]|null $excludedDeviceCapabilities
     * @return \Google\AdsApi\AdManager\v202302\DeviceCapabilityTargeting
     */
