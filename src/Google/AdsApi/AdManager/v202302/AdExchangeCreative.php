 ...
 */
class AdExchangeCreative extends \Google\AdsApi\AdManager\v202302\HasHtmlSnippetDynamicAllocationCreative
{
    ...
    /**
     * @param boolean $isNativeEligible
     * @return \Google\AdsApi\AdManager\v202302\AdExchangeCreative
     */
