 ...
 */
abstract class HasDestinationUrlCreative extends \Google\AdsApi\AdManager\v202302\Creative
{
    ...
    /**
     * @param string $destinationUrl
     * @return \Google\AdsApi\AdManager\v202302\HasDestinationUrlCreative
     */
