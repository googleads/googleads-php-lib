 ...
 */
class RichMediaStudioCreative extends \Google\AdsApi\AdManager\v202202\BaseRichMediaStudioCreative
{
    ...
    /**
     * @param string $lockedOrientation
     * @return \Google\AdsApi\AdManager\v202202\RichMediaStudioCreative
     */
