 ...
 */
class AdExchangeCreative extends \Google\AdsApi\AdManager\v202202\HasHtmlSnippetDynamicAllocationCreative
{
    ...
    /**
     * @param boolean $isNativeEligible
     * @return \Google\AdsApi\AdManager\v202202\AdExchangeCreative
     */
