 ...
 */
class RequestPlatformTargetingError extends \Google\AdsApi\AdManager\v202202\ApiError
{
    ...
    /**
     * @param string $reason
     * @return \Google\AdsApi\AdManager\v202202\RequestPlatformTargetingError
     */
