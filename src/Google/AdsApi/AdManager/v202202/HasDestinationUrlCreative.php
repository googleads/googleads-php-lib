 ...
 */
abstract class HasDestinationUrlCreative extends \Google\AdsApi\AdManager\v202202\Creative
{
    ...
    /**
     * @param string $destinationUrl
     * @return \Google\AdsApi\AdManager\v202202\HasDestinationUrlCreative
     */
