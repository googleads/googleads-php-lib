...
class MobileDeviceSubmodelTargeting
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202202\Technology[] $targetedMobileDeviceSubmodels
     */
    protected $targetedMobileDeviceSubmodels = null;

    /**
     * @var \Google\AdsApi\AdManager\v202202\Technology[] $excludedMobileDeviceSubmodels
     */
    protected $excludedMobileDeviceSubmodels = null;

    /**
     * @param \Google\AdsApi\AdManager\v202202\Technology[] $targetedMobileDeviceSubmodels
     * @param \Google\AdsApi\AdManager\v202202\Technology[] $excludedMobileDeviceSubmodels
     */
    ...
    /**
     * @param \Google\AdsApi\AdManager\v202202\Technology[]|null $targetedMobileDeviceSubmodels
    ...
    /**
     * @param \Google\AdsApi\AdManager\v202202\Technology[]|null $excludedMobileDeviceSubmodels
     * @return \Google\AdsApi\AdManager\v202202\MobileDeviceSubmodelTargeting
     */
