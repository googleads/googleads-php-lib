...
class Content
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v201802\DaiIngestError[] $hlsIngestErrors
     */
    protected $hlsIngestErrors = null;

    /**
     * @var \Google\AdsApi\AdManager\v201802\DateTime $lastHlsIngestDateTime
     */
    ...
    /**
     * @var \Google\AdsApi\AdManager\v201802\DaiIngestError[] $dashIngestErrors
     */
    protected $dashIngestErrors = null;

    /**
     * @var \Google\AdsApi\AdManager\v201802\DateTime $lastDashIngestDateTime
     */
    protected $lastDashIngestDateTime = null;

    /**
     * @var \Google\AdsApi\AdManager\v201802\DateTime $importDateTime
     */
    ...
    /**
     * @var \Google\AdsApi\AdManager\v201802\CmsContent[] $cmsSources
     */
     ...
     * @param \Google\AdsApi\AdManager\v201802\DaiIngestError[] $hlsIngestErrors
     * @param \Google\AdsApi\AdManager\v201802\DateTime $lastHlsIngestDateTime
     * @param string $dashIngestStatus
     * @param \Google\AdsApi\AdManager\v201802\DaiIngestError[] $dashIngestErrors
     * @param \Google\AdsApi\AdManager\v201802\DateTime $lastDashIngestDateTime
     * @param \Google\AdsApi\AdManager\v201802\DateTime $importDateTime
     ...
     * @param \Google\AdsApi\AdManager\v201802\CmsContent[] $cmsSources
     */
    ...
    /**
     * @param int $id
     * @return \Google\AdsApi\AdManager\v201802\Content
     */
    ...
    /**
     * @return \Google\AdsApi\AdManager\v201802\CmsContent[]
     */
