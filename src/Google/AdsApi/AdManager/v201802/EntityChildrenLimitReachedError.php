 ...
 */
class EntityChildrenLimitReachedError extends \Google\AdsApi\AdManager\v201802\ApiError
{
    ...
    /**
     * @param string $reason
     * @return \Google\AdsApi\AdManager\v201802\EntityChildrenLimitReachedError
     */
