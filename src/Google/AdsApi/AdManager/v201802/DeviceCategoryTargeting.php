...
class DeviceCategoryTargeting
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v201802\Technology[] $targetedDeviceCategories
     */
    protected $targetedDeviceCategories = null;

    /**
     * @var \Google\AdsApi\AdManager\v201802\Technology[] $excludedDeviceCategories
     */
    protected $excludedDeviceCategories = null;

    /**
     * @param \Google\AdsApi\AdManager\v201802\Technology[] $targetedDeviceCategories
     * @param \Google\AdsApi\AdManager\v201802\Technology[] $excludedDeviceCategories
     */
