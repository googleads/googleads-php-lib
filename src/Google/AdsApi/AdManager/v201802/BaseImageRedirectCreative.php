 ...
 */
abstract class BaseImageRedirectCreative extends \Google\AdsApi\AdManager\v201802\HasDestinationUrlCreative
{
    ...
    /**
     * @param string $imageUrl
     * @return \Google\AdsApi\AdManager\v201802\BaseImageRedirectCreative
     */
