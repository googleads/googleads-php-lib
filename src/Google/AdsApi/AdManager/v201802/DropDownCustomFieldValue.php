 ...
 */
class DropDownCustomFieldValue extends \Google\AdsApi\AdManager\v201802\BaseCustomFieldValue
{
    ...
    /**
     * @param int $customFieldOptionId
     * @return \Google\AdsApi\AdManager\v201802\DropDownCustomFieldValue
     */
