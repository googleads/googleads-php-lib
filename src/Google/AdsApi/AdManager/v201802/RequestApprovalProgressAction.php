 ...
 */
class RequestApprovalProgressAction extends \Google\AdsApi\AdManager\v201802\ProgressAction
{
    ...
    /**
     * @param int $approverId
     * @return \Google\AdsApi\AdManager\v201802\RequestApprovalProgressAction
     */
