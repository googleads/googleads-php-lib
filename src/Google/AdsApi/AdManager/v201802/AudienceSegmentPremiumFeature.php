 ...
 */
class AudienceSegmentPremiumFeature extends \Google\AdsApi\AdManager\v201802\PremiumFeature
{
    ...
    /**
     * @param int $audienceSegmentId
     * @return \Google\AdsApi\AdManager\v201802\AudienceSegmentPremiumFeature
     */
