 ...
 */
class AudienceSegmentCriteria extends \Google\AdsApi\AdManager\v201802\CustomCriteriaLeaf
{
    ...
    /**
     * @param string $operator
     * @return \Google\AdsApi\AdManager\v201802\AudienceSegmentCriteria
     */
