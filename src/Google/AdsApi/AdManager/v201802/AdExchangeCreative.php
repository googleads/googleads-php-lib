 ...
 */
class AdExchangeCreative extends \Google\AdsApi\AdManager\v201802\HasHtmlSnippetDynamicAllocationCreative
{
    ...
    /**
     * @param boolean $isNativeEligible
     * @return \Google\AdsApi\AdManager\v201802\AdExchangeCreative
     */
