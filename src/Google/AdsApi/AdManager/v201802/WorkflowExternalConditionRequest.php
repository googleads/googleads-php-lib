 ...
 */
class WorkflowExternalConditionRequest extends \Google\AdsApi\AdManager\v201802\WorkflowRequest
{
    ...
    /**
     * @param string $status
     * @return \Google\AdsApi\AdManager\v201802\WorkflowExternalConditionRequest
     */
