 ...
 */
class DropDownCustomFieldValue extends \Google\AdsApi\AdManager\v202402\BaseCustomFieldValue
{
    ...
    /**
     * @param int $customFieldOptionId
     * @return \Google\AdsApi\AdManager\v202402\DropDownCustomFieldValue
     */
