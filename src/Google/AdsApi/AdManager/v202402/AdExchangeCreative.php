 ...
 */
class AdExchangeCreative extends \Google\AdsApi\AdManager\v202402\HasHtmlSnippetDynamicAllocationCreative
{
    ...
    /**
     * @param boolean $isNativeEligible
     * @return \Google\AdsApi\AdManager\v202402\AdExchangeCreative
     */
