...
class SegmentPopulationResponse
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202402\IdError[] $idErrors
     */
    protected $idErrors = null;

    /**
     * @param int $batchUploadId
     * @param \Google\AdsApi\AdManager\v202402\IdError[] $idErrors
     */
    ...
    /**
     * @return \Google\AdsApi\AdManager\v202402\IdError[]
     */
    ...
    /**
     * @param \Google\AdsApi\AdManager\v202402\IdError[]|null $idErrors
     * @return \Google\AdsApi\AdManager\v202402\SegmentPopulationResponse
     */
