 ...
 */
class ImageRedirectCreative extends \Google\AdsApi\AdManager\v202402\BaseImageRedirectCreative
{
    ...
    /**
     * @param string $altText
     * @return \Google\AdsApi\AdManager\v202402\ImageRedirectCreative
     */
