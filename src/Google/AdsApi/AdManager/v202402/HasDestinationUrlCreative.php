 ...
 */
abstract class HasDestinationUrlCreative extends \Google\AdsApi\AdManager\v202402\Creative
{
    ...
    /**
     * @param string $destinationUrl
     * @return \Google\AdsApi\AdManager\v202402\HasDestinationUrlCreative
     */
