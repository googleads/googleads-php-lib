...
class InventoryUrlTargeting
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202402\InventoryUrl[] $targetedUrls
     */
    protected $targetedUrls = null;

    /**
     * @var \Google\AdsApi\AdManager\v202402\InventoryUrl[] $excludedUrls
     */
    protected $excludedUrls = null;

    /**
     * @param \Google\AdsApi\AdManager\v202402\InventoryUrl[] $targetedUrls
     * @param \Google\AdsApi\AdManager\v202402\InventoryUrl[] $excludedUrls
     */
    ...
    /**
     * @param \Google\AdsApi\AdManager\v202402\InventoryUrl[]|null $targetedUrls
    ...
    /**
     * @param \Google\AdsApi\AdManager\v202402\InventoryUrl[]|null $excludedUrls
     * @return \Google\AdsApi\AdManager\v202402\InventoryUrlTargeting
     */
