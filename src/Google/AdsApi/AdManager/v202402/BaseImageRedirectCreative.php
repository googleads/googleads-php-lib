 ...
 */
abstract class BaseImageRedirectCreative extends \Google\AdsApi\AdManager\v202402\HasDestinationUrlCreative
{
    ...
    /**
     * @param string $imageUrl
     * @return \Google\AdsApi\AdManager\v202402\BaseImageRedirectCreative
     */
