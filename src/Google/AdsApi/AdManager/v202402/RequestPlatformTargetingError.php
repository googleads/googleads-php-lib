 ...
 */
class RequestPlatformTargetingError extends \Google\AdsApi\AdManager\v202402\ApiError
{
    ...
    /**
     * @param string $reason
     * @return \Google\AdsApi\AdManager\v202402\RequestPlatformTargetingError
     */
