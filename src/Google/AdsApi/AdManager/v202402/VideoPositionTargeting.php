...
class VideoPositionTargeting
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202402\VideoPositionTarget[] $targetedPositions
     */
    protected $targetedPositions = null;

    /**
     * @param \Google\AdsApi\AdManager\v202402\VideoPositionTarget[] $targetedPositions
     */
    ...
    /**
     * @param \Google\AdsApi\AdManager\v202402\VideoPositionTarget[]|null $targetedPositions
