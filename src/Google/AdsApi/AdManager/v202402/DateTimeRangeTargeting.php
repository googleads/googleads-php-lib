...
class DateTimeRangeTargeting
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202402\DateTimeRange[] $targetedDateTimeRanges
     */
    protected $targetedDateTimeRanges = null;

    /**
     * @param \Google\AdsApi\AdManager\v202402\DateTimeRange[] $targetedDateTimeRanges
     */
    ...
    /**
     * @param \Google\AdsApi\AdManager\v202402\DateTimeRange[]|null $targetedDateTimeRanges
