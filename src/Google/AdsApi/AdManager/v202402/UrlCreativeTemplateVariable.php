 ...
 */
class UrlCreativeTemplateVariable extends \Google\AdsApi\AdManager\v202402\CreativeTemplateVariable
{
    ...
    /**
     * @param string $defaultValue
     * @return \Google\AdsApi\AdManager\v202402\UrlCreativeTemplateVariable
     */
