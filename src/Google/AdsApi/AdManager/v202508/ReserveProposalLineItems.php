 ...
 */
class ReserveProposalLineItems extends \Google\AdsApi\AdManager\v202508\ProposalLineItemAction
{
    ...
    /**
     * @param boolean $allowOverbook
     * @return \Google\AdsApi\AdManager\v202508\ReserveProposalLineItems
     */
