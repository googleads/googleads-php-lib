 ...
 */
class RichMediaStudioCreative extends \Google\AdsApi\AdManager\v202508\BaseRichMediaStudioCreative
{
    ...
    /**
     * @param string $lockedOrientation
     * @return \Google\AdsApi\AdManager\v202508\RichMediaStudioCreative
     */
