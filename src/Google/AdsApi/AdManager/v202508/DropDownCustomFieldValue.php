 ...
 */
class DropDownCustomFieldValue extends \Google\AdsApi\AdManager\v202508\BaseCustomFieldValue
{
    ...
    /**
     * @param int $customFieldOptionId
     * @return \Google\AdsApi\AdManager\v202508\DropDownCustomFieldValue
     */
