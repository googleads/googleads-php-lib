 ...
 */
class CreativeTemplateOperationError extends \Google\AdsApi\AdManager\v202508\ApiError
{
    ...
    /**
     * @param string $reason
     * @return \Google\AdsApi\AdManager\v202508\CreativeTemplateOperationError
     */
