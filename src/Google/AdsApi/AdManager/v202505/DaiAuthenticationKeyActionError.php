 ...
 */
class DaiAuthenticationKeyActionError extends \Google\AdsApi\AdManager\v202505\ApiError
{
    ...
    /**
     * @param string $reason
     * @return \Google\AdsApi\AdManager\v202505\DaiAuthenticationKeyActionError
     */
