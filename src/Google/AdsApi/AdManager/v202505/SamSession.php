...
class SamSession
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202505\StreamCreateRequest $streamCreateRequest
     */
    protected $streamCreateRequest = null;

    /**
     * @var \Google\AdsApi\AdManager\v202505\AdBreak[] $adBreaks
     */
     ...
     * @param \Google\AdsApi\AdManager\v202505\StreamCreateRequest $streamCreateRequest
     * @param \Google\AdsApi\AdManager\v202505\AdBreak[] $adBreaks
    ...
    /**
     * @return \Google\AdsApi\AdManager\v202505\StreamCreateRequest
     */
