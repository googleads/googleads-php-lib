...
class InventorySizeTargeting
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202505\TargetedSize[] $targetedSizes
     */
    protected $targetedSizes = null;

    /**
     * @param boolean $isTargeted
     * @param \Google\AdsApi\AdManager\v202505\TargetedSize[] $targetedSizes
     */
    ...
    /**
     * @return \Google\AdsApi\AdManager\v202505\TargetedSize[]
     */
    ...
    /**
     * @param \Google\AdsApi\AdManager\v202505\TargetedSize[]|null $targetedSizes
     * @return \Google\AdsApi\AdManager\v202505\InventorySizeTargeting
     */
