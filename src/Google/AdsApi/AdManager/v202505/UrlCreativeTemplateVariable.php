 ...
 */
class UrlCreativeTemplateVariable extends \Google\AdsApi\AdManager\v202505\CreativeTemplateVariable
{
    ...
    /**
     * @param string $defaultValue
     * @return \Google\AdsApi\AdManager\v202505\UrlCreativeTemplateVariable
     */
