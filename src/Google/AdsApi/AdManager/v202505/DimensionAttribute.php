...
class DimensionAttribute
{
    ...
    const LINE_ITEM_AVERAGE_NUMBER_OF_VIEWERS = 'LINE_ITEM_AVERAGE_NUMBER_OF_VIEWERS';
    ...
    const LINE_ITEM_COMPUTED_STATUS = 'LINE_ITEM_COMPUTED_STATUS';
    ...
    const CHILD_PARTNER_NAME = 'CHILD_PARTNER_NAME';
