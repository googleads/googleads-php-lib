 ...
 */
abstract class BaseVideoCreative extends \Google\AdsApi\AdManager\v202505\HasDestinationUrlCreative
{
    ...
    /**
     * @param int $duration
     * @return \Google\AdsApi\AdManager\v202505\BaseVideoCreative
     */
