...
class DeviceCategoryTargeting
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202505\Technology[] $targetedDeviceCategories
     */
    protected $targetedDeviceCategories = null;

    /**
     * @var \Google\AdsApi\AdManager\v202505\Technology[] $excludedDeviceCategories
     */
    protected $excludedDeviceCategories = null;

    /**
     * @param \Google\AdsApi\AdManager\v202505\Technology[] $targetedDeviceCategories
     * @param \Google\AdsApi\AdManager\v202505\Technology[] $excludedDeviceCategories
     */
    ...
    /**
     * @param \Google\AdsApi\AdManager\v202505\Technology[]|null $targetedDeviceCategories
