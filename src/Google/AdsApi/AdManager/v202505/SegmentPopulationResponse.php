...
class SegmentPopulationResponse
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202505\IdError[] $idErrors
     */
    protected $idErrors = null;

    /**
     * @param int $batchUploadId
     * @param \Google\AdsApi\AdManager\v202505\IdError[] $idErrors
     */
    ...
    /**
     * @return \Google\AdsApi\AdManager\v202505\IdError[]
     */
    ...
    /**
     * @param \Google\AdsApi\AdManager\v202505\IdError[]|null $idErrors
     * @return \Google\AdsApi\AdManager\v202505\SegmentPopulationResponse
     */
