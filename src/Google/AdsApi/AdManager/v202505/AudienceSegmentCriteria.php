 ...
 */
class AudienceSegmentCriteria extends \Google\AdsApi\AdManager\v202505\CustomCriteriaLeaf
{
    ...
    /**
     * @param string $operator
     * @return \Google\AdsApi\AdManager\v202505\AudienceSegmentCriteria
     */
