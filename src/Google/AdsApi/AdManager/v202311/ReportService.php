...
class ReportService extends \Google\AdsApi\Common\AdsSoapClient
{
    ...
    private static $classmap = array (
      ...
      'ReportDownloadOptions' => 'Google\\AdsApi\\AdManager\\v202311\\ReportDownloadOptions',
      'ReportError' => 'Google\\AdsApi\\AdManager\\v202311\\ReportError',
      'ReportJob' => 'Google\\AdsApi\\AdManager\\v202311\\ReportJob',
      'ReportQuery' => 'Google\\AdsApi\\AdManager\\v202311\\ReportQuery',
      ...
      'SavedQuery' => 'Google\\AdsApi\\AdManager\\v202311\\SavedQuery',
      'SavedQueryPage' => 'Google\\AdsApi\\AdManager\\v202311\\SavedQueryPage',
      ...
      'getReportDownloadURLResponse' => 'Google\\AdsApi\\AdManager\\v202311\\getReportDownloadURLResponse',
      'getReportDownloadUrlWithOptionsResponse' => 'Google\\AdsApi\\AdManager\\v202311\\getReportDownloadUrlWithOptionsResponse',
      'getReportJobStatusResponse' => 'Google\\AdsApi\\AdManager\\v202311\\getReportJobStatusResponse',
      'getSavedQueriesByStatementResponse' => 'Google\\AdsApi\\AdManager\\v202311\\getSavedQueriesByStatementResponse',
      'runReportJobResponse' => 'Google\\AdsApi\\AdManager\\v202311\\runReportJobResponse',
    );
    ...
    public function __construct(array $options = array(),
                $wsdl = 'https://ads.google.com/apis/ads/publisher/v202311/ReportService?wsdl')
    {
     ...
     * @param \Google\AdsApi\AdManager\v202311\ExportFormat $exportFormat Constant: string - Valid values: TSV, TSV_EXCEL, CSV_DUMP, XML, XLSX
     * @return string
     ...
     *
     * @param int $reportJobId
     * @param \Google\AdsApi\AdManager\v202311\ReportDownloadOptions $reportDownloadOptions
     * @return string
     * @throws \Google\AdsApi\AdManager\v202311\ApiException
     */
    public function getReportDownloadUrlWithOptions($reportJobId, \Google\AdsApi\AdManager\v202311\ReportDownloadOptions $reportDownloadOptions)
    {
     ...
     * @throws \Google\AdsApi\AdManager\v202311\ApiException
     */
    public function getSavedQueriesByStatement(\Google\AdsApi\AdManager\v202311\Statement $filterStatement)
    {
     ...
     * </ul>
     *
     * @param \Google\AdsApi\AdManager\v202311\ReportJob $reportJob
     * @return \Google\AdsApi\AdManager\v202311\ReportJob
     * @throws \Google\AdsApi\AdManager\v202311\ApiException
     */
    public function runReportJob(\Google\AdsApi\AdManager\v202311\ReportJob $reportJob)
    {
