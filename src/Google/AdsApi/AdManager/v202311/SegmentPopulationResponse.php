...
class SegmentPopulationResponse
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202311\IdError[] $idErrors
     */
    protected $idErrors = null;

    /**
     * @param int $batchUploadId
     * @param \Google\AdsApi\AdManager\v202311\IdError[] $idErrors
     */
    ...
    /**
     * @return \Google\AdsApi\AdManager\v202311\IdError[]
     */
    ...
    /**
     * @param \Google\AdsApi\AdManager\v202311\IdError[]|null $idErrors
     * @return \Google\AdsApi\AdManager\v202311\SegmentPopulationResponse
     */
