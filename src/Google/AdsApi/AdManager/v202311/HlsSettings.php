...
class HlsSettings
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202311\MasterPlaylistSettings $masterPlaylistSettings
     */
    protected $masterPlaylistSettings = null;

    /**
     * @param string $playlistType
     * @param \Google\AdsApi\AdManager\v202311\MasterPlaylistSettings $masterPlaylistSettings
     */
    ...
    /**
     * @return \Google\AdsApi\AdManager\v202311\MasterPlaylistSettings
     */
