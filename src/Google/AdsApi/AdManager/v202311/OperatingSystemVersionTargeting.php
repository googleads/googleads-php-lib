...
class OperatingSystemVersionTargeting
{
    ...
    /**
     * @var \Google\AdsApi\AdManager\v202311\Technology[] $targetedOperatingSystemVersions
     */
    protected $targetedOperatingSystemVersions = null;

    /**
     * @var \Google\AdsApi\AdManager\v202311\Technology[] $excludedOperatingSystemVersions
     */
    protected $excludedOperatingSystemVersions = null;

    /**
     * @param \Google\AdsApi\AdManager\v202311\Technology[] $targetedOperatingSystemVersions
     * @param \Google\AdsApi\AdManager\v202311\Technology[] $excludedOperatingSystemVersions
     */
    ...
    /**
     * @return \Google\AdsApi\AdManager\v202311\Technology[]
     */
    ...
    /**
     * @param \Google\AdsApi\AdManager\v202311\Technology[]|null $targetedOperatingSystemVersions
     * @return \Google\AdsApi\AdManager\v202311\OperatingSystemVersionTargeting
     */
    ...
    /**
     * @param \Google\AdsApi\AdManager\v202311\Technology[]|null $excludedOperatingSystemVersions
     * @return \Google\AdsApi\AdManager\v202311\OperatingSystemVersionTargeting
     */
