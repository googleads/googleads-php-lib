...
final class SoapLogMessageFormatter {
  ...
  public function __construct(
    ...
    $this->additionalResponseSummaryHeaders =
        $additionalResponseSummaryHeaders === null
            ? []
            : $additionalResponseSummaryHeaders;
    $this->faultMsgMaxLength = $faultMsgMaxLength === null
        ? self::$FAULT_MSG_MAX_LEN_DEFAULT
        : $faultMsgMaxLength;
  }
  ...
  public function formatSummary($serviceName, $methodName, $requestHeaders,
    ...
    return sprintf(
        ...
        $soapFault !== null,
        $soapFault !== null
            ? $this->formatSoapFaultForSummary($soapFault->getMessage())
            : ''
    );
  }
  ...
  private function formatSoapFaultForSummary($soapFault) {
    ...
    if (mb_strlen($soapFault, 'UTF-8') > $this->faultMsgMaxLength) {
      $soapFault =
          mb_substr($soapFault, 0, $this->faultMsgMaxLength, 'UTF-8') . '...';
    };
    return $soapFault;
  }
