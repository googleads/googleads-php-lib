 ...
 */
abstract class BaseFlashRedirectCreative extends \Google\AdsApi\Dfp\v201705\HasDestinationUrlCreative
{
    ...
    /**
     * @param string $flashUrl
     * @return \Google\AdsApi\Dfp\v201705\BaseFlashRedirectCreative
     */
