 ...
 */
class StringCreativeTemplateVariable extends \Google\AdsApi\Dfp\v201705\CreativeTemplateVariable
{
    ...
    /**
     * @param string $defaultValue
     * @return \Google\AdsApi\Dfp\v201705\StringCreativeTemplateVariable
     */
