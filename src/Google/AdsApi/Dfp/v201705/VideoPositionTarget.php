...
class VideoPositionTarget
{
    ...
    /**
     * @var \Google\AdsApi\Dfp\v201705\VideoPosition $videoPosition
     */
    ...
    /**
     * @var \Google\AdsApi\Dfp\v201705\VideoPositionWithinPod $videoPositionWithinPod
     */
    protected $videoPositionWithinPod = null;

    /**
     * @param \Google\AdsApi\Dfp\v201705\VideoPosition $videoPosition
     * @param string $videoBumperType
     * @param \Google\AdsApi\Dfp\v201705\VideoPositionWithinPod $videoPositionWithinPod
     */
    ...
    /**
     * @return \Google\AdsApi\Dfp\v201705\VideoPosition
     */
