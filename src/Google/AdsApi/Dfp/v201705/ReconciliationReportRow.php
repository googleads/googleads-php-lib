...
class ReconciliationReportRow
{
    ...
    /**
     * @var \Google\AdsApi\Dfp\v201705\Money $lineItemCostPerUnit
     */
    ...
    /**
     * @var \Google\AdsApi\Dfp\v201705\Money $contractedRevenue
     */
    protected $contractedRevenue = null;

    /**
     * @var \Google\AdsApi\Dfp\v201705\Money $dfpRevenue
     */
    protected $dfpRevenue = null;

    /**
     * @var \Google\AdsApi\Dfp\v201705\Money $thirdPartyRevenue
     */
    protected $thirdPartyRevenue = null;

    /**
     * @var \Google\AdsApi\Dfp\v201705\Money $manualRevenue
     */
    protected $manualRevenue = null;

    /**
     * @var \Google\AdsApi\Dfp\v201705\Money $reconciledRevenue
     */
     ...
     * @param \Google\AdsApi\Dfp\v201705\Money $lineItemCostPerUnit
     * @param int $lineItemContractedUnitsBought
     * @param int $dfpVolume
     * @param int $thirdPartyVolume
     * @param int $manualVolume
     * @param int $reconciledVolume
     * @param \Google\AdsApi\Dfp\v201705\Money $contractedRevenue
     * @param \Google\AdsApi\Dfp\v201705\Money $dfpRevenue
     * @param \Google\AdsApi\Dfp\v201705\Money $thirdPartyRevenue
     * @param \Google\AdsApi\Dfp\v201705\Money $manualRevenue
     * @param \Google\AdsApi\Dfp\v201705\Money $reconciledRevenue
