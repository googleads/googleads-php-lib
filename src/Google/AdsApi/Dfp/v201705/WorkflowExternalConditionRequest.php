 ...
 */
class WorkflowExternalConditionRequest extends \Google\AdsApi\Dfp\v201705\WorkflowRequest
{
    ...
    /**
     * @param string $status
     * @return \Google\AdsApi\Dfp\v201705\WorkflowExternalConditionRequest
     */
