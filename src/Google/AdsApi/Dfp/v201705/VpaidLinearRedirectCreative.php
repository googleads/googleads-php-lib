 ...
 */
class VpaidLinearRedirectCreative extends \Google\AdsApi\Dfp\v201705\HasDestinationUrlCreative
{
    ...
    /**
     * @param int[] $companionCreativeIds
     * @return \Google\AdsApi\Dfp\v201705\VpaidLinearRedirectCreative
     */
