 ...
 */
class InventoryUnitPartnerAssociationError extends \Google\AdsApi\Dfp\v201608\ApiError
{
    ...
    /**
     * @param string $reason
     * @return \Google\AdsApi\Dfp\v201608\InventoryUnitPartnerAssociationError
     */
