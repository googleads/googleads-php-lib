...
class OperatingSystemVersionTargeting
{
    ...
    /**
     * @var \Google\AdsApi\Dfp\v201608\Technology[] $targetedOperatingSystemVersions
     */
    protected $targetedOperatingSystemVersions = null;

    /**
     * @var \Google\AdsApi\Dfp\v201608\Technology[] $excludedOperatingSystemVersions
     */
    protected $excludedOperatingSystemVersions = null;

    /**
     * @param \Google\AdsApi\Dfp\v201608\Technology[] $targetedOperatingSystemVersions
     * @param \Google\AdsApi\Dfp\v201608\Technology[] $excludedOperatingSystemVersions
     */
    ...
    /**
     * @return \Google\AdsApi\Dfp\v201608\Technology[]
     */
