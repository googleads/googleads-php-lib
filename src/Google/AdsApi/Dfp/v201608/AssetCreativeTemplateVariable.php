 ...
 */
class AssetCreativeTemplateVariable extends \Google\AdsApi\Dfp\v201608\CreativeTemplateVariable
{
    ...
    /**
     * @param string $mimeTypes
     * @return \Google\AdsApi\Dfp\v201608\AssetCreativeTemplateVariable
     */
