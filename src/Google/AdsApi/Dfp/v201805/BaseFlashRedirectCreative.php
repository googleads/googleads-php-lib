 ...
 */
abstract class BaseFlashRedirectCreative extends \Google\AdsApi\Dfp\v201805\HasDestinationUrlCreative
{
    ...
    /**
     * @param string $flashUrl
     * @return \Google\AdsApi\Dfp\v201805\BaseFlashRedirectCreative
     */
