 ...
 */
abstract class BaseImageRedirectCreative extends \Google\AdsApi\Dfp\v201805\HasDestinationUrlCreative
{
    ...
    /**
     * @param string $imageUrl
     * @return \Google\AdsApi\Dfp\v201805\BaseImageRedirectCreative
     */
