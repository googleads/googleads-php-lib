...
class OperatingSystemVersionTargeting
{
    ...
    /**
     * @var \Google\AdsApi\Dfp\v201805\Technology[] $targetedOperatingSystemVersions
     */
    protected $targetedOperatingSystemVersions = null;

    /**
     * @var \Google\AdsApi\Dfp\v201805\Technology[] $excludedOperatingSystemVersions
     */
    protected $excludedOperatingSystemVersions = null;

    /**
     * @param \Google\AdsApi\Dfp\v201805\Technology[] $targetedOperatingSystemVersions
     * @param \Google\AdsApi\Dfp\v201805\Technology[] $excludedOperatingSystemVersions
     */
    ...
    /**
     * @return \Google\AdsApi\Dfp\v201805\Technology[]
     */
