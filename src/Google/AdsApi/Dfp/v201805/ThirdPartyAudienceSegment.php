 ...
 */
class ThirdPartyAudienceSegment extends \Google\AdsApi\Dfp\v201805\AudienceSegment
{
    ...
    /**
     * @var \Google\AdsApi\Dfp\v201805\Money $cost
     */
    protected $cost = null;
     ...
     * @param int $adIdSize
     * @param int $ppidSize
     * @param \Google\AdsApi\Dfp\v201805\AudienceSegmentDataProvider $dataProvider
     * @param string $type
     * @param string $approvalStatus
     * @param \Google\AdsApi\Dfp\v201805\Money $cost
    ...
    /**
     * @param string $approvalStatus
     * @return \Google\AdsApi\Dfp\v201805\ThirdPartyAudienceSegment
     */
