 ...
 */
class LineItemCreativeAssociationOperationError extends \Google\AdsApi\Dfp\v201805\ApiError
{
    ...
    /**
     * @param string $reason
     * @return \Google\AdsApi\Dfp\v201805\LineItemCreativeAssociationOperationError
     */
