...
class LineItemCreativeAssociationStats
{
    ...
    /**
     * @var \Google\AdsApi\Dfp\v201602\Long_StatsMapEntry[] $creativeSetStats
     */
    protected $creativeSetStats = null;

    /**
     * @var \Google\AdsApi\Dfp\v201602\Money $costInOrderCurrency
     */
    protected $costInOrderCurrency = null;

    /**
     * @param \Google\AdsApi\Dfp\v201602\Stats $stats
     * @param \Google\AdsApi\Dfp\v201602\Long_StatsMapEntry[] $creativeSetStats
     * @param \Google\AdsApi\Dfp\v201602\Money $costInOrderCurrency
     */
