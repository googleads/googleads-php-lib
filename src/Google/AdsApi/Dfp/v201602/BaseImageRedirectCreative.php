 ...
 */
abstract class BaseImageRedirectCreative extends \Google\AdsApi\Dfp\v201602\HasDestinationUrlCreative
{
    ...
    /**
     * @param string $imageUrl
     * @return \Google\AdsApi\Dfp\v201602\BaseImageRedirectCreative
     */
