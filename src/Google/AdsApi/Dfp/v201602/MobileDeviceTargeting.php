...
class MobileDeviceTargeting
{
    ...
    /**
     * @var \Google\AdsApi\Dfp\v201602\Technology[] $targetedMobileDevices
     */
    protected $targetedMobileDevices = null;

    /**
     * @var \Google\AdsApi\Dfp\v201602\Technology[] $excludedMobileDevices
     */
    protected $excludedMobileDevices = null;

    /**
     * @param \Google\AdsApi\Dfp\v201602\Technology[] $targetedMobileDevices
     * @param \Google\AdsApi\Dfp\v201602\Technology[] $excludedMobileDevices
     */
