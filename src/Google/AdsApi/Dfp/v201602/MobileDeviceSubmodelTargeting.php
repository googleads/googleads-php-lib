...
class MobileDeviceSubmodelTargeting
{
    ...
    /**
     * @var \Google\AdsApi\Dfp\v201602\Technology[] $targetedMobileDeviceSubmodels
     */
    protected $targetedMobileDeviceSubmodels = null;

    /**
     * @var \Google\AdsApi\Dfp\v201602\Technology[] $excludedMobileDeviceSubmodels
     */
    protected $excludedMobileDeviceSubmodels = null;

    /**
     * @param \Google\AdsApi\Dfp\v201602\Technology[] $targetedMobileDeviceSubmodels
     * @param \Google\AdsApi\Dfp\v201602\Technology[] $excludedMobileDeviceSubmodels
     */
