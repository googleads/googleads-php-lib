 ...
 */
class AssetCreativeTemplateVariable extends \Google\AdsApi\Dfp\v201602\CreativeTemplateVariable
{
    ...
    /**
     * @param string $mimeTypes
     * @return \Google\AdsApi\Dfp\v201602\AssetCreativeTemplateVariable
     */
