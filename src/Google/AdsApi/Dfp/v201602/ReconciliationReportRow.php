...
class ReconciliationReportRow
{
    ...
    /**
     * @var \Google\AdsApi\Dfp\v201602\Money $lineItemCostPerUnit
     */
    ...
    /**
     * @var \Google\AdsApi\Dfp\v201602\Money $contractedRevenue
     */
    protected $contractedRevenue = null;

    /**
     * @var \Google\AdsApi\Dfp\v201602\Money $dfpRevenue
     */
    protected $dfpRevenue = null;

    /**
     * @var \Google\AdsApi\Dfp\v201602\Money $thirdPartyRevenue
     */
    protected $thirdPartyRevenue = null;

    /**
     * @var \Google\AdsApi\Dfp\v201602\Money $manualRevenue
     */
    protected $manualRevenue = null;

    /**
     * @var \Google\AdsApi\Dfp\v201602\Money $reconciledRevenue
     */
     ...
     * @param \Google\AdsApi\Dfp\v201602\Money $lineItemCostPerUnit
     * @param int $lineItemContractedUnitsBought
     * @param int $dfpVolume
     * @param int $thirdPartyVolume
     * @param int $manualVolume
     * @param int $reconciledVolume
     * @param \Google\AdsApi\Dfp\v201602\Money $contractedRevenue
     * @param \Google\AdsApi\Dfp\v201602\Money $dfpRevenue
     * @param \Google\AdsApi\Dfp\v201602\Money $thirdPartyRevenue
     * @param \Google\AdsApi\Dfp\v201602\Money $manualRevenue
     * @param \Google\AdsApi\Dfp\v201602\Money $reconciledRevenue
    ...
    /**
     * @param int $id
     * @return \Google\AdsApi\Dfp\v201602\ReconciliationReportRow
     */
