...
class ContactService extends \Google\AdsApi\Common\AdsSoapClient
{
    ...
    private static $classmap = array (
      ...
      'Contact' => 'Google\\AdsApi\\Dfp\\v201602\\Contact',
      'ContactError' => 'Google\\AdsApi\\Dfp\\v201602\\ContactError',
      'ContactPage' => 'Google\\AdsApi\\Dfp\\v201602\\ContactPage',
      'BaseContact' => 'Google\\AdsApi\\Dfp\\v201602\\BaseContact',
    ...
    public function __construct(array $options = array(),
                $wsdl = 'https://ads.google.com/apis/ads/publisher/v201602/ContactService?wsdl')
    {
     ...
     *
     * @param \Google\AdsApi\Dfp\v201602\Contact[] $contacts
     * @return \Google\AdsApi\Dfp\v201602\Contact[]
     * @throws \Google\AdsApi\Dfp\v201602\ApiException
     */
    public function createContacts(array $contacts)
    {
      return $this->__soapCall('createContacts', array(array('contacts' => $contacts)))->rval;
    }
     ...
     * @return \Google\AdsApi\Dfp\v201602\ContactPage
     * @throws \Google\AdsApi\Dfp\v201602\ApiException
     */
    public function getContactsByStatement(\Google\AdsApi\Dfp\v201602\Statement $statement)
    {
      return $this->__soapCall('getContactsByStatement', array(array('statement' => $statement)))->rval;
    }
    ...
    {
      return $this->__soapCall('updateContacts', array(array('contacts' => $contacts)))->rval;
    }
