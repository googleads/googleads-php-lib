...
class DeviceCapabilityTargeting
{
    ...
    /**
     * @var \Google\AdsApi\Dfp\v201602\Technology[] $targetedDeviceCapabilities
     */
    protected $targetedDeviceCapabilities = null;

    /**
     * @var \Google\AdsApi\Dfp\v201602\Technology[] $excludedDeviceCapabilities
     */
    protected $excludedDeviceCapabilities = null;

    /**
     * @param \Google\AdsApi\Dfp\v201602\Technology[] $targetedDeviceCapabilities
     * @param \Google\AdsApi\Dfp\v201602\Technology[] $excludedDeviceCapabilities
     */
