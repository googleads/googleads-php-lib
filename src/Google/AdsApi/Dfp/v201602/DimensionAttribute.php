...
{
    const __default = 'LINE_ITEM_LABELS';
    ...
    const PROPOSAL_PROBABILITY_TO_CLOSE = 'PROPOSAL_PROBABILITY_TO_CLOSE';
    ...
    const PROPOSAL_LINE_ITEM_TARGET_RATE_NET = 'PROPOSAL_LINE_ITEM_TARGET_RATE_NET';
