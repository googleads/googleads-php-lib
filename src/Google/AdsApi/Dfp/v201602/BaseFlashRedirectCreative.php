 ...
 */
abstract class BaseFlashRedirectCreative extends \Google\AdsApi\Dfp\v201602\HasDestinationUrlCreative
{
    ...
    /**
     * @param string $flashUrl
     * @return \Google\AdsApi\Dfp\v201602\BaseFlashRedirectCreative
     */
