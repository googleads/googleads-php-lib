 ...
 */
abstract class BaseFlashRedirectCreative extends \Google\AdsApi\Dfp\v201802\HasDestinationUrlCreative
{
    ...
    /**
     * @param string $flashUrl
     * @return \Google\AdsApi\Dfp\v201802\BaseFlashRedirectCreative
     */
