 ...
 */
class ProductPackageRateCardAssociationError extends \Google\AdsApi\Dfp\v201802\ApiError
{
    ...
    /**
     * @param string $reason
     * @return \Google\AdsApi\Dfp\v201802\ProductPackageRateCardAssociationError
     */
