 ...
 */
class WorkflowExternalConditionRequest extends \Google\AdsApi\Dfp\v201802\WorkflowRequest
{
    ...
    /**
     * @param string $status
     * @return \Google\AdsApi\Dfp\v201802\WorkflowExternalConditionRequest
     */
