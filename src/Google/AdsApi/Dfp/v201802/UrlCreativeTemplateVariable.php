 ...
 */
class UrlCreativeTemplateVariable extends \Google\AdsApi\Dfp\v201802\CreativeTemplateVariable
{
    ...
    /**
     * @param string $defaultValue
     * @return \Google\AdsApi\Dfp\v201802\UrlCreativeTemplateVariable
     */
