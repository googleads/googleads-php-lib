...
class SavedQuery
{
    ...
    /**
     * @var \Google\AdsApi\Dfp\v201802\ReportQuery $reportQuery
     */
     ...
     * @param int $id
     * @param string $name
     * @param \Google\AdsApi\Dfp\v201802\ReportQuery $reportQuery
    ...
    /**
     * @param int $id
     * @return \Google\AdsApi\Dfp\v201802\SavedQuery
     */
