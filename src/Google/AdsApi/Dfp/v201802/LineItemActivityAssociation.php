...
class LineItemActivityAssociation
{
    ...
    /**
     * @var \Google\AdsApi\Dfp\v201802\Money $clickThroughConversionCost
     */
    protected $clickThroughConversionCost = null;

    /**
     * @var \Google\AdsApi\Dfp\v201802\Money $viewThroughConversionCost
     */
    protected $viewThroughConversionCost = null;

    /**
     * @param int $activityId
     * @param \Google\AdsApi\Dfp\v201802\Money $clickThroughConversionCost
     * @param \Google\AdsApi\Dfp\v201802\Money $viewThroughConversionCost
     */
