...
class MobileDeviceTargeting
{
    ...
    /**
     * @var \Google\AdsApi\Dfp\v201702\Technology[] $targetedMobileDevices
     */
    protected $targetedMobileDevices = null;

    /**
     * @var \Google\AdsApi\Dfp\v201702\Technology[] $excludedMobileDevices
     */
    protected $excludedMobileDevices = null;

    /**
     * @param \Google\AdsApi\Dfp\v201702\Technology[] $targetedMobileDevices
     * @param \Google\AdsApi\Dfp\v201702\Technology[] $excludedMobileDevices
     */
