 ...
 */
class RuleBasedFirstPartyAudienceSegment extends \Google\AdsApi\Dfp\v201702\RuleBasedFirstPartyAudienceSegmentSummary
{

    /**
     * @var \Google\AdsApi\Dfp\v201702\FirstPartyAudienceSegmentRule $rule
     */
    protected $rule = null;
     ...
     * @param int $idfaSize
     * @param int $adIdSize
     * @param \Google\AdsApi\Dfp\v201702\AudienceSegmentDataProvider $dataProvider
     * @param string $type
     * @param int $pageViews
     * @param int $recencyDays
     * @param int $membershipExpirationDays
     * @param \Google\AdsApi\Dfp\v201702\FirstPartyAudienceSegmentRule $rule
     */
    ...
    /**
     * @param \Google\AdsApi\Dfp\v201702\FirstPartyAudienceSegmentRule $rule
     * @return \Google\AdsApi\Dfp\v201702\RuleBasedFirstPartyAudienceSegment
     */
