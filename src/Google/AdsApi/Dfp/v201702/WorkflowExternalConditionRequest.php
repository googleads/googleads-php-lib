 ...
 */
class WorkflowExternalConditionRequest extends \Google\AdsApi\Dfp\v201702\WorkflowRequest
{
    ...
    /**
     * @param string $status
     * @return \Google\AdsApi\Dfp\v201702\WorkflowExternalConditionRequest
     */
