 ...
 */
class LineItemCreativeAssociationOperationError extends \Google\AdsApi\Dfp\v201702\ApiError
{
    ...
    /**
     * @param string $reason
     * @return \Google\AdsApi\Dfp\v201702\LineItemCreativeAssociationOperationError
     */
