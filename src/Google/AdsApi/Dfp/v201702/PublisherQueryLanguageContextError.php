 ...
 */
class PublisherQueryLanguageContextError extends \Google\AdsApi\Dfp\v201702\ApiError
{
    ...
    /**
     * @param string $reason
     * @return \Google\AdsApi\Dfp\v201702\PublisherQueryLanguageContextError
     */
