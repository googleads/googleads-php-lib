 ...
 */
class FlashRedirectOverlayCreative extends \Google\AdsApi\Dfp\v201702\BaseFlashRedirectCreative
{
    ...
    /**
     * @param int[] $companionCreativeIds
     * @return \Google\AdsApi\Dfp\v201702\FlashRedirectOverlayCreative
     */
