 ...
 */
abstract class BaseFlashRedirectCreative extends \Google\AdsApi\Dfp\v201702\HasDestinationUrlCreative
{
    ...
    /**
     * @param string $flashUrl
     * @return \Google\AdsApi\Dfp\v201702\BaseFlashRedirectCreative
     */
