...
use Google\AdsApi\Dfp\v201802\DeleteUserTeamAssociations;
use Google\AdsApi\Dfp\v201802\UserTeamAssociation;
use Google\AdsApi\Dfp\v201802\UserTeamAssociationService;
use RuntimeException;
use SoapClient;

/**
 * Helper class for DFP examples. Provides functionality to create prerequisite
 * objects for testing.
 */
class ExampleTestHelper
{
     ...
     *
     * @param DfpServices $services entry point for accessing the DFP SOAP
     *     services
     * @param DfpSession $session a session for using the DFP API
     */
    public function __construct(DfpServices $services, DfpSession $session)
    {
