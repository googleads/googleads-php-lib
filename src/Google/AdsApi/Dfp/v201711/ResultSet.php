...
class ResultSet
{
    ...
    /**
     * @var \Google\AdsApi\Dfp\v201711\ColumnType[] $columnTypes
     */
    protected $columnTypes = null;

    /**
     * @var \Google\AdsApi\Dfp\v201711\Row[] $rows
     */
    protected $rows = null;

    /**
     * @param \Google\AdsApi\Dfp\v201711\ColumnType[] $columnTypes
     * @param \Google\AdsApi\Dfp\v201711\Row[] $rows
     */
