 ...
 */
class WorkflowExternalConditionRequest extends \Google\AdsApi\Dfp\v201711\WorkflowRequest
{
    ...
    /**
     * @param string $status
     * @return \Google\AdsApi\Dfp\v201711\WorkflowExternalConditionRequest
     */
