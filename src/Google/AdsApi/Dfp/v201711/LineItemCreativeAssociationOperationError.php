 ...
 */
class LineItemCreativeAssociationOperationError extends \Google\AdsApi\Dfp\v201711\ApiError
{
    ...
    /**
     * @param string $reason
     * @return \Google\AdsApi\Dfp\v201711\LineItemCreativeAssociationOperationError
     */
