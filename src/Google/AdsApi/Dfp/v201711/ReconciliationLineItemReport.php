...
class ReconciliationLineItemReport
{
    ...
    /**
     * @var \Google\AdsApi\Dfp\v201711\Money $netBillableRevenue
     */
    protected $netBillableRevenue = null;

    /**
     * @var \Google\AdsApi\Dfp\v201711\Money $grossBillableRevenue
     */
    protected $grossBillableRevenue = null;

    /**
     * @var \Google\AdsApi\Dfp\v201711\BillableRevenueOverrides $billableRevenueOverrides
     */
     ...
     * @param \Google\AdsApi\Dfp\v201711\Money $netBillableRevenue
     * @param \Google\AdsApi\Dfp\v201711\Money $grossBillableRevenue
     * @param \Google\AdsApi\Dfp\v201711\BillableRevenueOverrides $billableRevenueOverrides
     */
    ...
    {
      $this->proposalLineItemId = (PHP_INT_SIZE === 4)
    ...
    {
      $this->thirdPartyVolume = (PHP_INT_SIZE === 4)
    ...
    {
      $this->manualVolume = (PHP_INT_SIZE === 4)
    ...
    {
      $this->reconciledVolume = (PHP_INT_SIZE === 4)
    ...
    {
      $this->rolloverVolume = (PHP_INT_SIZE === 4)
    ...
    {
      $this->billableVolume = (PHP_INT_SIZE === 4)
    ...
    /**
     * @return \Google\AdsApi\Dfp\v201711\BillableRevenueOverrides
     */
