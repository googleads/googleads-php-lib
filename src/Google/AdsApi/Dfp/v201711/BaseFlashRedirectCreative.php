 ...
 */
abstract class BaseFlashRedirectCreative extends \Google\AdsApi\Dfp\v201711\HasDestinationUrlCreative
{
    ...
    /**
     * @param string $flashUrl
     * @return \Google\AdsApi\Dfp\v201711\BaseFlashRedirectCreative
     */
