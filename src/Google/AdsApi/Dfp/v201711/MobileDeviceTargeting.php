...
class MobileDeviceTargeting
{
    ...
    /**
     * @var \Google\AdsApi\Dfp\v201711\Technology[] $targetedMobileDevices
     */
    protected $targetedMobileDevices = null;

    /**
     * @var \Google\AdsApi\Dfp\v201711\Technology[] $excludedMobileDevices
     */
    protected $excludedMobileDevices = null;

    /**
     * @param \Google\AdsApi\Dfp\v201711\Technology[] $targetedMobileDevices
     * @param \Google\AdsApi\Dfp\v201711\Technology[] $excludedMobileDevices
     */
