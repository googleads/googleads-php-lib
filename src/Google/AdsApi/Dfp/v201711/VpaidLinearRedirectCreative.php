 ...
 */
class VpaidLinearRedirectCreative extends \Google\AdsApi\Dfp\v201711\HasDestinationUrlCreative
{
    ...
    /**
     * @param int[] $companionCreativeIds
     * @return \Google\AdsApi\Dfp\v201711\VpaidLinearRedirectCreative
     */
