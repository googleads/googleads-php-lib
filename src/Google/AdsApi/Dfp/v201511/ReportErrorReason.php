...
class ReportErrorReason
{
    ...
    const DIMENSION_COMBINATION_NOT_ALLOWED = 'DIMENSION_COMBINATION_NOT_ALLOWED';
    ...
    const INVALID_TIME_ZONE_FOR_FEATURE_NOT_ENABLED = 'INVALID_TIME_ZONE_FOR_FEATURE_NOT_ENABLED';
    const INVALID_TIME_ZONE_FOR_ID = 'INVALID_TIME_ZONE_FOR_ID';
    const UNSUPPORTED_TIME_ZONE = 'UNSUPPORTED_TIME_ZONE';
