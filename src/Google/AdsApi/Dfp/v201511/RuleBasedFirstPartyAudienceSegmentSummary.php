...
class RuleBasedFirstPartyAudienceSegmentSummary extends \Google\AdsApi\Dfp\v201511\FirstPartyAudienceSegment
{
    ...
    /**
     * @param int $pageViews
     * @return \Google\AdsApi\Dfp\v201511\RuleBasedFirstPartyAudienceSegmentSummary
     */
