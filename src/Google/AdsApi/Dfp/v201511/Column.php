...
class Column
{
    const __default = 'AD_SERVER_IMPRESSIONS';
    ...
    const AD_SERVER_DELIVERY_INDICATOR = 'AD_SERVER_DELIVERY_INDICATOR';
    const AD_SERVER_CODE_SERVED_COUNT = 'AD_SERVER_CODE_SERVED_COUNT';
    const AD_SERVER_IMPRESSIONS_OUT_OF_NETWORK = 'AD_SERVER_IMPRESSIONS_OUT_OF_NETWORK';
    const AD_SERVER_CLICKS_OUT_OF_NETWORK = 'AD_SERVER_CLICKS_OUT_OF_NETWORK';
    const AD_SERVER_CTR_OUT_OF_NETWORK = 'AD_SERVER_CTR_OUT_OF_NETWORK';
    const DYNAMIC_ALLOCATION_INVENTORY_LEVEL_IMPRESSIONS = 'DYNAMIC_ALLOCATION_INVENTORY_LEVEL_IMPRESSIONS';
    const TOTAL_DYNAMIC_ALLOCATION_IMPRESSIONS_OUT_OF_NETWORK = 'TOTAL_DYNAMIC_ALLOCATION_IMPRESSIONS_OUT_OF_NETWORK';
    ...
    const AD_EXCHANGE_MATCHED_QUERIES = 'AD_EXCHANGE_MATCHED_QUERIES';
    const AD_EXCHANGE_VIEWED_QUERIES = 'AD_EXCHANGE_VIEWED_QUERIES';
    ...
    const AD_EXCHANGE_MATCHED_QUERIES_CTR = 'AD_EXCHANGE_MATCHED_QUERIES_CTR';
    const AD_EXCHANGE_LIFT = 'AD_EXCHANGE_LIFT';
    const AD_EXCHANGE_CPC_REVENUE = 'AD_EXCHANGE_CPC_REVENUE';
    const AD_EXCHANGE_REQUESTS = 'AD_EXCHANGE_REQUESTS';
    const AD_EXCHANGE_REQUEST_ECPM = 'AD_EXCHANGE_REQUEST_ECPM';
    const AD_EXCHANGE_REQUEST_CTR = 'AD_EXCHANGE_REQUEST_CTR';
    ...
    const AD_EXCHANGE_ECPM = 'AD_EXCHANGE_ECPM';
    const AD_EXCHANGE_ACTIVE_VIEW_MEASUREABLE_RATE = 'AD_EXCHANGE_ACTIVE_VIEW_MEASUREABLE_RATE';
    const AD_EXCHANGE_ACTIVE_VIEW_VIEWABLE_RATE = 'AD_EXCHANGE_ACTIVE_VIEW_VIEWABLE_RATE';
    const AD_EXCHANGE_VIDEO_FILL_RATE = 'AD_EXCHANGE_VIDEO_FILL_RATE';
    ...
    const AD_EXCHANGE_VIDEO_TRUEVIEWS = 'AD_EXCHANGE_VIDEO_TRUEVIEWS';
    const AD_EXCHANGE_VIDEO_VTR = 'AD_EXCHANGE_VIDEO_VTR';
    const AD_EXCHANGE_THIRD_PARTY_DISCREPANCY = 'AD_EXCHANGE_THIRD_PARTY_DISCREPANCY';
    const AD_EXCHANGE_THIRD_PARTY_EARNINGS = 'AD_EXCHANGE_THIRD_PARTY_EARNINGS';
    const AD_EXCHANGE_THIRD_PARTY_ECPM = 'AD_EXCHANGE_THIRD_PARTY_ECPM';
    const AD_EXCHANGE_THIRD_PARTY_FILL_RATE = 'AD_EXCHANGE_THIRD_PARTY_FILL_RATE';
    const AD_EXCHANGE_THIRD_PARTY_PASSBACKS = 'AD_EXCHANGE_THIRD_PARTY_PASSBACKS';
    const AD_EXCHANGE_THIRD_PARTY_IMPRESSIONS = 'AD_EXCHANGE_THIRD_PARTY_IMPRESSIONS';
    const AD_EXCHANGE_IMPRESSIONS_INCLUDING_THIRD_PARTY = 'AD_EXCHANGE_IMPRESSIONS_INCLUDING_THIRD_PARTY';
    ...
    const TOTAL_LINE_ITEM_LEVEL_IMPRESSIONS_INCLUDING_OUT_OF_NETWORK_DELIVERY = 'TOTAL_LINE_ITEM_LEVEL_IMPRESSIONS_INCLUDING_OUT_OF_NETWORK_DELIVERY';
    ...
    const TOTAL_UNFILLED_IMPRESSIONS_OUT_OF_NETWORK = 'TOTAL_UNFILLED_IMPRESSIONS_OUT_OF_NETWORK';
    ...
    const VIDEO_ERRORS_VAST_2_ERROR_COUNT = 'VIDEO_ERRORS_VAST_2_ERROR_COUNT';
    const VIDEO_ERRORS_VAST_3_ERROR_100_COUNT = 'VIDEO_ERRORS_VAST_3_ERROR_100_COUNT';
    const VIDEO_ERRORS_VAST_3_ERROR_101_COUNT = 'VIDEO_ERRORS_VAST_3_ERROR_101_COUNT';
    const VIDEO_ERRORS_VAST_3_ERROR_102_COUNT = 'VIDEO_ERRORS_VAST_3_ERROR_102_COUNT';
    const VIDEO_ERRORS_VAST_3_ERROR_200_COUNT = 'VIDEO_ERRORS_VAST_3_ERROR_200_COUNT';
    const VIDEO_ERRORS_VAST_3_ERROR_201_COUNT = 'VIDEO_ERRORS_VAST_3_ERROR_201_COUNT';
    const VIDEO_ERRORS_VAST_3_ERROR_202_COUNT = 'VIDEO_ERRORS_VAST_3_ERROR_202_COUNT';
    const VIDEO_ERRORS_VAST_3_ERROR_203_COUNT = 'VIDEO_ERRORS_VAST_3_ERROR_203_COUNT';
    const VIDEO_ERRORS_VAST_3_ERROR_300_COUNT = 'VIDEO_ERRORS_VAST_3_ERROR_300_COUNT';
    const VIDEO_ERRORS_VAST_3_ERROR_301_COUNT = 'VIDEO_ERRORS_VAST_3_ERROR_301_COUNT';
    const VIDEO_ERRORS_VAST_3_ERROR_302_COUNT = 'VIDEO_ERRORS_VAST_3_ERROR_302_COUNT';
    const VIDEO_ERRORS_VAST_3_ERROR_303_COUNT = 'VIDEO_ERRORS_VAST_3_ERROR_303_COUNT';
    const VIDEO_ERRORS_VAST_3_ERROR_400_COUNT = 'VIDEO_ERRORS_VAST_3_ERROR_400_COUNT';
    const VIDEO_ERRORS_VAST_3_ERROR_401_COUNT = 'VIDEO_ERRORS_VAST_3_ERROR_401_COUNT';
    const VIDEO_ERRORS_VAST_3_ERROR_402_COUNT = 'VIDEO_ERRORS_VAST_3_ERROR_402_COUNT';
    const VIDEO_ERRORS_VAST_3_ERROR_403_COUNT = 'VIDEO_ERRORS_VAST_3_ERROR_403_COUNT';
    const VIDEO_ERRORS_VAST_3_ERROR_405_COUNT = 'VIDEO_ERRORS_VAST_3_ERROR_405_COUNT';
    const VIDEO_ERRORS_VAST_3_ERROR_500_COUNT = 'VIDEO_ERRORS_VAST_3_ERROR_500_COUNT';
    const VIDEO_ERRORS_VAST_3_ERROR_501_COUNT = 'VIDEO_ERRORS_VAST_3_ERROR_501_COUNT';
    const VIDEO_ERRORS_VAST_3_ERROR_502_COUNT = 'VIDEO_ERRORS_VAST_3_ERROR_502_COUNT';
    const VIDEO_ERRORS_VAST_3_ERROR_503_COUNT = 'VIDEO_ERRORS_VAST_3_ERROR_503_COUNT';
    const VIDEO_ERRORS_VAST_3_ERROR_600_COUNT = 'VIDEO_ERRORS_VAST_3_ERROR_600_COUNT';
    const VIDEO_ERRORS_VAST_3_ERROR_601_COUNT = 'VIDEO_ERRORS_VAST_3_ERROR_601_COUNT';
    const VIDEO_ERRORS_VAST_3_ERROR_602_COUNT = 'VIDEO_ERRORS_VAST_3_ERROR_602_COUNT';
    const VIDEO_ERRORS_VAST_3_ERROR_603_COUNT = 'VIDEO_ERRORS_VAST_3_ERROR_603_COUNT';
    const VIDEO_ERRORS_VAST_3_ERROR_604_COUNT = 'VIDEO_ERRORS_VAST_3_ERROR_604_COUNT';
    const VIDEO_ERRORS_VAST_3_ERROR_900_COUNT = 'VIDEO_ERRORS_VAST_3_ERROR_900_COUNT';
    const VIDEO_ERRORS_VAST_3_ERROR_901_COUNT = 'VIDEO_ERRORS_VAST_3_ERROR_901_COUNT';
    ...
    const RECONCILIATION_DISCREPANCY = 'RECONCILIATION_DISCREPANCY';
    ...
    const BILLING_DELIVERY_ROLLOVER_FROM_PREVIOUS = 'BILLING_DELIVERY_ROLLOVER_FROM_PREVIOUS';
    ...
    const DISCOUNTS_BREAKDOWN_BILLABLE_NET_EXCLUDED_PREMIUMS = 'DISCOUNTS_BREAKDOWN_BILLABLE_NET_EXCLUDED_PREMIUMS';
    const DISCOUNTS_BREAKDOWN_BILLABLE_NET_ADVERTISER_DISCOUNT = 'DISCOUNTS_BREAKDOWN_BILLABLE_NET_ADVERTISER_DISCOUNT';
    const DISCOUNTS_BREAKDOWN_BILLABLE_NET_PRODUCT_ADJUSTMENT = 'DISCOUNTS_BREAKDOWN_BILLABLE_NET_PRODUCT_ADJUSTMENT';
    const DISCOUNTS_BREAKDOWN_BILLABLE_NET_PROPOSAL_DISCOUNT = 'DISCOUNTS_BREAKDOWN_BILLABLE_NET_PROPOSAL_DISCOUNT';
    const DISCOUNTS_BREAKDOWN_CONTRACTED_NET_EXCLUDED_PREMIUMS = 'DISCOUNTS_BREAKDOWN_CONTRACTED_NET_EXCLUDED_PREMIUMS';
    const DISCOUNTS_BREAKDOWN_CONTRACTED_NET_ADVERTISER_DISCOUNT = 'DISCOUNTS_BREAKDOWN_CONTRACTED_NET_ADVERTISER_DISCOUNT';
    const DISCOUNTS_BREAKDOWN_CONTRACTED_NET_PRODUCT_ADJUSTMENT = 'DISCOUNTS_BREAKDOWN_CONTRACTED_NET_PRODUCT_ADJUSTMENT';
    const DISCOUNTS_BREAKDOWN_CONTRACTED_NET_PROPOSAL_DISCOUNT = 'DISCOUNTS_BREAKDOWN_CONTRACTED_NET_PROPOSAL_DISCOUNT';
    const DISCOUNTS_BREAKDOWN_CONTRACTED_NET_NON_BILLABLE = 'DISCOUNTS_BREAKDOWN_CONTRACTED_NET_NON_BILLABLE';
    const SALESPERSON_PERFORMANCE_SHARED_PIPELINE_NET_REVENUE = 'SALESPERSON_PERFORMANCE_SHARED_PIPELINE_NET_REVENUE';
    const SALESPERSON_PERFORMANCE_SHARED_PIPELINE_GROSS_REVENUE = 'SALESPERSON_PERFORMANCE_SHARED_PIPELINE_GROSS_REVENUE';
    const SALESPERSON_PERFORMANCE_SHARED_UNIFIED_NET_REVENUE = 'SALESPERSON_PERFORMANCE_SHARED_UNIFIED_NET_REVENUE';
    const SALESPERSON_PERFORMANCE_SHARED_UNIFIED_GROSS_REVENUE = 'SALESPERSON_PERFORMANCE_SHARED_UNIFIED_GROSS_REVENUE';
    ...
    const PARTNER_MANAGEMENT_HOST_REVENUE = 'PARTNER_MANAGEMENT_HOST_REVENUE';
    const PARTNER_MANAGEMENT_HOST_ECPM = 'PARTNER_MANAGEMENT_HOST_ECPM';
    const PARTNER_MANAGEMENT_PARTNER_REVENUE = 'PARTNER_MANAGEMENT_PARTNER_REVENUE';
    const PARTNER_MANAGEMENT_PARTNER_ECPM = 'PARTNER_MANAGEMENT_PARTNER_ECPM';
