...
class ImageCreative extends \Google\AdsApi\Dfp\v201511\BaseImageCreative
{
    ...
    /**
     * @var \Google\AdsApi\Dfp\v201511\CreativeAsset[] $secondaryImageAssets
     */
     ...
     * @param \Google\AdsApi\Dfp\v201511\CreativeAsset $primaryImageAsset
     * @param string $altText
     * @param string $thirdPartyImpressionUrl
     * @param \Google\AdsApi\Dfp\v201511\CreativeAsset[] $secondaryImageAssets
    ...
    /**
     * @param string $altText
     * @return \Google\AdsApi\Dfp\v201511\ImageCreative
     */
