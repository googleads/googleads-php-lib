 ...
 */
class PublisherQueryLanguageContextError extends \Google\AdsApi\Dfp\v201708\ApiError
{
    ...
    /**
     * @param string $reason
     * @return \Google\AdsApi\Dfp\v201708\PublisherQueryLanguageContextError
     */
