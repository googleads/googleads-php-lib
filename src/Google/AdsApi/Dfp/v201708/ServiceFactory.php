...
/**
 * A factory class for creating Dfp service clients.
 */
final class ServiceFactory
{
    private $services;

    public function __construct(DfpServices $services = null)
    {
        $this->services = is_null($services) ? new DfpServices() : $services;
    }
    ...
    /**
     * Creates a new service client for `AuthenticationService`.
     *
     * @param AdsSession $session a session containing configurations for the service client
     * @return AuthenticationService a new service client
     */
    public function createAuthenticationService(AdsSession $session)
    {
        return $this->services->get($session, AuthenticationService::class);
    }
