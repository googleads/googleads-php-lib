 ...
 */
class VpaidLinearRedirectCreative extends \Google\AdsApi\Dfp\v201708\HasDestinationUrlCreative
{
    ...
    /**
     * @param int[] $companionCreativeIds
     * @return \Google\AdsApi\Dfp\v201708\VpaidLinearRedirectCreative
     */
