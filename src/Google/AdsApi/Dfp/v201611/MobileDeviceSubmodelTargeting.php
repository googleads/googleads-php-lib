...
class MobileDeviceSubmodelTargeting
{
    ...
    /**
     * @var \Google\AdsApi\Dfp\v201611\Technology[] $targetedMobileDeviceSubmodels
     */
    protected $targetedMobileDeviceSubmodels = null;

    /**
     * @var \Google\AdsApi\Dfp\v201611\Technology[] $excludedMobileDeviceSubmodels
     */
    protected $excludedMobileDeviceSubmodels = null;

    /**
     * @param \Google\AdsApi\Dfp\v201611\Technology[] $targetedMobileDeviceSubmodels
     * @param \Google\AdsApi\Dfp\v201611\Technology[] $excludedMobileDeviceSubmodels
     */
