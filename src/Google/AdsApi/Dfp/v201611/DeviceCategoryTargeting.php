...
class DeviceCategoryTargeting
{
    ...
    /**
     * @var \Google\AdsApi\Dfp\v201611\Technology[] $targetedDeviceCategories
     */
    protected $targetedDeviceCategories = null;

    /**
     * @var \Google\AdsApi\Dfp\v201611\Technology[] $excludedDeviceCategories
     */
    protected $excludedDeviceCategories = null;

    /**
     * @param \Google\AdsApi\Dfp\v201611\Technology[] $targetedDeviceCategories
     * @param \Google\AdsApi\Dfp\v201611\Technology[] $excludedDeviceCategories
     */
