 ...
 */
abstract class BaseFlashRedirectCreative extends \Google\AdsApi\Dfp\v201611\HasDestinationUrlCreative
{
    ...
    /**
     * @param string $flashUrl
     * @return \Google\AdsApi\Dfp\v201611\BaseFlashRedirectCreative
     */
