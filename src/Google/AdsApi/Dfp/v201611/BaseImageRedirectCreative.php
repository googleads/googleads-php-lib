 ...
 */
abstract class BaseImageRedirectCreative extends \Google\AdsApi\Dfp\v201611\HasDestinationUrlCreative
{
    ...
    /**
     * @param string $imageUrl
     * @return \Google\AdsApi\Dfp\v201611\BaseImageRedirectCreative
     */
