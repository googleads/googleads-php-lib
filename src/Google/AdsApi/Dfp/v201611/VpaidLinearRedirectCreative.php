 ...
 */
class VpaidLinearRedirectCreative extends \Google\AdsApi\Dfp\v201611\HasDestinationUrlCreative
{
    ...
    /**
     * @param int[] $companionCreativeIds
     * @return \Google\AdsApi\Dfp\v201611\VpaidLinearRedirectCreative
     */
