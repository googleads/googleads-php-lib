 ...
 */
class WorkflowExternalConditionRequest extends \Google\AdsApi\Dfp\v201611\WorkflowRequest
{
    ...
    /**
     * @param string $status
     * @return \Google\AdsApi\Dfp\v201611\WorkflowExternalConditionRequest
     */
