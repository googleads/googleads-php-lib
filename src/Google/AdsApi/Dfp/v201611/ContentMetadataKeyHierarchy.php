...
class ContentMetadataKeyHierarchy
{
    ...
    /**
     * @var \Google\AdsApi\Dfp\v201611\ContentMetadataKeyHierarchyLevel[] $hierarchyLevels
     */
     ...
     * @param int $id
     * @param string $name
     * @param \Google\AdsApi\Dfp\v201611\ContentMetadataKeyHierarchyLevel[] $hierarchyLevels
     * @param string $status
     */
    ...
    /**
     * @return \Google\AdsApi\Dfp\v201611\ContentMetadataKeyHierarchyLevel[]
     */
