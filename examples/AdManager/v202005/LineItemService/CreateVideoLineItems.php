...
namespace Google\AdsApi\Examples\AdManager\v202005\LineItemService;
...
use Google\AdsApi\AdManager\v202005\AdUnitTargeting;
use Google\AdsApi\AdManager\v202005\CmsMetadataCriteria;
use Google\AdsApi\AdManager\v202005\CmsMetadataCriteriaComparisonOperator;
use Google\AdsApi\AdManager\v202005\CompanionDeliveryOption;
use Google\AdsApi\AdManager\v202005\ContentTargeting;
use Google\AdsApi\AdManager\v202005\CostType;
use Google\AdsApi\AdManager\v202005\CreativePlaceholder;
use Google\AdsApi\AdManager\v202005\CreativeRotationType;
use Google\AdsApi\AdManager\v202005\CustomCriteriaSet;
use Google\AdsApi\AdManager\v202005\CustomCriteriaSetLogicalOperator;
use Google\AdsApi\AdManager\v202005\EnvironmentType;
use Google\AdsApi\AdManager\v202005\Goal;
use Google\AdsApi\AdManager\v202005\GoalType;
use Google\AdsApi\AdManager\v202005\InventoryTargeting;
use Google\AdsApi\AdManager\v202005\LineItem;
use Google\AdsApi\AdManager\v202005\LineItemType;
use Google\AdsApi\AdManager\v202005\Money;
use Google\AdsApi\AdManager\v202005\RequestPlatform;
use Google\AdsApi\AdManager\v202005\RequestPlatformTargeting;
use Google\AdsApi\AdManager\v202005\ServiceFactory;
use Google\AdsApi\AdManager\v202005\Size;
use Google\AdsApi\AdManager\v202005\StartDateTimeType;
use Google\AdsApi\AdManager\v202005\Targeting;
use Google\AdsApi\AdManager\v202005\VideoPosition;
use Google\AdsApi\AdManager\v202005\VideoPositionTarget;
use Google\AdsApi\AdManager\v202005\VideoPositionTargeting;
use Google\AdsApi\AdManager\v202005\VideoPositionType;
...
class CreateVideoLineItems
{
    ...
    public static function runExample(
        ...
        // https://developers.google.com/ad-manager/docs/reference/v202005/LineItemService.VideoPositionTarget
