...
namespace Google\AdsApi\Examples\AdManager\v202605\CmsMetadataService;
...
use Google\AdsApi\AdManager\v202605\CmsMetadataKeyStatus;
...
class ActivateCmsMetadataValues
{
    ...
    )
    {
        ...
        if ($totalResultSetSize > 0) {
            ...
            // Create an action.
            $action = new \Google\AdsApi\AdManager\v202605\ActivateCmsMetadataValues();
