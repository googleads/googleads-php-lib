...
namespace Google\AdsApi\Examples\AdManager\v202605\LineItemService;
...
use Google\AdsApi\AdManager\Util\v202605\AdManagerDateTimes;
use Google\AdsApi\AdManager\v202605\AdUnitTargeting;
use Google\AdsApi\AdManager\v202605\CmsMetadataCriteria;
use Google\AdsApi\AdManager\v202605\CmsMetadataCriteriaComparisonOperator;
use Google\AdsApi\AdManager\v202605\CompanionDeliveryOption;
use Google\AdsApi\AdManager\v202605\ContentTargeting;
use Google\AdsApi\AdManager\v202605\CostType;
use Google\AdsApi\AdManager\v202605\CreativePlaceholder;
use Google\AdsApi\AdManager\v202605\CreativeRotationType;
use Google\AdsApi\AdManager\v202605\CustomCriteriaSet;
use Google\AdsApi\AdManager\v202605\CustomCriteriaSetLogicalOperator;
use Google\AdsApi\AdManager\v202605\EnvironmentType;
use Google\AdsApi\AdManager\v202605\Goal;
use Google\AdsApi\AdManager\v202605\GoalType;
use Google\AdsApi\AdManager\v202605\InventoryTargeting;
use Google\AdsApi\AdManager\v202605\LineItem;
use Google\AdsApi\AdManager\v202605\LineItemType;
use Google\AdsApi\AdManager\v202605\Money;
use Google\AdsApi\AdManager\v202605\RequestPlatform;
use Google\AdsApi\AdManager\v202605\RequestPlatformTargeting;
use Google\AdsApi\AdManager\v202605\ServiceFactory;
use Google\AdsApi\AdManager\v202605\Size;
use Google\AdsApi\AdManager\v202605\StartDateTimeType;
use Google\AdsApi\AdManager\v202605\Targeting;
use Google\AdsApi\AdManager\v202605\VideoPosition;
use Google\AdsApi\AdManager\v202605\VideoPositionTarget;
use Google\AdsApi\AdManager\v202605\VideoPositionTargeting;
use Google\AdsApi\AdManager\v202605\VideoPositionType;
...
class CreateVideoLineItems
{
    ...
    public static function runExample(
        ...
        // https://developers.google.com/ad-manager/docs/reference/v202605/LineItemService.VideoPositionTarget
