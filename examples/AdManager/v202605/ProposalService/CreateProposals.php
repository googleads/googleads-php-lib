...
namespace Google\AdsApi\Examples\AdManager\v202605\ProposalService;

require __DIR__ . '/../../../../vendor/autoload.php';

use Google\AdsApi\AdManager\AdManagerSession;
use Google\AdsApi\AdManager\AdManagerSessionBuilder;
use Google\AdsApi\AdManager\v202605\Proposal;
use Google\AdsApi\AdManager\v202605\ProposalCompanyAssociation;
use Google\AdsApi\AdManager\v202605\ProposalCompanyAssociationType;
use Google\AdsApi\AdManager\v202605\ProposalMarketplaceInfo;
use Google\AdsApi\AdManager\v202605\SalespersonSplit;
