...
namespace Google\AdsApi\Examples\AdManager\v202302\ProposalService;

require __DIR__ . '/../../../../vendor/autoload.php';

use Google\AdsApi\AdManager\AdManagerSession;
use Google\AdsApi\AdManager\AdManagerSessionBuilder;
use Google\AdsApi\AdManager\v202302\Proposal;
use Google\AdsApi\AdManager\v202302\ProposalCompanyAssociation;
use Google\AdsApi\AdManager\v202302\ProposalCompanyAssociationType;
use Google\AdsApi\AdManager\v202302\ProposalMarketplaceInfo;
use Google\AdsApi\AdManager\v202302\SalespersonSplit;
