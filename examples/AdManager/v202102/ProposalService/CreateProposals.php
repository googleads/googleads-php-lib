...
namespace Google\AdsApi\Examples\AdManager\v202102\ProposalService;

require __DIR__ . '/../../../../vendor/autoload.php';

use Google\AdsApi\AdManager\AdManagerSession;
use Google\AdsApi\AdManager\AdManagerSessionBuilder;
use Google\AdsApi\AdManager\v202102\Proposal;
use Google\AdsApi\AdManager\v202102\ProposalCompanyAssociation;
use Google\AdsApi\AdManager\v202102\ProposalCompanyAssociationType;
use Google\AdsApi\AdManager\v202102\ProposalMarketplaceInfo;
use Google\AdsApi\AdManager\v202102\SalespersonSplit;
