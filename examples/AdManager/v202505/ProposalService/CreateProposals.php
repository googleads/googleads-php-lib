...
namespace Google\AdsApi\Examples\AdManager\v202505\ProposalService;

require __DIR__ . '/../../../../vendor/autoload.php';

use Google\AdsApi\AdManager\AdManagerSession;
use Google\AdsApi\AdManager\AdManagerSessionBuilder;
use Google\AdsApi\AdManager\v202505\Proposal;
use Google\AdsApi\AdManager\v202505\ProposalCompanyAssociation;
use Google\AdsApi\AdManager\v202505\ProposalCompanyAssociationType;
use Google\AdsApi\AdManager\v202505\ProposalMarketplaceInfo;
use Google\AdsApi\AdManager\v202505\SalespersonSplit;
