...
namespace Google\AdsApi\Examples\AdManager\v202505\LineItemService;
...
use Google\AdsApi\AdManager\Util\v202505\AdManagerDateTimes;
use Google\AdsApi\AdManager\v202505\AdUnitTargeting;
use Google\AdsApi\AdManager\v202505\CmsMetadataCriteria;
use Google\AdsApi\AdManager\v202505\CmsMetadataCriteriaComparisonOperator;
use Google\AdsApi\AdManager\v202505\CompanionDeliveryOption;
use Google\AdsApi\AdManager\v202505\ContentTargeting;
use Google\AdsApi\AdManager\v202505\CostType;
use Google\AdsApi\AdManager\v202505\CreativePlaceholder;
use Google\AdsApi\AdManager\v202505\CreativeRotationType;
use Google\AdsApi\AdManager\v202505\CustomCriteriaSet;
use Google\AdsApi\AdManager\v202505\CustomCriteriaSetLogicalOperator;
use Google\AdsApi\AdManager\v202505\EnvironmentType;
use Google\AdsApi\AdManager\v202505\Goal;
use Google\AdsApi\AdManager\v202505\GoalType;
use Google\AdsApi\AdManager\v202505\InventoryTargeting;
use Google\AdsApi\AdManager\v202505\LineItem;
use Google\AdsApi\AdManager\v202505\LineItemType;
use Google\AdsApi\AdManager\v202505\Money;
use Google\AdsApi\AdManager\v202505\RequestPlatform;
use Google\AdsApi\AdManager\v202505\RequestPlatformTargeting;
use Google\AdsApi\AdManager\v202505\ServiceFactory;
use Google\AdsApi\AdManager\v202505\Size;
use Google\AdsApi\AdManager\v202505\StartDateTimeType;
use Google\AdsApi\AdManager\v202505\Targeting;
use Google\AdsApi\AdManager\v202505\VideoPosition;
use Google\AdsApi\AdManager\v202505\VideoPositionTarget;
use Google\AdsApi\AdManager\v202505\VideoPositionTargeting;
use Google\AdsApi\AdManager\v202505\VideoPositionType;
...
class CreateVideoLineItems
{
    ...
    public static function runExample(
        ...
        // https://developers.google.com/ad-manager/docs/reference/v202505/LineItemService.VideoPositionTarget
