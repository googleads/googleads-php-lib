...
namespace Google\AdsApi\Examples\AdManager\v202602\CmsMetadataService;
...
use Google\AdsApi\AdManager\v202602\CmsMetadataKeyStatus;
...
class ActivateCmsMetadataValues
{
    ...
    )
    {
        ...
        if ($totalResultSetSize > 0) {
            ...
            // Create an action.
            $action = new \Google\AdsApi\AdManager\v202602\ActivateCmsMetadataValues();
