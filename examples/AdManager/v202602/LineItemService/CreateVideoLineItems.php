...
namespace Google\AdsApi\Examples\AdManager\v202602\LineItemService;
...
use Google\AdsApi\AdManager\Util\v202602\AdManagerDateTimes;
use Google\AdsApi\AdManager\v202602\AdUnitTargeting;
use Google\AdsApi\AdManager\v202602\CmsMetadataCriteria;
use Google\AdsApi\AdManager\v202602\CmsMetadataCriteriaComparisonOperator;
use Google\AdsApi\AdManager\v202602\CompanionDeliveryOption;
use Google\AdsApi\AdManager\v202602\ContentTargeting;
use Google\AdsApi\AdManager\v202602\CostType;
use Google\AdsApi\AdManager\v202602\CreativePlaceholder;
use Google\AdsApi\AdManager\v202602\CreativeRotationType;
use Google\AdsApi\AdManager\v202602\CustomCriteriaSet;
use Google\AdsApi\AdManager\v202602\CustomCriteriaSetLogicalOperator;
use Google\AdsApi\AdManager\v202602\EnvironmentType;
use Google\AdsApi\AdManager\v202602\Goal;
use Google\AdsApi\AdManager\v202602\GoalType;
use Google\AdsApi\AdManager\v202602\InventoryTargeting;
use Google\AdsApi\AdManager\v202602\LineItem;
use Google\AdsApi\AdManager\v202602\LineItemType;
use Google\AdsApi\AdManager\v202602\Money;
use Google\AdsApi\AdManager\v202602\RequestPlatform;
use Google\AdsApi\AdManager\v202602\RequestPlatformTargeting;
use Google\AdsApi\AdManager\v202602\ServiceFactory;
use Google\AdsApi\AdManager\v202602\Size;
use Google\AdsApi\AdManager\v202602\StartDateTimeType;
use Google\AdsApi\AdManager\v202602\Targeting;
use Google\AdsApi\AdManager\v202602\VideoPosition;
use Google\AdsApi\AdManager\v202602\VideoPositionTarget;
use Google\AdsApi\AdManager\v202602\VideoPositionTargeting;
use Google\AdsApi\AdManager\v202602\VideoPositionType;
...
class CreateVideoLineItems
{
    ...
    public static function runExample(
        ...
        // https://developers.google.com/ad-manager/docs/reference/v202602/LineItemService.VideoPositionTarget
