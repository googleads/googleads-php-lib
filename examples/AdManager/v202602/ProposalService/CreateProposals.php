...
namespace Google\AdsApi\Examples\AdManager\v202602\ProposalService;

require __DIR__ . '/../../../../vendor/autoload.php';

use Google\AdsApi\AdManager\AdManagerSession;
use Google\AdsApi\AdManager\AdManagerSessionBuilder;
use Google\AdsApi\AdManager\v202602\Proposal;
use Google\AdsApi\AdManager\v202602\ProposalCompanyAssociation;
use Google\AdsApi\AdManager\v202602\ProposalCompanyAssociationType;
use Google\AdsApi\AdManager\v202602\ProposalMarketplaceInfo;
use Google\AdsApi\AdManager\v202602\SalespersonSplit;
