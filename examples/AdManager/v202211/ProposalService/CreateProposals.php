...
namespace Google\AdsApi\Examples\AdManager\v202211\ProposalService;

require __DIR__ . '/../../../../vendor/autoload.php';

use Google\AdsApi\AdManager\AdManagerSession;
use Google\AdsApi\AdManager\AdManagerSessionBuilder;
use Google\AdsApi\AdManager\v202211\Proposal;
use Google\AdsApi\AdManager\v202211\ProposalCompanyAssociation;
use Google\AdsApi\AdManager\v202211\ProposalCompanyAssociationType;
use Google\AdsApi\AdManager\v202211\ProposalMarketplaceInfo;
use Google\AdsApi\AdManager\v202211\SalespersonSplit;
