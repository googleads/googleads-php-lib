...
namespace Google\AdsApi\Examples\AdManager\v202211\LineItemService;
...
use Google\AdsApi\AdManager\v202211\AdUnitTargeting;
use Google\AdsApi\AdManager\v202211\CmsMetadataCriteria;
use Google\AdsApi\AdManager\v202211\CmsMetadataCriteriaComparisonOperator;
use Google\AdsApi\AdManager\v202211\CompanionDeliveryOption;
use Google\AdsApi\AdManager\v202211\ContentTargeting;
use Google\AdsApi\AdManager\v202211\CostType;
use Google\AdsApi\AdManager\v202211\CreativePlaceholder;
use Google\AdsApi\AdManager\v202211\CreativeRotationType;
use Google\AdsApi\AdManager\v202211\CustomCriteriaSet;
use Google\AdsApi\AdManager\v202211\CustomCriteriaSetLogicalOperator;
use Google\AdsApi\AdManager\v202211\EnvironmentType;
use Google\AdsApi\AdManager\v202211\Goal;
use Google\AdsApi\AdManager\v202211\GoalType;
use Google\AdsApi\AdManager\v202211\InventoryTargeting;
use Google\AdsApi\AdManager\v202211\LineItem;
use Google\AdsApi\AdManager\v202211\LineItemType;
use Google\AdsApi\AdManager\v202211\Money;
use Google\AdsApi\AdManager\v202211\RequestPlatform;
use Google\AdsApi\AdManager\v202211\RequestPlatformTargeting;
use Google\AdsApi\AdManager\v202211\ServiceFactory;
use Google\AdsApi\AdManager\v202211\Size;
use Google\AdsApi\AdManager\v202211\StartDateTimeType;
use Google\AdsApi\AdManager\v202211\Targeting;
use Google\AdsApi\AdManager\v202211\VideoPosition;
use Google\AdsApi\AdManager\v202211\VideoPositionTarget;
use Google\AdsApi\AdManager\v202211\VideoPositionTargeting;
use Google\AdsApi\AdManager\v202211\VideoPositionType;
...
class CreateVideoLineItems
{
    ...
    public static function runExample(
        ...
        // https://developers.google.com/ad-manager/docs/reference/v202211/LineItemService.VideoPositionTarget
