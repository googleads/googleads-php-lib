...
namespace Google\AdsApi\Examples\AdManager\v202511\ProposalService;

require __DIR__ . '/../../../../vendor/autoload.php';

use Google\AdsApi\AdManager\AdManagerSession;
use Google\AdsApi\AdManager\AdManagerSessionBuilder;
use Google\AdsApi\AdManager\v202511\Proposal;
use Google\AdsApi\AdManager\v202511\ProposalCompanyAssociation;
use Google\AdsApi\AdManager\v202511\ProposalCompanyAssociationType;
use Google\AdsApi\AdManager\v202511\ProposalMarketplaceInfo;
use Google\AdsApi\AdManager\v202511\SalespersonSplit;
