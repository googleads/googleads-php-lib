...
namespace Google\AdsApi\Examples\AdManager\v202511\LineItemService;
...
use Google\AdsApi\AdManager\Util\v202511\AdManagerDateTimes;
use Google\AdsApi\AdManager\v202511\AdUnitTargeting;
use Google\AdsApi\AdManager\v202511\CmsMetadataCriteria;
use Google\AdsApi\AdManager\v202511\CmsMetadataCriteriaComparisonOperator;
use Google\AdsApi\AdManager\v202511\CompanionDeliveryOption;
use Google\AdsApi\AdManager\v202511\ContentTargeting;
use Google\AdsApi\AdManager\v202511\CostType;
use Google\AdsApi\AdManager\v202511\CreativePlaceholder;
use Google\AdsApi\AdManager\v202511\CreativeRotationType;
use Google\AdsApi\AdManager\v202511\CustomCriteriaSet;
use Google\AdsApi\AdManager\v202511\CustomCriteriaSetLogicalOperator;
use Google\AdsApi\AdManager\v202511\EnvironmentType;
use Google\AdsApi\AdManager\v202511\Goal;
use Google\AdsApi\AdManager\v202511\GoalType;
use Google\AdsApi\AdManager\v202511\InventoryTargeting;
use Google\AdsApi\AdManager\v202511\LineItem;
use Google\AdsApi\AdManager\v202511\LineItemType;
use Google\AdsApi\AdManager\v202511\Money;
use Google\AdsApi\AdManager\v202511\RequestPlatform;
use Google\AdsApi\AdManager\v202511\RequestPlatformTargeting;
use Google\AdsApi\AdManager\v202511\ServiceFactory;
use Google\AdsApi\AdManager\v202511\Size;
use Google\AdsApi\AdManager\v202511\StartDateTimeType;
use Google\AdsApi\AdManager\v202511\Targeting;
use Google\AdsApi\AdManager\v202511\VideoPosition;
use Google\AdsApi\AdManager\v202511\VideoPositionTarget;
use Google\AdsApi\AdManager\v202511\VideoPositionTargeting;
use Google\AdsApi\AdManager\v202511\VideoPositionType;
...
class CreateVideoLineItems
{
    ...
    public static function runExample(
        ...
        // https://developers.google.com/ad-manager/docs/reference/v202511/LineItemService.VideoPositionTarget
