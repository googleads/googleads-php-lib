...
namespace Google\AdsApi\Examples\AdManager\v202205\ProposalService;

require __DIR__ . '/../../../../vendor/autoload.php';

use Google\AdsApi\AdManager\AdManagerSession;
use Google\AdsApi\AdManager\AdManagerSessionBuilder;
use Google\AdsApi\AdManager\v202205\Proposal;
use Google\AdsApi\AdManager\v202205\ProposalCompanyAssociation;
use Google\AdsApi\AdManager\v202205\ProposalCompanyAssociationType;
use Google\AdsApi\AdManager\v202205\ProposalMarketplaceInfo;
use Google\AdsApi\AdManager\v202205\SalespersonSplit;
