...
namespace Google\AdsApi\Examples\AdManager\v202111\CmsMetadataService;
...
use Google\AdsApi\AdManager\v202111\CmsMetadataKeyStatus;
...
class ActivateCmsMetadataValues
{
    ...
    )
    {
        ...
        if ($totalResultSetSize > 0) {
            ...
            // Create an action.
            $action = new \Google\AdsApi\AdManager\v202111\ActivateCmsMetadataValues();
