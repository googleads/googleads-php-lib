...
namespace Google\AdsApi\Examples\AdManager\v202111\ProposalService;

require __DIR__ . '/../../../../vendor/autoload.php';

use Google\AdsApi\AdManager\AdManagerSession;
use Google\AdsApi\AdManager\AdManagerSessionBuilder;
use Google\AdsApi\AdManager\v202111\Proposal;
use Google\AdsApi\AdManager\v202111\ProposalCompanyAssociation;
use Google\AdsApi\AdManager\v202111\ProposalCompanyAssociationType;
use Google\AdsApi\AdManager\v202111\ProposalMarketplaceInfo;
use Google\AdsApi\AdManager\v202111\SalespersonSplit;
