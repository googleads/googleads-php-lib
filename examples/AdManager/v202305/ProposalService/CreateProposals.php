...
namespace Google\AdsApi\Examples\AdManager\v202305\ProposalService;

require __DIR__ . '/../../../../vendor/autoload.php';

use Google\AdsApi\AdManager\AdManagerSession;
use Google\AdsApi\AdManager\AdManagerSessionBuilder;
use Google\AdsApi\AdManager\v202305\Proposal;
use Google\AdsApi\AdManager\v202305\ProposalCompanyAssociation;
use Google\AdsApi\AdManager\v202305\ProposalCompanyAssociationType;
use Google\AdsApi\AdManager\v202305\ProposalMarketplaceInfo;
use Google\AdsApi\AdManager\v202305\SalespersonSplit;
