...
namespace Google\AdsApi\Examples\AdManager\v202608\ProposalService;

require __DIR__ . '/../../../../vendor/autoload.php';

use Google\AdsApi\AdManager\AdManagerSession;
use Google\AdsApi\AdManager\AdManagerSessionBuilder;
use Google\AdsApi\AdManager\v202608\Proposal;
use Google\AdsApi\AdManager\v202608\ProposalCompanyAssociation;
use Google\AdsApi\AdManager\v202608\ProposalCompanyAssociationType;
use Google\AdsApi\AdManager\v202608\ProposalMarketplaceInfo;
use Google\AdsApi\AdManager\v202608\SalespersonSplit;
