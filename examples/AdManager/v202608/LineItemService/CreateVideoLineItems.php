...
namespace Google\AdsApi\Examples\AdManager\v202608\LineItemService;
...
use Google\AdsApi\AdManager\Util\v202608\AdManagerDateTimes;
use Google\AdsApi\AdManager\v202608\AdUnitTargeting;
use Google\AdsApi\AdManager\v202608\CmsMetadataCriteria;
use Google\AdsApi\AdManager\v202608\CmsMetadataCriteriaComparisonOperator;
use Google\AdsApi\AdManager\v202608\CompanionDeliveryOption;
use Google\AdsApi\AdManager\v202608\ContentTargeting;
use Google\AdsApi\AdManager\v202608\CostType;
use Google\AdsApi\AdManager\v202608\CreativePlaceholder;
use Google\AdsApi\AdManager\v202608\CreativeRotationType;
use Google\AdsApi\AdManager\v202608\CustomCriteriaSet;
use Google\AdsApi\AdManager\v202608\CustomCriteriaSetLogicalOperator;
use Google\AdsApi\AdManager\v202608\EnvironmentType;
use Google\AdsApi\AdManager\v202608\Goal;
use Google\AdsApi\AdManager\v202608\GoalType;
use Google\AdsApi\AdManager\v202608\InventoryTargeting;
use Google\AdsApi\AdManager\v202608\LineItem;
use Google\AdsApi\AdManager\v202608\LineItemType;
use Google\AdsApi\AdManager\v202608\Money;
use Google\AdsApi\AdManager\v202608\RequestPlatform;
use Google\AdsApi\AdManager\v202608\RequestPlatformTargeting;
use Google\AdsApi\AdManager\v202608\ServiceFactory;
use Google\AdsApi\AdManager\v202608\Size;
use Google\AdsApi\AdManager\v202608\StartDateTimeType;
use Google\AdsApi\AdManager\v202608\Targeting;
use Google\AdsApi\AdManager\v202608\VideoPosition;
use Google\AdsApi\AdManager\v202608\VideoPositionTarget;
use Google\AdsApi\AdManager\v202608\VideoPositionTargeting;
use Google\AdsApi\AdManager\v202608\VideoPositionType;
...
class CreateVideoLineItems
{
    ...
    public static function runExample(
        ...
        // https://developers.google.com/ad-manager/docs/reference/v202608/LineItemService.VideoPositionTarget
