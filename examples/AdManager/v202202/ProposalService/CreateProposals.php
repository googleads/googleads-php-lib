...
namespace Google\AdsApi\Examples\AdManager\v202202\ProposalService;

require __DIR__ . '/../../../../vendor/autoload.php';

use Google\AdsApi\AdManager\AdManagerSession;
use Google\AdsApi\AdManager\AdManagerSessionBuilder;
use Google\AdsApi\AdManager\v202202\Proposal;
use Google\AdsApi\AdManager\v202202\ProposalCompanyAssociation;
use Google\AdsApi\AdManager\v202202\ProposalCompanyAssociationType;
use Google\AdsApi\AdManager\v202202\ProposalMarketplaceInfo;
use Google\AdsApi\AdManager\v202202\SalespersonSplit;
