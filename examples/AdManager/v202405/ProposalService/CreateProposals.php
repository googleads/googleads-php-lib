...
namespace Google\AdsApi\Examples\AdManager\v202405\ProposalService;

require __DIR__ . '/../../../../vendor/autoload.php';

use Google\AdsApi\AdManager\AdManagerSession;
use Google\AdsApi\AdManager\AdManagerSessionBuilder;
use Google\AdsApi\AdManager\v202405\Proposal;
use Google\AdsApi\AdManager\v202405\ProposalCompanyAssociation;
use Google\AdsApi\AdManager\v202405\ProposalCompanyAssociationType;
use Google\AdsApi\AdManager\v202405\ProposalMarketplaceInfo;
use Google\AdsApi\AdManager\v202405\SalespersonSplit;
