...
namespace Google\AdsApi\Examples\AdManager\v202405\LineItemService;
...
use Google\AdsApi\AdManager\v202405\CmsMetadataCriteria;
use Google\AdsApi\AdManager\v202405\CmsMetadataCriteriaComparisonOperator;
use Google\AdsApi\AdManager\v202405\CompanionDeliveryOption;
use Google\AdsApi\AdManager\v202405\ContentTargeting;
use Google\AdsApi\AdManager\v202405\CostType;
use Google\AdsApi\AdManager\v202405\CreativePlaceholder;
use Google\AdsApi\AdManager\v202405\CreativeRotationType;
use Google\AdsApi\AdManager\v202405\CustomCriteriaSet;
use Google\AdsApi\AdManager\v202405\CustomCriteriaSetLogicalOperator;
use Google\AdsApi\AdManager\v202405\EnvironmentType;
use Google\AdsApi\AdManager\v202405\Goal;
use Google\AdsApi\AdManager\v202405\GoalType;
use Google\AdsApi\AdManager\v202405\InventoryTargeting;
use Google\AdsApi\AdManager\v202405\LineItem;
use Google\AdsApi\AdManager\v202405\LineItemType;
use Google\AdsApi\AdManager\v202405\Money;
use Google\AdsApi\AdManager\v202405\RequestPlatform;
use Google\AdsApi\AdManager\v202405\RequestPlatformTargeting;
use Google\AdsApi\AdManager\v202405\ServiceFactory;
use Google\AdsApi\AdManager\v202405\Size;
use Google\AdsApi\AdManager\v202405\StartDateTimeType;
use Google\AdsApi\AdManager\v202405\Targeting;
use Google\AdsApi\AdManager\v202405\VideoPosition;
use Google\AdsApi\AdManager\v202405\VideoPositionTarget;
use Google\AdsApi\AdManager\v202405\VideoPositionTargeting;
use Google\AdsApi\AdManager\v202405\VideoPositionType;
...
class CreateVideoLineItems
{
    ...
    public static function runExample(
        ...
        // https://developers.google.com/ad-manager/docs/reference/v202405/LineItemService.VideoPositionTarget
