...
namespace Google\AdsApi\Examples\AdManager\v202011\ProposalService;

require __DIR__ . '/../../../../vendor/autoload.php';

use Google\AdsApi\AdManager\AdManagerSession;
use Google\AdsApi\AdManager\AdManagerSessionBuilder;
use Google\AdsApi\AdManager\v202011\Proposal;
use Google\AdsApi\AdManager\v202011\ProposalCompanyAssociation;
use Google\AdsApi\AdManager\v202011\ProposalCompanyAssociationType;
use Google\AdsApi\AdManager\v202011\ProposalMarketplaceInfo;
use Google\AdsApi\AdManager\v202011\SalespersonSplit;
