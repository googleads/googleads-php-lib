...
namespace Google\AdsApi\Examples\AdManager\v202502\ProposalService;

require __DIR__ . '/../../../../vendor/autoload.php';

use Google\AdsApi\AdManager\AdManagerSession;
use Google\AdsApi\AdManager\AdManagerSessionBuilder;
use Google\AdsApi\AdManager\v202502\Proposal;
use Google\AdsApi\AdManager\v202502\ProposalCompanyAssociation;
use Google\AdsApi\AdManager\v202502\ProposalCompanyAssociationType;
use Google\AdsApi\AdManager\v202502\ProposalMarketplaceInfo;
use Google\AdsApi\AdManager\v202502\SalespersonSplit;
