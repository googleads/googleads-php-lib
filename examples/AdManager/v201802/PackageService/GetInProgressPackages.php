...
namespace Google\AdsApi\Examples\AdManager\v201802\PackageService;
...
use Google\AdsApi\AdManager\v201802\PackageService;
use Google\AdsApi\AdManager\v201802\PackageStatus;
...
class GetInProgressPackages
{
    ...
    public static function runExample(
        ...
        $packageService = $adManagerServices->get(
            $session,
        ...
        do {
            ...
            if ($page->getResults() !== null) {
                ...
                foreach ($page->getResults() as $pkg) {
                    printf(
                        "%d) Package with ID %d, name '%s', and proposal ID %d"
                        . " was found.\n",
                        $i++,
                        $pkg->getId(),
                        $pkg->getName(),
