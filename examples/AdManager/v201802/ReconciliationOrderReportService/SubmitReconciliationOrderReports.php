...
namespace Google\AdsApi\Examples\AdManager\v201802\ReconciliationOrderReportService;
...
use Google\AdsApi\AdManager\v201802\ReconciliationOrderReportService;
use Google\AdsApi\AdManager\v201802\SubmitReconciliationOrderReports as SubmitReconciliationOrderReportsAction;
    ...
    public static function runExample(
        ...
        $reconciliationOrderReportService =
            $adManagerServices->get(
                $session,
                ReconciliationOrderReportService::class
            );
        ...
        printf(
            "Total number of reconciliation order reports to be submitted:"
            . " %d\n",
            $totalResultSetSize
        );
