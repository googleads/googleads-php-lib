...
use Google\AdsApi\AdManager\v201802\TriggerWorkflowExternalConditionRequests as TriggerWorkflowExternalConditionRequestsAction;
    ...
    public static function runExample(
            ...
            if ($page->getResults() !== null) {
                ...
                foreach ($page->getResults() as $workflowRequest) {
                    printf(
                        ...
                        . "for '%s', and ID %d will be triggered.\n",
                        $i++,
        ...
        if ($totalResultSetSize > 0) {
            ...
            if ($result !== null && $result->getNumChanges() > 0) {
                ...
                printf("No workflow external condition requests were "
                . "triggered.\n");
            }
        }
    }
