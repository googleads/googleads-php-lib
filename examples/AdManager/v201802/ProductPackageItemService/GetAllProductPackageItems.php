...
namespace Google\AdsApi\Examples\AdManager\v201802\ProductPackageItemService;
...
use Google\AdsApi\AdManager\v201802\ProductPackageItemService;
...
class GetAllProductPackageItems
{
    ...
    public static function runExample(
        ...
        $productPackageItemService = $adManagerServices->get(
            $session,
            ProductPackageItemService::class
        );
            ...
            if ($page->getResults() !== null) {
                ...
                foreach ($page->getResults() as $productPackageItem) {
                    printf(
                        ...
                        . "and product package id %d was found.\n",
                        $i++,
