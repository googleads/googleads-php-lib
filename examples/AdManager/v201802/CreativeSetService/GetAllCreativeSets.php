...
namespace Google\AdsApi\Examples\AdManager\v201802\CreativeSetService;
...
use Google\AdsApi\AdManager\v201802\CreativeSetService;
...
class GetAllCreativeSets
{
    ...
    public static function runExample(
        ...
        $creativeSetService = $adManagerServices->get(
            $session,
            CreativeSetService::class
        );
