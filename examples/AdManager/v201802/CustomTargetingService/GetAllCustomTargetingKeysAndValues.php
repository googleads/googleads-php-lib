...
class GetAllCustomTargetingKeysAndValues
{
    ...
    public static function runExample(
        ...
        $customTargetingKeyIds = self::getAllCustomTargetingKeyIds(
            $adManagerServices,
            $session
        );
                ...
                if ($page->getResults() !== null) {
                    ...
                    foreach ($page->getResults() as $customTargetingValue) {
                        printf(
                            ...
                            . "display name '%s', belonging to key with ID %d "
                            . "was found.\n",
                            $totalValueCounter++,
     ...
     */
    private static function getAllCustomTargetingKeyIds(
        AdManagerServices $adManagerServices,
        AdManagerSession $session
    ) {
...
GetAllCustomTargetingKeysAndValues::main();
