...
namespace Google\AdsApi\Examples\AdManager\v201802\CustomTargetingService;
...
use Google\AdsApi\AdManager\v201802\CustomTargetingKey;
use Google\AdsApi\AdManager\v201802\CustomTargetingKeyType;
use Google\AdsApi\AdManager\v201802\CustomTargetingService;
use Google\AdsApi\AdManager\v201802\CustomTargetingValue;
use Google\AdsApi\AdManager\v201802\CustomTargetingValueMatchType;
...
class CreateCustomTargetingKeysAndValues
{
    ...
    public static function runExample(
        ...
        $customTargetingService = $adManagerServices->get(
            $session,
            CustomTargetingService::class
        );
        ...
        foreach ($values as $value) {
            printf(
                ...
                . " %d, name '%s', and display name '%s' was created.\n",
                $value->getId(),
