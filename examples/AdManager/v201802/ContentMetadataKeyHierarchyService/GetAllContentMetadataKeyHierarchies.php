...
namespace Google\AdsApi\Examples\AdManager\v201802\ContentMetadataKeyHierarchyService;
...
use Google\AdsApi\AdManager\v201802\ContentMetadataKeyHierarchyService;
    ...
    public static function runExample(
        ...
        $contentMetadataKeyHierarchyService =
            $adManagerServices->get(
                $session,
                ContentMetadataKeyHierarchyService::class
            );
        ...
        // Retrieve a small amount of content metadata key hierarchies at a
        // time, paging through until all content metadata key hierarchies have
        // been retrieved.
        ...
        do {
            ...
            // Print out some information for each content metadata key
            // hierarchy.
            if ($page->getResults() !== null) {
                ...
                foreach ($page->getResults() as $contentMetadataKeyHierarchy) {
                    printf(
                        "%d) Content metadata key hierarchy with ID %d and name"
                        . " '%s' was found.\n",
                        $i++,
