...
namespace Google\AdsApi\Examples\AdManager\v201802\CdnConfigurationService;
...
use Google\AdsApi\AdManager\v201802\CdnConfiguration;
use Google\AdsApi\AdManager\v201802\CdnConfigurationService;
use Google\AdsApi\AdManager\v201802\CdnConfigurationType;
use Google\AdsApi\AdManager\v201802\MediaLocationSettings;
use Google\AdsApi\AdManager\v201802\OriginForwardingType;
use Google\AdsApi\AdManager\v201802\SecurityPolicySettings;
use Google\AdsApi\AdManager\v201802\SecurityPolicyType;
use Google\AdsApi\AdManager\v201802\SourceContentConfiguration;
...
class CreateCdnConfigurations
{
    ...
    public static function runExample(
        ...
        $cdnConfigurationService = $adManagerServices->get(
            $session,
            CdnConfigurationService::class
        );
