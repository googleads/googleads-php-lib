...
namespace Google\AdsApi\Examples\AdManager\v201802\ActivityGroupService;
...
use Google\AdsApi\AdManager\v201802\ActivityGroupService;
use Google\AdsApi\AdManager\v201802\ActivityGroupStatus;
...
class GetActiveActivityGroups
{
    ...
    public static function runExample(
        ...
        $activityGroupService = $adManagerServices->get(
            $session,
            ActivityGroupService::class
        );
        ...
        $statementBuilder = (new StatementBuilder())->where('status = :status')
            ->orderBy('id ASC')
            ->limit($pageSize)
            ->withBindVariableValue('status', ActivityGroupStatus::ACTIVE);
        ...
        do {
            ...
            if ($page->getResults() !== null) {
                ...
                foreach ($page->getResults() as $activityGroup) {
                    printf(
                        "%d) Activity group with ID %d and name '%s' was "
                        . "found.\n",
                        $i++,
                        $activityGroup->getId(),
