...
namespace Google\AdsApi\Examples\AdManager\v201802\CreativeWrapperService;
...
use Google\AdsApi\AdManager\v201802\CreativeWrapperService;
use Google\AdsApi\AdManager\v201802\CreativeWrapperStatus;
...
class GetActiveCreativeWrappers
{
    ...
    public static function runExample(
        ...
        $creativeWrapperService = $adManagerServices->get(
            $session,
            CreativeWrapperService::class
        );
