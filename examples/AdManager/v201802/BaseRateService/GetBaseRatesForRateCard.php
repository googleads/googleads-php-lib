...
namespace Google\AdsApi\Examples\AdManager\v201802\BaseRateService;
...
use Google\AdsApi\AdManager\v201802\BaseRateService;
...
class GetBaseRatesForRateCard
{
    ...
    public static function runExample(
        ...
        $baseRateService = $adManagerServices->get(
            $session,
            BaseRateService::class
        );
        ...
        do {
            ...
            if ($page->getResults() !== null) {
                ...
                foreach ($page->getResults() as $baseRate) {
                    printf(
                        "%d) Base rate with ID %d, type '%s', and rate card ID "
                        . "%d was found.\n",
                        $i++,
                        $baseRate->getId(),
