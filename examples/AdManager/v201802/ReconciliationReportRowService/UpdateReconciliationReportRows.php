...
namespace Google\AdsApi\Examples\AdManager\v201802\ReconciliationReportRowService;
...
use Google\AdsApi\AdManager\v201802\ReconciliationReportRowService;
...
class UpdateReconciliationReportRows
{
    ...
    const RECONCILIATION_REPORT_ID =
    ...
    public static function runExample(
        ...
        $reconciliationReportRowService = $adManagerServices->get(
            $session,
        ...
        $row->setComments(
            'Third party volume didn\'t match AdManager - we agreed to split '
            . 'the difference'
        );
