...
use Google\AdsApi\AdManager\v201802\AssetCreativeTemplateVariableValue;
...
use Google\AdsApi\AdManager\v201802\StringCreativeTemplateVariableValue;
use Google\AdsApi\AdManager\v201802\TemplateCreative;
use Google\AdsApi\AdManager\v201802\UrlCreativeTemplateVariableValue;
...
class CreateNativeCreatives
{
    ...
    public static function runExample(
        ...
        $appIconAsset->setAssetByteArray(
            file_get_contents(
                'https://lh6.ggpht.com/Jzvjne5CLs6fJ1MHF-XeuUfpABzl0YNMlp4RpHnv'
                . 'PRCIj4--eTDwtyouwUDzVVekXw=w300'
            )
        );
