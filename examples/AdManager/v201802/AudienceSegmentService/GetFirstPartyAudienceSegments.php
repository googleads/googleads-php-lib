...
namespace Google\AdsApi\Examples\AdManager\v201802\AudienceSegmentService;
...
use Google\AdsApi\AdManager\v201802\AudienceSegmentService;
use Google\AdsApi\AdManager\v201802\AudienceSegmentType;
...
class GetFirstPartyAudienceSegments
{
    ...
    public static function runExample(
        ...
        $audienceSegmentService = $adManagerServices->get(
            $session,
            AudienceSegmentService::class
        );
