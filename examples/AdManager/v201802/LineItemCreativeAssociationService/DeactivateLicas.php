...
use Google\AdsApi\AdManager\v201802\DeactivateLineItemCreativeAssociations as DeactivateLineItemCreativeAssociationsAction;
            ...
            if ($page->getResults() !== null) {
                ...
                foreach ($page->getResults() as $lica) {
                    if ($lica->getCreativeSetId() !== null) {
                        printf(
                            "%d) Line item creative association with line item"
                            . " ID %d and creative set ID %d will be "
                            . "deactivated.\n",
                            $i++,
                            $lica->getLineItemId(),
                        ...
                        printf(
                            "%d) Line item creative association with line item"
                            . " ID %d and creative ID %d will be "
                            . "deactivated.\n",
                            $i++,
                            $lica->getLineItemId(),
                            $lica->getCreativeId()
