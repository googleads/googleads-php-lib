...
namespace Google\AdsApi\Examples\AdManager\v201802\LabelService;
...
use Google\AdsApi\AdManager\v201802\LabelService;
...
class GetActiveLabels
{
    ...
    public static function runExample(
        ...
        $labelService = $adManagerServices->get($session, LabelService::class);
