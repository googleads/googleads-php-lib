...
namespace Google\AdsApi\Examples\AdManager\v201802\RateCardService;
...
use Google\AdsApi\AdManager\v201802\RateCardService;
...
class GetMarketplaceRateCards
{
    ...
    public static function runExample(
        ...
        $rateCardService = $adManagerServices->get(
            $session,
            RateCardService::class
        );
        ...
        do {
            ...
            if ($page->getResults() !== null) {
                ...
                foreach ($page->getResults() as $rateCard) {
                    printf(
                        "%d) Rate card with ID %d, name '%s', and currency code"
                        . " '%s' was found.\n",
                        $i++,
                        $rateCard->getId(),
                        $rateCard->getName(),
