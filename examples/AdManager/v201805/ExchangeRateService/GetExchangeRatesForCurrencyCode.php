...
namespace Google\AdsApi\Examples\AdManager\v201805\ExchangeRateService;
...
class GetExchangeRatesForCurrencyCode
{
            ...
            if ($page->getResults() !== null) {
                ...
                foreach ($page->getResults() as $exchangeRate) {
                    printf(
                        ...
                        . " and exchange rate %.2f was found.%s",
                        $i++,
                        $exchangeRate->getId(),
    ...
    public static function main()
    {
        ...
        self::runExample(new ServiceFactory(), $session, self::CURRENCY_CODE);
    }
}
