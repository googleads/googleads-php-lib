...
namespace Google\AdsApi\Examples\AdManager\v201811\ReportService;

require __DIR__ . '/../../../../vendor/autoload.php';

use Google\AdsApi\AdManager\AdManagerSession;
use Google\AdsApi\AdManager\AdManagerSessionBuilder;
use Google\AdsApi\AdManager\Util\v201811\ReportDownloader;
use Google\AdsApi\AdManager\Util\v201811\StatementBuilder;
use Google\AdsApi\AdManager\v201811\Column;
use Google\AdsApi\AdManager\v201811\DateRangeType;
use Google\AdsApi\AdManager\v201811\Dimension;
use Google\AdsApi\AdManager\v201811\ExportFormat;
use Google\AdsApi\AdManager\v201811\ReportJob;
use Google\AdsApi\AdManager\v201811\ReportQuery;
use Google\AdsApi\AdManager\v201811\ReportQueryAdUnitView;
