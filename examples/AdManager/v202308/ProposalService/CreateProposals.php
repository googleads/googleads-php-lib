...
namespace Google\AdsApi\Examples\AdManager\v202308\ProposalService;

require __DIR__ . '/../../../../vendor/autoload.php';

use Google\AdsApi\AdManager\AdManagerSession;
use Google\AdsApi\AdManager\AdManagerSessionBuilder;
use Google\AdsApi\AdManager\v202308\Proposal;
use Google\AdsApi\AdManager\v202308\ProposalCompanyAssociation;
use Google\AdsApi\AdManager\v202308\ProposalCompanyAssociationType;
use Google\AdsApi\AdManager\v202308\ProposalMarketplaceInfo;
use Google\AdsApi\AdManager\v202308\SalespersonSplit;
