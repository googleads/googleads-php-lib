...
namespace Google\AdsApi\Examples\AdManager\v202408\ProposalService;

require __DIR__ . '/../../../../vendor/autoload.php';

use Google\AdsApi\AdManager\AdManagerSession;
use Google\AdsApi\AdManager\AdManagerSessionBuilder;
use Google\AdsApi\AdManager\v202408\Proposal;
use Google\AdsApi\AdManager\v202408\ProposalCompanyAssociation;
use Google\AdsApi\AdManager\v202408\ProposalCompanyAssociationType;
use Google\AdsApi\AdManager\v202408\ProposalMarketplaceInfo;
use Google\AdsApi\AdManager\v202408\SalespersonSplit;
