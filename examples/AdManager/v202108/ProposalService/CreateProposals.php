...
namespace Google\AdsApi\Examples\AdManager\v202108\ProposalService;

require __DIR__ . '/../../../../vendor/autoload.php';

use Google\AdsApi\AdManager\AdManagerSession;
use Google\AdsApi\AdManager\AdManagerSessionBuilder;
use Google\AdsApi\AdManager\v202108\Proposal;
use Google\AdsApi\AdManager\v202108\ProposalCompanyAssociation;
use Google\AdsApi\AdManager\v202108\ProposalCompanyAssociationType;
use Google\AdsApi\AdManager\v202108\ProposalMarketplaceInfo;
use Google\AdsApi\AdManager\v202108\SalespersonSplit;
