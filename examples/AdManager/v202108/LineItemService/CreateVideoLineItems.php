...
namespace Google\AdsApi\Examples\AdManager\v202108\LineItemService;
...
use Google\AdsApi\AdManager\v202108\AdUnitTargeting;
use Google\AdsApi\AdManager\v202108\CmsMetadataCriteria;
use Google\AdsApi\AdManager\v202108\CmsMetadataCriteriaComparisonOperator;
use Google\AdsApi\AdManager\v202108\CompanionDeliveryOption;
use Google\AdsApi\AdManager\v202108\ContentTargeting;
use Google\AdsApi\AdManager\v202108\CostType;
use Google\AdsApi\AdManager\v202108\CreativePlaceholder;
use Google\AdsApi\AdManager\v202108\CreativeRotationType;
use Google\AdsApi\AdManager\v202108\CustomCriteriaSet;
use Google\AdsApi\AdManager\v202108\CustomCriteriaSetLogicalOperator;
use Google\AdsApi\AdManager\v202108\EnvironmentType;
use Google\AdsApi\AdManager\v202108\Goal;
use Google\AdsApi\AdManager\v202108\GoalType;
use Google\AdsApi\AdManager\v202108\InventoryTargeting;
use Google\AdsApi\AdManager\v202108\LineItem;
use Google\AdsApi\AdManager\v202108\LineItemType;
use Google\AdsApi\AdManager\v202108\Money;
use Google\AdsApi\AdManager\v202108\RequestPlatform;
use Google\AdsApi\AdManager\v202108\RequestPlatformTargeting;
use Google\AdsApi\AdManager\v202108\ServiceFactory;
use Google\AdsApi\AdManager\v202108\Size;
use Google\AdsApi\AdManager\v202108\StartDateTimeType;
use Google\AdsApi\AdManager\v202108\Targeting;
use Google\AdsApi\AdManager\v202108\VideoPosition;
use Google\AdsApi\AdManager\v202108\VideoPositionTarget;
use Google\AdsApi\AdManager\v202108\VideoPositionTargeting;
use Google\AdsApi\AdManager\v202108\VideoPositionType;
...
class CreateVideoLineItems
{
    ...
    public static function runExample(
        ...
        // https://developers.google.com/ad-manager/docs/reference/v202108/LineItemService.VideoPositionTarget
