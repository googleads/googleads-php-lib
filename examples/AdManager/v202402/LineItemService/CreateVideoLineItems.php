...
namespace Google\AdsApi\Examples\AdManager\v202402\LineItemService;
...
use Google\AdsApi\AdManager\v202402\AdUnitTargeting;
use Google\AdsApi\AdManager\v202402\CmsMetadataCriteria;
use Google\AdsApi\AdManager\v202402\CmsMetadataCriteriaComparisonOperator;
use Google\AdsApi\AdManager\v202402\CompanionDeliveryOption;
use Google\AdsApi\AdManager\v202402\ContentTargeting;
use Google\AdsApi\AdManager\v202402\CostType;
use Google\AdsApi\AdManager\v202402\CreativePlaceholder;
use Google\AdsApi\AdManager\v202402\CreativeRotationType;
use Google\AdsApi\AdManager\v202402\CustomCriteriaSet;
use Google\AdsApi\AdManager\v202402\CustomCriteriaSetLogicalOperator;
use Google\AdsApi\AdManager\v202402\EnvironmentType;
use Google\AdsApi\AdManager\v202402\Goal;
use Google\AdsApi\AdManager\v202402\GoalType;
use Google\AdsApi\AdManager\v202402\InventoryTargeting;
use Google\AdsApi\AdManager\v202402\LineItem;
use Google\AdsApi\AdManager\v202402\LineItemType;
use Google\AdsApi\AdManager\v202402\Money;
use Google\AdsApi\AdManager\v202402\RequestPlatform;
use Google\AdsApi\AdManager\v202402\RequestPlatformTargeting;
use Google\AdsApi\AdManager\v202402\ServiceFactory;
use Google\AdsApi\AdManager\v202402\Size;
use Google\AdsApi\AdManager\v202402\StartDateTimeType;
use Google\AdsApi\AdManager\v202402\Targeting;
use Google\AdsApi\AdManager\v202402\VideoPosition;
use Google\AdsApi\AdManager\v202402\VideoPositionTarget;
use Google\AdsApi\AdManager\v202402\VideoPositionTargeting;
use Google\AdsApi\AdManager\v202402\VideoPositionType;
...
class CreateVideoLineItems
{
    ...
    public static function runExample(
        ...
        // https://developers.google.com/ad-manager/docs/reference/v202402/LineItemService.VideoPositionTarget
