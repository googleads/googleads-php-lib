...
namespace Google\AdsApi\Examples\AdManager\v202402\ProposalService;

require __DIR__ . '/../../../../vendor/autoload.php';

use Google\AdsApi\AdManager\AdManagerSession;
use Google\AdsApi\AdManager\AdManagerSessionBuilder;
use Google\AdsApi\AdManager\v202402\Proposal;
use Google\AdsApi\AdManager\v202402\ProposalCompanyAssociation;
use Google\AdsApi\AdManager\v202402\ProposalCompanyAssociationType;
use Google\AdsApi\AdManager\v202402\ProposalMarketplaceInfo;
use Google\AdsApi\AdManager\v202402\SalespersonSplit;
