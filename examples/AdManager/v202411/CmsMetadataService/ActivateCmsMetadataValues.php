...
namespace Google\AdsApi\Examples\AdManager\v202411\CmsMetadataService;
...
use Google\AdsApi\AdManager\v202411\CmsMetadataKeyStatus;
...
class ActivateCmsMetadataValues
{
    ...
    )
    {
        ...
        if ($totalResultSetSize > 0) {
            ...
            // Create an action.
            $action = new \Google\AdsApi\AdManager\v202411\ActivateCmsMetadataValues();
