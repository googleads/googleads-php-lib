...
namespace Google\AdsApi\Examples\AdManager\v202411\ProposalService;

require __DIR__ . '/../../../../vendor/autoload.php';

use Google\AdsApi\AdManager\AdManagerSession;
use Google\AdsApi\AdManager\AdManagerSessionBuilder;
use Google\AdsApi\AdManager\v202411\Proposal;
use Google\AdsApi\AdManager\v202411\ProposalCompanyAssociation;
use Google\AdsApi\AdManager\v202411\ProposalCompanyAssociationType;
use Google\AdsApi\AdManager\v202411\ProposalMarketplaceInfo;
use Google\AdsApi\AdManager\v202411\SalespersonSplit;
