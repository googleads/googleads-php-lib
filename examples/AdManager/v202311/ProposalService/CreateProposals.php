...
namespace Google\AdsApi\Examples\AdManager\v202311\ProposalService;

require __DIR__ . '/../../../../vendor/autoload.php';

use Google\AdsApi\AdManager\AdManagerSession;
use Google\AdsApi\AdManager\AdManagerSessionBuilder;
use Google\AdsApi\AdManager\v202311\Proposal;
use Google\AdsApi\AdManager\v202311\ProposalCompanyAssociation;
use Google\AdsApi\AdManager\v202311\ProposalCompanyAssociationType;
use Google\AdsApi\AdManager\v202311\ProposalMarketplaceInfo;
use Google\AdsApi\AdManager\v202311\SalespersonSplit;
