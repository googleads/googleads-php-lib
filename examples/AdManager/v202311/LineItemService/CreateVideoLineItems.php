...
namespace Google\AdsApi\Examples\AdManager\v202311\LineItemService;
...
use Google\AdsApi\AdManager\Util\v202311\AdManagerDateTimes;
use Google\AdsApi\AdManager\v202311\AdUnitTargeting;
use Google\AdsApi\AdManager\v202311\CmsMetadataCriteria;
use Google\AdsApi\AdManager\v202311\CmsMetadataCriteriaComparisonOperator;
use Google\AdsApi\AdManager\v202311\CompanionDeliveryOption;
use Google\AdsApi\AdManager\v202311\ContentTargeting;
use Google\AdsApi\AdManager\v202311\CostType;
use Google\AdsApi\AdManager\v202311\CreativePlaceholder;
use Google\AdsApi\AdManager\v202311\CreativeRotationType;
use Google\AdsApi\AdManager\v202311\CustomCriteriaSet;
use Google\AdsApi\AdManager\v202311\CustomCriteriaSetLogicalOperator;
use Google\AdsApi\AdManager\v202311\EnvironmentType;
use Google\AdsApi\AdManager\v202311\Goal;
use Google\AdsApi\AdManager\v202311\GoalType;
use Google\AdsApi\AdManager\v202311\InventoryTargeting;
use Google\AdsApi\AdManager\v202311\LineItem;
use Google\AdsApi\AdManager\v202311\LineItemType;
use Google\AdsApi\AdManager\v202311\Money;
use Google\AdsApi\AdManager\v202311\RequestPlatform;
use Google\AdsApi\AdManager\v202311\RequestPlatformTargeting;
use Google\AdsApi\AdManager\v202311\ServiceFactory;
use Google\AdsApi\AdManager\v202311\Size;
use Google\AdsApi\AdManager\v202311\StartDateTimeType;
use Google\AdsApi\AdManager\v202311\Targeting;
use Google\AdsApi\AdManager\v202311\VideoPosition;
use Google\AdsApi\AdManager\v202311\VideoPositionTarget;
use Google\AdsApi\AdManager\v202311\VideoPositionTargeting;
use Google\AdsApi\AdManager\v202311\VideoPositionType;
...
class CreateVideoLineItems
{
    ...
    public static function runExample(
        ...
        // https://developers.google.com/ad-manager/docs/reference/v202311/LineItemService.VideoPositionTarget
