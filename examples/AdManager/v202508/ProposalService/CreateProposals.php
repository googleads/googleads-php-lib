...
namespace Google\AdsApi\Examples\AdManager\v202508\ProposalService;

require __DIR__ . '/../../../../vendor/autoload.php';

use Google\AdsApi\AdManager\AdManagerSession;
use Google\AdsApi\AdManager\AdManagerSessionBuilder;
use Google\AdsApi\AdManager\v202508\Proposal;
use Google\AdsApi\AdManager\v202508\ProposalCompanyAssociation;
use Google\AdsApi\AdManager\v202508\ProposalCompanyAssociationType;
use Google\AdsApi\AdManager\v202508\ProposalMarketplaceInfo;
use Google\AdsApi\AdManager\v202508\SalespersonSplit;
