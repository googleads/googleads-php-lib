...
namespace Google\AdsApi\Examples\AdManager\v202508\LineItemService;
...
use Google\AdsApi\AdManager\Util\v202508\AdManagerDateTimes;
use Google\AdsApi\AdManager\v202508\AdUnitTargeting;
use Google\AdsApi\AdManager\v202508\CmsMetadataCriteria;
use Google\AdsApi\AdManager\v202508\CmsMetadataCriteriaComparisonOperator;
use Google\AdsApi\AdManager\v202508\CompanionDeliveryOption;
use Google\AdsApi\AdManager\v202508\ContentTargeting;
use Google\AdsApi\AdManager\v202508\CostType;
use Google\AdsApi\AdManager\v202508\CreativePlaceholder;
use Google\AdsApi\AdManager\v202508\CreativeRotationType;
use Google\AdsApi\AdManager\v202508\CustomCriteriaSet;
use Google\AdsApi\AdManager\v202508\CustomCriteriaSetLogicalOperator;
use Google\AdsApi\AdManager\v202508\EnvironmentType;
use Google\AdsApi\AdManager\v202508\Goal;
use Google\AdsApi\AdManager\v202508\GoalType;
use Google\AdsApi\AdManager\v202508\InventoryTargeting;
use Google\AdsApi\AdManager\v202508\LineItem;
use Google\AdsApi\AdManager\v202508\LineItemType;
use Google\AdsApi\AdManager\v202508\Money;
use Google\AdsApi\AdManager\v202508\RequestPlatform;
use Google\AdsApi\AdManager\v202508\RequestPlatformTargeting;
use Google\AdsApi\AdManager\v202508\ServiceFactory;
use Google\AdsApi\AdManager\v202508\Size;
use Google\AdsApi\AdManager\v202508\StartDateTimeType;
use Google\AdsApi\AdManager\v202508\Targeting;
use Google\AdsApi\AdManager\v202508\VideoPosition;
use Google\AdsApi\AdManager\v202508\VideoPositionTarget;
use Google\AdsApi\AdManager\v202508\VideoPositionTargeting;
use Google\AdsApi\AdManager\v202508\VideoPositionType;
...
class CreateVideoLineItems
{
    ...
    public static function runExample(
        ...
        // https://developers.google.com/ad-manager/docs/reference/v202508/LineItemService.VideoPositionTarget
