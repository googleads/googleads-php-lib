...
namespace Google\AdsApi\Examples\AdManager\v202508\ContactService;
...
use Google\AdsApi\AdManager\v202508\ContactStatus;
...
class GetUninvitedContacts
{
    ...
    public static function runExample(
        ...
        $contactService = $serviceFactory->createContactService($session);
        ...
        do {
            ...
            if ($page->getResults() !== null) {
                ...
                foreach ($page->getResults() as $contact) {
                    printf(
                        "%d) Contact with ID %d and name '%s' was found.%s",
                        $i++,
                        $contact->getId(),
                        $contact->getName(),
                        PHP_EOL
