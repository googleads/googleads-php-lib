...
namespace Google\AdsApi\Examples\AdManager\v202208\ProposalService;

require __DIR__ . '/../../../../vendor/autoload.php';

use Google\AdsApi\AdManager\AdManagerSession;
use Google\AdsApi\AdManager\AdManagerSessionBuilder;
use Google\AdsApi\AdManager\v202208\Proposal;
use Google\AdsApi\AdManager\v202208\ProposalCompanyAssociation;
use Google\AdsApi\AdManager\v202208\ProposalCompanyAssociationType;
use Google\AdsApi\AdManager\v202208\ProposalMarketplaceInfo;
use Google\AdsApi\AdManager\v202208\SalespersonSplit;
