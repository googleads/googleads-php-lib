...
namespace Google\AdsApi\Examples\AdManager\v202208\CmsMetadataService;
...
use Google\AdsApi\AdManager\v202208\CmsMetadataKeyStatus;
...
class ActivateCmsMetadataValues
{
    ...
    )
    {
        ...
        if ($totalResultSetSize > 0) {
            ...
            // Create an action.
            $action = new \Google\AdsApi\AdManager\v202208\ActivateCmsMetadataValues();
