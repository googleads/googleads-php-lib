...
namespace Google\AdsApi\Examples\AdManager\v202208\LineItemService;
...
use Google\AdsApi\AdManager\v202208\CmsMetadataCriteria;
use Google\AdsApi\AdManager\v202208\CmsMetadataCriteriaComparisonOperator;
use Google\AdsApi\AdManager\v202208\CompanionDeliveryOption;
use Google\AdsApi\AdManager\v202208\ContentTargeting;
use Google\AdsApi\AdManager\v202208\CostType;
use Google\AdsApi\AdManager\v202208\CreativePlaceholder;
use Google\AdsApi\AdManager\v202208\CreativeRotationType;
use Google\AdsApi\AdManager\v202208\CustomCriteriaSet;
use Google\AdsApi\AdManager\v202208\CustomCriteriaSetLogicalOperator;
use Google\AdsApi\AdManager\v202208\EnvironmentType;
use Google\AdsApi\AdManager\v202208\Goal;
use Google\AdsApi\AdManager\v202208\GoalType;
use Google\AdsApi\AdManager\v202208\InventoryTargeting;
use Google\AdsApi\AdManager\v202208\LineItem;
use Google\AdsApi\AdManager\v202208\LineItemType;
use Google\AdsApi\AdManager\v202208\Money;
use Google\AdsApi\AdManager\v202208\RequestPlatform;
...
use Google\AdsApi\AdManager\v202208\StartDateTimeType;
use Google\AdsApi\AdManager\v202208\Targeting;
use Google\AdsApi\AdManager\v202208\VideoPosition;
use Google\AdsApi\AdManager\v202208\VideoPositionTarget;
use Google\AdsApi\AdManager\v202208\VideoPositionTargeting;
use Google\AdsApi\AdManager\v202208\VideoPositionType;
...
class CreateVideoLineItems
{
    ...
    public static function runExample(
        ...
        // https://developers.google.com/ad-manager/docs/reference/v202208/LineItemService.VideoPositionTarget
