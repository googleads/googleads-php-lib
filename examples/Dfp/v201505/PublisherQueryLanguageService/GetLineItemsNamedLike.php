 ...
 * https://developers.google.com/doubleclick-publishers/docs/reference/v201505/PublisherQueryLanguageService#Line_Item
 *
...
require_once 'Google/Api/Ads/Dfp/Util/v201505/Pql.php';
...
try {
  ...
  $pqlService = $user->GetService('PublisherQueryLanguageService', 'v201505');
