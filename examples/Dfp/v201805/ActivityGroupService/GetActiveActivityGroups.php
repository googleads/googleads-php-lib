...
namespace Google\AdsApi\Examples\Dfp\v201805\ActivityGroupService;
...
use Google\AdsApi\Dfp\v201805\ActivityGroupService;
use Google\AdsApi\Dfp\v201805\ActivityGroupStatus;
...
class GetActiveActivityGroups
{
    ...
    public static function runExample(
        ...
        $activityGroupService = $serviceFactory->createActivityGroupService(
            $session
        );
