<?php
/**
 * This example gets all rate cards that have a currency in US dollars. To
 * create rate cards, run CreateRateCards.php.
 *
 * PHP version 5
 *
...
try {
  ...
  $rateCardService = $user->GetService('RateCardService', 'v201605');

  // Create a statement to select only rate cards that have a currency in US
  // dollars.
