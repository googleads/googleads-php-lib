<?php
/**
 * This example updates a company's comment. To determine which companies exist,
 * run GetAllCompanies.php.
 *
 * PHP version 5
 *
...
try {
  ...
  $companyService = $user->GetService('CompanyService', 'v201605');
