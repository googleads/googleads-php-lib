 ...
 */
namespace Google\AdsApi\Examples\Dfp\v201708\WorkflowRequestService;
...
use Google\AdsApi\Dfp\v201708\TriggerWorkflowExternalConditionRequests as TriggerWorkflowExternalConditionRequestsAction;
use Google\AdsApi\Dfp\v201708\WorkflowEntityType;
use Google\AdsApi\Dfp\v201708\WorkflowRequestService;
use Google\AdsApi\Dfp\v201708\WorkflowRequestType;
  ...
  public static function runExample(DfpServices $dfpServices,
    ...
    $statementBuilder = (new StatementBuilder())
        ...
        ->withBindVariableValue(
            'type', WorkflowRequestType::WORKFLOW_EXTERNAL_CONDITION_REQUEST);
    ...
    printf(
        "Total number of workflow external condition requests to be triggered: "
            . "%d\n",
        $totalResultSetSize
    );
    ...
    if ($totalResultSetSize > 0) {
      ...
      if ($result !== null && $result->getNumChanges() > 0) {
        printf("Number of workflow external condition requests triggered: %d\n",
