 ...
 */
namespace Google\AdsApi\Examples\Dfp\v201708\PackageService;
...
use Google\AdsApi\Dfp\v201708\PackageStatus;
use Google\AdsApi\Dfp\v201708\PackageService;
...
class GetInProgressPackages {
  ...
  public static function runExample(DfpServices $dfpServices,
      DfpSession $session) {
    $packageService =
        $dfpServices->get($session, PackageService::class);
