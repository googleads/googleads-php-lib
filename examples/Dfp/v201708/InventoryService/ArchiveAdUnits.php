...
namespace Google\AdsApi\Examples\Dfp\v201708\InventoryService;
...
use Google\AdsApi\Dfp\v201708\ArchiveAdUnits as ArchiveAdUnitsAction;
use Google\AdsApi\Dfp\v201708\InventoryService;
...
class ArchiveAdUnits
{
    ...
    public static function runExample(
        ...
        $statementBuilder =
            (new StatementBuilder())->where('parentId = :parentId or id = :parentId')
                ->orderBy(
                    'id ASC'
                )
                ->limit($pageSize)
