 ...
 */
namespace Google\AdsApi\Examples\Dfp\v201705\ReconciliationLineItemReportService;
...
use Google\AdsApi\Dfp\v201705\BillFrom;
use Google\AdsApi\Dfp\v201705\ReconciliationLineItemReportService;
...
class UpdateReconciliationLineItemReports {
  ...
  public static function runExample(DfpServices $dfpServices,
      DfpSession $session, $reconciliationLineItemReportId) {
    ...
    $statementBuilder = (new StatementBuilder())
        ...
        ->withBindVariableValue(
            'reconciliationLineItemReportId', $reconciliationLineItemReportId);
