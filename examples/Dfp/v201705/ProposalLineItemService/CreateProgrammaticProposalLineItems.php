 ...
 */
namespace Google\AdsApi\Examples\Dfp\v201705\ProposalLineItemService;
...
use Google\AdsApi\Dfp\v201705\AdExchangeEnvironment;
use Google\AdsApi\Dfp\v201705\Goal;
use Google\AdsApi\Dfp\v201705\LineItemType;
use Google\AdsApi\Dfp\v201705\Money;
use Google\AdsApi\Dfp\v201705\ProposalLineItem;
use Google\AdsApi\Dfp\v201705\ProposalLineItemMarketplaceInfo;
use Google\AdsApi\Dfp\v201705\ProposalLineItemService;
...
class CreateProgrammaticProposalLineItems {
  ...
  public static function runExample(DfpServices $dfpServices,
      DfpSession $session, $proposalId, $productId, $rateCardId) {
    ...
    foreach ($results as $i => $proposalLineItem) {
      printf(
          "%d) Programmatic proposal line item with ID %d and name '%s' was "
              . "created.\n",
          $i,
