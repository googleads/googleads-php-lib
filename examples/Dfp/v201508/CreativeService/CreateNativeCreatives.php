...
try {
  ...
  $imageVariableValue->assetByteArray =
      MediaUtils::GetBase64Data('https://lh4.ggpht.com/GIGNKdGHMEHFDw6TM2bgAUDK'
          . 'PQQRIReKZPqEpMeEhZOPYnTdOQGaSpGSEZflIFs0iw=h300');
  $nativeAppInstallCreative->creativeTemplateVariableValues[] =
      $imageVariableValue;
  ...
  $appIconVariableValue->assetByteArray =
      MediaUtils::GetBase64Data('https://lh6.ggpht.com/Jzvjne5CLs6fJ1MHF-XeuUfp'
          . 'ABzl0YNMlp4RpHnvPRCIj4--eTDwtyouwUDzVVekXw=w300');
  $nativeAppInstallCreative->creativeTemplateVariableValues[] =
