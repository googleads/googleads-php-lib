...
// Set the IDs of the reconciliation report, line item, and creative to retrieve
// rows for.
...
try {
  ...
  $reconciliationReportRowService =
      $user->GetService('ReconciliationReportRowService', 'v201508');
  ...
  $statementBuilder->Where('reconciliationReportId = :reconciliationReportId '
      . 'AND lineItemId = :lineItemId AND creativeId = :creativeId')
