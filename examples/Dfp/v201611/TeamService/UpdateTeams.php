<?php
/**
 * This example updates a team's description. To determine which teams exist,
 * run GetAllTeams.php.
 *
 * PHP version 5
 *
...
try {
  ...
  // Get the TeamService.
  $teamService = $user->GetService('TeamService', 'v201611');
  ...
  $newDescription = $team->description . ' - UPDATED';
