 ...
 *
 * Tags: ForecastService.getLineItemDeliveryForecasts
 *
 * PHP version 5
 *
...
require_once 'Google/Api/Ads/Dfp/Util/v201502/DateTimeUtils.php';
...
try {
  ...
  $forecastService = $user->GetService('ForecastService', 'v201502');
