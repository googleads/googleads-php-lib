 ...
 */
namespace Google\AdsApi\Examples\Dfp\v201602\LineItemService;
...
use Google\AdsApi\Dfp\v201602\PauseLineItems as PauseLineItemsAction;
...
class PauseLineItems {
  ...
  public static function runExample(DfpServices $dfpServices,
    ...
    $lineItemService = $dfpServices->get(
        $session, 'LineItemService', 'v201602');
