 ...
 */
namespace Google\AdsApi\Examples\Dfp\v201602\CustomFieldService;
...
use Google\AdsApi\Dfp\v201602\CustomFieldEntityType;
...
class GetCustomFieldsForLineItems {
  ...
  public static function runExample(DfpServices $dfpServices,
      DfpSession $session) {
    $customFieldService =
        $dfpServices->get($session, 'CustomFieldService', 'v201602');
