 ...
 */
namespace Google\AdsApi\Examples\Dfp\v201602\ProposalService;
...
use Google\AdsApi\Dfp\v201602\ProposalStatus;
...
class GetProposalsPendingApproval {
  ...
  public static function runExample(DfpServices $dfpServices,
      DfpSession $session) {
    $proposalService =
        $dfpServices->get($session, 'ProposalService', 'v201602');
