 ...
 */
namespace Google\AdsApi\Examples\Dfp\v201602\PlacementService;
...
use Google\AdsApi\Dfp\v201602\InventoryStatus;
...
class GetActivePlacements {
  ...
  public static function runExample(DfpServices $dfpServices,
      DfpSession $session) {
    $placementService =
        $dfpServices->get($session, 'PlacementService', 'v201602');
