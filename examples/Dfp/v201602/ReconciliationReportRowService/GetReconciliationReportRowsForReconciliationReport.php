 ...
 */
namespace Google\AdsApi\Examples\Dfp\v201602\ReconciliationReportRowService;
...
class GetReconciliationReportRowsForReconciliationReport {
  ...
  public static function runExample(DfpServices $dfpServices,
    ...
    $reconciliationReportRowService =
        $dfpServices->get($session, 'ReconciliationReportRowService', 'v201602');
    ...
    do {
      ...
      if ($page->getResults() !== null) {
        ...
        foreach ($page->getResults() as $reconciliationReportRow) {
          printf(
              "%d) Reconciliation report row with ID %d, reconciliation source '%s', and reconciled volume %d was found.\n",
              $i++,
