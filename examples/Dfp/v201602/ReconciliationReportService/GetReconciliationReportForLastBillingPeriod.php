 ...
 */
namespace Google\AdsApi\Examples\Dfp\v201602\ReconciliationReportService;
...
class GetReconciliationReportForLastBillingPeriod {
  ...
  public static function runExample(DfpServices $dfpServices,
    ...
    $reconciliationReportService =
        $dfpServices->get($session, 'ReconciliationReportService', 'v201602');

    $networkService = $dfpServices->get($session, 'NetworkService', 'v201602');
