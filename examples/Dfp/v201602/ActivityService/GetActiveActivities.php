 ...
 */
namespace Google\AdsApi\Examples\Dfp\v201602\ActivityService;
...
use Google\AdsApi\Dfp\v201602\ActivityStatus;
...
class GetActiveActivities {
  ...
  public static function runExample(DfpServices $dfpServices,
      DfpSession $session) {
    $activityService =
        $dfpServices->get($session, 'ActivityService', 'v201602');
