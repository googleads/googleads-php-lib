 ...
 */
namespace Google\AdsApi\Examples\Dfp\v201602\ReportService;
...
use Google\AdsApi\Dfp\v201602\Column;
use Google\AdsApi\Dfp\v201602\DateRangeType;
use Google\AdsApi\Dfp\v201602\Dimension;
use Google\AdsApi\Dfp\v201602\ExportFormat;
use Google\AdsApi\Dfp\v201602\ReportJob;
use Google\AdsApi\Dfp\v201602\ReportQuery;
use Google\AdsApi\Dfp\v201602\ReportQueryAdUnitView;
...
class RunInventoryReport {
  ...
  public static function runExample(DfpServices $dfpServices,
      DfpSession $session) {
    $reportService =
        $dfpServices->get($session, 'ReportService', 'v201602');
    $networkService =
        $dfpServices->get($session, 'NetworkService', 'v201602');
