...
try {
  ...
  $contentService = $user->GetService('ContentService', 'v201308');

  // Get the NetworkService.
  $networkService = $user->GetService('NetworkService', 'v201308');

  // Get the CustomTargetingService.
  $customTargetingService =
      $user->GetService('CustomTargetingService', 'v201308');
