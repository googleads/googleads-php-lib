...
namespace Google\AdsApi\Examples\Dfp\v201711\ContentService;
...
use Google\AdsApi\Dfp\v201711\ContentService;
...
class GetAllContent
{
    ...
    public static function runExample(
        ...
        $contentService = $dfpServices->get($session, ContentService::class);
