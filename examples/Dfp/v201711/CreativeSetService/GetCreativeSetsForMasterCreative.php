...
namespace Google\AdsApi\Examples\Dfp\v201711\CreativeSetService;
...
use Google\AdsApi\Dfp\v201711\CreativeSetService;
...
class GetCreativeSetsForMasterCreative
{
    ...
    public static function runExample(
        ...
        $statementBuilder = (new StatementBuilder())->where('masterCreativeId = :masterCreativeId')
            ->orderBy(
                'id ASC'
            )
            ->limit($pageSize)
