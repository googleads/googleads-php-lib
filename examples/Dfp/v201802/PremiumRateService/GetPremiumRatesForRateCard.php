...
namespace Google\AdsApi\Examples\Dfp\v201802\PremiumRateService;
...
use Google\AdsApi\Dfp\v201802\PremiumRateService;
...
class GetPremiumRatesForRateCard
{
    ...
    public static function runExample(DfpServices $dfpServices, DfpSession $session, $rateCardId)
    {
        ...
        $statementBuilder = (new StatementBuilder())->where('rateCardId = :rateCardId')
            ->orderBy('id ASC')
            ->limit(
                $pageSize
            )
