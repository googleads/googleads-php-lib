...
class CreateLineItemsWithCustomCriteria
{
    ...
    const CUSTOM_TARGETING_VALUE_ID_2A = 'INSERT_CUSTOM_TARGETING_VALUE_ID_2A_HERE';
    const CUSTOM_TARGETING_VALUE_ID_2B = 'INSERT_CUSTOM_TARGETING_VALUE_ID_2B_HERE';
