...
namespace Google\AdsApi\Examples\Dfp\v201802\CustomFieldService;
...
use Google\AdsApi\Dfp\v201802\CustomFieldEntityType;
use Google\AdsApi\Dfp\v201802\CustomFieldService;
...
class GetCustomFieldsForLineItems
{
    ...
    public static function runExample(DfpServices $dfpServices, DfpSession $session)
    {
        ...
        $statementBuilder = (new StatementBuilder())->where('entityType = :entityType')
            ->orderBy('id ASC')
            ->limit(
                $pageSize
            )
