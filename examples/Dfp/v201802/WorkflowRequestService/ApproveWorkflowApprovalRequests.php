...
namespace Google\AdsApi\Examples\Dfp\v201802\WorkflowRequestService;
...
use Google\AdsApi\Dfp\v201802\ApproveWorkflowApprovalRequests as ApproveWorkflowApprovalRequestsAction;
use Google\AdsApi\Dfp\v201802\WorkflowEntityType;
use Google\AdsApi\Dfp\v201802\WorkflowRequestService;
use Google\AdsApi\Dfp\v201802\WorkflowRequestType;
...
class ApproveWorkflowApprovalRequests
{
    ...
    public static function runExample(
        ...
        printf(
            "Total number of workflow approval requests to be approved: %d\n",
            $totalResultSetSize
        );
        ...
        if ($totalResultSetSize > 0) {
            ...
            if ($result !== null && $result->getNumChanges() > 0) {
                printf(
                    "Number of workflow approval requests approved: %d\n",
