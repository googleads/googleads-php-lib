...
namespace Google\AdsApi\Examples\Dfp\v201802\ActivityGroupService;
...
use Google\AdsApi\Dfp\v201802\ActivityGroupService;
use Google\AdsApi\Dfp\v201802\ActivityGroupStatus;
...
class GetActiveActivityGroups
{
    ...
    public static function runExample(
        ...
        $activityGroupService = $dfpServices->get($session, ActivityGroupService::class);
