 ...
 */
namespace Google\AdsApi\Examples\Dfp\v201702\ReconciliationReportService;
...
use Google\AdsApi\Dfp\Util\v201702\DfpDates;
use Google\AdsApi\Dfp\Util\v201702\StatementBuilder;
use Google\AdsApi\Dfp\v201702\ReconciliationReportService;
    ...
    do {
      ...
      if ($page->getResults() !== null) {
        ...
        foreach ($page->getResults() as $reconciliationReport) {
          printf(
              "%d) Reconciliation report with ID %d and start date '%s' was "
                  . "found.\n",
              $i++,
              $reconciliationReport->getId(),
              DfpDates::toDateString($reconciliationReport->getStartDate())
          );
        }
      }
