 ...
 */
namespace Google\AdsApi\Examples\Dfp\v201702\AudienceSegmentService;
...
use Google\AdsApi\Dfp\v201702\AudienceSegmentType;
use Google\AdsApi\Dfp\v201702\AudienceSegmentService;
...
class GetFirstPartyAudienceSegments {
  ...
  public static function runExample(DfpServices $dfpServices,
    ...
    $audienceSegmentService =
        $dfpServices->get($session, AudienceSegmentService::class);
