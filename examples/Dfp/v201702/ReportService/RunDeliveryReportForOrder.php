...
require_once 'Google/Api/Ads/Dfp/Util/v201702/DateTimeUtils.php';
require_once 'Google/Api/Ads/Dfp/Util/v201702/ReportDownloader.php';
...
try {
  ...
  $reportService = $user->GetService('ReportService', 'v201702');
