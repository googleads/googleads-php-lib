...
try {
  ...
  $contentService = $user->GetService('ContentService', 'v201311');

  // Get the NetworkService.
  $networkService = $user->GetService('NetworkService', 'v201311');

  // Get the CustomTargetingService.
  $customTargetingService =
      $user->GetService('CustomTargetingService', 'v201311');
