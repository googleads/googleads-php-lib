 ...
 * http://code.google.com/apis/dfp/docs/reference/v201306/PublisherQueryLanguageService.html
 *
...
try {
  ...
  $pqlService = $user->GetService('PublisherQueryLanguageService', 'v201306');
