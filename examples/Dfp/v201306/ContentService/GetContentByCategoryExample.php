...
try {
  ...
  $contentService = $user->GetService('ContentService', 'v201306');

  // Get the NetworkService.
  $networkService = $user->GetService('NetworkService', 'v201306');

  // Get the CustomTargetingService.
  $customTargetingService =
      $user->GetService('CustomTargetingService', 'v201306');
