<?php
/**
 * This example gets all exchange rates. To create exchange rates, run
 * CreateExchangeRates.php.
 *
 * PHP version 5
 *
...
try {
  ...
  $exchangeRateService = $user->GetService('ExchangeRateService', 'v201608');
