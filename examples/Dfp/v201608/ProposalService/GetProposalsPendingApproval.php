 ...
 */
namespace Google\AdsApi\Examples\Dfp\v201608\ProposalService;
...
use Google\AdsApi\Dfp\v201608\ProposalStatus;
...
class GetProposalsPendingApproval {
  ...
  public static function runExample(DfpServices $dfpServices,
      DfpSession $session) {
    $proposalService =
        $dfpServices->get($session, 'ProposalService', 'v201608');
    ...
    do {
      ...
      if ($page->getResults() !== null) {
        ...
        foreach ($page->getResults() as $proposal) {
          printf(
              "%d) Proposal with ID %d and name '%s' was found.\n",
              $i++,
              $proposal->getId(),
              $proposal->getName()
          );
