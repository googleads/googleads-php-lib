 ...
 */
namespace Google\AdsApi\Examples\Dfp\v201608\ProductPackageItemService;
...
class GetProductPackageItemsForProductPackage {
  ...
  public static function runExample(DfpServices $dfpServices,
      DfpSession $session, $productPackageId) {
    $productPackageItemService =
        $dfpServices->get($session, 'ProductPackageItemService', 'v201608');
  ...
  public static function main() {
    ...
    self::runExample(new DfpServices(), $session, intval(self::PRODUCT_PACKAGE_ID));
  }
}
