 ...
 */
namespace Google\AdsApi\Examples\Dfp\v201608\ReconciliationReportService;
...
class GetReconciliationReportForLastBillingPeriod {
  ...
  public static function runExample(DfpServices $dfpServices,
    ...
    $reconciliationReportService =
        $dfpServices->get($session, 'ReconciliationReportService', 'v201608');

    $networkService = $dfpServices->get($session, 'NetworkService', 'v201608');
