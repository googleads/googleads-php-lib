 ...
 */
namespace Google\AdsApi\Examples\Dfp\v201608\ReportService;
...
use Google\AdsApi\Dfp\Util\v201608\ReportDownloader;
use Google\AdsApi\Dfp\Util\v201608\StatementBuilder;
use Google\AdsApi\Dfp\v201608\Column;
use Google\AdsApi\Dfp\v201608\DateRangeType;
use Google\AdsApi\Dfp\v201608\Dimension;
use Google\AdsApi\Dfp\v201608\ExportFormat;
use Google\AdsApi\Dfp\v201608\ReportJob;
use Google\AdsApi\Dfp\v201608\ReportQuery;
use Google\AdsApi\Dfp\v201608\ReportQueryAdUnitView;
...
class RunInventoryReport {
  ...
  public static function runExample(DfpServices $dfpServices,
      DfpSession $session) {
    $reportService =
        $dfpServices->get($session, 'ReportService', 'v201608');
    $networkService =
        $dfpServices->get($session, 'NetworkService', 'v201608');
    ...
    $reportDownloader = new ReportDownloader(
        $reportService, $reportJob->getId(), $session->getLogger());
