 ...
 */
namespace Google\AdsApi\Examples\Dfp\v201608\CustomFieldService;
...
use Google\AdsApi\Dfp\v201608\CustomFieldEntityType;
...
class GetCustomFieldsForLineItems {
  ...
  public static function runExample(DfpServices $dfpServices,
      DfpSession $session) {
    $customFieldService =
        $dfpServices->get($session, 'CustomFieldService', 'v201608');
