 ...
 */
namespace Google\AdsApi\Examples\Dfp\v201608\PlacementService;
...
use Google\AdsApi\Dfp\v201608\InventoryStatus;
...
class GetActivePlacements {
  ...
  public static function runExample(DfpServices $dfpServices,
      DfpSession $session) {
    $placementService =
        $dfpServices->get($session, 'PlacementService', 'v201608');
