<?php
/**
 * This example gets all line item creative associations (LICAs). To create
 * LICAs, run CreateLicas.php.
 *
 * PHP version 5
 *
...
try {
  ...
  $licaService =
      $user->GetService('LineItemCreativeAssociationService', 'v201608');
