<?php
/**
 * This example gets all products created from a specific product template. To
 * see what product templates exist, run GetAllProductTemplates.php.
 *
 * PHP version 5
 *
...
try {
  ...
  $productService = $user->GetService('ProductService', 'v201608');

  // Create a statement to select only products created from a specific product
  // template.
  $statementBuilder = new StatementBuilder();
  $statementBuilder->Where('productTemplateId = :productTemplateId')
      ->OrderBy('id ASC')
