 ...
 */
namespace Google\AdsApi\Examples\Dfp\v201608\RateCardService;
...
class GetMarketplaceRateCards {
  ...
  public static function runExample(DfpServices $dfpServices,
      DfpSession $session) {
    $rateCardService =
        $dfpServices->get($session, 'RateCardService', 'v201608');
    ...
    do {
      ...
      if ($page->getResults() !== null) {
        ...
        foreach ($page->getResults() as $rateCard) {
          printf(
              "%d) Rate card with ID %d, name '%s', and currency code '%s' was "
                  . "found.\n",
              $i++,
              $rateCard->getId(),
              $rateCard->getName(),
