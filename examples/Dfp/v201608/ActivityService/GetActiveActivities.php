 ...
 */
namespace Google\AdsApi\Examples\Dfp\v201608\ActivityService;
...
use Google\AdsApi\Dfp\v201608\ActivityStatus;
...
class GetActiveActivities {
  ...
  public static function runExample(DfpServices $dfpServices,
      DfpSession $session) {
    $activityService =
        $dfpServices->get($session, 'ActivityService', 'v201608');
