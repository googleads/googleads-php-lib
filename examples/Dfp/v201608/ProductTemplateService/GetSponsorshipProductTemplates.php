<?php
/**
 * This example gets all sponsorship product templates. To create product
 * templates, run CreateProductTemplates.php.
 *
 * PHP version 5
 *
...
try {
  ...
  $statementBuilder->Where('lineItemType = :lineItemType')
      ->OrderBy('id ASC')
      ->Limit(StatementBuilder::SUGGESTED_PAGE_LIMIT)
      ->WithBindVariableValue('lineItemType', 'SPONSORSHIP');
