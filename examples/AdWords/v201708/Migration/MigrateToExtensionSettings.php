...
namespace Google\AdsApi\Examples\AdWords\v201708\Migration;
...
use Google\AdsApi\AdWords\v201708\cm\CampaignExtensionSetting;
use Google\AdsApi\AdWords\v201708\cm\CampaignExtensionSettingOperation;
use Google\AdsApi\AdWords\v201708\cm\CampaignExtensionSettingService;
use Google\AdsApi\AdWords\v201708\cm\CampaignFeedOperation;
use Google\AdsApi\AdWords\v201708\cm\CampaignFeedService;
use Google\AdsApi\AdWords\v201708\cm\ExtensionSetting;
use Google\AdsApi\AdWords\v201708\cm\ExtensionSettingPlatform;
...
use Google\AdsApi\AdWords\v201708\cm\FunctionOperand;
use Google\AdsApi\AdWords\v201708\cm\FunctionOperator;
use Google\AdsApi\AdWords\v201708\cm\Operator;
use Google\AdsApi\AdWords\v201708\cm\RequestContextOperand;
use Google\AdsApi\AdWords\v201708\cm\RequestContextOperandContextType;
use Google\AdsApi\AdWords\v201708\cm\SitelinkFeedItem;
...
class MigrateToExtensionSettings
{
    ...
    private static function getFeeds(
        ...
        $page = $feedService->query(
            'SELECT Id, Name, Attributes WHERE ' . 'Origin="USER" AND FeedStatus="ENABLED"'
        );
