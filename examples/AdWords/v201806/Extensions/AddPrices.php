...
use Google\AdsApi\AdWords\v201806\cm\CustomerExtensionSetting;
use Google\AdsApi\AdWords\v201806\cm\CustomerExtensionSettingOperation;
use Google\AdsApi\AdWords\v201806\cm\CustomerExtensionSettingService;
use Google\AdsApi\AdWords\v201806\cm\DayOfWeek;
use Google\AdsApi\AdWords\v201806\cm\ExtensionSetting;
use Google\AdsApi\AdWords\v201806\cm\FeedItemCampaignTargeting;
use Google\AdsApi\AdWords\v201806\cm\FeedItemSchedule;
use Google\AdsApi\AdWords\v201806\cm\FeedItemScheduling;
use Google\AdsApi\AdWords\v201806\cm\FeedType;
use Google\AdsApi\AdWords\v201806\cm\MinuteOfHour;
use Google\AdsApi\AdWords\v201806\cm\Money;
use Google\AdsApi\AdWords\v201806\cm\MoneyWithCurrency;
use Google\AdsApi\AdWords\v201806\cm\Operator;
use Google\AdsApi\AdWords\v201806\cm\PriceExtensionPriceQualifier;
use Google\AdsApi\AdWords\v201806\cm\PriceExtensionPriceUnit;
use Google\AdsApi\AdWords\v201806\cm\PriceExtensionType;
use Google\AdsApi\AdWords\v201806\cm\PriceFeedItem;
use Google\AdsApi\AdWords\v201806\cm\PriceTableRow;
