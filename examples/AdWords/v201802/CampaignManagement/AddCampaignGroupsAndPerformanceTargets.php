...
use Google\AdsApi\AdWords\v201802\cm\CampaignGroup;
use Google\AdsApi\AdWords\v201802\cm\CampaignGroupOperation;
use Google\AdsApi\AdWords\v201802\cm\CampaignGroupPerformanceTarget;
use Google\AdsApi\AdWords\v201802\cm\CampaignGroupPerformanceTargetOperation;
use Google\AdsApi\AdWords\v201802\cm\CampaignGroupPerformanceTargetService;
use Google\AdsApi\AdWords\v201802\cm\CampaignGroupService;
use Google\AdsApi\AdWords\v201802\cm\CampaignOperation;
use Google\AdsApi\AdWords\v201802\cm\CampaignService;
use Google\AdsApi\AdWords\v201802\cm\EfficiencyTargetType;
use Google\AdsApi\AdWords\v201802\cm\Money;
use Google\AdsApi\AdWords\v201802\cm\Operator;
use Google\AdsApi\AdWords\v201802\cm\PerformanceTarget;
use Google\AdsApi\AdWords\v201802\cm\SpendTargetType;
use Google\AdsApi\AdWords\v201802\cm\VolumeGoalType;
