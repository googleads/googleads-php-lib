...
namespace Google\AdsApi\Examples\AdWords\v201802\Extensions;
...
use Google\AdsApi\AdWords\v201802\cm\CustomerExtensionSetting;
use Google\AdsApi\AdWords\v201802\cm\CustomerExtensionSettingOperation;
use Google\AdsApi\AdWords\v201802\cm\CustomerExtensionSettingService;
use Google\AdsApi\AdWords\v201802\cm\DayOfWeek;
use Google\AdsApi\AdWords\v201802\cm\ExtensionSetting;
use Google\AdsApi\AdWords\v201802\cm\FeedItemCampaignTargeting;
use Google\AdsApi\AdWords\v201802\cm\FeedItemSchedule;
use Google\AdsApi\AdWords\v201802\cm\FeedItemScheduling;
use Google\AdsApi\AdWords\v201802\cm\FeedType;
use Google\AdsApi\AdWords\v201802\cm\MinuteOfHour;
use Google\AdsApi\AdWords\v201802\cm\Money;
use Google\AdsApi\AdWords\v201802\cm\MoneyWithCurrency;
use Google\AdsApi\AdWords\v201802\cm\Operator;
use Google\AdsApi\AdWords\v201802\cm\PriceExtensionPriceQualifier;
use Google\AdsApi\AdWords\v201802\cm\PriceExtensionPriceUnit;
use Google\AdsApi\AdWords\v201802\cm\PriceExtensionType;
use Google\AdsApi\AdWords\v201802\cm\PriceFeedItem;
use Google\AdsApi\AdWords\v201802\cm\PriceTableRow;
use Google\AdsApi\AdWords\v201802\cm\UrlList;
