...
use Google\AdsApi\AdWords\v201802\cm\AttributeFieldMapping;
...
use Google\AdsApi\AdWords\v201802\cm\DynamicSearchAdsSetting;
use Google\AdsApi\AdWords\v201802\cm\Feed;
...
use Google\AdsApi\AdWords\v201802\cm\FeedOperation;
use Google\AdsApi\AdWords\v201802\cm\FeedOrigin;
...
use Google\AdsApi\AdWords\v201802\cm\PageFeed;
use Google\AdsApi\AdWords\v201802\cm\Predicate;
use Google\AdsApi\AdWords\v201802\cm\PredicateOperator;
use Google\AdsApi\AdWords\v201802\cm\Selector;
use Google\AdsApi\AdWords\v201802\cm\Webpage;
use Google\AdsApi\AdWords\v201802\cm\WebpageCondition;
use Google\AdsApi\AdWords\v201802\cm\WebpageConditionOperand;
use Google\AdsApi\AdWords\v201802\cm\WebpageParameter;
...
class AddDynamicPageFeed
{
    ...
    public static function runExample(
        ...
        printf(
            "Dynamic page feed setup is complete for campaign ID %d.\n",
            $campaignId
        );
    }
