...
use Google\AdsApi\AdWords\v201802\cm\BiddingStrategyOperation;
use Google\AdsApi\AdWords\v201802\cm\BiddingStrategyService;
...
use Google\AdsApi\AdWords\v201802\cm\SharedBiddingStrategy;
use Google\AdsApi\AdWords\v201802\cm\TargetSpendBiddingScheme;
...
class UsePortfolioBiddingStrategy
{
     ...
     */
    private static function createSharedBudget(
        AdWordsServices $adWordsServices,
        AdWordsSession $session
    ) {
    ...
    private static function createCampaignWithBiddingStrategy(
        ...
        printf(
            "Campaign with name '%s', ID %d and bidding scheme ID %d was created.\n",
            $newCampaign->getName(),
            $newCampaign->getId(),
