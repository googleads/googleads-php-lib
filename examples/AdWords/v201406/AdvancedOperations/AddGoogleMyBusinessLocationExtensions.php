...
// To obtain an access token for your GMB account, run the Auth/GetRefreshToken
// example. Make sure you are logged in as the same user as GMB_EMAIL_ADDRESS
// above when you follow the link provided by the example, then capture the
// generated Credential's access token.
define('GMB_ACCESS_TOKEN', 'INSERT_GMB_ACCESS_TOKEN');
 ...
 * @param string $gmbEmailAddress E-Mail address of the GMB account owner
 * @param string $gmbAccessToken Access token for the GMB account
 */
function AddGoogleMyBusinessLocationExtensions(
    AdWordsUser $user, $gmbEmailAddress, $gmbAccessToken) {
...
try {
  ...
  AddGoogleMyBusinessLocationExtensions(
      $user, GMB_EMAIL_ADDRESS, GMB_ACCESS_TOKEN);
