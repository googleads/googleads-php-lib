 ...
 */
namespace Google\AdsApi\Examples\AdWords\v201607\Reporting;

require '../../../../vendor/autoload.php';

use Google\AdsApi\AdWords\AdWordsSession;
use Google\AdsApi\AdWords\AdWordsSessionBuilder;
use Google\AdsApi\AdWords\Reporting\v201607\DownloadFormat;
use Google\AdsApi\AdWords\Reporting\v201607\ReportDefinition;
use Google\AdsApi\AdWords\Reporting\v201607\ReportDefinitionDateRangeType;
use Google\AdsApi\AdWords\Reporting\v201607\ReportDownloader;
...
class DownloadCriteriaReport {
  ...
  public static function runExample(AdWordsSession $session, $filePath) {
    ...
    $selector->setPredicates([new Predicate('Status', 'NOT_IN', ['PAUSED'])]);
    ...
    $reportDownloader->downloadReport($reportDefinition, $filePath);
