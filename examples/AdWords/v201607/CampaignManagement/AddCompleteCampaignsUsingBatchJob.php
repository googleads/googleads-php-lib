 ...
 */
namespace Google\AdsApi\Examples\AdWords\v201607\CampaignManagement;
...
use Google\AdsApi\AdWords\BatchJobs\v201607\BatchJobs;
use Google\AdsApi\AdWords\v201607\cm\AdGroup;
use Google\AdsApi\AdWords\v201607\cm\AdGroupOperation;
use Google\AdsApi\AdWords\v201607\cm\AdGroupAd;
use Google\AdsApi\AdWords\v201607\cm\AdGroupAdOperation;
use Google\AdsApi\AdWords\v201607\cm\AdGroupCriterionOperation;
use Google\AdsApi\AdWords\v201607\cm\BatchJob;
use Google\AdsApi\AdWords\v201607\cm\BatchJobOperation;
use Google\AdsApi\AdWords\v201607\cm\BiddableAdGroupCriterion;
use Google\AdsApi\AdWords\v201607\cm\BiddingStrategyConfiguration;
use Google\AdsApi\AdWords\v201607\cm\Budget;
use Google\AdsApi\AdWords\v201607\cm\BudgetOperation;
use Google\AdsApi\AdWords\v201607\cm\Campaign;
use Google\AdsApi\AdWords\v201607\cm\CampaignCriterionOperation;
use Google\AdsApi\AdWords\v201607\cm\CampaignOperation;
use Google\AdsApi\AdWords\v201607\cm\CpcBid;
use Google\AdsApi\AdWords\v201607\cm\Keyword;
use Google\AdsApi\AdWords\v201607\cm\ManualCpcBiddingScheme;
use Google\AdsApi\AdWords\v201607\cm\Money;
use Google\AdsApi\AdWords\v201607\cm\NegativeCampaignCriterion;
use Google\AdsApi\AdWords\v201607\cm\Predicate;
use Google\AdsApi\AdWords\v201607\cm\Selector;
use Google\AdsApi\AdWords\v201607\cm\TextAd;
...
class AddCompleteCampaignsUsingBatchJob {
  ...
  public static function runExample(
    ...
    $batchJobService =
        $adWordsServices->get($session, 'BatchJobService', 'v201607', 'cm');

    // Create a BatchJob.
    $addOp = new BatchJobOperation();
    $addOp->setOperator('ADD');
    ...
    $batchJobUtils = new BatchJobs();
    $batchJobUtils->uploadBatchJobOperations($operations, $uploadUrl);
    ...
    do {
      ...
      $selector->setPredicates([
          new Predicate('Id', 'EQUALS', [$batchJob->getId()])
      ]);
    ...
    if ($batchJob->getDownloadUrl() !== null
      ...
      $mutateResults = $batchJobUtils->downloadBatchJobResults(
  ...
  private static function buildAdGroupAdOperations(array $adGroupOperations) {
    ...
    foreach ($adGroupOperations as $adGroupOperation) {
      ...
      $textAd->setFinalUrls(['http://www.example.com/1']);
  ...
  private static function buildBudgetOperation($namePrefix) {
    ...
    $budgetOperation->setOperator('ADD');
