...
class RequestOptionsFactoryTest extends PHPUnit_Framework_TestCase {
  ...
  /**
   * @covers Google\AdsApi\AdWords\Reporting\v201607\RequestOptionsFactory::createRequestOptionsWithReportDefinition
   */
  ...
  /**
   * @covers Google\AdsApi\AdWords\Reporting\v201607\RequestOptionsFactory::createRequestOptionsWithAwqlQuery
   */
