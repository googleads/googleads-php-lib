...
class RequestOptionsFactoryTest extends TestCase {
  ...
  /**
   * @covers Google\AdsApi\AdWords\Reporting\v201705\RequestOptionsFactory::createRequestOptionsWithReportDefinition
   */
  ...
  /**
   * @covers Google\AdsApi\AdWords\Reporting\v201705\RequestOptionsFactory::createRequestOptionsWithAwqlQuery
   */
