...
class ReportDownloaderTest extends PHPUnit_Framework_TestCase {
  ...
  /**
   * @covers Google\AdsApi\AdWords\Reporting\v201609\ReportDownloader::downloadReport
   */
  ...
  /**
   * @covers Google\AdsApi\AdWords\Reporting\v201609\ReportDownloader::downloadReportWithAwql
   */
