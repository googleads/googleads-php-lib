...
class BatchJobsDelegateTest extends PHPUnit_Framework_TestCase {
  ...
  /**
   * @covers Google\AdsApi\AdWords\BatchJobs\v201609\BatchJobsDelegate::uploadIncrementalBatchJobOperations
   */
    ...
    $this->assertXmlStringEqualsXmlString(
        ...
        sprintf(
            '<ns1:mutate xmlns:ns1="https://adwords.google.com/api/adwords/cm/'
                . 'v201609" xmlns:xsi="http://www.w3.org/2001/'
  ...
  /**
   * @covers Google\AdsApi\AdWords\BatchJobs\v201609\BatchJobsDelegate::uploadIncrementalBatchJobOperations
   * @expectedException Google\AdsApi\AdWords\v201609\cm\ApiException
   */
  ...
  /**
   * @covers Google\AdsApi\AdWords\BatchJobs\v201609\BatchJobsDelegate::closeIncrementalUpload
   */
  ...
  /**
   * @covers Google\AdsApi\AdWords\BatchJobs\v201609\BatchJobsDelegate::downloadBatchJobResults
   */
