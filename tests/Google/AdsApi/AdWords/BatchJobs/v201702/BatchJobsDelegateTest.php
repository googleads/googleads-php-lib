...
use Google\AdsApi\AdWords\Testing\BatchJobs\v201702\BatchJobsTestProvider;
use Google\AdsApi\AdWords\Testing\BatchJobs\v201702\FakeMutateResult;
...
class BatchJobsDelegateTest extends PHPUnit_Framework_TestCase {
  ...
  /**
   * @covers Google\AdsApi\AdWords\BatchJobs\v201702\BatchJobsDelegate::uploadIncrementalBatchJobOperations
   */
    ...
    $this->assertXmlStringEqualsXmlString(
        ...
        sprintf(
            '<ns1:mutate xmlns:ns1="https://adwords.google.com/api/adwords/cm/'
                . 'v201702" xmlns:xsi="http://www.w3.org/2001/'
  ...
  /**
   * @covers Google\AdsApi\AdWords\BatchJobs\v201702\BatchJobsDelegate::closeIncrementalUpload
   */
  ...
  /**
   * @covers Google\AdsApi\AdWords\BatchJobs\v201702\BatchJobsDelegate::downloadBatchJobResults
   */
