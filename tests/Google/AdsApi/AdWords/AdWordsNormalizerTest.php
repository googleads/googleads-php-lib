...
class AdWordsNormalizerTest extends PHPUnit_Framework_TestCase {
  ...
  public function testSetNormalizeCallback() {
    ...
    $normalizer->setCallbacks(['normalize' =>
        function ($value, $type) {
          if ($value !== null) {
            return 'adwords';
          }
  ...
  public function testDenormalizeObjectUsingXsiType() {
    ...
    $actualMoney = $this->serializer->denormalize(
        ...
        'Google\AdsApi\AdWords\Testing\FakeMoney'
    );
  ...
  public function testDenormalizeNestedObject() {
    ...
    $actualBudget = $this->serializer->denormalize(
        AdWordsNormalizerTestProvider::
            getDecodedBudgetWithAllProperties(),
        'Google\AdsApi\AdWords\Testing\FakeBudget'
    );

    $this->assertSame($expectedBudget->getBudgetId(),
        $actualBudget->getBudgetId());
    $this->assertSame($expectedBudget->getName(), $actualBudget->getName());
    $this->assertSame($expectedBudget->getAmount()->getMicroAmount(),
  ...
  public function testDenormalizeObjectWhoseMemberIsArrayOfOneObject() {
    ...
    $actualMutateResult = $this->serializer->denormalize(
        AdWordsNormalizerTestProvider::
            getDecodedMutateResultWithOneResult(),
        'Google\AdsApi\AdWords\Testing\FakeMutateResult'
    );

    $this->assertCount(count($expectedMutateResult->getResult()),
  ...
  public function testDenormalizeObjectWithNameConverter() {
    $serializer = new Serializer(
        [new AdWordsNormalizer(null, new CamelCaseToSnakeCaseNameConverter()),
