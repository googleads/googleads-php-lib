...
class AdWordsSessionBuilderTest extends TestCase {
  ...
  public function testBuildFrom() {
    ...
    $this->assertSame(true, $adWordsSession->isIncludeUtilitiesInUserAgent());
    $this->assertSame(
    ...
    $this->assertInstanceOf(StreamHandler::class,
  ...
  public function testBuildFromWithCustomLogger() {
    ...
    $this->assertInstanceOf(
        NullHandler::class, $adWordsSession->getSoapLogger()->getHandlers()[0]);
  }
  ...
  public function testBuildWithDisableIncludeUtilitiesInUserAgent() {
    ...
    $this->assertInstanceOf(FetchAuthTokenInterface::class,
        $adWordsSession->getOAuth2Credential());
    $this->assertSame(false, $adWordsSession->isIncludeUtilitiesInUserAgent());
  }
}
