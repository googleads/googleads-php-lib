...
namespace Google\AdsApi\AdManager\Util\v202305;

use Google\AdsApi\AdManager\v202305\AdUnitTargeting;
use Google\AdsApi\AdManager\v202305\BooleanValue;
use Google\AdsApi\AdManager\v202305\ColumnType;
use Google\AdsApi\AdManager\v202305\Date;
use Google\AdsApi\AdManager\v202305\DateTime as AdManagerDateTime;
use Google\AdsApi\AdManager\v202305\DateTimeValue;
use Google\AdsApi\AdManager\v202305\DateValue;
use Google\AdsApi\AdManager\v202305\InventoryTargeting;
use Google\AdsApi\AdManager\v202305\NumberValue;
use Google\AdsApi\AdManager\v202305\ResultSet;
use Google\AdsApi\AdManager\v202305\Row;
use Google\AdsApi\AdManager\v202305\SetValue;
use Google\AdsApi\AdManager\v202305\Targeting;
use Google\AdsApi\AdManager\v202305\TargetingValue;
use Google\AdsApi\AdManager\v202305\TextValue;
use Google\AdsApi\AdManager\v202305\Value;
...
class PqlTest extends TestCase
{
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202305\Pql::createValue
     */
    ...
    public function testCreateValueWithInvalidTypeThrowsException()
    {
        ...
        $this->expectExceptionMessage("Unsupported value type [Google\\AdsApi\\AdManager\\Util\\v202305\\MyObject]");
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202305\Pql::toString
     */
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage("Unsupported value type [Google\\AdsApi\\AdManager\\Util\\v202305\\MyValue]");
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202305\Pql::getColumnLabels
     */
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202305\Pql::getRowStringValues
     */
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202305\Pql::combineResultSets
     */
