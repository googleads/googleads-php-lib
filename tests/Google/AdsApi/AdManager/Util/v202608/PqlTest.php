...
namespace Google\AdsApi\AdManager\Util\v202608;

use Google\AdsApi\AdManager\v202608\AdUnitTargeting;
use Google\AdsApi\AdManager\v202608\BooleanValue;
use Google\AdsApi\AdManager\v202608\ColumnType;
use Google\AdsApi\AdManager\v202608\Date;
use Google\AdsApi\AdManager\v202608\DateTime as AdManagerDateTime;
use Google\AdsApi\AdManager\v202608\DateTimeValue;
use Google\AdsApi\AdManager\v202608\DateValue;
use Google\AdsApi\AdManager\v202608\InventoryTargeting;
use Google\AdsApi\AdManager\v202608\NumberValue;
use Google\AdsApi\AdManager\v202608\ResultSet;
use Google\AdsApi\AdManager\v202608\Row;
use Google\AdsApi\AdManager\v202608\SetValue;
use Google\AdsApi\AdManager\v202608\Targeting;
use Google\AdsApi\AdManager\v202608\TargetingValue;
use Google\AdsApi\AdManager\v202608\TextValue;
use Google\AdsApi\AdManager\v202608\Value;
...
class PqlTest extends TestCase
{
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202608\Pql::createValue
     */
    ...
    public function testCreateValueWithInvalidTypeThrowsException()
    {
        ...
        $this->expectExceptionMessage("Unsupported value type [Google\\AdsApi\\AdManager\\Util\\v202608\\MyObject]");
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202608\Pql::toString
     */
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage("Unsupported value type [Google\\AdsApi\\AdManager\\Util\\v202608\\MyValue]");
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202608\Pql::getColumnLabels
     */
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202608\Pql::getRowStringValues
     */
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202608\Pql::combineResultSets
     */
