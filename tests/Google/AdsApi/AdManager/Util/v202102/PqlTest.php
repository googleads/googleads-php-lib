...
namespace Google\AdsApi\AdManager\Util\v202102;

use Google\AdsApi\AdManager\v202102\AdUnitTargeting;
use Google\AdsApi\AdManager\v202102\BooleanValue;
use Google\AdsApi\AdManager\v202102\ColumnType;
use Google\AdsApi\AdManager\v202102\Date;
use Google\AdsApi\AdManager\v202102\DateTime as AdManagerDateTime;
use Google\AdsApi\AdManager\v202102\DateTimeValue;
use Google\AdsApi\AdManager\v202102\DateValue;
use Google\AdsApi\AdManager\v202102\InventoryTargeting;
use Google\AdsApi\AdManager\v202102\NumberValue;
use Google\AdsApi\AdManager\v202102\ResultSet;
use Google\AdsApi\AdManager\v202102\Row;
use Google\AdsApi\AdManager\v202102\SetValue;
use Google\AdsApi\AdManager\v202102\Targeting;
use Google\AdsApi\AdManager\v202102\TargetingValue;
use Google\AdsApi\AdManager\v202102\TextValue;
use Google\AdsApi\AdManager\v202102\Value;
...
class PqlTest extends TestCase
{
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202102\Pql::createValue
     */
    ...
    public function testCreateValueWithInvalidTypeThrowsException()
    {
        ...
        $this->expectExceptionMessage("Unsupported value type [Google\\AdsApi\\AdManager\\Util\\v202102\\MyObject]");
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202102\Pql::toString
     */
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage("Unsupported value type [Google\\AdsApi\\AdManager\\Util\\v202102\\MyValue]");
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202102\Pql::getColumnLabels
     */
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202102\Pql::getRowStringValues
     */
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202102\Pql::combineResultSets
     */
