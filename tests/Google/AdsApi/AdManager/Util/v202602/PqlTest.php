...
namespace Google\AdsApi\AdManager\Util\v202602;

use Google\AdsApi\AdManager\v202602\AdUnitTargeting;
use Google\AdsApi\AdManager\v202602\BooleanValue;
use Google\AdsApi\AdManager\v202602\ColumnType;
use Google\AdsApi\AdManager\v202602\Date;
use Google\AdsApi\AdManager\v202602\DateTime as AdManagerDateTime;
use Google\AdsApi\AdManager\v202602\DateTimeValue;
use Google\AdsApi\AdManager\v202602\DateValue;
use Google\AdsApi\AdManager\v202602\InventoryTargeting;
use Google\AdsApi\AdManager\v202602\NumberValue;
use Google\AdsApi\AdManager\v202602\ResultSet;
use Google\AdsApi\AdManager\v202602\Row;
use Google\AdsApi\AdManager\v202602\SetValue;
use Google\AdsApi\AdManager\v202602\Targeting;
use Google\AdsApi\AdManager\v202602\TargetingValue;
use Google\AdsApi\AdManager\v202602\TextValue;
use Google\AdsApi\AdManager\v202602\Value;
...
class PqlTest extends TestCase
{
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202602\Pql::createValue
     */
    ...
    public function testCreateValueWithInvalidTypeThrowsException()
    {
        ...
        $this->expectExceptionMessage("Unsupported value type [Google\\AdsApi\\AdManager\\Util\\v202602\\MyObject]");
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202602\Pql::toString
     */
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage("Unsupported value type [Google\\AdsApi\\AdManager\\Util\\v202602\\MyValue]");
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202602\Pql::getColumnLabels
     */
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202602\Pql::getRowStringValues
     */
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202602\Pql::combineResultSets
     */
