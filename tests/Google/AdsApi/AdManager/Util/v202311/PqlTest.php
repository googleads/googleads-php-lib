...
namespace Google\AdsApi\AdManager\Util\v202311;

use Google\AdsApi\AdManager\v202311\AdUnitTargeting;
use Google\AdsApi\AdManager\v202311\BooleanValue;
use Google\AdsApi\AdManager\v202311\ColumnType;
use Google\AdsApi\AdManager\v202311\Date;
use Google\AdsApi\AdManager\v202311\DateTime as AdManagerDateTime;
use Google\AdsApi\AdManager\v202311\DateTimeValue;
use Google\AdsApi\AdManager\v202311\DateValue;
use Google\AdsApi\AdManager\v202311\InventoryTargeting;
use Google\AdsApi\AdManager\v202311\NumberValue;
use Google\AdsApi\AdManager\v202311\ResultSet;
use Google\AdsApi\AdManager\v202311\Row;
use Google\AdsApi\AdManager\v202311\SetValue;
use Google\AdsApi\AdManager\v202311\Targeting;
use Google\AdsApi\AdManager\v202311\TargetingValue;
use Google\AdsApi\AdManager\v202311\TextValue;
use Google\AdsApi\AdManager\v202311\Value;
...
class PqlTest extends TestCase
{
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202311\Pql::createValue
     */
    ...
    public function testCreateValueWithInvalidTypeThrowsException()
    {
        ...
        $this->expectExceptionMessage("Unsupported value type [Google\\AdsApi\\AdManager\\Util\\v202311\\MyObject]");
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202311\Pql::toString
     */
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage("Unsupported value type [Google\\AdsApi\\AdManager\\Util\\v202311\\MyValue]");
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202311\Pql::getColumnLabels
     */
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202311\Pql::getRowStringValues
     */
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202311\Pql::combineResultSets
     */
