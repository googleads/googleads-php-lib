...
namespace Google\AdsApi\AdManager\Util\v202408;

use Google\AdsApi\AdManager\v202408\AdUnitTargeting;
use Google\AdsApi\AdManager\v202408\BooleanValue;
use Google\AdsApi\AdManager\v202408\ColumnType;
use Google\AdsApi\AdManager\v202408\Date;
use Google\AdsApi\AdManager\v202408\DateTime as AdManagerDateTime;
use Google\AdsApi\AdManager\v202408\DateTimeValue;
use Google\AdsApi\AdManager\v202408\DateValue;
use Google\AdsApi\AdManager\v202408\InventoryTargeting;
use Google\AdsApi\AdManager\v202408\NumberValue;
use Google\AdsApi\AdManager\v202408\ResultSet;
use Google\AdsApi\AdManager\v202408\Row;
use Google\AdsApi\AdManager\v202408\SetValue;
use Google\AdsApi\AdManager\v202408\Targeting;
use Google\AdsApi\AdManager\v202408\TargetingValue;
use Google\AdsApi\AdManager\v202408\TextValue;
use Google\AdsApi\AdManager\v202408\Value;
...
class PqlTest extends TestCase
{
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202408\Pql::createValue
     */
    ...
    public function testCreateValueWithInvalidTypeThrowsException()
    {
        ...
        $this->expectExceptionMessage("Unsupported value type [Google\\AdsApi\\AdManager\\Util\\v202408\\MyObject]");
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202408\Pql::toString
     */
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage("Unsupported value type [Google\\AdsApi\\AdManager\\Util\\v202408\\MyValue]");
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202408\Pql::getColumnLabels
     */
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202408\Pql::getRowStringValues
     */
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202408\Pql::combineResultSets
     */
