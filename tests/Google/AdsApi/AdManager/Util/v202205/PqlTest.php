...
namespace Google\AdsApi\AdManager\Util\v202205;

use Google\AdsApi\AdManager\v202205\AdUnitTargeting;
use Google\AdsApi\AdManager\v202205\BooleanValue;
use Google\AdsApi\AdManager\v202205\ColumnType;
use Google\AdsApi\AdManager\v202205\Date;
use Google\AdsApi\AdManager\v202205\DateTime as AdManagerDateTime;
use Google\AdsApi\AdManager\v202205\DateTimeValue;
use Google\AdsApi\AdManager\v202205\DateValue;
use Google\AdsApi\AdManager\v202205\InventoryTargeting;
use Google\AdsApi\AdManager\v202205\NumberValue;
use Google\AdsApi\AdManager\v202205\ResultSet;
use Google\AdsApi\AdManager\v202205\Row;
use Google\AdsApi\AdManager\v202205\SetValue;
use Google\AdsApi\AdManager\v202205\Targeting;
use Google\AdsApi\AdManager\v202205\TargetingValue;
use Google\AdsApi\AdManager\v202205\TextValue;
use Google\AdsApi\AdManager\v202205\Value;
...
class PqlTest extends TestCase
{
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202205\Pql::createValue
     */
    ...
    public function testCreateValueWithInvalidTypeThrowsException()
    {
        ...
        $this->expectExceptionMessage("Unsupported value type [Google\\AdsApi\\AdManager\\Util\\v202205\\MyObject]");
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202205\Pql::toString
     */
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage("Unsupported value type [Google\\AdsApi\\AdManager\\Util\\v202205\\MyValue]");
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202205\Pql::getColumnLabels
     */
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202205\Pql::getRowStringValues
     */
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202205\Pql::combineResultSets
     */
