...
namespace Google\AdsApi\AdManager\Util\v202008;

use Google\AdsApi\AdManager\v202008\AdUnitTargeting;
use Google\AdsApi\AdManager\v202008\BooleanValue;
use Google\AdsApi\AdManager\v202008\ColumnType;
use Google\AdsApi\AdManager\v202008\Date;
use Google\AdsApi\AdManager\v202008\DateTime as AdManagerDateTime;
use Google\AdsApi\AdManager\v202008\DateTimeValue;
use Google\AdsApi\AdManager\v202008\DateValue;
use Google\AdsApi\AdManager\v202008\InventoryTargeting;
use Google\AdsApi\AdManager\v202008\NumberValue;
use Google\AdsApi\AdManager\v202008\ResultSet;
use Google\AdsApi\AdManager\v202008\Row;
use Google\AdsApi\AdManager\v202008\SetValue;
use Google\AdsApi\AdManager\v202008\Targeting;
use Google\AdsApi\AdManager\v202008\TargetingValue;
use Google\AdsApi\AdManager\v202008\TextValue;
use Google\AdsApi\AdManager\v202008\Value;
...
class PqlTest extends TestCase
{
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202008\Pql::createValue
     */
    ...
    public function testCreateValueWithInvalidTypeThrowsException()
    {
        ...
        $this->expectExceptionMessage("Unsupported value type [Google\\AdsApi\\AdManager\\Util\\v202008\\MyObject]");
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202008\Pql::toString
     */
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage("Unsupported value type [Google\\AdsApi\\AdManager\\Util\\v202008\\MyValue]");
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202008\Pql::getColumnLabels
     */
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202008\Pql::getRowStringValues
     */
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202008\Pql::combineResultSets
     */
