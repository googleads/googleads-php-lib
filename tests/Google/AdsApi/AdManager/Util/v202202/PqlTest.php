...
namespace Google\AdsApi\AdManager\Util\v202202;

use Google\AdsApi\AdManager\v202202\AdUnitTargeting;
use Google\AdsApi\AdManager\v202202\BooleanValue;
use Google\AdsApi\AdManager\v202202\ColumnType;
use Google\AdsApi\AdManager\v202202\Date;
use Google\AdsApi\AdManager\v202202\DateTime as AdManagerDateTime;
use Google\AdsApi\AdManager\v202202\DateTimeValue;
use Google\AdsApi\AdManager\v202202\DateValue;
use Google\AdsApi\AdManager\v202202\InventoryTargeting;
use Google\AdsApi\AdManager\v202202\NumberValue;
use Google\AdsApi\AdManager\v202202\ResultSet;
use Google\AdsApi\AdManager\v202202\Row;
use Google\AdsApi\AdManager\v202202\SetValue;
use Google\AdsApi\AdManager\v202202\Targeting;
use Google\AdsApi\AdManager\v202202\TargetingValue;
use Google\AdsApi\AdManager\v202202\TextValue;
use Google\AdsApi\AdManager\v202202\Value;
...
class PqlTest extends TestCase
{
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202202\Pql::createValue
     */
    ...
    public function testCreateValueWithInvalidTypeThrowsException()
    {
        ...
        $this->expectExceptionMessage("Unsupported value type [Google\\AdsApi\\AdManager\\Util\\v202202\\MyObject]");
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202202\Pql::toString
     */
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage("Unsupported value type [Google\\AdsApi\\AdManager\\Util\\v202202\\MyValue]");
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202202\Pql::getColumnLabels
     */
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202202\Pql::getRowStringValues
     */
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202202\Pql::combineResultSets
     */
