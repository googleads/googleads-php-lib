...
namespace Google\AdsApi\AdManager\Util\v202011;
...
class StatementBuilderTest extends TestCase
{
    ...
    /**
     * @covers Google\AdsApi\AdManager\Util\v202011\StatementBuilder::toStatement
     */
    public function testToStatementForPqlTable()
    {
        $expectedQuery =
            'SELECT Id FROM table WHERE a = b AND b = c ORDER BY a '
            . 'ASC, b DESC LIMIT 200 OFFSET 0';
        $statementBuilder = new StatementBuilder();
        $query = $statementBuilder->Select('Id')->from('table')->where(
            'a = b AND b = c'
        )->orderBy('a ASC, b DESC')->limit(200)->offset(0)->toStatement()
            ->getQuery();
    ...
    public function testToStatementForPqlTableWithKeywords()
    {
        $expectedQuery =
            ...
            . 'ASC, b DESC LIMIT 200 OFFSET 0';
        $statementBuilder = new StatementBuilder();
        $query = $statementBuilder->Select('Id')->from('FrOM table')->where(
            'WHERE a = b AND b = c'
        )->orderBy('order BY a ASC, b DESC')->limit(200)->offset(0)
    ...
    public function testToStatementNotPqlTable()
    {
        $expectedQuery =
            ...
            . 'OFFSET 0';
        $statementBuilder = new StatementBuilder();
        $query = $statementBuilder->where('a = b AND b = c')->orderBy(
            'a ASC, b DESC'
        )->limit(200)->offset(0)->toStatement()->getQuery();
        $this->assertSame($expectedQuery, $query);
    }
    ...
    public function testToStatementNoOffset()
    {
        ...
        $query = $statementBuilder->where('a = b AND b = c')->orderBy(
            'a ASC, b DESC'
        )->limit(200)->toStatement()->getQuery();
        $this->assertSame($expectedQuery, $query);
    }
    ...
    public function testToStatementLimitAndOffset()
    {
        ...
        $statementBuilder = new StatementBuilder();
        $query =
            $statementBuilder->limit(500)->offset(0)->toStatement()->getQuery();
        $this->assertSame($expectedQuery, $query);
    }

    /**
     * @covers Google\AdsApi\AdManager\Util\v202011\StatementBuilder::toStatement
     * @covers Google\AdsApi\AdManager\Util\v202011\StatementBuilder::removeLimitAndOffset
     */
    ...
    /**
     * @covers Google\AdsApi\AdManager\Util\v202011\StatementBuilder::toStatement
     * @covers Google\AdsApi\AdManager\Util\v202011\StatementBuilder::increaseOffsetBy
     */
    public function testToStatementIncreaseOffsetNoInitialOffset()
    {
        ...
        $statementBuilder = new StatementBuilder();
        $statementBuilder->limit(500)->where('a = b')->orderBy('a');
        $this->assertSame(
            $expectedQueryBefore,
            $statementBuilder->toStatement()->getQuery()
        );
    ...
    /**
     * @covers Google\AdsApi\AdManager\Util\v202011\StatementBuilder::withBindVariableValue
     */
