...
use Google\AdsApi\AdManager\v202302\BooleanValue;
use Google\AdsApi\AdManager\v202302\ColumnType;
use Google\AdsApi\AdManager\v202302\Date;
use Google\AdsApi\AdManager\v202302\DateTime as AdManagerDateTime;
use Google\AdsApi\AdManager\v202302\DateTimeValue;
use Google\AdsApi\AdManager\v202302\DateValue;
use Google\AdsApi\AdManager\v202302\InventoryTargeting;
use Google\AdsApi\AdManager\v202302\NumberValue;
use Google\AdsApi\AdManager\v202302\ResultSet;
use Google\AdsApi\AdManager\v202302\Row;
use Google\AdsApi\AdManager\v202302\SetValue;
use Google\AdsApi\AdManager\v202302\Targeting;
use Google\AdsApi\AdManager\v202302\TargetingValue;
use Google\AdsApi\AdManager\v202302\TextValue;
use Google\AdsApi\AdManager\v202302\Value;
...
class PqlTest extends TestCase
{
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202302\Pql::createValue
     */
    ...
    public function testCreateValueWithInvalidTypeThrowsException()
    {
        ...
        $this->expectExceptionMessage("Unsupported value type [Google\\AdsApi\\AdManager\\Util\\v202302\\MyObject]");
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202302\Pql::toString
     */
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage("Unsupported value type [Google\\AdsApi\\AdManager\\Util\\v202302\\MyValue]");
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202302\Pql::getColumnLabels
     */
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202302\Pql::getRowStringValues
     */
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202302\Pql::combineResultSets
     */
