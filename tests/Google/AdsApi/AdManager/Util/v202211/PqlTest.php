...
namespace Google\AdsApi\AdManager\Util\v202211;

use Google\AdsApi\AdManager\v202211\AdUnitTargeting;
use Google\AdsApi\AdManager\v202211\BooleanValue;
use Google\AdsApi\AdManager\v202211\ColumnType;
use Google\AdsApi\AdManager\v202211\Date;
use Google\AdsApi\AdManager\v202211\DateTime as AdManagerDateTime;
use Google\AdsApi\AdManager\v202211\DateTimeValue;
use Google\AdsApi\AdManager\v202211\DateValue;
use Google\AdsApi\AdManager\v202211\InventoryTargeting;
use Google\AdsApi\AdManager\v202211\NumberValue;
use Google\AdsApi\AdManager\v202211\ResultSet;
use Google\AdsApi\AdManager\v202211\Row;
use Google\AdsApi\AdManager\v202211\SetValue;
use Google\AdsApi\AdManager\v202211\Targeting;
use Google\AdsApi\AdManager\v202211\TargetingValue;
use Google\AdsApi\AdManager\v202211\TextValue;
use Google\AdsApi\AdManager\v202211\Value;
...
class PqlTest extends TestCase
{
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202211\Pql::createValue
     */
    ...
    public function testCreateValueWithInvalidTypeThrowsException()
    {
        ...
        $this->expectExceptionMessage("Unsupported value type [Google\\AdsApi\\AdManager\\Util\\v202211\\MyObject]");
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202211\Pql::toString
     */
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage("Unsupported value type [Google\\AdsApi\\AdManager\\Util\\v202211\\MyValue]");
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202211\Pql::getColumnLabels
     */
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202211\Pql::getRowStringValues
     */
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202211\Pql::combineResultSets
     */
