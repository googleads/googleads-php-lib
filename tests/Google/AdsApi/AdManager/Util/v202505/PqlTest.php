...
use Google\AdsApi\AdManager\v202505\BooleanValue;
use Google\AdsApi\AdManager\v202505\ColumnType;
use Google\AdsApi\AdManager\v202505\Date;
use Google\AdsApi\AdManager\v202505\DateTime as AdManagerDateTime;
use Google\AdsApi\AdManager\v202505\DateTimeValue;
use Google\AdsApi\AdManager\v202505\DateValue;
use Google\AdsApi\AdManager\v202505\InventoryTargeting;
use Google\AdsApi\AdManager\v202505\NumberValue;
use Google\AdsApi\AdManager\v202505\ResultSet;
use Google\AdsApi\AdManager\v202505\Row;
use Google\AdsApi\AdManager\v202505\SetValue;
use Google\AdsApi\AdManager\v202505\Targeting;
use Google\AdsApi\AdManager\v202505\TargetingValue;
use Google\AdsApi\AdManager\v202505\TextValue;
use Google\AdsApi\AdManager\v202505\Value;
...
class PqlTest extends TestCase
{
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202505\Pql::createValue
     */
    ...
    public function testCreateValueWithInvalidTypeThrowsException()
    {
        ...
        $this->expectExceptionMessage("Unsupported value type [Google\\AdsApi\\AdManager\\Util\\v202505\\MyObject]");
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202505\Pql::toString
     */
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage("Unsupported value type [Google\\AdsApi\\AdManager\\Util\\v202505\\MyValue]");
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202505\Pql::getColumnLabels
     */
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202505\Pql::getRowStringValues
     */
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202505\Pql::combineResultSets
     */
