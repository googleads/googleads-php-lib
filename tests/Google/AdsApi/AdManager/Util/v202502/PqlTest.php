...
namespace Google\AdsApi\AdManager\Util\v202502;

use Google\AdsApi\AdManager\v202502\AdUnitTargeting;
use Google\AdsApi\AdManager\v202502\BooleanValue;
use Google\AdsApi\AdManager\v202502\ColumnType;
use Google\AdsApi\AdManager\v202502\Date;
use Google\AdsApi\AdManager\v202502\DateTime as AdManagerDateTime;
use Google\AdsApi\AdManager\v202502\DateTimeValue;
use Google\AdsApi\AdManager\v202502\DateValue;
use Google\AdsApi\AdManager\v202502\InventoryTargeting;
use Google\AdsApi\AdManager\v202502\NumberValue;
use Google\AdsApi\AdManager\v202502\ResultSet;
use Google\AdsApi\AdManager\v202502\Row;
use Google\AdsApi\AdManager\v202502\SetValue;
use Google\AdsApi\AdManager\v202502\Targeting;
use Google\AdsApi\AdManager\v202502\TargetingValue;
use Google\AdsApi\AdManager\v202502\TextValue;
use Google\AdsApi\AdManager\v202502\Value;
...
class PqlTest extends TestCase
{
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202502\Pql::createValue
     */
    ...
    public function testCreateValueWithInvalidTypeThrowsException()
    {
        ...
        $this->expectExceptionMessage("Unsupported value type [Google\\AdsApi\\AdManager\\Util\\v202502\\MyObject]");
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202502\Pql::toString
     */
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage("Unsupported value type [Google\\AdsApi\\AdManager\\Util\\v202502\\MyValue]");
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202502\Pql::getColumnLabels
     */
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202502\Pql::getRowStringValues
     */
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202502\Pql::combineResultSets
     */
