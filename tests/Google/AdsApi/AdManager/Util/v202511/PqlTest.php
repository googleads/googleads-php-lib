...
namespace Google\AdsApi\AdManager\Util\v202511;

use Google\AdsApi\AdManager\v202511\AdUnitTargeting;
use Google\AdsApi\AdManager\v202511\BooleanValue;
use Google\AdsApi\AdManager\v202511\ColumnType;
use Google\AdsApi\AdManager\v202511\Date;
use Google\AdsApi\AdManager\v202511\DateTime as AdManagerDateTime;
use Google\AdsApi\AdManager\v202511\DateTimeValue;
use Google\AdsApi\AdManager\v202511\DateValue;
use Google\AdsApi\AdManager\v202511\InventoryTargeting;
use Google\AdsApi\AdManager\v202511\NumberValue;
use Google\AdsApi\AdManager\v202511\ResultSet;
use Google\AdsApi\AdManager\v202511\Row;
use Google\AdsApi\AdManager\v202511\SetValue;
use Google\AdsApi\AdManager\v202511\Targeting;
use Google\AdsApi\AdManager\v202511\TargetingValue;
use Google\AdsApi\AdManager\v202511\TextValue;
use Google\AdsApi\AdManager\v202511\Value;
...
class PqlTest extends TestCase
{
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202511\Pql::createValue
     */
    ...
    public function testCreateValueWithInvalidTypeThrowsException()
    {
        ...
        $this->expectExceptionMessage("Unsupported value type [Google\\AdsApi\\AdManager\\Util\\v202511\\MyObject]");
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202511\Pql::toString
     */
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage("Unsupported value type [Google\\AdsApi\\AdManager\\Util\\v202511\\MyValue]");
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202511\Pql::getColumnLabels
     */
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202511\Pql::getRowStringValues
     */
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202511\Pql::combineResultSets
     */
