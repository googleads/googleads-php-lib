...
namespace Google\AdsApi\AdManager\Util\v202111;

use Google\AdsApi\AdManager\v202111\AdUnitTargeting;
use Google\AdsApi\AdManager\v202111\BooleanValue;
use Google\AdsApi\AdManager\v202111\ColumnType;
use Google\AdsApi\AdManager\v202111\Date;
use Google\AdsApi\AdManager\v202111\DateTime as AdManagerDateTime;
use Google\AdsApi\AdManager\v202111\DateTimeValue;
use Google\AdsApi\AdManager\v202111\DateValue;
use Google\AdsApi\AdManager\v202111\InventoryTargeting;
use Google\AdsApi\AdManager\v202111\NumberValue;
use Google\AdsApi\AdManager\v202111\ResultSet;
use Google\AdsApi\AdManager\v202111\Row;
use Google\AdsApi\AdManager\v202111\SetValue;
use Google\AdsApi\AdManager\v202111\Targeting;
use Google\AdsApi\AdManager\v202111\TargetingValue;
use Google\AdsApi\AdManager\v202111\TextValue;
use Google\AdsApi\AdManager\v202111\Value;
...
class PqlTest extends TestCase
{
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202111\Pql::createValue
     */
    ...
    public function testCreateValueWithInvalidTypeThrowsException()
    {
        ...
        $this->expectExceptionMessage("Unsupported value type [Google\\AdsApi\\AdManager\\Util\\v202111\\MyObject]");
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202111\Pql::toString
     */
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage("Unsupported value type [Google\\AdsApi\\AdManager\\Util\\v202111\\MyValue]");
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202111\Pql::getColumnLabels
     */
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202111\Pql::getRowStringValues
     */
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202111\Pql::combineResultSets
     */
