...
namespace Google\AdsApi\AdManager\Util\v202508;

use Google\AdsApi\AdManager\v202508\AdUnitTargeting;
use Google\AdsApi\AdManager\v202508\BooleanValue;
use Google\AdsApi\AdManager\v202508\ColumnType;
use Google\AdsApi\AdManager\v202508\Date;
use Google\AdsApi\AdManager\v202508\DateTime as AdManagerDateTime;
use Google\AdsApi\AdManager\v202508\DateTimeValue;
use Google\AdsApi\AdManager\v202508\DateValue;
use Google\AdsApi\AdManager\v202508\InventoryTargeting;
use Google\AdsApi\AdManager\v202508\NumberValue;
use Google\AdsApi\AdManager\v202508\ResultSet;
use Google\AdsApi\AdManager\v202508\Row;
use Google\AdsApi\AdManager\v202508\SetValue;
use Google\AdsApi\AdManager\v202508\Targeting;
use Google\AdsApi\AdManager\v202508\TargetingValue;
use Google\AdsApi\AdManager\v202508\TextValue;
use Google\AdsApi\AdManager\v202508\Value;
...
class PqlTest extends TestCase
{
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202508\Pql::createValue
     */
    ...
    public function testCreateValueWithInvalidTypeThrowsException()
    {
        ...
        $this->expectExceptionMessage("Unsupported value type [Google\\AdsApi\\AdManager\\Util\\v202508\\MyObject]");
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202508\Pql::toString
     */
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage("Unsupported value type [Google\\AdsApi\\AdManager\\Util\\v202508\\MyValue]");
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202508\Pql::getColumnLabels
     */
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202508\Pql::getRowStringValues
     */
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202508\Pql::combineResultSets
     */
