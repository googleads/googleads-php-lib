...
use Google\AdsApi\AdManager\v202402\BooleanValue;
use Google\AdsApi\AdManager\v202402\ColumnType;
use Google\AdsApi\AdManager\v202402\Date;
use Google\AdsApi\AdManager\v202402\DateTime as AdManagerDateTime;
use Google\AdsApi\AdManager\v202402\DateTimeValue;
use Google\AdsApi\AdManager\v202402\DateValue;
use Google\AdsApi\AdManager\v202402\InventoryTargeting;
use Google\AdsApi\AdManager\v202402\NumberValue;
use Google\AdsApi\AdManager\v202402\ResultSet;
use Google\AdsApi\AdManager\v202402\Row;
use Google\AdsApi\AdManager\v202402\SetValue;
use Google\AdsApi\AdManager\v202402\Targeting;
use Google\AdsApi\AdManager\v202402\TargetingValue;
use Google\AdsApi\AdManager\v202402\TextValue;
use Google\AdsApi\AdManager\v202402\Value;
...
class PqlTest extends TestCase
{
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202402\Pql::createValue
     */
    ...
    public function testCreateValueWithInvalidTypeThrowsException()
    {
        ...
        $this->expectExceptionMessage("Unsupported value type [Google\\AdsApi\\AdManager\\Util\\v202402\\MyObject]");
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202402\Pql::toString
     */
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage("Unsupported value type [Google\\AdsApi\\AdManager\\Util\\v202402\\MyValue]");
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202402\Pql::getColumnLabels
     */
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202402\Pql::getRowStringValues
     */
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202402\Pql::combineResultSets
     */
