...
namespace Google\AdsApi\AdManager\Util\v202411;

use Google\AdsApi\AdManager\v202411\AdUnitTargeting;
use Google\AdsApi\AdManager\v202411\BooleanValue;
use Google\AdsApi\AdManager\v202411\ColumnType;
use Google\AdsApi\AdManager\v202411\Date;
use Google\AdsApi\AdManager\v202411\DateTime as AdManagerDateTime;
use Google\AdsApi\AdManager\v202411\DateTimeValue;
use Google\AdsApi\AdManager\v202411\DateValue;
use Google\AdsApi\AdManager\v202411\InventoryTargeting;
use Google\AdsApi\AdManager\v202411\NumberValue;
use Google\AdsApi\AdManager\v202411\ResultSet;
use Google\AdsApi\AdManager\v202411\Row;
use Google\AdsApi\AdManager\v202411\SetValue;
use Google\AdsApi\AdManager\v202411\Targeting;
use Google\AdsApi\AdManager\v202411\TargetingValue;
use Google\AdsApi\AdManager\v202411\TextValue;
use Google\AdsApi\AdManager\v202411\Value;
...
class PqlTest extends TestCase
{
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202411\Pql::createValue
     */
    ...
    public function testCreateValueWithInvalidTypeThrowsException()
    {
        ...
        $this->expectExceptionMessage("Unsupported value type [Google\\AdsApi\\AdManager\\Util\\v202411\\MyObject]");
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202411\Pql::toString
     */
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage("Unsupported value type [Google\\AdsApi\\AdManager\\Util\\v202411\\MyValue]");
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202411\Pql::getColumnLabels
     */
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202411\Pql::getRowStringValues
     */
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202411\Pql::combineResultSets
     */
