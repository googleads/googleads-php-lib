...
namespace Google\AdsApi\AdManager\Util\v202002;

use Google\AdsApi\AdManager\v202002\AdUnitTargeting;
use Google\AdsApi\AdManager\v202002\BooleanValue;
use Google\AdsApi\AdManager\v202002\ColumnType;
use Google\AdsApi\AdManager\v202002\Date;
use Google\AdsApi\AdManager\v202002\DateTime as AdManagerDateTime;
use Google\AdsApi\AdManager\v202002\DateTimeValue;
use Google\AdsApi\AdManager\v202002\DateValue;
use Google\AdsApi\AdManager\v202002\InventoryTargeting;
use Google\AdsApi\AdManager\v202002\NumberValue;
use Google\AdsApi\AdManager\v202002\ResultSet;
use Google\AdsApi\AdManager\v202002\Row;
use Google\AdsApi\AdManager\v202002\SetValue;
use Google\AdsApi\AdManager\v202002\Targeting;
use Google\AdsApi\AdManager\v202002\TargetingValue;
use Google\AdsApi\AdManager\v202002\TextValue;
use Google\AdsApi\AdManager\v202002\Value;
...
class PqlTest extends TestCase
{
    ...
    /**
     * @covers Google\AdsApi\AdManager\Util\v202002\Pql::createValue
     */
     ...
     *     [Google\AdsApi\AdManager\Util\v202002\MyObject]
     */
    ...
    /**
     * @covers Google\AdsApi\AdManager\Util\v202002\Pql::toString
     */
     ...
     * @expectedException InvalidArgumentException
     * @expectedExceptionMessage Unsupported value type
     *     [Google\AdsApi\AdManager\Util\v202002\MyValue]
     */
    ...
    /**
     * @covers Google\AdsApi\AdManager\Util\v202002\Pql::getColumnLabels
     */
    ...
    /**
     * @covers Google\AdsApi\AdManager\Util\v202002\Pql::getRowStringValues
     */
    ...
    /**
     * @covers Google\AdsApi\AdManager\Util\v202002\Pql::combineResultSets
     */
