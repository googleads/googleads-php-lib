...
namespace Google\AdsApi\AdManager\Util\v202605;

use Google\AdsApi\AdManager\v202605\AdUnitTargeting;
use Google\AdsApi\AdManager\v202605\BooleanValue;
use Google\AdsApi\AdManager\v202605\ColumnType;
use Google\AdsApi\AdManager\v202605\Date;
use Google\AdsApi\AdManager\v202605\DateTime as AdManagerDateTime;
use Google\AdsApi\AdManager\v202605\DateTimeValue;
use Google\AdsApi\AdManager\v202605\DateValue;
use Google\AdsApi\AdManager\v202605\InventoryTargeting;
use Google\AdsApi\AdManager\v202605\NumberValue;
use Google\AdsApi\AdManager\v202605\ResultSet;
use Google\AdsApi\AdManager\v202605\Row;
use Google\AdsApi\AdManager\v202605\SetValue;
use Google\AdsApi\AdManager\v202605\Targeting;
use Google\AdsApi\AdManager\v202605\TargetingValue;
use Google\AdsApi\AdManager\v202605\TextValue;
use Google\AdsApi\AdManager\v202605\Value;
...
class PqlTest extends TestCase
{
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202605\Pql::createValue
     */
    ...
    public function testCreateValueWithInvalidTypeThrowsException()
    {
        ...
        $this->expectExceptionMessage("Unsupported value type [Google\\AdsApi\\AdManager\\Util\\v202605\\MyObject]");
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202605\Pql::toString
     */
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage("Unsupported value type [Google\\AdsApi\\AdManager\\Util\\v202605\\MyValue]");
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202605\Pql::getColumnLabels
     */
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202605\Pql::getRowStringValues
     */
    ...
    /**
     * @covers \Google\AdsApi\AdManager\Util\v202605\Pql::combineResultSets
     */
