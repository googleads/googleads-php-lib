...
class DateTimeUtilsTest extends PHPUnit_Framework_TestCase {
  ...
  /**
   * @covers Google\AdsApi\Dfp\Util\v201511\DateTimeUtils::toDfpDateTime
   */
  ...
  /**
   * @covers
   *     Google\AdsApi\Dfp\Util\v201511\DateTimeUtils::toDfpDateTimeFromString
   */
  ...
  /**
   * @covers
   *     Google\AdsApi\Dfp\Util\v201511\DateTimeUtils::toDfpDateTimeFromStringWithTimeZone
   */
  ...
  /**
   * @covers Google\AdsApi\Dfp\Util\v201511\DateTimeUtils::fromDfpDateTime
   */
  ...
  /**
   * @covers Google\AdsApi\Dfp\Util\v201511\DateTimeUtils::toString
   */
  ...
  /**
   * @covers Google\AdsApi\Dfp\Util\v201511\DateTimeUtils::toStringWithTimeZone
   */
  ...
  /**
   * @covers Google\AdsApi\Dfp\Util\v201511\DateTimeUtils::toStringForTimeZone
   */
