...
use Google\AdsApi\Dfp\Util\v201511\DateTimeUtils;
use Google\AdsApi\Dfp\Util\v201511\Pql;
use Google\AdsApi\Dfp\v201511\AdUnitTargeting;
use Google\AdsApi\Dfp\v201511\BooleanValue;
use Google\AdsApi\Dfp\v201511\ColumnType;
...
use Google\AdsApi\Dfp\v201511\InventoryTargeting;
...
class PqlTest extends PHPUnit_Framework_TestCase {
  ...
  /**
   * @covers Google\AdsApi\Dfp\Util\v201511\Pql::createValue
   */
  ...
  /**
   * @covers Google\AdsApi\Dfp\Util\v201511\Pql::toString
   */
  ...
  /**
   * @covers Google\AdsApi\Dfp\Util\v201511\Pql::getColumnLabels
   */
  public function testGetColumnLabels() {
    $resultSet = new ResultSet(array($this->column1, $this->column2,
        $this->column3));
    $this->assertSame(array('Id', 'Name', 'Status'),
        Pql::getColumnLabels($resultSet));
  }

  /**
   * @covers Google\AdsApi\Dfp\Util\v201511\Pql::getRowStringValues
   */
  public function testGetRowStringValues() {
    $row = new Row(array($this->textValue1, $this->booleanValue1,
        $this->numberValue1));
    $this->assertSame(array('hello world', 'false', '2'),
        Pql::getRowStringValues($row));
  }

  /**
   * @covers Google\AdsApi\Dfp\Util\v201511\Pql::combineResultSets
   */
