...
use Google\AdsApi\Dfp\Util\v201608\DateTimeUtils;
use Google\AdsApi\Dfp\Util\v201608\Pql;
use Google\AdsApi\Dfp\v201608\AdUnitTargeting;
use Google\AdsApi\Dfp\v201608\BooleanValue;
use Google\AdsApi\Dfp\v201608\ColumnType;
use Google\AdsApi\Dfp\v201608\Date;
use Google\AdsApi\Dfp\v201608\DateTime as DfpDateTime;
use Google\AdsApi\Dfp\v201608\DateTimeValue;
use Google\AdsApi\Dfp\v201608\DateValue;
use Google\AdsApi\Dfp\v201608\InventoryTargeting;
use Google\AdsApi\Dfp\v201608\NumberValue;
use Google\AdsApi\Dfp\v201608\ResultSet;
use Google\AdsApi\Dfp\v201608\Row;
use Google\AdsApi\Dfp\v201608\SetValue;
use Google\AdsApi\Dfp\v201608\Targeting;
use Google\AdsApi\Dfp\v201608\TargetingValue;
use Google\AdsApi\Dfp\v201608\TextValue;
use Google\AdsApi\Dfp\v201608\Value;
...
class PqlTest extends PHPUnit_Framework_TestCase {
  ...
  /**
   * @covers Google\AdsApi\Dfp\Util\v201608\Pql::createValue
   */
  public function testCreateValue() {
    ...
    $this->assertSame(
        '100',
        Pql::createValue($this->targeting1)
            ->getValue()
  ...
  /**
   * @covers Google\AdsApi\Dfp\Util\v201608\Pql::toString
   */
  ...
  /**
   * @covers Google\AdsApi\Dfp\Util\v201608\Pql::getColumnLabels
   */
  public function testGetColumnLabels() {
    ...
    $this->assertSame(['Id', 'Name', 'Status'],
        Pql::getColumnLabels($resultSet));
  }

  /**
   * @covers Google\AdsApi\Dfp\Util\v201608\Pql::getRowStringValues
   */
  public function testGetRowStringValues() {
    ...
    $this->assertSame(['hello world', 'false', '2'],
        Pql::getRowStringValues($row));
  }

  /**
   * @covers Google\AdsApi\Dfp\Util\v201608\Pql::combineResultSets
   */
