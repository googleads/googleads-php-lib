...
class ReportDownloaderTest extends PHPUnit_Framework_TestCase {
  ...
  protected function setUp() {
    $this->reportServiceMock =
        $this->getMockBuilder('Google\AdsApi\Dfp\v201608\ReportService')
        ->disableOriginalConstructor()
        ->getMock();
  }

  /**
   * @covers Google\AdsApi\Dfp\Util\v201608\ReportDownloader::waitForReportToFinish
   */
  ...
  /**
   * @covers Google\AdsApi\Dfp\Util\v201608\ReportDownloader::downloadReport
   */
