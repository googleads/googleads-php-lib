...
class PqlTest extends TestCase {
   ...
   * @expectedExceptionMessage Unsupported value type [Google\AdsApi\Dfp\Util\v201711\MyObject]
   */
   ...
   * @covers Google\AdsApi\Dfp\Util\v201711\Pql::toString
   * @expectedException InvalidArgumentException
   * @expectedExceptionMessage Unsupported value type [Google\AdsApi\Dfp\Util\v201711\MyValue]
   */
