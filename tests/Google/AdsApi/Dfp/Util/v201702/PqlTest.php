...
use Google\AdsApi\Dfp\v201702\BooleanValue;
use Google\AdsApi\Dfp\v201702\ColumnType;
use Google\AdsApi\Dfp\v201702\Date;
use Google\AdsApi\Dfp\v201702\DateTime as DfpDateTime;
use Google\AdsApi\Dfp\v201702\DateTimeValue;
use Google\AdsApi\Dfp\v201702\DateValue;
use Google\AdsApi\Dfp\v201702\InventoryTargeting;
use Google\AdsApi\Dfp\v201702\NumberValue;
use Google\AdsApi\Dfp\v201702\ResultSet;
use Google\AdsApi\Dfp\v201702\Row;
use Google\AdsApi\Dfp\v201702\SetValue;
...
class PqlTest extends TestCase {
  ...
  /**
   * @covers Google\AdsApi\Dfp\Util\v201702\Pql::createValue
   */
   ...
   * @expectedExceptionMessage Unsupported value type [Google\AdsApi\Dfp\Util\v201702\MyObject]
   */
  ...
  /**
   * @covers Google\AdsApi\Dfp\Util\v201702\Pql::toString
   */
   ...
   * @covers Google\AdsApi\Dfp\Util\v201702\Pql::toString
   * @expectedException InvalidArgumentException
   * @expectedExceptionMessage Unsupported value type [Google\AdsApi\Dfp\Util\v201702\MyValue]
   */
  ...
  /**
   * @covers Google\AdsApi\Dfp\Util\v201702\Pql::getColumnLabels
   */
  ...
  /**
   * @covers Google\AdsApi\Dfp\Util\v201702\Pql::getRowStringValues
   */
  ...
  /**
   * @covers Google\AdsApi\Dfp\Util\v201702\Pql::combineResultSets
   */
