...
class DfpDateTimesTest extends TestCase {
  ...
  /**
   * @covers Google\AdsApi\Dfp\Util\v201702\DfpDateTimes::fromDateTime
   */
  ...
  /**
   * @covers Google\AdsApi\Dfp\Util\v201702\DfpDateTimes::fromDateTimeString
   */
  ...
  /**
   * @covers Google\AdsApi\Dfp\Util\v201702\DfpDateTimes::toDateTime
   */
  ...
  /**
   * @covers Google\AdsApi\Dfp\Util\v201702\DfpDateTimes::toDateTimeString
   */
