...
use Google\AdsApi\Dfp\v201611\BooleanValue;
use Google\AdsApi\Dfp\v201611\ColumnType;
use Google\AdsApi\Dfp\v201611\Date;
use Google\AdsApi\Dfp\v201611\DateTime as DfpDateTime;
use Google\AdsApi\Dfp\v201611\DateTimeValue;
use Google\AdsApi\Dfp\v201611\DateValue;
use Google\AdsApi\Dfp\v201611\InventoryTargeting;
use Google\AdsApi\Dfp\v201611\NumberValue;
use Google\AdsApi\Dfp\v201611\ResultSet;
use Google\AdsApi\Dfp\v201611\Row;
use Google\AdsApi\Dfp\v201611\SetValue;
use Google\AdsApi\Dfp\v201611\Targeting;
use Google\AdsApi\Dfp\v201611\TargetingValue;
use Google\AdsApi\Dfp\v201611\TextValue;
use Google\AdsApi\Dfp\v201611\Value;
...
class PqlTest extends PHPUnit_Framework_TestCase {
  ...
  /**
   * @covers Google\AdsApi\Dfp\Util\v201611\Pql::createValue
   */
   ...
   * @expectedExceptionMessage Unsupported value type [Google\AdsApi\Dfp\Util\v201611\MyObject]
   */
  ...
  /**
   * @covers Google\AdsApi\Dfp\Util\v201611\Pql::toString
   */
   ...
   * @covers Google\AdsApi\Dfp\Util\v201611\Pql::toString
   * @expectedException InvalidArgumentException
   * @expectedExceptionMessage Unsupported value type [Google\AdsApi\Dfp\Util\v201611\MyValue]
   */
  ...
  /**
   * @covers Google\AdsApi\Dfp\Util\v201611\Pql::getColumnLabels
   */
  ...
  /**
   * @covers Google\AdsApi\Dfp\Util\v201611\Pql::getRowStringValues
   */
  ...
  /**
   * @covers Google\AdsApi\Dfp\Util\v201611\Pql::combineResultSets
   */
