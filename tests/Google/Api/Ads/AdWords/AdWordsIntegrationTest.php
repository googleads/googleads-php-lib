...
use Google\Api\Ads\Common\Testing\AssetHelper;
use Google\Api\Ads\AdWords\Lib\AdWordsUser;
use Google\Api\Ads\AdWords\v201402\Selector;
...
class AdWordsIntegrationTest extends PHPUnit_Framework_TestCase {
  ...
  public function testIntegrationOAuth2Handler_InvalidAccessToken() {
    ...
    $oAuth2Handler = $this->getMock('Google\Api\Ads\Common\Util\SimpleOAuth2Handler',
