 ...
 *
 * @package    GoogleApiAdsAdWordsUtilv201705
 * @subpackage Testing
...
require_once 'Google/Api/Ads/AdWords/Util/v201705/ReportClasses.php';
require_once 'Google/Api/Ads/AdWords/Util/v201705/BatchJobClasses.php';
