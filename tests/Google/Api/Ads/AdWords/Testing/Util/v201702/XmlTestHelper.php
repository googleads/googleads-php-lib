 ...
 *
 * @package    GoogleApiAdsAdWordsUtilv201702
 * @subpackage Testing
...
require_once 'Google/Api/Ads/AdWords/Util/v201702/ReportClasses.php';
require_once 'Google/Api/Ads/AdWords/Util/v201702/BatchJobClasses.php';
