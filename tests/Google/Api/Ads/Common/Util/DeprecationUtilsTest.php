...
/**
 * Unit tests for {@link Google\Api\Ads\Common\Util\DeprecationUtils}.
 * @group small
 */
class DeprecationUtilsTest extends PHPUnit_Framework_TestCase {
  ...
  public function testIsUsingOAuth2_UsingOAuth2() {
    ...
    $mockUser = $this->getMockBuilder('Google\Api\Ads\Common\Lib\AdsUser')
  ...
  /**
   * @expectedException Google\Api\Ads\Common\Lib\ServiceException
   */
  public function
