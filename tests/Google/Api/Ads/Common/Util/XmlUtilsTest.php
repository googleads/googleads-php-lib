...
/**
 * Unit tests for {@link Google\Api\Ads\Common\Util\XmlUtils}.
 * @group small
 */
class XmlUtilsTest extends PHPUnit_Framework_TestCase {
   ...
   * @covers Google\Api\Ads\Common\Util\XmlUtils::GetDomFromXml
   ...
   * @covers Google\Api\Ads\Common\Util\XmlUtils::GetXmlFromDom
   * @dataProvider ValidXmlProvider
   */
   ...
   * @covers Google\Api\Ads\Common\Util\XmlUtils::PrettyPrint
   ...
   * @covers Google\Api\Ads\Common\Util\XmlUtils::ConvertDocumentToObject
   * @covers Google\Api\Ads\Common\Util\XmlUtils::ConvertElementToObject
   * @covers Google\Api\Ads\Common\Util\XmlUtils::ConvertNodeValueToObject
   ...
   * @covers Google\Api\Ads\Common\Util\XmlUtils::ConvertObjectToDocument
   * @covers Google\Api\Ads\Common\Util\XmlUtils::ConvertObjectToElement
   * @covers Google\Api\Ads\Common\Util\XmlUtils::ConvertObjectToNodeValue
