...
/**
 * Unit tests for {@link Google\Api\Ads\Common\Util\AuthToken}.
 * @group small
 */
class AuthTokenTest extends PHPUnit_Framework_TestCase {
  ...
  protected function setUp() {
    $this->curlUtilsMock = $this->getMockBuilder('Google\Api\Ads\Common\Util\CurlUtils')
  ...
  /**
   * @covers Google\Api\Ads\Common\Util\AuthToken::GetAuthToken
   */
  ...
  /**
   * @covers Google\Api\Ads\Common\Util\AuthToken::GetAuthToken
   * @expectedException Google\Api\Ads\Common\Util\AuthTokenException
   */
