...
use Google\Api\Ads\Common\Util\OgnlUtils;
error_reporting(E_STRICT | E_ALL);

require_once 'Google/Api/Ads/Common/Util/OgnlUtils.php';

/**
 * Unit tests for {@link Google\Api\Ads\Common\Util\OgnlUtils}.
 * @group small
 */
class OgnlUtilsTest extends PHPUnit_Framework_TestCase {
   ...
   * @covers Google\Api\Ads\Common\Util\OgnlUtils::GetValue
   ...
   * @covers Google\Api\Ads\Common\Util\OgnlUtils::GetOperationIndex
