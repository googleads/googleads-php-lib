...
use Google\Api\Ads\Common\Util\ChoiceUtils;
error_reporting(E_STRICT | E_ALL);

require_once 'Google/Api/Ads/Common/Util/ChoiceUtils.php';

/**
 * Unit tests for {@link Google\Api\Ads\Common\Util\ChoiceUtils}.
 * @group small
 */
class ChoiceUtilsTest extends PHPUnit_Framework_TestCase {
   ...
   * @covers Google\Api\Ads\Common\Util\ChoiceUtils::GetValue
