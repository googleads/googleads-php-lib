...
use \SoapFault;
use Google\Api\Ads\Common\Util\ErrorUtils;
use \SoapVar;
...
/**
 * Unit tests for {@link Google\Api\Ads\Common\Util\ErrorUtils}.
 * @group small
 */
class ErrorUtilsTest extends PHPUnit_Framework_TestCase {
   ...
   * @covers Google\Api\Ads\Common\Util\ErrorUtils::GetApiErrors
   ...
   * @param Google\Api\Ads\AdWords\v201402\ApiError $error the ApiError to get the operation for
   * @param int $expected the expected operation
   * @covers Google\Api\Ads\Common\Util\ErrorUtils::GetSourceOperationIndex
