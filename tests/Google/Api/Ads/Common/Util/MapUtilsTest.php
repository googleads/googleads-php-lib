...
/**
 * Unit tests for {@link Google\Api\Ads\Common\Util\MapUtils}.
 * @group small
 */
class MapUtilsTest extends PHPUnit_Framework_TestCase {
   ...
   * @covers Google\Api\Ads\Common\Util\MapUtils::GetMap
   ...
   * @covers Google\Api\Ads\Common\Util\MapUtils::GetMapEntries
   * @dataProvider MapEntriesProvider
   */
  ...
  public function testGetMapEntries_NamedEntries() {
    $map = array('foo' => 'bar');
    $result = MapUtils::GetMapEntries($map, 'Google\Api\Ads\Common\Util\TestMapEntry');
   ...
   * @covers Google\Api\Ads\Common\Util\MapUtils::IsMap
   ...
   * @covers Google\Api\Ads\Common\Util\MapUtils::MapToMethodParameters
