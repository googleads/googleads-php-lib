...
/**
 * Unit tests for {@link Google\Api\Ads\Common\Lib\AdsUser}.
 * @group small
 */
class AdsUserTest extends PHPUnit_Framework_TestCase {
   ...
   * @covers Google\Api\Ads\Common\Lib\AdsUser::LoadSettings
   */
  ...
  public function testLoadSettings_Auth() {
    ...
    $oAuth2HandlerClass = 'Google\Api\Ads\Common\Util\SimpleOAuth2Handler';
    $settings = array(
        'AUTH' => array(
            'AUTH_SERVER' => $server,
  ...
  public function testLoadSettings_Auth_Defaults() {
    ...
    $this->assertEquals('Google\Api\Ads\Common\Util\SimpleOAuth2Handler',
        get_class($user->GetOAuth2Handler()));
  }
...
class TestAdsUser extends AdsUser {
  ...
  const OAUTH2_SCOPE = '';
  const HANDLER_CLASS = 'Google\Api\Ads\Common\Util\SimpleOAuth2Handler';
  ...
  /**
   * @see Google\Api\Ads\Common\Lib\AdsUser::GetUserAgentHeaderName()
   */
  ...
  /**
   * @see Google\Api\Ads\Common\Lib\AdsUser::GetClientLibraryNameAndVersion()
   */
