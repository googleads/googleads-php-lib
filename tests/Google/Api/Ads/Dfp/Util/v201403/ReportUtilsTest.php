...
use Google\Api\Ads\Dfp\Util\v201403\ReportUtils;
error_reporting(E_STRICT | E_ALL);

require_once 'Google/Api/Ads/Dfp/Util/v201403/ReportUtils.php';
...
class ReportUtilsTest extends PHPUnit_Framework_TestCase {
   ...
   * report URL.
   * @covers Google\Api\Ads\Dfp\Util\v201403\ReportUtils::DownloadReport
   */
