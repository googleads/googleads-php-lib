...
use Google\Api\Ads\Dfp\Util\v201403\StatementBuilder;
error_reporting(E_STRICT | E_ALL);

require_once 'Google/Api/Ads/Dfp/Util/v201403/StatementBuilder.php';
...
class StatementBuilderTest extends PHPUnit_Framework_TestCase {
  ...
  /**
   * @covers Google\Api\Ads\Dfp\Util\v201403\StatementBuilder::ToStatement
   */
  ...
  /**
   * @covers Google\Api\Ads\Dfp\Util\v201403\StatementBuilder::ToStatement
   * @covers Google\Api\Ads\Dfp\Util\v201403\StatementBuilder::RemoveLimitAndOffset
   */
  ...
  /**
   * @covers Google\Api\Ads\Dfp\Util\v201403\StatementBuilder::WithBindVariableValue
   */
